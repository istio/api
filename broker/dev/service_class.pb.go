...
func (*ServiceClass) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*Deployment) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*CatalogEntry) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func init() { proto.RegisterFile("broker/dev/service_class.proto", fileDescriptor1) }
