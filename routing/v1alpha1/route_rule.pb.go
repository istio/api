...
type Port struct {
	// Types that are valid to be assigned to Pspec:
	//	*Port_Number
	//	*Port_Name
	Pspec isPort_Pspec `protobuf_oneof:"pspec"`
...
func (*Port) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{12} }

type isPort_Pspec interface {
	isPort_Pspec()
}

type Port_Number struct {
	Number int32 `protobuf:"varint,1,opt,name=number,oneof"`
}
type Port_Name struct {
	Name string `protobuf:"bytes,2,opt,name=name,oneof"`
}

func (*Port_Number) isPort_Pspec() {}
func (*Port_Name) isPort_Pspec()   {}

func (m *Port) GetPspec() isPort_Pspec {
	if m != nil {
		return m.Pspec
	}
	return nil
...
func (m *Port) GetNumber() int32 {
	if x, ok := m.GetPspec().(*Port_Number); ok {
		return x.Number
	}
	return 0
}
...
func (m *Port) GetName() string {
	if x, ok := m.GetPspec().(*Port_Name); ok {
		return x.Name
	}
	return ""
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*Port) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Port_OneofMarshaler, _Port_OneofUnmarshaler, _Port_OneofSizer, []interface{}{
		(*Port_Number)(nil),
		(*Port_Name)(nil),
	}
}

func _Port_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*Port)
	// pspec
	switch x := m.Pspec.(type) {
	case *Port_Number:
	...
	case nil:
	default:
		return fmt.Errorf("Port.Pspec has unexpected type %T", x)
	}
	return nil
}

func _Port_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Port)
	switch tag {
	case 1: // pspec.number
...
func _Port_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*Port)
	// pspec
	switch x := m.Pspec.(type) {
	case *Port_Number:
...
func init() {
	...
	proto.RegisterType((*Port)(nil), "istio.routing.v1alpha1.Port")
}
...
var fileDescriptor5 = []byte{
	...
	,
}
