...
func (*L4FaultInjection) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
type L4FaultInjection_Throttle struct {
	...
	ThrottleForPeriod *google_protobuf.Duration `protobuf:"bytes,6,opt,name=throttle_for_period,json=throttleForPeriod" json:"throttle_for_period,omitempty"`
}
...
func (*L4FaultInjection_Throttle) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 0} }
...
type L4FaultInjection_Throttle_ThrottleAfterPeriod struct {
	ThrottleAfterPeriod *google_protobuf.Duration `protobuf:"bytes,4,opt,name=throttle_after_period,json=throttleAfterPeriod,oneof"`
}
...
func (m *L4FaultInjection_Throttle) GetThrottleAfterPeriod() *google_protobuf.Duration {
...
func (m *L4FaultInjection_Throttle) GetThrottleForPeriod() *google_protobuf.Duration {
	if m != nil {
...
type L4FaultInjection_Terminate struct {
	...
	TerminateAfterPeriod *google_protobuf.Duration `protobuf:"bytes,2,opt,name=terminate_after_period,json=terminateAfterPeriod" json:"terminate_after_period,omitempty"`
}
...
func (*L4FaultInjection_Terminate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 1} }
...
func (m *L4FaultInjection_Terminate) GetTerminateAfterPeriod() *google_protobuf.Duration {
	if m != nil {
...
func init() { proto.RegisterFile("routing/v1alpha1/l4_fault.proto", fileDescriptor0) }
