...
func (*EgressRule) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{0} }
...
func (*EgressRule_Port) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{0, 0} }
...
func init() { proto.RegisterFile("routing/v1alpha1/egress_rule.proto", fileDescriptor2) }
