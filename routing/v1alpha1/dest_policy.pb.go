...
func (*DestinationPolicy) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*LoadBalancing) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*CircuitBreaker) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func init() { proto.RegisterFile("routing/v1alpha1/dest_policy.proto", fileDescriptor1) }
