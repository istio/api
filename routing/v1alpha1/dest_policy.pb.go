...
type LoadBalancing_RingHash_ struct {
	RingHash *LoadBalancing_RingHash `protobuf:"bytes,2,opt,name=ring_hash,json=ringHash,oneof"`
}
type LoadBalancing_Custom struct {
	Custom *google_protobuf.Any `protobuf:"bytes,3,opt,name=custom,oneof"`
}

func (*LoadBalancing_Name) isLoadBalancing_LbPolicy()      {}
func (*LoadBalancing_RingHash_) isLoadBalancing_LbPolicy() {}
...
func (m *LoadBalancing) GetRingHash() *LoadBalancing_RingHash {
	if x, ok := m.GetLbPolicy().(*LoadBalancing_RingHash_); ok {
		return x.RingHash
	}
	return nil
}
...
func _LoadBalancing_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // lb_policy.name
		...
		return true, err
	case 2: // lb_policy.ring_hash
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(LoadBalancing_RingHash)
		err := b.DecodeMessage(msg)
		m.LbPolicy = &LoadBalancing_RingHash_{msg}
		return true, err
	case 3: // lb_policy.custom
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
...
type LoadBalancing_RingHash struct {
	// REQUIRED.Minimum ring size (e.g. virtual nodes). A larger size will provide better
	// request distribution since each host in the cluster will have more virtual
	// nodes. If the number of hosts is greater than the ring size, each host
	// will be allocated a single virtual node.
	RingSize uint32 `protobuf:"varint,1,opt,name=ring_size,json=ringSize" json:"ring_size,omitempty"`
	// Use Envoy standard hash in the ring. If false, Envoy will use xxHash.
	StdHash bool `protobuf:"varint,2,opt,name=std_hash,json=stdHash" json:"std_hash,omitempty"`
}

func (m *LoadBalancing_RingHash) Reset()                    { *m = LoadBalancing_RingHash{} }
func (m *LoadBalancing_RingHash) String() string            { return proto.CompactTextString(m) }
func (*LoadBalancing_RingHash) ProtoMessage()               {}
func (*LoadBalancing_RingHash) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1, 0} }

func (m *LoadBalancing_RingHash) GetRingSize() uint32 {
	if m != nil {
		return m.RingSize
	}
	return 0
...
func (m *LoadBalancing_RingHash) GetStdHash() bool {
	if m != nil {
		return m.StdHash
	}
	return false
...
func init() {
	...
	proto.RegisterType((*LoadBalancing_RingHash)(nil), "istio.routing.v1alpha1.LoadBalancing.RingHash")
...
var fileDescriptor0 = []byte{
	...
	,
}
