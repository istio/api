...
type DestinationPolicy struct {
	...
	Custom *google_protobuf1.Any `protobuf:"bytes,100,opt,name=custom" json:"custom,omitempty"`
}
...
func (*DestinationPolicy) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (m *DestinationPolicy) GetCustom() *google_protobuf1.Any {
	if m != nil {
		return m.Custom
	}
	return nil
...
func (*LoadBalancing) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1} }
...
func (m *LoadBalancing) GetCustom() *google_protobuf1.Any {
...
func (*CircuitBreaker) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{2} }
...
func (m *CircuitBreaker) GetCustom() *google_protobuf1.Any {
...
type CircuitBreaker_SimpleCircuitBreakerPolicy struct {
	...
	HttpDetectionInterval *google_protobuf.Duration `protobuf:"bytes,6,opt,name=http_detection_interval,json=httpDetectionInterval" json:"http_detection_interval,omitempty"`
...
func (m *CircuitBreaker_SimpleCircuitBreakerPolicy) GetSleepWindow() *google_protobuf.Duration {
	if m != nil {
...
func (m *CircuitBreaker_SimpleCircuitBreakerPolicy) GetHttpDetectionInterval() *google_protobuf.Duration {
	if m != nil {
...
func init() { proto.RegisterFile("routing/v1alpha1/dest_policy.proto", fileDescriptor4) }
