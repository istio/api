...
type Destination struct {
	...
	//	*Destination_Port
	DestinationPort isDestination_DestinationPort `protobuf_oneof:"destination_port"`
}
...
type isDestination_DestinationPort interface {
	isDestination_DestinationPort()
}

type Destination_PortName struct {
	PortName string `protobuf:"bytes,3,opt,name=port_name,json=portName,oneof"`
}
type Destination_Port struct {
	Port uint32 `protobuf:"varint,4,opt,name=port,oneof"`
}

func (*Destination_PortName) isDestination_DestinationPort() {}
func (*Destination_Port) isDestination_DestinationPort()     {}

func (m *Destination) GetDestinationPort() isDestination_DestinationPort {
	if m != nil {
...
func (m *Destination) GetPortName() string {
	if x, ok := m.GetDestinationPort().(*Destination_PortName); ok {
		return x.PortName
	}
	return ""
}
...
func (m *Destination) GetPort() uint32 {
	if x, ok := m.GetDestinationPort().(*Destination_Port); ok {
		return x.Port
	}
	return 0
}
...
func _Destination_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case nil:
	default:
		return fmt.Errorf("Destination.DestinationPort has unexpected type %T", x)
	}
	return nil
}
...
func _Destination_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Destination)
	switch tag {
	case 3: // destination_port.port_name
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.DestinationPort = &Destination_PortName{x}
		return true, err
	case 4: // destination_port.port
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.DestinationPort = &Destination_Port{uint32(x)}
		return true, err
	default:
		return false, nil
	}
...
//           incomingPortName: redis #only applies to ports named redis
//         route:
//         - destination:
//             name: redis.prod
//
...
type HTTPMatchRequest struct {
	...
	//	*HTTPMatchRequest_IncomingPortName
	//	*HTTPMatchRequest_IncomingPort
...
type HTTPMatchRequest_IncomingPortName struct {
	IncomingPortName string `protobuf:"bytes,6,opt,name=incoming_port_name,json=incomingPortName,oneof"`
}
type HTTPMatchRequest_IncomingPort struct {
	IncomingPort uint32 `protobuf:"varint,7,opt,name=incoming_port,json=incomingPort,oneof"`
}

func (*HTTPMatchRequest_IncomingPortName) isHTTPMatchRequest_Port() {}
func (*HTTPMatchRequest_IncomingPort) isHTTPMatchRequest_Port()     {}
...
func (m *HTTPMatchRequest) GetIncomingPortName() string {
	if x, ok := m.GetPort().(*HTTPMatchRequest_IncomingPortName); ok {
		return x.IncomingPortName
	}
	return ""
}

func (m *HTTPMatchRequest) GetIncomingPort() uint32 {
	if x, ok := m.GetPort().(*HTTPMatchRequest_IncomingPort); ok {
...
func (*HTTPMatchRequest) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _HTTPMatchRequest_OneofMarshaler, _HTTPMatchRequest_OneofUnmarshaler, _HTTPMatchRequest_OneofSizer, []interface{}{
		(*HTTPMatchRequest_IncomingPortName)(nil),
		(*HTTPMatchRequest_IncomingPort)(nil),
	}
}
...
func _HTTPMatchRequest_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *HTTPMatchRequest_IncomingPortName:
		b.EncodeVarint(6<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.IncomingPortName)
	case *HTTPMatchRequest_IncomingPort:
		b.EncodeVarint(7<<3 | proto.WireVarint)
		b.EncodeVarint(uint64(x.IncomingPort))
	case nil:
	default:
...
func _HTTPMatchRequest_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*HTTPMatchRequest)
	switch tag {
	case 6: // port.incoming_port_name
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Port = &HTTPMatchRequest_IncomingPortName{x}
		return true, err
	case 7: // port.incoming_port
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.Port = &HTTPMatchRequest_IncomingPort{uint32(x)}
		return true, err
	default:
		return false, nil
	}
...
func _HTTPMatchRequest_OneofSizer(msg proto.Message) (n int) {
	...
	case *HTTPMatchRequest_IncomingPortName:
		...
		n += proto.SizeVarint(uint64(len(x.IncomingPortName)))
		n += len(x.IncomingPortName)
	case *HTTPMatchRequest_IncomingPort:
		n += proto.SizeVarint(7<<3 | proto.WireVarint)
		n += proto.SizeVarint(uint64(x.IncomingPort))
	case nil:
	default:
		panic(fmt.Sprintf("proto: unexpected type %T in oneof", x))
	}
...
type L4MatchAttributes struct {
	...
	//
	// Types that are valid to be assigned to Port:
	//	*L4MatchAttributes_IncomingPortName
	//	*L4MatchAttributes_IncomingPort
...
type L4MatchAttributes_IncomingPortName struct {
	IncomingPortName string `protobuf:"bytes,2,opt,name=incoming_port_name,json=incomingPortName,oneof"`
}
type L4MatchAttributes_IncomingPort struct {
	IncomingPort uint32 `protobuf:"varint,3,opt,name=incoming_port,json=incomingPort,oneof"`
}

func (*L4MatchAttributes_IncomingPortName) isL4MatchAttributes_Port() {}
func (*L4MatchAttributes_IncomingPort) isL4MatchAttributes_Port()     {}
...
func (m *L4MatchAttributes) GetIncomingPortName() string {
	if x, ok := m.GetPort().(*L4MatchAttributes_IncomingPortName); ok {
		return x.IncomingPortName
	}
	return ""
}

func (m *L4MatchAttributes) GetIncomingPort() uint32 {
	if x, ok := m.GetPort().(*L4MatchAttributes_IncomingPort); ok {
		return x.IncomingPort
	}
	return 0
}
...
func (*L4MatchAttributes) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _L4MatchAttributes_OneofMarshaler, _L4MatchAttributes_OneofUnmarshaler, _L4MatchAttributes_OneofSizer, []interface{}{
		(*L4MatchAttributes_IncomingPortName)(nil),
		(*L4MatchAttributes_IncomingPort)(nil),
	}
}
...
func _L4MatchAttributes_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	// port
	switch x := m.Port.(type) {
	case *L4MatchAttributes_IncomingPortName:
		b.EncodeVarint(2<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.IncomingPortName)
	case *L4MatchAttributes_IncomingPort:
...
func _L4MatchAttributes_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*L4MatchAttributes)
	switch tag {
	case 2: // port.incoming_port_name
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Port = &L4MatchAttributes_IncomingPortName{x}
		return true, err
	case 3: // port.incoming_port
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.Port = &L4MatchAttributes_IncomingPort{uint32(x)}
		return true, err
	default:
		return false, nil
	}
...
var fileDescriptor1 = []byte{
	...
	,
}
