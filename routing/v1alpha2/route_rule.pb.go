...
//           uri: "/api/v2"
//         route:
//         - destinationId: reviews-v2
//           weight: 100
//       - route:
//         - destinationId: reviews-v1
//           weight: 100
//       destinations:
//       - id: reviews-v1
//         name: reviews
//         labels:
//           version: v1
//         ..more settings like circuit breakers..
//       - id: reviews-v2
//         name: reviews
//         labels:
//           version: v2
...
type RouteRule struct {
	...
	// Definitions of the destinations defined in the routes earlier. The
	// destination definition indicates the service/subsets of a service to
	// which requests/connections should be forwarded to, as well as
	// properties such as circuit breakers, connection pool size, etc.
	Destinations []*Destination `protobuf:"bytes,5,rep,name=destinations" json:"destinations,omitempty"`
}
...
func (m *RouteRule) GetDestinations() []*Destination {
	if m != nil {
...
type Destination struct {
	// The ID associated with this destination configuration. One or more
	// routes in a single rule can refer to this configuration by its
	// ID. These IDs are not visible outside the scope of this routing
	// rule. Two rules with same destination IDs may refer to entirely
	...
	// label>.
	Port *PortSelector `protobuf:"bytes,4,opt,name=port" json:"port,omitempty"`
}
...
type DestinationWeight struct {
	// REQUIRED. The ID associated with the destination to which the
	// requests/connections will be routed to. The list of destinations must
	// be defined as part of the routing rule.
...
func (m *DestinationWeight) GetDestinationId() string {
	if m != nil {
...
var fileDescriptor1 = []byte{
	...
	,
}
