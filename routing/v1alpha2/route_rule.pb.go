...
type RouteRule struct {
	...
	UpstreamSettings *UpstreamSettings `protobuf:"bytes,7,opt,name=upstream_settings,json=upstreamSettings" json:"upstream_settings,omitempty"`
}
...
func (m *RouteRule) GetSource() []*Endpoint {
	if m != nil {
		return m.Source
	}
	return nil
...
func (m *RouteRule) GetTrafficPassthrough() bool {
	if m != nil {
...
var fileDescriptor1 = []byte{
	...
	,
}
