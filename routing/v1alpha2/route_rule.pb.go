...
type HTTPRoute struct {
	...
	// HashPolicy specifies the route's hashing policy if the upstream cluster
	// is using a hashing load balancer.
	HashPolicy *HashPolicy `protobuf:"bytes,12,opt,name=hash_policy,json=hashPolicy" json:"hash_policy,omitempty"`
}
...
func (m *HTTPRoute) GetHashPolicy() *HashPolicy {
	if m != nil {
		return m.HashPolicy
	}
	return nil
...
type HashPolicy struct {
	...
	// random number as the hash, rendering load balancing policy random.
...
func (*HashPolicy) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{13} }

func (m *HashPolicy) GetHeaderName() string {
	if m != nil {
		return m.HeaderName
	}
	return ""
...
func (*PortSelector) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{14} }
...
func init() {
	...
	proto.RegisterType((*HashPolicy)(nil), "istio.routing.v1alpha2.HashPolicy")
...
var fileDescriptor3 = []byte{
	...
	,
}
