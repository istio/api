...
type CorsPolicy struct {
	...
	AllowCredentials *google_protobuf3.BoolValue `protobuf:"bytes,6,opt,name=allow_credentials,json=allowCredentials" json:"allow_credentials,omitempty"`
}
...
func (m *CorsPolicy) GetAllowCredentials() *google_protobuf3.BoolValue {
	if m != nil {
