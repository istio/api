...
//       hosts:
//       - reviews
//       exposure: # if omitted, defaults to "mesh"
//       - bookinfo
//       - mesh
//       http:
//       - match:
...
type RouteRule struct {
	...
	// the mesh. When this field is omitted, the default exposure ("mesh")
	...
	// specify "mesh" as one of the exposure values.
	Exposure []string `protobuf:"bytes,2,rep,name=exposure" json:"exposure,omitempty"`
...
func (m *RouteRule) GetExposure() []string {
	if m != nil {
		return m.Exposure
	}
	return nil
...
var fileDescriptor2 = []byte{
	...
	,
}
