...
// RouteRule for usage examples. The destination.name should unambiguously
// refer to a service in the service registry. It can be a short name or a
// fully qualified domain name from the service registry, a resolvable DNS
// name, an IP address or a service name from the service registry and a
// subset name. The order of inference is as follows:
//
...
// by a dot (e.g., reviews.prod), one of the following
...
type Destination struct {
	...
	// name from the service registry, a resolvable DNS name, a service name
	// from the service registry prefixed with a subset name or an IP
	// address. The order of inference is as follows:
	//
