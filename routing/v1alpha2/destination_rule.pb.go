...
func (TLSSettings_TLSmode) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{6, 0} }
...
func (*DestinationRule) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*TrafficPolicy) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*Subset) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func (*LoadBalancerSettings) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{3} }
...
func (*ConnectionPoolSettings) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{4} }
...
func (*OutlierDetection) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{5} }
...
func (*TLSSettings) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{6} }
...
func init() { proto.RegisterFile("routing/v1alpha2/destination_rule.proto", fileDescriptor1) }
