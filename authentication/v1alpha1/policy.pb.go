...
type Policy struct {
	...
	// List rules to select workloads that the policy should be applied on.
	// Different from TargetSelector, WorkloadSelector is based on the labels
	// and ports.
	// If empty, policy will be used on all workloads in the same namespace.
	Selectors []*WorkloadSelector `protobuf:"bytes,10,rep,name=selectors" json:"selectors,omitempty"`
...
func (m *Policy) GetSelectors() []*WorkloadSelector {
	if m != nil {
		return m.Selectors
	}
	return nil
...
type WorkloadSelector struct {
	...
	MatchLabels map[string]string `protobuf:"bytes,1,rep,name=match_labels,json=matchLabels" json:"match_labels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Limit the policy's scope to workloads only on these ports. Leave empty to apply to all ports
	// (provided by the selected pods/VM)
	Ports []uint32 `protobuf:"varint,2,rep,packed,name=ports" json:"ports,omitempty"`
}
...
func (*WorkloadSelector) Descriptor() ([]byte, []int) { return fileDescriptorPolicy, []int{8} }
...
func (m *WorkloadSelector) GetPorts() []uint32 {
	if m != nil {
		return m.Ports
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*WorkloadSelector)(nil), "istio.authentication.v1alpha1.WorkloadSelector")
...
func (m *WorkloadSelector) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Ports) > 0 {
		dAtA8 := make([]byte, len(m.Ports)*10)
		var j7 int
...
func (m *Policy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			m.Selectors = append(m.Selectors, &WorkloadSelector{})
...
var fileDescriptorPolicy = []byte{
	...
	,
}
