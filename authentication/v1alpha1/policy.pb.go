...
type Jwt struct {
	...
	//	*Jwt_JwksUri
	//	*Jwt_JwksInline
	Jwks isJwt_Jwks `protobuf_oneof:"jwks"`
...
type Jwt_JwksInline struct {
	JwksInline string `protobuf:"bytes,4,opt,name=jwks_inline,json=jwksInline,proto3,oneof"`
}

func (*Jwt_JwksUri) isJwt_Jwks()    {}
func (*Jwt_JwksInline) isJwt_Jwks() {}

func (m *Jwt) GetJwks() isJwt_Jwks {
	if m != nil {
		return m.Jwks
	}
	return nil
...
func (m *Jwt) GetJwksUri() string {
	if x, ok := m.GetJwks().(*Jwt_JwksUri); ok {
		return x.JwksUri
	}
	return ""
}

func (m *Jwt) GetJwksInline() string {
	if x, ok := m.GetJwks().(*Jwt_JwksInline); ok {
		return x.JwksInline
	}
	return ""
}
...
func _Jwt_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Jwt_JwksInline:
		...
		_ = b.EncodeStringBytes(x.JwksInline)
	case nil:
	default:
		return fmt.Errorf("Jwt.Jwks has unexpected type %T", x)
	}
	return nil
}
...
func _Jwt_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Jwt)
	switch tag {
	case 3: // jwks.jwks_uri
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Jwks = &Jwt_JwksUri{x}
		return true, err
	case 4: // jwks.jwks_inline
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Jwks = &Jwt_JwksInline{x}
		return true, err
	default:
		return false, nil
	}
...
func _Jwt_OneofSizer(msg proto.Message) (n int) {
	...
	case *Jwt_JwksInline:
		...
		n += proto.SizeVarint(uint64(len(x.JwksInline)))
		n += len(x.JwksInline)
	case nil:
	default:
...
func (m *Jwt) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Jwks != nil {
		nn1, err := m.Jwks.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn1
...
func (m *Jwt_JwksInline) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	dAtA[i] = 0x22
	i++
	i = encodeVarintPolicy(dAtA, i, uint64(len(m.JwksInline)))
	i += copy(dAtA[i:], m.JwksInline)
	return i, nil
}
...
func (m *Jwt_JwksInline) Size() (n int) {
	var l int
	_ = l
	l = len(m.JwksInline)
	n += 1 + l + sovPolicy(uint64(l))
...
func (m *Jwt) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Jwks = &Jwt_JwksUri{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JwksInline", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Jwks = &Jwt_JwksInline{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
...
var fileDescriptorPolicy = []byte{
	...
	,
}
