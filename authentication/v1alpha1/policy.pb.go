...
type Jwt struct {
	...
	JwtHeaders []string `protobuf:"bytes,4,rep,name=jwt_headers,json=jwtHeaders" json:"jwt_headers,omitempty"`
	// JWT is sent in a query parameter. `query` represents the
	// query parameter name.
	//
	// For example, `query=jwt_token`.
	JwtParams []string `protobuf:"bytes,5,rep,name=jwt_params,json=jwtParams" json:"jwt_params,omitempty"`
}
...
var fileDescriptorPolicy = []byte{
	...
	0x14, 0x8d, 0xeb, 0xc4, 0x4d, 0x6e, 0xfa, 0x45, 0xf9, 0x46, 0x08, 0x99, 0x9f, 0x96, 0xca, 0xea,
	...
	,
}
