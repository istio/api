...
type Jwt struct {
	...
	// Types that are valid to be assigned to JwksType:
	//	*Jwt_JwksUri
	//	*Jwt_Jwks
	JwksType isJwt_JwksType `protobuf_oneof:"jwks_type"`
...
type isJwt_JwksType interface {
	isJwt_JwksType()
	MarshalTo([]byte) (int, error)
	Size() int
}

type Jwt_JwksUri struct {
	JwksUri string `protobuf:"bytes,3,opt,name=jwks_uri,json=jwksUri,proto3,oneof"`
}
type Jwt_Jwks struct {
	Jwks string `protobuf:"bytes,10,opt,name=jwks,proto3,oneof"`
}

func (*Jwt_JwksUri) isJwt_JwksType() {}
func (*Jwt_Jwks) isJwt_JwksType()    {}

func (m *Jwt) GetJwksType() isJwt_JwksType {
	if m != nil {
		return m.JwksType
	}
	return nil
...
func (m *Jwt) GetJwksUri() string {
	if x, ok := m.GetJwksType().(*Jwt_JwksUri); ok {
		return x.JwksUri
	}
	return ""
}
...
func (m *Jwt) GetJwks() string {
	if x, ok := m.GetJwksType().(*Jwt_Jwks); ok {
		return x.Jwks
	}
	return ""
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*Jwt) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Jwt_OneofMarshaler, _Jwt_OneofUnmarshaler, _Jwt_OneofSizer, []interface{}{
		(*Jwt_JwksUri)(nil),
		(*Jwt_Jwks)(nil),
	}
}

func _Jwt_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*Jwt)
	// jwks_type
	switch x := m.JwksType.(type) {
	case *Jwt_JwksUri:
		_ = b.EncodeVarint(3<<3 | proto.WireBytes)
	...
	case nil:
	default:
		return fmt.Errorf("Jwt.JwksType has unexpected type %T", x)
	}
	return nil
}

func _Jwt_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Jwt)
	switch tag {
	case 3: // jwks_type.jwks_uri
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.JwksType = &Jwt_JwksUri{x}
		return true, err
	case 10: // jwks_type.jwks
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.JwksType = &Jwt_Jwks{x}
		return true, err
	default:
		return false, nil
	}
...
func _Jwt_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*Jwt)
	// jwks_type
	switch x := m.JwksType.(type) {
	case *Jwt_JwksUri:
...
func (m *Jwt) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.JwksType != nil {
		nn2, err := m.JwksType.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn2
...
func (m *Jwt_JwksUri) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	dAtA[i] = 0x1a
	i++
...
func (m *Jwt_Jwks) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	dAtA[i] = 0x52
	i++
...
func (m *Jwt) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.JwksType = &Jwt_JwksUri{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
		...
		case 10:
			...
			m.JwksType = &Jwt_Jwks{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPolicy(dAtA[iNdEx:])
...
var fileDescriptorPolicy = []byte{
	...
	,
}
