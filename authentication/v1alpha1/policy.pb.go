...
func (x *PeerAuthenticationMethod) GetParams() isPeerAuthenticationMethod_Params {
	if x != nil {
		return x.Params
	}
	return nil
...
func (x *PeerAuthenticationMethod) GetMtls() *MutualTls {
	if x != nil {
		if x, ok := x.Params.(*PeerAuthenticationMethod_Mtls); ok {
			return x.Mtls
		}
	}
	return nil
...
func (x *PeerAuthenticationMethod) GetJwt() *Jwt {
	if x != nil {
		if x, ok := x.Params.(*PeerAuthenticationMethod_Jwt); ok {
			return x.Jwt
		}
	}
	return nil
...
func (x *PortSelector) GetPort() isPortSelector_Port {
	if x != nil {
		return x.Port
	}
	return nil
...
func (x *PortSelector) GetNumber() uint32 {
	if x != nil {
		if x, ok := x.Port.(*PortSelector_Number); ok {
			return x.Number
		}
	}
	return 0
...
func (x *PortSelector) GetName() string {
	if x != nil {
		if x, ok := x.Port.(*PortSelector_Name); ok {
			return x.Name
		}
	}
	return ""
...
const file_authentication_v1alpha1_policy_proto_rawDesc = "" +
	"\n" +
	...
	"\x05regex\x18\x04 \x01(\tH\x00R\x05regexB\f\n" +
	"\n" +
	"match_type\"\x93\x01\n" +
	"\tMutualTls\x12\x1f\n" +
	"\tallow_tls\x18\x01 \x01(\bB\x02\x18\x01R\ballowTls\x12A\n" +
	"\x04mode\x18\x02 \x01(\x0e2-.istio.authentication.v1alpha1.MutualTls.ModeR\x04mode\"\"\n" +
	"\x04Mode\x12\n" +
	"\n" +
	...
	"\vjwt_headers\x18\x06 \x03(\tR\n" +
	"jwtHeaders\x12\x1d\n" +
	"\n" +
	"jwt_params\x18\a \x03(\tR\tjwtParams\x12S\n" +
	"\rtrigger_rules\x18\t \x03(\v2..istio.authentication.v1alpha1.Jwt.TriggerRuleR\ftriggerRules\x1a\xb3\x01\n" +
	"\vTriggerRule\x12Q\n" +
	"\x0eexcluded_paths\x18\x01 \x03(\v2*.istio.authentication.v1alpha1.StringMatchR\rexcludedPaths\x12Q\n" +
	"\x0eincluded_paths\x18\x02 \x03(\v2*.istio.authentication.v1alpha1.StringMatchR\rincludedPaths\"\xa0\x01\n" +
	"\x18PeerAuthenticationMethod\x12>\n" +
	"\x04mtls\x18\x01 \x01(\v2(.istio.authentication.v1alpha1.MutualTlsH\x00R\x04mtls\x12:\n" +
	"\x03jwt\x18\x02 \x01(\v2\".istio.authentication.v1alpha1.JwtB\x02\x18\x01H\x00R\x03jwtB\b\n" +
	"\x06params\"R\n" +
	"\x1aOriginAuthenticationMethod\x124\n" +
	"\x03jwt\x18\x01 \x01(\v2\".istio.authentication.v1alpha1.JwtR\x03jwt\"\xbf\x03\n" +
	"\x06Policy\x12K\n" +
	"\atargets\x18\x01 \x03(\v2-.istio.authentication.v1alpha1.TargetSelectorB\x02\x18\x01R\atargets\x12M\n" +
	"\x05peers\x18\x02 \x03(\v27.istio.authentication.v1alpha1.PeerAuthenticationMethodR\x05peers\x12,\n" +
	"\x10peer_is_optional\x18\x03 \x01(\bB\x02\x18\x01R\x0epeerIsOptional\x12W\n" +
	"\aorigins\x18\x04 \x03(\v29.istio.authentication.v1alpha1.OriginAuthenticationMethodB\x02\x18\x01R\aorigins\x120\n" +
	"\x12origin_is_optional\x18\x05 \x01(\bB\x02\x18\x01R\x10originIsOptional\x12`\n" +
	"\x11principal_binding\x18\x06 \x01(\x0e2/.istio.authentication.v1alpha1.PrincipalBindingB\x02\x18\x01R\x10principalBinding\"{\n" +
	"\x0eTargetSelector\x12\x18\n" +
	"\x04name\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\x04name\x12A\n" +
	"\x05ports\x18\x02 \x03(\v2+.istio.authentication.v1alpha1.PortSelectorR\x05portsJ\x04\b\x03\x10\x04R\x06labels\"F\n" +
	"\fPortSelector\x12\x18\n" +
	"\x06number\x18\x01 \x01(\rH\x00R\x06number\x12\x14\n" +
	"\x04name\x18\x02 \x01(\tH\x00R\x04nameB\x06\n" +
	"\x04port*0\n" +
	"\x10PrincipalBinding\x12\f\n" +
	"\bUSE_PEER\x10\x00\x12\x0e\n" +
	"\n" +
	"USE_ORIGIN\x10\x01B&Z$istio.io/api/authentication/v1alpha1b\x06proto3"

var (
	file_authentication_v1alpha1_policy_proto_rawDescOnce sync.Once
	file_authentication_v1alpha1_policy_proto_rawDescData []byte
)
...
func file_authentication_v1alpha1_policy_proto_rawDescGZIP() []byte {
	file_authentication_v1alpha1_policy_proto_rawDescOnce.Do(func() {
		file_authentication_v1alpha1_policy_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_authentication_v1alpha1_policy_proto_rawDesc), len(file_authentication_v1alpha1_policy_proto_rawDesc)))
	})
...
func file_authentication_v1alpha1_policy_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_authentication_v1alpha1_policy_proto_rawDesc), len(file_authentication_v1alpha1_policy_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
