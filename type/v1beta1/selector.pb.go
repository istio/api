...
// ProtocolSelector is the criteria for specifying if a policy can be applied to
// traffic of a specific protocol.
type ProtocolSelector int32

const (
	// Default value, which will be interpreted by its own usage.
	ProtocolSelector_P_UNDEFINED ProtocolSelector = 0
	// Applies Policy to HTTP traffic only.
	ProtocolSelector_HTTP ProtocolSelector = 1
	// Applies Policy to TCP traffic only.
	ProtocolSelector_TCP ProtocolSelector = 2
	// Applies Policy to all traffic.
	ProtocolSelector_ANY ProtocolSelector = 3
)

// Enum value maps for ProtocolSelector.
var (
	ProtocolSelector_name = map[int32]string{
		0: "P_UNDEFINED",
		1: "HTTP",
		2: "TCP",
		3: "ANY",
	}
	ProtocolSelector_value = map[string]int32{
		"P_UNDEFINED": 0,
		"HTTP":        1,
		"TCP":         2,
		"ANY":         3,
...
func (x ProtocolSelector) Enum() *ProtocolSelector {
	p := new(ProtocolSelector)
	*p = x
	return p
}
...
func (ProtocolSelector) Descriptor() protoreflect.EnumDescriptor {
	return file_type_v1beta1_selector_proto_enumTypes[1].Descriptor()
}

func (ProtocolSelector) Type() protoreflect.EnumType {
	return &file_type_v1beta1_selector_proto_enumTypes[1]
}

func (x ProtocolSelector) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ProtocolSelector.Descriptor instead.
func (ProtocolSelector) EnumDescriptor() ([]byte, []int) {
...
type PortSelector struct {
	...
	Protocol ProtocolSelector `protobuf:"varint,2,opt,name=protocol,proto3,enum=istio.type.v1beta1.ProtocolSelector" json:"protocol,omitempty"`
}
...
func (x *PortSelector) GetProtocol() ProtocolSelector {
	if x != nil {
		return x.Protocol
	}
	return ProtocolSelector_P_UNDEFINED
}
...
var file_type_v1beta1_selector_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x68, 0x0a, 0x0c, 0x50, 0x6f, 0x72, 0x74, 0x53, 0x65,
	0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x40,
	...
	0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x53, 0x65,
	0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c,
	...
	0x54, 0x5f, 0x41, 0x4e, 0x44, 0x5f, 0x53, 0x45, 0x52, 0x56, 0x45, 0x52, 0x10, 0x03, 0x2a, 0x3f,
	0x0a, 0x10, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74,
	0x6f, 0x72, 0x12, 0x0f, 0x0a, 0x0b, 0x50, 0x5f, 0x55, 0x4e, 0x44, 0x45, 0x46, 0x49, 0x4e, 0x45,
	0x44, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x48, 0x54, 0x54, 0x50, 0x10, 0x01, 0x12, 0x07, 0x0a,
	0x03, 0x54, 0x43, 0x50, 0x10, 0x02, 0x12, 0x07, 0x0a, 0x03, 0x41, 0x4e, 0x59, 0x10, 0x03, 0x42,
	0x1b, 0x5a, 0x19, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x69, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x2f,
...
var file_type_v1beta1_selector_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_type_v1beta1_selector_proto_goTypes = []interface{}{
	...
	(ProtocolSelector)(0),    // 1: istio.type.v1beta1.ProtocolSelector
	(*WorkloadSelector)(nil), // 2: istio.type.v1beta1.WorkloadSelector
	(*PortSelector)(nil),     // 3: istio.type.v1beta1.PortSelector
...
var file_type_v1beta1_selector_proto_depIdxs = []int32{
	...
	1, // 1: istio.type.v1beta1.PortSelector.protocol:type_name -> istio.type.v1beta1.ProtocolSelector
