...
type MeshConfig struct {
	...
	// Port on which Istio Ingress should listen for inbound http traffic.
	IngressHttpPort int32 `protobuf:"varint,16,opt,name=ingress_http_port,json=ingressHttpPort" json:"ingress_http_port,omitempty"`
	// Port on which Istio Ingress should listen for inbound https traffic.
	IngressHttpsPort int32 `protobuf:"varint,17,opt,name=ingress_https_port,json=ingressHttpsPort" json:"ingress_https_port,omitempty"`
}
...
func (m *MeshConfig) GetIngressHttpPort() int32 {
	if m != nil {
		return m.IngressHttpPort
	}
	return 0
}

func (m *MeshConfig) GetIngressHttpsPort() int32 {
	if m != nil {
		return m.IngressHttpsPort
	}
	return 0
}
...
var fileDescriptor5 = []byte{
	...
	,
}
