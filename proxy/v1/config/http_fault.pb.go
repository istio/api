...
func (*HTTPFaultInjection) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*HTTPFaultInjection_Delay) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0, 0} }
...
func (*HTTPFaultInjection_Abort) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0, 1} }
...
func init() { proto.RegisterFile("proxy/v1/config/http_fault.proto", fileDescriptor1) }
