...
func (x PluginConfig_MetadataMode) Enum() *PluginConfig_MetadataMode {
	p := new(PluginConfig_MetadataMode)
	*p = x
	return p
}

func (x PluginConfig_MetadataMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PluginConfig_MetadataMode) Descriptor() protoreflect.EnumDescriptor {
	return file_envoy_extensions_stats_config_proto_enumTypes[1].Descriptor()
}

func (PluginConfig_MetadataMode) Type() protoreflect.EnumType {
	return &file_envoy_extensions_stats_config_proto_enumTypes[1]
}

func (x PluginConfig_MetadataMode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PluginConfig_MetadataMode.Descriptor instead.
func (PluginConfig_MetadataMode) EnumDescriptor() ([]byte, []int) {
	return file_envoy_extensions_stats_config_proto_rawDescGZIP(), []int{2, 0}
}
...
type PluginConfig struct {
	...
	MetadataMode PluginConfig_MetadataMode `protobuf:"varint,10,opt,name=metadata_mode,json=metadataMode,proto3,enum=stats.PluginConfig_MetadataMode" json:"metadata_mode,omitempty"`
}
...
func (x *PluginConfig) GetMetadataMode() PluginConfig_MetadataMode {
	if x != nil {
...
var file_envoy_extensions_stats_config_proto_rawDesc = []byte{
	...
	0x45, 0x0a, 0x0d, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x6d, 0x6f, 0x64, 0x65,
	...
	0x52, 0x41, 0x4d, 0x10, 0x02, 0x42, 0x25, 0x5a, 0x23, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x69,
	0x6f, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2f, 0x65, 0x78, 0x74, 0x65,
	0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x73, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_envoy_extensions_stats_config_proto_goTypes = []interface{}{
	...
	(PluginConfig_MetadataMode)(0), // 1: stats.PluginConfig.MetadataMode
...
var file_envoy_extensions_stats_config_proto_depIdxs = []int32{
	...
	1, // 5: stats.PluginConfig.metadata_mode:type_name -> stats.PluginConfig.MetadataMode
