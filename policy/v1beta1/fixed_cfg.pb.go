...
//
// In the following example we define a `metrics` handler for `prometheus` adapter.
// The example is in the form of kubernetes resource:
...
type Handler struct {
	...
	Connection interface{} `protobuf:"bytes,4,opt,name=connection" json:"connection,omitempty"`
}
...
func (m *Handler) GetConnection() interface{} {
	if m != nil {
		return m.Connection
	}
	return nil
...
var fileDescriptorCfg = []byte{
	...
	,
}
