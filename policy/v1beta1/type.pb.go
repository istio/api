...
// An instance field of type Duration denotes that the expression for the field must evaluatee to
...
// An instance field of type TimeStamp denotes that the expression for the field must evaluatee to
...
// An instance field of type DNSName denotes that the expression for the field must evaluatee to
...
// An instance field of type EmailAddress denotes that the expression for the field must evaluatee to
...
// DO NOT USE !! Under Development
// An instance field of type Uri denotes that the expression for the field must evaluatee to
