...
// source: policy/v1beta/cfg.proto
...
/*
	...
	It is generated from these files:
		...
		policy/v1beta/value_type.proto
...
// [`AttributeInfo`][istio.policy.v1beta] is used to define an attribute's
...
type AttributeManifest_AttributeInfo struct {
	...
	ValueType ValueType `protobuf:"varint,2,opt,name=value_type,json=valueType,proto3,enum=istio.policy.v1beta.ValueType" json:"value_type,omitempty"`
}
...
// Action describes which [Handler][istio.policy.v1beta.Handler] to invoke and what data to pass to it for processing.
//
...
type Action struct {
	...
	// Must match the `name` of a [Handler][istio.policy.v1beta.Handler.name].
	...
	// [Instance][istio.policy.v1beta.Instance.name]s.
...
// Instances produced with this instance can be referenced by [Actions][istio.policy.v1beta.Action] using name
// 'RequestCountByService'.
//
// ```yaml
...
type Instance struct {
	...
	//
	// Must be unique amongst other Instances in scope. Used by [Action][istio.policy.v1beta.Action] to refer
...
// ```
type Handler struct {
	// Required. Must be unique in the entire mixer configuration. Used by [Actions][istio.policy.v1beta.Action.handler]
...
func init() {
	proto.RegisterType((*AttributeManifest)(nil), "istio.policy.v1beta.AttributeManifest")
	proto.RegisterType((*AttributeManifest_AttributeInfo)(nil), "istio.policy.v1beta.AttributeManifest.AttributeInfo")
	proto.RegisterType((*Rule)(nil), "istio.policy.v1beta.Rule")
	proto.RegisterType((*Action)(nil), "istio.policy.v1beta.Action")
	proto.RegisterType((*Instance)(nil), "istio.policy.v1beta.Instance")
	proto.RegisterType((*Handler)(nil), "istio.policy.v1beta.Handler")
}
...
func (this *AttributeManifest) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&v1beta.AttributeManifest{")
...
func (this *AttributeManifest_AttributeInfo) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&v1beta.AttributeManifest_AttributeInfo{")
...
func init() { proto.RegisterFile("policy/v1beta/cfg.proto", fileDescriptorCfg) }

var fileDescriptorCfg = []byte{
	// 487 bytes of a gzipped FileDescriptorProto
	,
}
