...
_RULE_HEADEROPERATIONTEMPLATE_OPERATION = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REPLACE_ALWAYS', index=3, number=3,
      options=None,
      type=None),
  ],
