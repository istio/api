...
_SAMPLING = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='random_sampling', full_name='istio.policy.v1beta1.Sampling.random_sampling', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rate_limit_sampling', full_name='istio.policy.v1beta1.Sampling.rate_limit_sampling', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RANDOMSAMPLING = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='attribute', full_name='istio.policy.v1beta1.RandomSampling.attribute', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SAMPLING.fields_by_name['random_sampling'].message_type = _RANDOMSAMPLING
_SAMPLING.fields_by_name['rate_limit_sampling'].message_type = _RATELIMITSAMPLING
