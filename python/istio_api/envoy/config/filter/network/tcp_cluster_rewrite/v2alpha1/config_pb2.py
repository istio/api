...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_options=_b('ZEistio.io/api/envoy/config/filter/network/tcp_cluster_rewrite/v2alpha1'),
...
TcpClusterRewrite = _reflection.GeneratedProtocolMessageType('TcpClusterRewrite', (_message.Message,), {
