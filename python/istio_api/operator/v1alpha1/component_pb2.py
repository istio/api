...
_ISTIOCOMPONENTSETSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='istiod_remote', full_name='istio.operator.v1alpha1.IstioComponentSetSpec.istiod_remote', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ingress_gateways', full_name='istio.operator.v1alpha1.IstioComponentSetSpec.ingress_gateways', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='egress_gateways', full_name='istio.operator.v1alpha1.IstioComponentSetSpec.egress_gateways', index=12,
...
_KUBERNETESRESOURCESSPEC.fields_by_name['securityContext'].message_type = operator_dot_v1alpha1_dot_kubernetes__pb2._PODSECURITYCONTEXT
