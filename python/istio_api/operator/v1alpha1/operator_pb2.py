...
_KUBERNETESRESOURCESSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='autoScaleEnabled', full_name='istio.operator.v1alpha1.KubernetesResourcesSpec.autoScaleEnabled', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='overlays', full_name='istio.operator.v1alpha1.KubernetesResourcesSpec.overlays', index=17,
...
_KUBERNETESRESOURCESSPEC.fields_by_name['autoScaleEnabled'].message_type = _TYPEBOOLVALUEFORPB
