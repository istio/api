...
_ISTIOCOMPONENTSETSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='remote', full_name='istio.operator.v1alpha1.IstioComponentSetSpec.remote', index=5,
      number=42, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='remote', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='config', full_name='istio.operator.v1alpha1.IstioComponentSetSpec.config', index=6,
...
_ISTIOCOMPONENTSETSPEC.fields_by_name['remote'].message_type = _COMPONENTSPEC
_ISTIOCOMPONENTSETSPEC.fields_by_name['config'].message_type = _COMPONENTSPEC
