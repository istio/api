...
_ISTIOOPERATORSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='namespace', full_name='istio.operator.v1alpha1.IstioOperatorSpec.namespace', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='revision', full_name='istio.operator.v1alpha1.IstioOperatorSpec.revision', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='default_revision', full_name='istio.operator.v1alpha1.IstioOperatorSpec.default_revision', index=6,
