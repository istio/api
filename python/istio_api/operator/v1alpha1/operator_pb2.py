...
_ISTIOCOMPONENTSETSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='istiod_central', full_name='istio.operator.v1alpha1.IstioComponentSetSpec.istiod_central', index=6,
...
_ISTIOCOMPONENTSETSPEC.fields_by_name['istiod_central'].message_type = _COMPONENTSPEC
