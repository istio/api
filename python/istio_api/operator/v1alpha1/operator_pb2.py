...
_KUBERNETESRESOURCESSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='podDisruptionBudgetEnabled', full_name='istio.operator.v1alpha1.KubernetesResourcesSpec.podDisruptionBudgetEnabled', index=17,
...
_KUBERNETESRESOURCESSPEC.fields_by_name['podDisruptionBudgetEnabled'].message_type = _TYPEBOOLVALUEFORPB
