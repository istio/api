...
_K8SOVERLAY = _descriptor.Descriptor(
  name='K8sOverlay',
  full_name='istio.operator.v1alpha1.K8sOverlay',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='overlays', full_name='istio.operator.v1alpha1.K8sOverlay.overlays', index=0,
...
_BASECOMPONENTSPEC.fields_by_name['k8s'].message_type = _K8SOVERLAY
_K8SOVERLAY.fields_by_name['overlays'].message_type = _K8SOBJECTOVERLAY
...
DESCRIPTOR.message_types_by_name['K8sOverlay'] = _K8SOVERLAY
...
K8sOverlay = _reflection.GeneratedProtocolMessageType('K8sOverlay', (_message.Message,), {
  'DESCRIPTOR' : _K8SOVERLAY,
  '__module__' : 'operator.v1alpha1.operator_pb2'
  # @@protoc_insertion_point(class_scope:istio.operator.v1alpha1.K8sOverlay)
  })
_sym_db.RegisterMessage(K8sOverlay)
