...
_ISTIOOPERATORSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='installPackagePath', full_name='istio.operator.v1alpha1.IstioOperatorSpec.installPackagePath', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='resourceSuffix', full_name='istio.operator.v1alpha1.IstioOperatorSpec.resourceSuffix', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='defaultRevision', full_name='istio.operator.v1alpha1.IstioOperatorSpec.defaultRevision', index=7,
    ...
    _descriptor.FieldDescriptor(
      name='meshConfig', full_name='istio.operator.v1alpha1.IstioOperatorSpec.meshConfig', index=8,
    ...
    _descriptor.FieldDescriptor(
      name='addonComponents', full_name='istio.operator.v1alpha1.IstioOperatorSpec.addonComponents', index=10,
    ...
    _descriptor.FieldDescriptor(
      name='unvalidatedValues', full_name='istio.operator.v1alpha1.IstioOperatorSpec.unvalidatedValues', index=12,
...
_INSTALLSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='componentStatus', full_name='istio.operator.v1alpha1.InstallStatus.componentStatus', index=2,
...
_ISTIOCOMPONENTSETSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='istiodRemote', full_name='istio.operator.v1alpha1.IstioComponentSetSpec.istiodRemote', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='ingressGateways', full_name='istio.operator.v1alpha1.IstioComponentSetSpec.ingressGateways', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='egressGateways', full_name='istio.operator.v1alpha1.IstioComponentSetSpec.egressGateways', index=5,
...
_EXTERNALCOMPONENTSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='spec', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='chartPath', full_name='istio.operator.v1alpha1.ExternalComponentSpec.chartPath', index=3,
...
_KUBERNETESRESOURCESSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='hpaSpec', full_name='istio.operator.v1alpha1.KubernetesResourcesSpec.hpaSpec', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='imagePullPolicy', full_name='istio.operator.v1alpha1.KubernetesResourcesSpec.imagePullPolicy', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='nodeSelector', full_name='istio.operator.v1alpha1.KubernetesResourcesSpec.nodeSelector', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='podDisruptionBudget', full_name='istio.operator.v1alpha1.KubernetesResourcesSpec.podDisruptionBudget', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='podAnnotations', full_name='istio.operator.v1alpha1.KubernetesResourcesSpec.podAnnotations', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='priorityClassName', full_name='istio.operator.v1alpha1.KubernetesResourcesSpec.priorityClassName', index=7,
    ...
    _descriptor.FieldDescriptor(
      name='readinessProbe', full_name='istio.operator.v1alpha1.KubernetesResourcesSpec.readinessProbe', index=8,
    ...
    _descriptor.FieldDescriptor(
      name='replicaCount', full_name='istio.operator.v1alpha1.KubernetesResourcesSpec.replicaCount', index=9,
    ...
    _descriptor.FieldDescriptor(
      name='serviceAnnotations', full_name='istio.operator.v1alpha1.KubernetesResourcesSpec.serviceAnnotations', index=14,
...
_K8SOBJECTOVERLAY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='apiVersion', full_name='istio.operator.v1alpha1.K8sObjectOverlay.apiVersion', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INTORSTRING = _descriptor.Descriptor(
  name='IntOrString',
  full_name='istio.operator.v1alpha1.IntOrString',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='istio.operator.v1alpha1.IntOrString.type', index=0,
      ...
      serialized_options=None, json_name='type', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='intVal', full_name='istio.operator.v1alpha1.IntOrString.intVal', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='intVal', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='strVal', full_name='istio.operator.v1alpha1.IntOrString.strVal', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='strVal', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_ISTIOOPERATORSPEC.fields_by_name['tag'].message_type = google_dot_protobuf_dot_struct__pb2._VALUE
_ISTIOOPERATORSPEC.fields_by_name['meshConfig'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
_ISTIOOPERATORSPEC.fields_by_name['components'].message_type = _ISTIOCOMPONENTSETSPEC
_ISTIOOPERATORSPEC.fields_by_name['addonComponents'].message_type = _ISTIOOPERATORSPEC_ADDONCOMPONENTSENTRY
_ISTIOOPERATORSPEC.fields_by_name['values'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
_ISTIOOPERATORSPEC.fields_by_name['unvalidatedValues'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
...
_INSTALLSTATUS.fields_by_name['componentStatus'].message_type = _INSTALLSTATUS_COMPONENTSTATUSENTRY
...
_ISTIOCOMPONENTSETSPEC.fields_by_name['istiodRemote'].message_type = _COMPONENTSPEC
_ISTIOCOMPONENTSETSPEC.fields_by_name['ingressGateways'].message_type = _GATEWAYSPEC
_ISTIOCOMPONENTSETSPEC.fields_by_name['egressGateways'].message_type = _GATEWAYSPEC
...
_KUBERNETESRESOURCESSPEC.fields_by_name['hpaSpec'].message_type = _HORIZONTALPODAUTOSCALERSPEC
_KUBERNETESRESOURCESSPEC.fields_by_name['nodeSelector'].message_type = _KUBERNETESRESOURCESSPEC_NODESELECTORENTRY
_KUBERNETESRESOURCESSPEC.fields_by_name['podDisruptionBudget'].message_type = _PODDISRUPTIONBUDGETSPEC
_KUBERNETESRESOURCESSPEC.fields_by_name['podAnnotations'].message_type = _KUBERNETESRESOURCESSPEC_PODANNOTATIONSENTRY
_KUBERNETESRESOURCESSPEC.fields_by_name['readinessProbe'].message_type = _READINESSPROBE
...
_KUBERNETESRESOURCESSPEC.fields_by_name['serviceAnnotations'].message_type = _KUBERNETESRESOURCESSPEC_SERVICEANNOTATIONSENTRY
...
_K8SOBJECTOVERLAY_PATHVALUE.fields_by_name['value'].message_type = google_dot_protobuf_dot_struct__pb2._VALUE
...
_EXTERNALMETRICSOURCE.fields_by_name['targetValue'].message_type = _INTORSTRING
_EXTERNALMETRICSOURCE.fields_by_name['targetAverageValue'].message_type = _INTORSTRING
_HTTPGETACTION.fields_by_name['port'].message_type = _INTORSTRING
...
_OBJECTMETRICSOURCE.fields_by_name['targetValue'].message_type = _INTORSTRING
...
_OBJECTMETRICSOURCE.fields_by_name['averageValue'].message_type = _INTORSTRING
...
_PODDISRUPTIONBUDGETSPEC.fields_by_name['minAvailable'].message_type = _INTORSTRING
...
_PODDISRUPTIONBUDGETSPEC.fields_by_name['maxUnavailable'].message_type = _INTORSTRING
_PODSMETRICSOURCE.fields_by_name['targetAverageValue'].message_type = _INTORSTRING
...
_RESOURCEFIELDSELECTOR.fields_by_name['divisor'].message_type = _INTORSTRING
_RESOURCEMETRICSOURCE.fields_by_name['targetAverageValue'].message_type = _INTORSTRING
...
_ROLLINGUPDATEDEPLOYMENT.fields_by_name['maxUnavailable'].message_type = _INTORSTRING
_ROLLINGUPDATEDEPLOYMENT.fields_by_name['maxSurge'].message_type = _INTORSTRING
...
_SERVICEPORT.fields_by_name['targetPort'].message_type = _INTORSTRING
_SESSIONAFFINITYCONFIG.fields_by_name['clientIP'].message_type = _CLIENTIPCONFIG
_TCPSOCKETACTION.fields_by_name['port'].message_type = _INTORSTRING
...
_INTORSTRING.fields_by_name['intVal'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT32VALUE
_INTORSTRING.fields_by_name['strVal'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
