...
_CHECKRESPONSE_PRECONDITIONRESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='directive', full_name='istio.mixer.v1.CheckResponse.PreconditionResult.directive', index=4,
...
_DIRECTIVE = _descriptor.Descriptor(
  name='Directive',
  full_name='istio.mixer.v1.Directive',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='request_headers', full_name='istio.mixer.v1.Directive.request_headers', index=0,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response_headers', full_name='istio.mixer.v1.Directive.response_headers', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response_code', full_name='istio.mixer.v1.Directive.response_code', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response_body', full_name='istio.mixer.v1.Directive.response_body', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='destination_service', full_name='istio.mixer.v1.Directive.destination_service', index=4,
...
_CHECKRESPONSE_PRECONDITIONRESULT.fields_by_name['directive'].message_type = _DIRECTIVE
...
_DIRECTIVE.fields_by_name['request_headers'].message_type = _HEADEROPERATION
_DIRECTIVE.fields_by_name['response_headers'].message_type = _HEADEROPERATION
...
Directive = _reflection.GeneratedProtocolMessageType('Directive', (_message.Message,), dict(
  ...
  __module__ = 'mixer.v1.check_pb2'
  # @@protoc_insertion_point(class_scope:istio.mixer.v1.Directive)
  ))
...
_DIRECTIVE.fields_by_name['request_headers'].has_options = True
_DIRECTIVE.fields_by_name['request_headers']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_DIRECTIVE.fields_by_name['response_headers'].has_options = True
_DIRECTIVE.fields_by_name['response_headers']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
