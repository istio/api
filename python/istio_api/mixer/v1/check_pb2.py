...
from audit.v1alpha1 import audit_pb2 as audit_dot_v1alpha1_dot_audit__pb2
...
_CHECKRESPONSE_PRECONDITIONRESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='audit_directive', full_name='istio.mixer.v1.CheckResponse.PreconditionResult.audit_directive', index=5,
...
_AUDITDIRECTIVE = _descriptor.Descriptor(
  name='AuditDirective',
  full_name='istio.mixer.v1.AuditDirective',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='level', full_name='istio.mixer.v1.AuditDirective.level', index=0,
...
_CHECKRESPONSE_PRECONDITIONRESULT.fields_by_name['audit_directive'].message_type = _AUDITDIRECTIVE
...
_AUDITDIRECTIVE.fields_by_name['level'].enum_type = audit_dot_v1alpha1_dot_audit__pb2._AUDITLEVEL
...
AuditDirective = _reflection.GeneratedProtocolMessageType('AuditDirective', (_message.Message,), dict(
  ...
  __module__ = 'mixer.v1.check_pb2'
  # @@protoc_insertion_point(class_scope:istio.mixer.v1.AuditDirective)
  ))
