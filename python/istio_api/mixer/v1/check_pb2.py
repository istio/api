...
_ROUTEDIRECTIVE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='update_request_headers', full_name='istio.mixer.v1.RouteDirective.update_request_headers', index=0,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update_response_headers', full_name='istio.mixer.v1.RouteDirective.update_response_headers', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='override_destination_service', full_name='istio.mixer.v1.RouteDirective.override_destination_service', index=4,
...
_ROUTEDIRECTIVE.fields_by_name['update_request_headers'].message_type = _HEADEROPERATION
_ROUTEDIRECTIVE.fields_by_name['update_response_headers'].message_type = _HEADEROPERATION
...
_ROUTEDIRECTIVE.fields_by_name['update_request_headers'].has_options = True
_ROUTEDIRECTIVE.fields_by_name['update_request_headers']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_ROUTEDIRECTIVE.fields_by_name['update_response_headers'].has_options = True
_ROUTEDIRECTIVE.fields_by_name['update_response_headers']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
