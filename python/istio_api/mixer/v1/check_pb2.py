...
_CHECKRESPONSE_PRECONDITIONRESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='action', full_name='istio.mixer.v1.CheckResponse.PreconditionResult.action', index=5,
...
_HEADEROPERATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='istio.mixer.v1.HeaderOperation.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='remove', full_name='istio.mixer.v1.HeaderOperation.remove', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='append', full_name='istio.mixer.v1.HeaderOperation.append', index=3,
...
_ROUTEACTION = _descriptor.Descriptor(
  name='RouteAction',
  full_name='istio.mixer.v1.RouteAction',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='request_headers', full_name='istio.mixer.v1.RouteAction.request_headers', index=0,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response_headers', full_name='istio.mixer.v1.RouteAction.response_headers', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response_code', full_name='istio.mixer.v1.RouteAction.response_code', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response_body', full_name='istio.mixer.v1.RouteAction.response_body', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='destination_service', full_name='istio.mixer.v1.RouteAction.destination_service', index=4,
...
_CHECKRESPONSE_PRECONDITIONRESULT.fields_by_name['action'].message_type = _ROUTEACTION
...
_ROUTEACTION.fields_by_name['request_headers'].message_type = _HEADEROPERATION
_ROUTEACTION.fields_by_name['response_headers'].message_type = _HEADEROPERATION
...
RouteAction = _reflection.GeneratedProtocolMessageType('RouteAction', (_message.Message,), dict(
  ...
  __module__ = 'mixer.v1.check_pb2'
  # @@protoc_insertion_point(class_scope:istio.mixer.v1.RouteAction)
  ))
...
_ROUTEACTION.fields_by_name['request_headers'].has_options = True
_ROUTEACTION.fields_by_name['request_headers']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_ROUTEACTION.fields_by_name['response_headers'].has_options = True
_ROUTEACTION.fields_by_name['response_headers']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
