...
_ROUTEDIRECTIVE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='request_headers', full_name='istio.mixer.v1.RouteDirective.request_headers', index=0,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response_headers', full_name='istio.mixer.v1.RouteDirective.response_headers', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response_code', full_name='istio.mixer.v1.RouteDirective.response_code', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response_body', full_name='istio.mixer.v1.RouteDirective.response_body', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='destination_service', full_name='istio.mixer.v1.RouteDirective.destination_service', index=4,
...
_CHECKRESPONSE_PRECONDITIONRESULT.fields_by_name['directive'].message_type = _ROUTEDIRECTIVE
...
_ROUTEDIRECTIVE.fields_by_name['request_headers'].message_type = _HEADEROPERATION
_ROUTEDIRECTIVE.fields_by_name['response_headers'].message_type = _HEADEROPERATION
...
_ROUTEDIRECTIVE.fields_by_name['request_headers'].has_options = True
_ROUTEDIRECTIVE.fields_by_name['request_headers']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_ROUTEDIRECTIVE.fields_by_name['response_headers'].has_options = True
_ROUTEDIRECTIVE.fields_by_name['response_headers']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
