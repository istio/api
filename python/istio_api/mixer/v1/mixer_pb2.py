...
_CHECKRESPONSE_QUOTARESULT.fields_by_name['status'].has_options = True
_CHECKRESPONSE_QUOTARESULT.fields_by_name['status']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
