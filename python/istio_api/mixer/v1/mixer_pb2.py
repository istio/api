...
CheckRequest = _reflection.GeneratedProtocolMessageType('CheckRequest', (_message.Message,), {
  ...
  'QuotaParams' : _reflection.GeneratedProtocolMessageType('QuotaParams', (_message.Message,), {
  ...
  'QuotasEntry' : _reflection.GeneratedProtocolMessageType('QuotasEntry', (_message.Message,), {
...
CheckResponse = _reflection.GeneratedProtocolMessageType('CheckResponse', (_message.Message,), {
  ...
  'PreconditionResult' : _reflection.GeneratedProtocolMessageType('PreconditionResult', (_message.Message,), {
  ...
  'QuotaResult' : _reflection.GeneratedProtocolMessageType('QuotaResult', (_message.Message,), {
...
ReferencedAttributes = _reflection.GeneratedProtocolMessageType('ReferencedAttributes', (_message.Message,), {
...
HeaderOperation = _reflection.GeneratedProtocolMessageType('HeaderOperation', (_message.Message,), {
...
RouteDirective = _reflection.GeneratedProtocolMessageType('RouteDirective', (_message.Message,), {
