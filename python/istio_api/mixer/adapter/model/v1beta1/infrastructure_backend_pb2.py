...
CreateSessionRequest = _reflection.GeneratedProtocolMessageType('CreateSessionRequest', (_message.Message,), {
  ...
  'InferredTypesEntry' : _reflection.GeneratedProtocolMessageType('InferredTypesEntry', (_message.Message,), {
...
_CREATESESSIONREQUEST_INFERREDTYPESENTRY._options = None
_VALIDATEREQUEST_INFERREDTYPESENTRY._options = None
