...
_PROXYCONFIG_METAENTRY = _descriptor.Descriptor(
  name='MetaEntry',
  full_name='istio.mesh.v1alpha1.ProxyConfig.MetaEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='istio.mesh.v1alpha1.ProxyConfig.MetaEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='istio.mesh.v1alpha1.ProxyConfig.MetaEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PROXYCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='meta', full_name='istio.mesh.v1alpha1.ProxyConfig.meta', index=23,
  ...
  nested_types=[_PROXYCONFIG_METAENTRY, ],
  enum_types=[
...
_PROXYCONFIG_METAENTRY.containing_type = _PROXYCONFIG
...
_PROXYCONFIG.fields_by_name['meta'].message_type = _PROXYCONFIG_METAENTRY
...
ProxyConfig = _reflection.GeneratedProtocolMessageType('ProxyConfig', (_message.Message,), {
  ...
  'MetaEntry' : _reflection.GeneratedProtocolMessageType('MetaEntry', (_message.Message,), {
    'DESCRIPTOR' : _PROXYCONFIG_METAENTRY,
    '__module__' : 'mesh.v1alpha1.proxy_pb2'
    # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.ProxyConfig.MetaEntry)
    })
  ,
...
_sym_db.RegisterMessage(ProxyConfig.MetaEntry)
...
_PROXYCONFIG_METAENTRY._options = None
