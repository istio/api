...
_PROXYCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='envoy_http_grpc_als_address', full_name='istio.mesh.v1alpha1.ProxyConfig.envoy_http_grpc_als_address', index=21,
