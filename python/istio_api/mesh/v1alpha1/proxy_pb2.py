...
_PROXYCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='verify_certificate_at_client', full_name='istio.mesh.v1alpha1.ProxyConfig.verify_certificate_at_client', index=32,
    ...
    _descriptor.FieldDescriptor(
      name='default_certificate_authority_path', full_name='istio.mesh.v1alpha1.ProxyConfig.default_certificate_authority_path', index=33,
      number=36, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='defaultCertificateAuthorityPath', file=DESCRIPTOR),
  ],
  extensions=[
  ],
...
_PROXYCONFIG.fields_by_name['verify_certificate_at_client'].message_type = google_dot_protobuf_dot_wrappers__pb2._BOOLVALUE
