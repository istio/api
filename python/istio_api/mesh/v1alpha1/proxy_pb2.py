...
_PROXYCONFIG_TLSPROTOCOL = _descriptor.EnumDescriptor(
  name='TLSProtocol',
  full_name='istio.mesh.v1alpha1.ProxyConfig.TLSProtocol',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_PROXYCONFIG_TLSPROTOCOL)
...
_PROXYCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='min_protocol_version', full_name='istio.mesh.v1alpha1.ProxyConfig.min_protocol_version', index=28,
...
_PROXYCONFIG.fields_by_name['min_protocol_version'].enum_type = _PROXYCONFIG_TLSPROTOCOL
_PROXYCONFIG_INBOUNDINTERCEPTIONMODE.containing_type = _PROXYCONFIG
_PROXYCONFIG_TLSPROTOCOL.containing_type = _PROXYCONFIG
