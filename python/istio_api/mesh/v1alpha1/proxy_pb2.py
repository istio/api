...
from mesh.v1alpha1 import certificate_pb2 as mesh_dot_v1alpha1_dot_certificate__pb2
...
_PROXYCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='certificate', full_name='istio.mesh.v1alpha1.ProxyConfig.certificate', index=32,
      number=35, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='certificate', file=DESCRIPTOR),
  ],
  extensions=[
  ],
...
_PROXYCONFIG.fields_by_name['certificate'].message_type = mesh_dot_v1alpha1_dot_certificate__pb2._CERTIFICATEPARAMETERS
