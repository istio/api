...
_PROXYCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='proxy_stats_matcher', full_name='istio.mesh.v1alpha1.ProxyConfig.proxy_stats_matcher', index=28,
