...
_PROXYCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='header_options', full_name='istio.mesh.v1alpha1.ProxyConfig.header_options', index=32,
      number=35, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='headerOptions', file=DESCRIPTOR),
  ],
  extensions=[
  ],
...
_HEADEROPTIONS = _descriptor.Descriptor(
  name='HeaderOptions',
  full_name='istio.mesh.v1alpha1.HeaderOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='preserve_header_key_casing', full_name='istio.mesh.v1alpha1.HeaderOptions.preserve_header_key_casing', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PROXYCONFIG.fields_by_name['header_options'].message_type = _HEADEROPTIONS
...
DESCRIPTOR.message_types_by_name['HeaderOptions'] = _HEADEROPTIONS
...
HeaderOptions = _reflection.GeneratedProtocolMessageType('HeaderOptions', (_message.Message,), {
  'DESCRIPTOR' : _HEADEROPTIONS,
  '__module__' : 'mesh.v1alpha1.proxy_pb2'
  # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.HeaderOptions)
  })
_sym_db.RegisterMessage(HeaderOptions)
