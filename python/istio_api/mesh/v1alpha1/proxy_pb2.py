...
_TOPOLOGY_SETCURRENTCLIENTCERTDETAILS = _descriptor.Descriptor(
  name='SetCurrentClientCertDetails',
  full_name='istio.mesh.v1alpha1.Topology.SetCurrentClientCertDetails',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='subject', full_name='istio.mesh.v1alpha1.Topology.SetCurrentClientCertDetails.subject', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='cert', full_name='istio.mesh.v1alpha1.Topology.SetCurrentClientCertDetails.cert', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='cert', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='chain', full_name='istio.mesh.v1alpha1.Topology.SetCurrentClientCertDetails.chain', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='dns', full_name='istio.mesh.v1alpha1.Topology.SetCurrentClientCertDetails.dns', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='uri', full_name='istio.mesh.v1alpha1.Topology.SetCurrentClientCertDetails.uri', index=4,
...
_TOPOLOGY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='set_current_client_cert_details', full_name='istio.mesh.v1alpha1.Topology.set_current_client_cert_details', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='setCurrentClientCertDetails', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[_TOPOLOGY_SETCURRENTCLIENTCERTDETAILS, ],
  enum_types=[
...
_TOPOLOGY_SETCURRENTCLIENTCERTDETAILS.fields_by_name['subject'].message_type = google_dot_protobuf_dot_wrappers__pb2._BOOLVALUE
_TOPOLOGY_SETCURRENTCLIENTCERTDETAILS.fields_by_name['cert'].message_type = google_dot_protobuf_dot_wrappers__pb2._BOOLVALUE
_TOPOLOGY_SETCURRENTCLIENTCERTDETAILS.fields_by_name['chain'].message_type = google_dot_protobuf_dot_wrappers__pb2._BOOLVALUE
_TOPOLOGY_SETCURRENTCLIENTCERTDETAILS.fields_by_name['dns'].message_type = google_dot_protobuf_dot_wrappers__pb2._BOOLVALUE
_TOPOLOGY_SETCURRENTCLIENTCERTDETAILS.fields_by_name['uri'].message_type = google_dot_protobuf_dot_wrappers__pb2._BOOLVALUE
_TOPOLOGY_SETCURRENTCLIENTCERTDETAILS.containing_type = _TOPOLOGY
_TOPOLOGY.fields_by_name['forward_client_cert_details'].enum_type = _TOPOLOGY_FORWARDCLIENTCERTDETAILS
_TOPOLOGY.fields_by_name['set_current_client_cert_details'].message_type = _TOPOLOGY_SETCURRENTCLIENTCERTDETAILS
...
Topology = _reflection.GeneratedProtocolMessageType('Topology', (_message.Message,), {
  ...
  'SetCurrentClientCertDetails' : _reflection.GeneratedProtocolMessageType('SetCurrentClientCertDetails', (_message.Message,), {
    'DESCRIPTOR' : _TOPOLOGY_SETCURRENTCLIENTCERTDETAILS,
    '__module__' : 'mesh.v1alpha1.proxy_pb2'
    # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.Topology.SetCurrentClientCertDetails)
    })
  ,
...
_sym_db.RegisterMessage(Topology.SetCurrentClientCertDetails)
