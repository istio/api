...
_PROXYCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='ca_certificates', full_name='istio.mesh.v1alpha1.ProxyConfig.ca_certificates', index=31,
