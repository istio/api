...
_TRACING_OPENCENSUSAGENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='debug', full_name='istio.mesh.v1alpha1.Tracing.OpenCensusAgent.debug', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_number_of_attributes', full_name='istio.mesh.v1alpha1.Tracing.OpenCensusAgent.max_number_of_attributes', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_number_of_annotations', full_name='istio.mesh.v1alpha1.Tracing.OpenCensusAgent.max_number_of_annotations', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_number_of_message_events', full_name='istio.mesh.v1alpha1.Tracing.OpenCensusAgent.max_number_of_message_events', index=5,
...
_PROXYCONFIG_ENVOYSTATSINCLUSION = _descriptor.Descriptor(
  name='EnvoyStatsInclusion',
  full_name='istio.mesh.v1alpha1.ProxyConfig.EnvoyStatsInclusion',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='stats_inclusion_prefixes', full_name='istio.mesh.v1alpha1.ProxyConfig.EnvoyStatsInclusion.stats_inclusion_prefixes', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stats_inclusion_suffixes', full_name='istio.mesh.v1alpha1.ProxyConfig.EnvoyStatsInclusion.stats_inclusion_suffixes', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stats_inclusion_regexps', full_name='istio.mesh.v1alpha1.ProxyConfig.EnvoyStatsInclusion.stats_inclusion_regexps', index=2,
...
_PROXYCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='envoy_stats_inclusion', full_name='istio.mesh.v1alpha1.ProxyConfig.envoy_stats_inclusion', index=28,
  ...
  nested_types=[_PROXYCONFIG_PROXYMETADATAENTRY, _PROXYCONFIG_ENVOYSTATSINCLUSION, ],
  enum_types=[
...
_TRACING_OPENCENSUSAGENT.fields_by_name['max_number_of_attributes'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT64VALUE
_TRACING_OPENCENSUSAGENT.fields_by_name['max_number_of_annotations'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT64VALUE
_TRACING_OPENCENSUSAGENT.fields_by_name['max_number_of_message_events'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT64VALUE
...
_PROXYCONFIG_ENVOYSTATSINCLUSION.containing_type = _PROXYCONFIG
...
_PROXYCONFIG.fields_by_name['envoy_stats_inclusion'].message_type = _PROXYCONFIG_ENVOYSTATSINCLUSION
...
ProxyConfig = _reflection.GeneratedProtocolMessageType('ProxyConfig', (_message.Message,), {
  ...
  'EnvoyStatsInclusion' : _reflection.GeneratedProtocolMessageType('EnvoyStatsInclusion', (_message.Message,), {
    'DESCRIPTOR' : _PROXYCONFIG_ENVOYSTATSINCLUSION,
    '__module__' : 'mesh.v1alpha1.proxy_pb2'
    # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.ProxyConfig.EnvoyStatsInclusion)
    })
  ,
...
_sym_db.RegisterMessage(ProxyConfig.EnvoyStatsInclusion)
