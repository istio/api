...
_PROXYCONFIG_ENVOYNODEMETADATAENTRY = _descriptor.Descriptor(
  name='EnvoyNodeMetadataEntry',
  full_name='istio.mesh.v1alpha1.ProxyConfig.EnvoyNodeMetadataEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='istio.mesh.v1alpha1.ProxyConfig.EnvoyNodeMetadataEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='istio.mesh.v1alpha1.ProxyConfig.EnvoyNodeMetadataEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PROXYCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='envoy_node_metadata', full_name='istio.mesh.v1alpha1.ProxyConfig.envoy_node_metadata', index=20,
  ...
  nested_types=[_PROXYCONFIG_ENVOYNODEMETADATAENTRY, ],
  enum_types=[
...
_PROXYCONFIG_ENVOYNODEMETADATAENTRY.containing_type = _PROXYCONFIG
...
_PROXYCONFIG.fields_by_name['envoy_node_metadata'].message_type = _PROXYCONFIG_ENVOYNODEMETADATAENTRY
...
ProxyConfig = _reflection.GeneratedProtocolMessageType('ProxyConfig', (_message.Message,), dict(
  ...
  EnvoyNodeMetadataEntry = _reflection.GeneratedProtocolMessageType('EnvoyNodeMetadataEntry', (_message.Message,), dict(
    DESCRIPTOR = _PROXYCONFIG_ENVOYNODEMETADATAENTRY,
    __module__ = 'mesh.v1alpha1.proxy_pb2'
    # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.ProxyConfig.EnvoyNodeMetadataEntry)
    ))
  ,
...
_sym_db.RegisterMessage(ProxyConfig.EnvoyNodeMetadataEntry)


DESCRIPTOR.has_options = True
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('Z\032istio.io/api/mesh/v1alpha1'))
_PROXYCONFIG_ENVOYNODEMETADATAENTRY.has_options = True
_PROXYCONFIG_ENVOYNODEMETADATAENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
