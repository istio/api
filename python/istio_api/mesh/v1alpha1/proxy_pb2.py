...
_PROXYCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='ca_certificate_pems', full_name='istio.mesh.v1alpha1.ProxyConfig.ca_certificate_pems', index=31,
