...
_TRACING_OPENCENSUS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='address', full_name='istio.mesh.v1alpha1.Tracing.OpenCensus.address', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='debug', full_name='istio.mesh.v1alpha1.Tracing.OpenCensus.debug', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_number_of_attributes', full_name='istio.mesh.v1alpha1.Tracing.OpenCensus.max_number_of_attributes', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_number_of_annotations', full_name='istio.mesh.v1alpha1.Tracing.OpenCensus.max_number_of_annotations', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_number_of_message_events', full_name='istio.mesh.v1alpha1.Tracing.OpenCensus.max_number_of_message_events', index=4,
...
_TRACING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='open_census', full_name='istio.mesh.v1alpha1.Tracing.open_census', index=4,
  ...
  nested_types=[_TRACING_ZIPKIN, _TRACING_LIGHTSTEP, _TRACING_DATADOG, _TRACING_STACKDRIVER, _TRACING_OPENCENSUS, _TRACING_CUSTOMTAG, _TRACING_LITERAL, _TRACING_ENVIRONMENT, _TRACING_REQUESTHEADER, _TRACING_CUSTOMTAGSENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_TRACING_OPENCENSUS.fields_by_name['max_number_of_attributes'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT64VALUE
_TRACING_OPENCENSUS.fields_by_name['max_number_of_annotations'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT64VALUE
_TRACING_OPENCENSUS.fields_by_name['max_number_of_message_events'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT64VALUE
...
_TRACING.fields_by_name['open_census'].message_type = _TRACING_OPENCENSUS
...
_TRACING.oneofs_by_name['tracer'].fields.append(
  _TRACING.fields_by_name['open_census'])
_TRACING.fields_by_name['open_census'].containing_oneof = _TRACING.oneofs_by_name['tracer']
...
Tracing = _reflection.GeneratedProtocolMessageType('Tracing', (_message.Message,), {
  ...
  'OpenCensus' : _reflection.GeneratedProtocolMessageType('OpenCensus', (_message.Message,), {
