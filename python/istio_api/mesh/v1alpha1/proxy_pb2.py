...
_TRACING_ZIPKIN = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='shared_span_context', full_name='istio.mesh.v1alpha1.Tracing.Zipkin.shared_span_context', index=1,
