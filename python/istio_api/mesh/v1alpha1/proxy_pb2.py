...
_PROXYCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sts', full_name='istio.mesh.v1alpha1.ProxyConfig.sts', index=24,
...
_STS = _descriptor.Descriptor(
  name='STS',
  full_name='istio.mesh.v1alpha1.STS',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='service_port', full_name='istio.mesh.v1alpha1.STS.service_port', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PROXYCONFIG.fields_by_name['sts'].message_type = _STS
...
DESCRIPTOR.message_types_by_name['STS'] = _STS
...
STS = _reflection.GeneratedProtocolMessageType('STS', (_message.Message,), {
  'DESCRIPTOR' : _STS,
  '__module__' : 'mesh.v1alpha1.proxy_pb2'
  # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.STS)
  })
_sym_db.RegisterMessage(STS)
