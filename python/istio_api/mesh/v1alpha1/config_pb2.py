...
_MESHCONFIG_NETWORKSCOPE_MODE = _descriptor.EnumDescriptor(
  name='Mode',
  full_name='istio.mesh.v1alpha1.MeshConfig.NetworkScope.Mode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ALL_NAMESPACES', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CURRENT_NAMESPACE', index=2, number=2,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_MESHCONFIG_NETWORKSCOPE_MODE)
...
_MESHCONFIG_NETWORKSCOPE = _descriptor.Descriptor(
  name='NetworkScope',
  full_name='istio.mesh.v1alpha1.MeshConfig.NetworkScope',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='default_scope', full_name='istio.mesh.v1alpha1.MeshConfig.NetworkScope.default_scope', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='shared_namespaces', full_name='istio.mesh.v1alpha1.MeshConfig.NetworkScope.shared_namespaces', index=1,
...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='network_scope', full_name='istio.mesh.v1alpha1.MeshConfig.network_scope', index=26,
  ...
  nested_types=[_MESHCONFIG_OUTBOUNDTRAFFICPOLICY, _MESHCONFIG_NETWORKSCOPE, ],
  enum_types=[
...
_MESHCONFIG_NETWORKSCOPE.fields_by_name['default_scope'].enum_type = _MESHCONFIG_NETWORKSCOPE_MODE
_MESHCONFIG_NETWORKSCOPE.containing_type = _MESHCONFIG
_MESHCONFIG_NETWORKSCOPE_MODE.containing_type = _MESHCONFIG_NETWORKSCOPE
...
_MESHCONFIG.fields_by_name['network_scope'].message_type = _MESHCONFIG_NETWORKSCOPE
...
MeshConfig = _reflection.GeneratedProtocolMessageType('MeshConfig', (_message.Message,), dict(
  ...
  NetworkScope = _reflection.GeneratedProtocolMessageType('NetworkScope', (_message.Message,), dict(
    DESCRIPTOR = _MESHCONFIG_NETWORKSCOPE,
    __module__ = 'mesh.v1alpha1.config_pb2'
    # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.NetworkScope)
    ))
  ,
...
_sym_db.RegisterMessage(MeshConfig.NetworkScope)
