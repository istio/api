...
_MESHCONFIG_EXTENSIONPROVIDER_STACKDRIVERPROVIDER_LOGGINGOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='compress_logs', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.StackdriverProvider.LoggingOptions.compress_logs', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='compressLogs', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='only_errors', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.StackdriverProvider.LoggingOptions.only_errors', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='onlyErrors', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_MESHCONFIG_EXTENSIONPROVIDER_STACKDRIVERPROVIDER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='loggingOptions', file=DESCRIPTOR),
  ],
  extensions=[
  ],
...
_MESHCONFIG_EXTENSIONPROVIDER_STACKDRIVERPROVIDER_LOGGINGOPTIONS.fields_by_name['compress_logs'].message_type = google_dot_protobuf_dot_wrappers__pb2._BOOLVALUE
_MESHCONFIG_EXTENSIONPROVIDER_STACKDRIVERPROVIDER_LOGGINGOPTIONS.fields_by_name['only_errors'].message_type = google_dot_protobuf_dot_wrappers__pb2._BOOLVALUE
