...
_MESHCONFIG_INSECURECERTIFICATEVALIDATIONATCLIENT = _descriptor.EnumDescriptor(
  name='InsecureCertificateValidationAtClient',
  full_name='istio.mesh.v1alpha1.MeshConfig.InsecureCertificateValidationAtClient',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_MESHCONFIG_INSECURECERTIFICATEVALIDATIONATCLIENT)
...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='insecure_skip_client_verify', full_name='istio.mesh.v1alpha1.MeshConfig.insecure_skip_client_verify', index=35,
  ...
  enum_types=[
    ...
    _MESHCONFIG_INSECURECERTIFICATEVALIDATIONATCLIENT,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_MESHCONFIG.fields_by_name['insecure_skip_client_verify'].enum_type = _MESHCONFIG_INSECURECERTIFICATEVALIDATIONATCLIENT
...
_MESHCONFIG_INSECURECERTIFICATEVALIDATIONATCLIENT.containing_type = _MESHCONFIG
