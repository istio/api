...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='use_request_id_for_trace_sampling', full_name='istio.mesh.v1alpha1.MeshConfig.use_request_id_for_trace_sampling', index=42,
...
_MESHCONFIG.fields_by_name['use_request_id_for_trace_sampling'].message_type = google_dot_protobuf_dot_wrappers__pb2._BOOLVALUE
