...
_MESHCONFIG_EXTERNALSERVER_AUTHORIZATION_HTTP = _descriptor.Descriptor(
  name='HTTP',
  full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization.HTTP',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='path_prefix', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization.HTTP.path_prefix', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='include_headers_in_check', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization.HTTP.include_headers_in_check', index=1,
      number=2, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='headers_to_upstream_on_allow', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization.HTTP.headers_to_upstream_on_allow', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='headers_to_downstream_on_deny', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization.HTTP.headers_to_downstream_on_deny', index=3,
...
_MESHCONFIG_EXTERNALSERVER_AUTHORIZATION_GRPC = _descriptor.Descriptor(
  name='GRPC',
  full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization.GRPC',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_MESHCONFIG_EXTERNALSERVER_AUTHORIZATION = _descriptor.Descriptor(
  name='Authorization',
  full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='service', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization.service', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timeout', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization.timeout', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='http', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization.http', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='grpc', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization.grpc', index=3,
  ...
  nested_types=[_MESHCONFIG_EXTERNALSERVER_AUTHORIZATION_HTTP, _MESHCONFIG_EXTERNALSERVER_AUTHORIZATION_GRPC, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='external_authz_service_type', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization.external_authz_service_type',
...
_MESHCONFIG_EXTERNALSERVER = _descriptor.Descriptor(
  name='ExternalServer',
  full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='authorization', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.authorization', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_MESHCONFIG_EXTERNALSERVER_AUTHORIZATION, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='config', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.config',
      index=0, containing_type=None, fields=[]),
  ],
...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='external_servers', full_name='istio.mesh.v1alpha1.MeshConfig.external_servers', index=37,
  ...
  nested_types=[_MESHCONFIG_OUTBOUNDTRAFFICPOLICY, _MESHCONFIG_THRIFTCONFIG, _MESHCONFIG_SERVICESETTINGS, _MESHCONFIG_CA, _MESHCONFIG_EXTERNALSERVER, ],
  enum_types=[
...
_MESHCONFIG_EXTERNALSERVER_AUTHORIZATION_HTTP.containing_type = _MESHCONFIG_EXTERNALSERVER_AUTHORIZATION
_MESHCONFIG_EXTERNALSERVER_AUTHORIZATION_GRPC.containing_type = _MESHCONFIG_EXTERNALSERVER_AUTHORIZATION
_MESHCONFIG_EXTERNALSERVER_AUTHORIZATION.fields_by_name['service'].message_type = networking_dot_v1alpha3_dot_virtual__service__pb2._DESTINATION
_MESHCONFIG_EXTERNALSERVER_AUTHORIZATION.fields_by_name['timeout'].message_type = google_dot_protobuf_dot_duration__pb2._DURATION
_MESHCONFIG_EXTERNALSERVER_AUTHORIZATION.fields_by_name['http'].message_type = _MESHCONFIG_EXTERNALSERVER_AUTHORIZATION_HTTP
_MESHCONFIG_EXTERNALSERVER_AUTHORIZATION.fields_by_name['grpc'].message_type = _MESHCONFIG_EXTERNALSERVER_AUTHORIZATION_GRPC
_MESHCONFIG_EXTERNALSERVER_AUTHORIZATION.containing_type = _MESHCONFIG_EXTERNALSERVER
_MESHCONFIG_EXTERNALSERVER_AUTHORIZATION.oneofs_by_name['external_authz_service_type'].fields.append(
  _MESHCONFIG_EXTERNALSERVER_AUTHORIZATION.fields_by_name['http'])
_MESHCONFIG_EXTERNALSERVER_AUTHORIZATION.fields_by_name['http'].containing_oneof = _MESHCONFIG_EXTERNALSERVER_AUTHORIZATION.oneofs_by_name['external_authz_service_type']
_MESHCONFIG_EXTERNALSERVER_AUTHORIZATION.oneofs_by_name['external_authz_service_type'].fields.append(
  _MESHCONFIG_EXTERNALSERVER_AUTHORIZATION.fields_by_name['grpc'])
_MESHCONFIG_EXTERNALSERVER_AUTHORIZATION.fields_by_name['grpc'].containing_oneof = _MESHCONFIG_EXTERNALSERVER_AUTHORIZATION.oneofs_by_name['external_authz_service_type']
_MESHCONFIG_EXTERNALSERVER.fields_by_name['authorization'].message_type = _MESHCONFIG_EXTERNALSERVER_AUTHORIZATION
_MESHCONFIG_EXTERNALSERVER.containing_type = _MESHCONFIG
_MESHCONFIG_EXTERNALSERVER.oneofs_by_name['config'].fields.append(
  _MESHCONFIG_EXTERNALSERVER.fields_by_name['authorization'])
_MESHCONFIG_EXTERNALSERVER.fields_by_name['authorization'].containing_oneof = _MESHCONFIG_EXTERNALSERVER.oneofs_by_name['config']
...
_MESHCONFIG.fields_by_name['external_servers'].message_type = _MESHCONFIG_EXTERNALSERVER
...
MeshConfig = _reflection.GeneratedProtocolMessageType('MeshConfig', (_message.Message,), {
  ...
  'ExternalServer' : _reflection.GeneratedProtocolMessageType('ExternalServer', (_message.Message,), {
    ...
    'Authorization' : _reflection.GeneratedProtocolMessageType('Authorization', (_message.Message,), {
      ...
      'HTTP' : _reflection.GeneratedProtocolMessageType('HTTP', (_message.Message,), {
        'DESCRIPTOR' : _MESHCONFIG_EXTERNALSERVER_AUTHORIZATION_HTTP,
        '__module__' : 'mesh.v1alpha1.config_pb2'
        # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization.HTTP)
        })
      ,

      'GRPC' : _reflection.GeneratedProtocolMessageType('GRPC', (_message.Message,), {
        'DESCRIPTOR' : _MESHCONFIG_EXTERNALSERVER_AUTHORIZATION_GRPC,
        '__module__' : 'mesh.v1alpha1.config_pb2'
        # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization.GRPC)
        })
      ,
      'DESCRIPTOR' : _MESHCONFIG_EXTERNALSERVER_AUTHORIZATION,
      '__module__' : 'mesh.v1alpha1.config_pb2'
      # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization)
      })
    ,
    'DESCRIPTOR' : _MESHCONFIG_EXTERNALSERVER,
    '__module__' : 'mesh.v1alpha1.config_pb2'
    # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.ExternalServer)
    })
  ,
...
_sym_db.RegisterMessage(MeshConfig.ExternalServer)
_sym_db.RegisterMessage(MeshConfig.ExternalServer.Authorization)
_sym_db.RegisterMessage(MeshConfig.ExternalServer.Authorization.HTTP)
_sym_db.RegisterMessage(MeshConfig.ExternalServer.Authorization.GRPC)
