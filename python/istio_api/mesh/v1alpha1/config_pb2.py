...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='enable_prometheus_aggregation', full_name='istio.mesh.v1alpha1.MeshConfig.enable_prometheus_aggregation', index=48,
...
_MESHCONFIG.fields_by_name['enable_prometheus_aggregation'].message_type = google_dot_protobuf_dot_wrappers__pb2._BOOLVALUE
