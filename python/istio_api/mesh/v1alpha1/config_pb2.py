...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='proxy_inbound_listen_port', full_name='istio.mesh.v1alpha1.MeshConfig.proxy_inbound_listen_port', index=6,
