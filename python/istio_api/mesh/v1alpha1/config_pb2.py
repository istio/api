...
_MESHCONFIG_EXTERNALAUTH_EXTERNAL = _descriptor.Descriptor(
  name='External',
  full_name='istio.mesh.v1alpha1.MeshConfig.ExternalAuth.External',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='address', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalAuth.External.address', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timeout', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalAuth.External.timeout', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tls_settings', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalAuth.External.tls_settings', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='include_headers', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalAuth.External.include_headers', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='forward_to_upstream', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalAuth.External.forward_to_upstream', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='forward_to_downstream', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalAuth.External.forward_to_downstream', index=5,
...
_MESHCONFIG_EXTERNALAUTH_SERVERSENTRY = _descriptor.Descriptor(
  name='ServersEntry',
  full_name='istio.mesh.v1alpha1.MeshConfig.ExternalAuth.ServersEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalAuth.ServersEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalAuth.ServersEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MESHCONFIG_EXTERNALAUTH = _descriptor.Descriptor(
  name='ExternalAuth',
  full_name='istio.mesh.v1alpha1.MeshConfig.ExternalAuth',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='servers', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalAuth.servers', index=0,
  ...
  nested_types=[_MESHCONFIG_EXTERNALAUTH_EXTERNAL, _MESHCONFIG_EXTERNALAUTH_SERVERSENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='external_auth', full_name='istio.mesh.v1alpha1.MeshConfig.external_auth', index=37,
  ...
  nested_types=[_MESHCONFIG_OUTBOUNDTRAFFICPOLICY, _MESHCONFIG_THRIFTCONFIG, _MESHCONFIG_SERVICESETTINGS, _MESHCONFIG_CA, _MESHCONFIG_EXTERNALAUTH, ],
  enum_types=[
...
_MESHCONFIG_EXTERNALAUTH_EXTERNAL.fields_by_name['timeout'].message_type = google_dot_protobuf_dot_duration__pb2._DURATION
_MESHCONFIG_EXTERNALAUTH_EXTERNAL.fields_by_name['tls_settings'].message_type = networking_dot_v1alpha3_dot_destination__rule__pb2._CLIENTTLSSETTINGS
_MESHCONFIG_EXTERNALAUTH_EXTERNAL.containing_type = _MESHCONFIG_EXTERNALAUTH
_MESHCONFIG_EXTERNALAUTH_SERVERSENTRY.fields_by_name['value'].message_type = _MESHCONFIG_EXTERNALAUTH_EXTERNAL
_MESHCONFIG_EXTERNALAUTH_SERVERSENTRY.containing_type = _MESHCONFIG_EXTERNALAUTH
_MESHCONFIG_EXTERNALAUTH.fields_by_name['servers'].message_type = _MESHCONFIG_EXTERNALAUTH_SERVERSENTRY
_MESHCONFIG_EXTERNALAUTH.containing_type = _MESHCONFIG
...
_MESHCONFIG.fields_by_name['external_auth'].message_type = _MESHCONFIG_EXTERNALAUTH
...
MeshConfig = _reflection.GeneratedProtocolMessageType('MeshConfig', (_message.Message,), {
  ...
  'ExternalAuth' : _reflection.GeneratedProtocolMessageType('ExternalAuth', (_message.Message,), {
    ...
    'External' : _reflection.GeneratedProtocolMessageType('External', (_message.Message,), {
      'DESCRIPTOR' : _MESHCONFIG_EXTERNALAUTH_EXTERNAL,
      '__module__' : 'mesh.v1alpha1.config_pb2'
      # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.ExternalAuth.External)
      })
    ,

    'ServersEntry' : _reflection.GeneratedProtocolMessageType('ServersEntry', (_message.Message,), {
      'DESCRIPTOR' : _MESHCONFIG_EXTERNALAUTH_SERVERSENTRY,
      '__module__' : 'mesh.v1alpha1.config_pb2'
      # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.ExternalAuth.ServersEntry)
      })
    ,
    'DESCRIPTOR' : _MESHCONFIG_EXTERNALAUTH,
    '__module__' : 'mesh.v1alpha1.config_pb2'
    # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.ExternalAuth)
    })
  ,
...
_sym_db.RegisterMessage(MeshConfig.ExternalAuth)
_sym_db.RegisterMessage(MeshConfig.ExternalAuth.External)
_sym_db.RegisterMessage(MeshConfig.ExternalAuth.ServersEntry)
...
_MESHCONFIG_EXTERNALAUTH_SERVERSENTRY._options = None
