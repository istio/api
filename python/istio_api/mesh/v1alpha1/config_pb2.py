...
_MESHCONFIG_ROOTCONFIG_MODE = _descriptor.EnumDescriptor(
  name='Mode',
  full_name='istio.mesh.v1alpha1.MeshConfig.RootConfig.Mode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='CITADEL', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SPIFFE_BUNDLE_ENDPOINT', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PEM_CONTENT', index=2, number=2,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_MESHCONFIG_ROOTCONFIG_MODE)
...
_MESHCONFIG_ROOTCONFIG = _descriptor.Descriptor(
  name='RootConfig',
  full_name='istio.mesh.v1alpha1.MeshConfig.RootConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='mode', full_name='istio.mesh.v1alpha1.MeshConfig.RootConfig.mode', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='config', full_name='istio.mesh.v1alpha1.MeshConfig.RootConfig.config', index=1,
...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='root_config', full_name='istio.mesh.v1alpha1.MeshConfig.root_config', index=21,
  ...
  nested_types=[_MESHCONFIG_OUTBOUNDTRAFFICPOLICY, _MESHCONFIG_ROOTCONFIG, _MESHCONFIG_THRIFTCONFIG, _MESHCONFIG_SERVICESETTINGS, _MESHCONFIG_CA, _MESHCONFIG_EXTENSIONPROVIDER, ],
  enum_types=[
...
_MESHCONFIG_ROOTCONFIG.fields_by_name['mode'].enum_type = _MESHCONFIG_ROOTCONFIG_MODE
_MESHCONFIG_ROOTCONFIG.containing_type = _MESHCONFIG
_MESHCONFIG_ROOTCONFIG_MODE.containing_type = _MESHCONFIG_ROOTCONFIG
...
_MESHCONFIG.fields_by_name['root_config'].message_type = _MESHCONFIG_ROOTCONFIG
...
MeshConfig = _reflection.GeneratedProtocolMessageType('MeshConfig', (_message.Message,), {
  ...
  'RootConfig' : _reflection.GeneratedProtocolMessageType('RootConfig', (_message.Message,), {
    'DESCRIPTOR' : _MESHCONFIG_ROOTCONFIG,
    '__module__' : 'mesh.v1alpha1.config_pb2'
    # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.RootConfig)
    })
  ,
...
_sym_db.RegisterMessage(MeshConfig.RootConfig)
