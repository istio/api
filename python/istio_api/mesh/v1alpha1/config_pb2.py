...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='enable_insecure_skip_client_verify', full_name='istio.mesh.v1alpha1.MeshConfig.enable_insecure_skip_client_verify', index=35,
