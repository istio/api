...
_MESHCONFIG_CERTIFICATEREFERENCE = _descriptor.Descriptor(
  name='CertificateReference',
  full_name='istio.mesh.v1alpha1.MeshConfig.CertificateReference',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='pem', full_name='istio.mesh.v1alpha1.MeshConfig.CertificateReference.pem', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='spiffe_bundle_url', full_name='istio.mesh.v1alpha1.MeshConfig.CertificateReference.spiffe_bundle_url', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='certificate_reference', full_name='istio.mesh.v1alpha1.MeshConfig.CertificateReference.certificate_reference',
...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  nested_types=[_MESHCONFIG_OUTBOUNDTRAFFICPOLICY, _MESHCONFIG_CERTIFICATEREFERENCE, _MESHCONFIG_THRIFTCONFIG, _MESHCONFIG_SERVICESETTINGS, _MESHCONFIG_CA, _MESHCONFIG_EXTENSIONPROVIDER, ],
  enum_types=[
...
_MESHCONFIG_CERTIFICATEREFERENCE.containing_type = _MESHCONFIG
_MESHCONFIG_CERTIFICATEREFERENCE.oneofs_by_name['certificate_reference'].fields.append(
  _MESHCONFIG_CERTIFICATEREFERENCE.fields_by_name['pem'])
_MESHCONFIG_CERTIFICATEREFERENCE.fields_by_name['pem'].containing_oneof = _MESHCONFIG_CERTIFICATEREFERENCE.oneofs_by_name['certificate_reference']
_MESHCONFIG_CERTIFICATEREFERENCE.oneofs_by_name['certificate_reference'].fields.append(
  _MESHCONFIG_CERTIFICATEREFERENCE.fields_by_name['spiffe_bundle_url'])
_MESHCONFIG_CERTIFICATEREFERENCE.fields_by_name['spiffe_bundle_url'].containing_oneof = _MESHCONFIG_CERTIFICATEREFERENCE.oneofs_by_name['certificate_reference']
...
_MESHCONFIG.fields_by_name['ca_certificates'].message_type = _MESHCONFIG_CERTIFICATEREFERENCE
...
MeshConfig = _reflection.GeneratedProtocolMessageType('MeshConfig', (_message.Message,), {
  ...
  'CertificateReference' : _reflection.GeneratedProtocolMessageType('CertificateReference', (_message.Message,), {
    'DESCRIPTOR' : _MESHCONFIG_CERTIFICATEREFERENCE,
    '__module__' : 'mesh.v1alpha1.config_pb2'
    # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.CertificateReference)
    })
  ,
...
_sym_db.RegisterMessage(MeshConfig.CertificateReference)
