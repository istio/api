...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='upstream_ca_address', full_name='istio.mesh.v1alpha1.MeshConfig.upstream_ca_address', index=50,
