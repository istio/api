...
_MESHCONFIG_EXTERNALPROVIDER = _descriptor.Descriptor(
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='provider', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalProvider.provider',
...
_MESHCONFIG_EXTERNALPROVIDER.oneofs_by_name['provider'].fields.append(
  _MESHCONFIG_EXTERNALPROVIDER.fields_by_name['envoy_ext_authz_http'])
_MESHCONFIG_EXTERNALPROVIDER.fields_by_name['envoy_ext_authz_http'].containing_oneof = _MESHCONFIG_EXTERNALPROVIDER.oneofs_by_name['provider']
_MESHCONFIG_EXTERNALPROVIDER.oneofs_by_name['provider'].fields.append(
  _MESHCONFIG_EXTERNALPROVIDER.fields_by_name['envoy_ext_authz_grpc'])
_MESHCONFIG_EXTERNALPROVIDER.fields_by_name['envoy_ext_authz_grpc'].containing_oneof = _MESHCONFIG_EXTERNALPROVIDER.oneofs_by_name['provider']
