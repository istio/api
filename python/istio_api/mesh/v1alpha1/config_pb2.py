...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='thrift_rate_limit_url', full_name='istio.mesh.v1alpha1.MeshConfig.thrift_rate_limit_url', index=46,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='thrift_rate_limit_timeout', full_name='istio.mesh.v1alpha1.MeshConfig.thrift_rate_limit_timeout', index=47,
