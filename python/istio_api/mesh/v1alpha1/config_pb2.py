...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='verify_external_server_certs_using_system_ca', full_name='istio.mesh.v1alpha1.MeshConfig.verify_external_server_certs_using_system_ca', index=35,
...
_MESHCONFIG.fields_by_name['verify_external_server_certs_using_system_ca'].message_type = google_dot_protobuf_dot_wrappers__pb2._BOOLVALUE
