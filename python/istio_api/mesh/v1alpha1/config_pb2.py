...
_MESHCONFIG_CA_K8SCACONFIG = _descriptor.Descriptor(
  name='K8sCAConfig',
  full_name='istio.mesh.v1alpha1.MeshConfig.CA.K8sCAConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='signer_name', full_name='istio.mesh.v1alpha1.MeshConfig.CA.K8sCAConfig.signer_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ca_cert_path', full_name='istio.mesh.v1alpha1.MeshConfig.CA.K8sCAConfig.ca_cert_path', index=1,
...
_MESHCONFIG_CA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='k8s_config', full_name='istio.mesh.v1alpha1.MeshConfig.CA.k8s_config', index=3,
  ...
  nested_types=[_MESHCONFIG_CA_K8SCACONFIG, ],
  enum_types=[
...
_MESHCONFIG_CA_K8SCACONFIG.containing_type = _MESHCONFIG_CA
...
_MESHCONFIG_CA.fields_by_name['k8s_config'].message_type = _MESHCONFIG_CA_K8SCACONFIG
...
MeshConfig = _reflection.GeneratedProtocolMessageType('MeshConfig', (_message.Message,), {
  ...
  'CA' : _reflection.GeneratedProtocolMessageType('CA', (_message.Message,), {
    ...
    'K8sCAConfig' : _reflection.GeneratedProtocolMessageType('K8sCAConfig', (_message.Message,), {
      'DESCRIPTOR' : _MESHCONFIG_CA_K8SCACONFIG,
      '__module__' : 'mesh.v1alpha1.config_pb2'
      # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.CA.K8sCAConfig)
      })
    ,
...
_sym_db.RegisterMessage(MeshConfig.CA.K8sCAConfig)
