...
_MESHCONFIG_EXTENSIONPROVIDER_ZIPKINTRACINGPROVIDER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='use_request_id_for_trace_sampling', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.ZipkinTracingProvider.use_request_id_for_trace_sampling', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='useRequestIdForTraceSampling', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_MESHCONFIG_EXTENSIONPROVIDER_SKYWALKINGTRACINGPROVIDER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='accessToken', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_request_id_for_trace_sampling', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.SkyWalkingTracingProvider.use_request_id_for_trace_sampling', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
