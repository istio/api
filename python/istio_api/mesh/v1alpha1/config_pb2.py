...
_MESHCONFIG_DEFAULTNETWORKSCOPE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='default_scope', full_name='istio.mesh.v1alpha1.MeshConfig.DefaultNetworkScope.default_scope', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='shared_namespaces', full_name='istio.mesh.v1alpha1.MeshConfig.DefaultNetworkScope.shared_namespaces', index=1,
...
_MESHCONFIG_DEFAULTNETWORKSCOPE.fields_by_name['default_scope'].enum_type = _MESHCONFIG_DEFAULTNETWORKSCOPE_MODE
