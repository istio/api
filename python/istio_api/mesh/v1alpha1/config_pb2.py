...
_MESHCONFIG_EXTENSIONPROVIDER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stackdriver_telemetry_provider', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.stackdriver_telemetry_provider', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='prometheus_metrics_provider', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.prometheus_metrics_provider', index=4,
  ...
  nested_types=[_MESHCONFIG_EXTENSIONPROVIDER_ENVOYEXTERNALAUTHORIZATIONHTTPPROVIDER, _MESHCONFIG_EXTENSIONPROVIDER_ENVOYEXTERNALAUTHORIZATIONGRPCPROVIDER, _MESHCONFIG_EXTENSIONPROVIDER_STACKDRIVERTELEMETRYPROVIDER, _MESHCONFIG_EXTENSIONPROVIDER_PROMETHEUSMETRICSPROVIDER, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_MESHCONFIG_EXTENSIONPROVIDER.fields_by_name['stackdriver_telemetry_provider'].message_type = _MESHCONFIG_EXTENSIONPROVIDER_STACKDRIVERTELEMETRYPROVIDER
_MESHCONFIG_EXTENSIONPROVIDER.fields_by_name['prometheus_metrics_provider'].message_type = _MESHCONFIG_EXTENSIONPROVIDER_PROMETHEUSMETRICSPROVIDER
...
_MESHCONFIG_EXTENSIONPROVIDER.oneofs_by_name['provider'].fields.append(
  _MESHCONFIG_EXTENSIONPROVIDER.fields_by_name['stackdriver_telemetry_provider'])
_MESHCONFIG_EXTENSIONPROVIDER.fields_by_name['stackdriver_telemetry_provider'].containing_oneof = _MESHCONFIG_EXTENSIONPROVIDER.oneofs_by_name['provider']
_MESHCONFIG_EXTENSIONPROVIDER.oneofs_by_name['provider'].fields.append(
  _MESHCONFIG_EXTENSIONPROVIDER.fields_by_name['prometheus_metrics_provider'])
_MESHCONFIG_EXTENSIONPROVIDER.fields_by_name['prometheus_metrics_provider'].containing_oneof = _MESHCONFIG_EXTENSIONPROVIDER.oneofs_by_name['provider']
