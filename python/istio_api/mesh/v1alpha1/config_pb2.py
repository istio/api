...
_MESHCONFIG_EXTENSIONPROVIDER_RATELIMITPROVIDER = _descriptor.Descriptor(
  name='RateLimitProvider',
  full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.RateLimitProvider',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='service', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.RateLimitProvider.service', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='service', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='port', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.RateLimitProvider.port', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='port', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='domain', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.RateLimitProvider.domain', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='domain', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='failure_mode_deny', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.RateLimitProvider.failure_mode_deny', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='failureModeDeny', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_MESHCONFIG_EXTENSIONPROVIDER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='rate_limit', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.rate_limit', index=9,
...
_MESHCONFIG_EXTENSIONPROVIDER_RATELIMITPROVIDER.containing_type = _MESHCONFIG_EXTENSIONPROVIDER
...
_MESHCONFIG_EXTENSIONPROVIDER.oneofs_by_name['provider'].fields.append(
  _MESHCONFIG_EXTENSIONPROVIDER.fields_by_name['rate_limit'])
_MESHCONFIG_EXTENSIONPROVIDER.fields_by_name['rate_limit'].containing_oneof = _MESHCONFIG_EXTENSIONPROVIDER.oneofs_by_name['provider']
...
MeshConfig = _reflection.GeneratedProtocolMessageType('MeshConfig', (_message.Message,), {
  ...
  'ExtensionProvider' : _reflection.GeneratedProtocolMessageType('ExtensionProvider', (_message.Message,), {
    ...
    'RateLimitProvider' : _reflection.GeneratedProtocolMessageType('RateLimitProvider', (_message.Message,), {
      'DESCRIPTOR' : _MESHCONFIG_EXTENSIONPROVIDER_RATELIMITPROVIDER,
      '__module__' : 'mesh.v1alpha1.config_pb2'
      # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.RateLimitProvider)
      })
    ,
...
_sym_db.RegisterMessage(MeshConfig.ExtensionProvider.RateLimitProvider)
