...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='discovery_selectors', full_name='istio.mesh.v1alpha1.MeshConfig.discovery_selectors', index=37,
