...
_MESHCONFIG_EXTERNALPROVIDER_ENVOYEXTERNALGRPCAUTHORIZATIONPROVIDER = _descriptor.Descriptor(
  name='EnvoyExternalGrpcAuthorizationProvider',
  full_name='istio.mesh.v1alpha1.MeshConfig.ExternalProvider.EnvoyExternalGrpcAuthorizationProvider',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_MESHCONFIG_EXTERNALPROVIDER = _descriptor.Descriptor(
  ...
  full_name='istio.mesh.v1alpha1.MeshConfig.ExternalProvider',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalProvider.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='envoy_ext_authz_http', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalProvider.envoy_ext_authz_http', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='envoy_ext_authz_grpc', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalProvider.envoy_ext_authz_grpc', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='config', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalProvider.config',
...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='external_providers', full_name='istio.mesh.v1alpha1.MeshConfig.external_providers', index=38,
  ...
  nested_types=[_MESHCONFIG_OUTBOUNDTRAFFICPOLICY, _MESHCONFIG_THRIFTCONFIG, _MESHCONFIG_SERVICESETTINGS, _MESHCONFIG_CA, _MESHCONFIG_EXTERNALPROVIDER, ],
  enum_types=[
...
_MESHCONFIG_EXTERNALPROVIDER.containing_type = _MESHCONFIG
_MESHCONFIG_EXTERNALPROVIDER.oneofs_by_name['config'].fields.append(
  _MESHCONFIG_EXTERNALPROVIDER.fields_by_name['envoy_ext_authz_http'])
_MESHCONFIG_EXTERNALPROVIDER.fields_by_name['envoy_ext_authz_http'].containing_oneof = _MESHCONFIG_EXTERNALPROVIDER.oneofs_by_name['config']
_MESHCONFIG_EXTERNALPROVIDER.oneofs_by_name['config'].fields.append(
  _MESHCONFIG_EXTERNALPROVIDER.fields_by_name['envoy_ext_authz_grpc'])
_MESHCONFIG_EXTERNALPROVIDER.fields_by_name['envoy_ext_authz_grpc'].containing_oneof = _MESHCONFIG_EXTERNALPROVIDER.oneofs_by_name['config']
...
_MESHCONFIG.fields_by_name['external_providers'].message_type = _MESHCONFIG_EXTERNALPROVIDER
...
MeshConfig = _reflection.GeneratedProtocolMessageType('MeshConfig', (_message.Message,), {
  ...
  'ExternalProvider' : _reflection.GeneratedProtocolMessageType('ExternalProvider', (_message.Message,), {
    ...
    'EnvoyExternalHttpAuthorizationProvider' : _reflection.GeneratedProtocolMessageType('EnvoyExternalHttpAuthorizationProvider', (_message.Message,), {
      ...
      '__module__' : 'mesh.v1alpha1.config_pb2'
      # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.ExternalProvider.EnvoyExternalHttpAuthorizationProvider)
      })
    ,

    'EnvoyExternalGrpcAuthorizationProvider' : _reflection.GeneratedProtocolMessageType('EnvoyExternalGrpcAuthorizationProvider', (_message.Message,), {
      'DESCRIPTOR' : _MESHCONFIG_EXTERNALPROVIDER_ENVOYEXTERNALGRPCAUTHORIZATIONPROVIDER,
      '__module__' : 'mesh.v1alpha1.config_pb2'
      # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.ExternalProvider.EnvoyExternalGrpcAuthorizationProvider)
      })
    ,
    'DESCRIPTOR' : _MESHCONFIG_EXTERNALPROVIDER,
    '__module__' : 'mesh.v1alpha1.config_pb2'
    # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.ExternalProvider)
    })
  ,
