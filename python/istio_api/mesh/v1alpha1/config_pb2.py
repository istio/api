...
_MESHCONFIG_NODEPORTGATEWAYIPSELECTION_MODE = _descriptor.EnumDescriptor(
  name='Mode',
  full_name='istio.mesh.v1alpha1.MeshConfig.NodePortGatewayIPSelection.Mode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='DISALLOW_NODE_IPS', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='USE_ANY_NODE_IP', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='USE_NODES_WITH_LABEL', index=2, number=2,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_MESHCONFIG_NODEPORTGATEWAYIPSELECTION_MODE)
...
_MESHCONFIG_NODEPORTGATEWAYIPSELECTION_NODELABELSENTRY = _descriptor.Descriptor(
  name='NodeLabelsEntry',
  full_name='istio.mesh.v1alpha1.MeshConfig.NodePortGatewayIPSelection.NodeLabelsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='istio.mesh.v1alpha1.MeshConfig.NodePortGatewayIPSelection.NodeLabelsEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='istio.mesh.v1alpha1.MeshConfig.NodePortGatewayIPSelection.NodeLabelsEntry.value', index=1,
...
_MESHCONFIG_NODEPORTGATEWAYIPSELECTION = _descriptor.Descriptor(
  name='NodePortGatewayIPSelection',
  full_name='istio.mesh.v1alpha1.MeshConfig.NodePortGatewayIPSelection',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='node_selection_mode', full_name='istio.mesh.v1alpha1.MeshConfig.NodePortGatewayIPSelection.node_selection_mode', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='node_labels', full_name='istio.mesh.v1alpha1.MeshConfig.NodePortGatewayIPSelection.node_labels', index=1,
  ...
  nested_types=[_MESHCONFIG_NODEPORTGATEWAYIPSELECTION_NODELABELSENTRY, ],
  enum_types=[
    _MESHCONFIG_NODEPORTGATEWAYIPSELECTION_MODE,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nodeport_gateway_ip_selection', full_name='istio.mesh.v1alpha1.MeshConfig.nodeport_gateway_ip_selection', index=49,
  ...
  nested_types=[_MESHCONFIG_OUTBOUNDTRAFFICPOLICY, _MESHCONFIG_THRIFTCONFIG, _MESHCONFIG_NODEPORTGATEWAYIPSELECTION, ],
  enum_types=[
...
_MESHCONFIG_NODEPORTGATEWAYIPSELECTION_NODELABELSENTRY.containing_type = _MESHCONFIG_NODEPORTGATEWAYIPSELECTION
_MESHCONFIG_NODEPORTGATEWAYIPSELECTION.fields_by_name['node_selection_mode'].enum_type = _MESHCONFIG_NODEPORTGATEWAYIPSELECTION_MODE
_MESHCONFIG_NODEPORTGATEWAYIPSELECTION.fields_by_name['node_labels'].message_type = _MESHCONFIG_NODEPORTGATEWAYIPSELECTION_NODELABELSENTRY
_MESHCONFIG_NODEPORTGATEWAYIPSELECTION.containing_type = _MESHCONFIG
_MESHCONFIG_NODEPORTGATEWAYIPSELECTION_MODE.containing_type = _MESHCONFIG_NODEPORTGATEWAYIPSELECTION
...
_MESHCONFIG.fields_by_name['nodeport_gateway_ip_selection'].message_type = _MESHCONFIG_NODEPORTGATEWAYIPSELECTION
...
MeshConfig = _reflection.GeneratedProtocolMessageType('MeshConfig', (_message.Message,), {
  ...
  'NodePortGatewayIPSelection' : _reflection.GeneratedProtocolMessageType('NodePortGatewayIPSelection', (_message.Message,), {

    'NodeLabelsEntry' : _reflection.GeneratedProtocolMessageType('NodeLabelsEntry', (_message.Message,), {
      'DESCRIPTOR' : _MESHCONFIG_NODEPORTGATEWAYIPSELECTION_NODELABELSENTRY,
      '__module__' : 'mesh.v1alpha1.config_pb2'
      # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.NodePortGatewayIPSelection.NodeLabelsEntry)
      })
    ,
    'DESCRIPTOR' : _MESHCONFIG_NODEPORTGATEWAYIPSELECTION,
    '__module__' : 'mesh.v1alpha1.config_pb2'
    # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.NodePortGatewayIPSelection)
    })
  ,
...
_sym_db.RegisterMessage(MeshConfig.NodePortGatewayIPSelection)
_sym_db.RegisterMessage(MeshConfig.NodePortGatewayIPSelection.NodeLabelsEntry)
...
_MESHCONFIG_NODEPORTGATEWAYIPSELECTION_NODELABELSENTRY._options = None
