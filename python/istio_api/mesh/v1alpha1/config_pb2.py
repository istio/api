...
_FEATURENAME = _descriptor.EnumDescriptor(
  name='FeatureName',
  full_name='istio.mesh.v1alpha1.FeatureName',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='LOCALITY_AWARE_ROUTING', index=0, number=0,
      options=None,
      type=None),
  ],
...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='features', full_name='istio.mesh.v1alpha1.MeshConfig.features', index=39,
...
_FEATURE = _descriptor.Descriptor(
  name='Feature',
  full_name='istio.mesh.v1alpha1.Feature',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='feature', full_name='istio.mesh.v1alpha1.Feature.feature', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='enable', full_name='istio.mesh.v1alpha1.Feature.enable', index=1,
...
_MESHCONFIG.fields_by_name['features'].message_type = _FEATURE
...
_FEATURE.fields_by_name['feature'].enum_type = _FEATURENAME
...
Feature = _reflection.GeneratedProtocolMessageType('Feature', (_message.Message,), dict(
  DESCRIPTOR = _FEATURE,
  __module__ = 'mesh.v1alpha1.config_pb2'
  # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.Feature)
  ))
