...
_MESHCONFIG_MUTUALTLSMODE = _descriptor.EnumDescriptor(
  name='MutualTLSMode',
  full_name='istio.mesh.v1alpha1.MeshConfig.MutualTLSMode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='MTLS_PERMISSIVE', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MTLS_STRICT', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MTLS_DISABLE', index=2, number=99,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_MESHCONFIG_MUTUALTLSMODE)
...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mtls_mode', full_name='istio.mesh.v1alpha1.MeshConfig.mtls_mode', index=28,
...
_MESHCONFIG.fields_by_name['mtls_mode'].enum_type = _MESHCONFIG_MUTUALTLSMODE
...
_MESHCONFIG_MUTUALTLSMODE.containing_type = _MESHCONFIG
