...
_MESHCONFIG_EXTENSIONPROVIDER_ENVOYFILEBASEDACCESSLOGGER_ACCESSLOGENCODING = _descriptor.EnumDescriptor(
  name='AccessLogEncoding',
  full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyFileBasedAccessLogger.AccessLogEncoding',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_MESHCONFIG_EXTENSIONPROVIDER_ENVOYFILEBASEDACCESSLOGGER_ACCESSLOGENCODING)
...
_MESHCONFIG_EXTENSIONPROVIDER_ENVOYFILEBASEDACCESSLOGGER = _descriptor.Descriptor(
  name='EnvoyFileBasedAccessLogger',
  full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyFileBasedAccessLogger',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='file', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyFileBasedAccessLogger.file', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='format', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyFileBasedAccessLogger.format', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='encoding', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyFileBasedAccessLogger.encoding', index=2,
  ...
  nested_types=[],
  enum_types=[
    _MESHCONFIG_EXTENSIONPROVIDER_ENVOYFILEBASEDACCESSLOGGER_ACCESSLOGENCODING,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_MESHCONFIG_EXTENSIONPROVIDER_ENVOYFILEBASEDACCESSLOGGER.fields_by_name['encoding'].enum_type = _MESHCONFIG_EXTENSIONPROVIDER_ENVOYFILEBASEDACCESSLOGGER_ACCESSLOGENCODING
_MESHCONFIG_EXTENSIONPROVIDER_ENVOYFILEBASEDACCESSLOGGER.containing_type = _MESHCONFIG_EXTENSIONPROVIDER
_MESHCONFIG_EXTENSIONPROVIDER_ENVOYFILEBASEDACCESSLOGGER_ACCESSLOGENCODING.containing_type = _MESHCONFIG_EXTENSIONPROVIDER_ENVOYFILEBASEDACCESSLOGGER
...
MeshConfig = _reflection.GeneratedProtocolMessageType('MeshConfig', (_message.Message,), {
  ...
  'ExtensionProvider' : _reflection.GeneratedProtocolMessageType('ExtensionProvider', (_message.Message,), {
    ...
    'EnvoyFileBasedAccessLogger' : _reflection.GeneratedProtocolMessageType('EnvoyFileBasedAccessLogger', (_message.Message,), {
      'DESCRIPTOR' : _MESHCONFIG_EXTENSIONPROVIDER_ENVOYFILEBASEDACCESSLOGGER,
      '__module__' : 'mesh.v1alpha1.config_pb2'
      # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyFileBasedAccessLogger)
      })
    ,
...
_sym_db.RegisterMessage(MeshConfig.ExtensionProvider.EnvoyFileBasedAccessLogger)
