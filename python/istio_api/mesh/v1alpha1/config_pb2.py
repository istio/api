...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='enabled_spiffe_multiple_independent_trust_domain_authentication', full_name='istio.mesh.v1alpha1.MeshConfig.enabled_spiffe_multiple_independent_trust_domain_authentication', index=22,
      number=60, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='enabledSpiffeMultipleIndependentTrustDomainAuthentication', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
