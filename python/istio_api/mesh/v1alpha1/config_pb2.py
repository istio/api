...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='operator_manage_webhooks', full_name='istio.mesh.v1alpha1.MeshConfig.operator_manage_webhooks', index=46,
