...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mesh_traffic_server_cert_paths', full_name='istio.mesh.v1alpha1.MeshConfig.mesh_traffic_server_cert_paths', index=33,
...
_SERVERCERTPATHS = _descriptor.Descriptor(
  name='ServerCertPaths',
  full_name='istio.mesh.v1alpha1.ServerCertPaths',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='cert_chain', full_name='istio.mesh.v1alpha1.ServerCertPaths.cert_chain', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='key', full_name='istio.mesh.v1alpha1.ServerCertPaths.key', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='root_cert', full_name='istio.mesh.v1alpha1.ServerCertPaths.root_cert', index=2,
...
_MESHCONFIG.fields_by_name['mesh_traffic_server_cert_paths'].message_type = _SERVERCERTPATHS
...
DESCRIPTOR.message_types_by_name['ServerCertPaths'] = _SERVERCERTPATHS
...
ServerCertPaths = _reflection.GeneratedProtocolMessageType('ServerCertPaths', (_message.Message,), dict(
  DESCRIPTOR = _SERVERCERTPATHS,
  __module__ = 'mesh.v1alpha1.config_pb2'
  # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.ServerCertPaths)
  ))
_sym_db.RegisterMessage(ServerCertPaths)
