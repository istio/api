...
_MESHCONFIG_EXTENSIONPROVIDER_STACKDRIVERPROVIDER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='maxTagLength', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='address', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.StackdriverProvider.address', index=5,
      ...
      serialized_options=None, json_name='address', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='project', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.StackdriverProvider.project', index=6,
...
_MESHCONFIG_EXTENSIONPROVIDER_PROMETHEUSMETRICSPROVIDER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='disable_agent_metrics_merge', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.PrometheusMetricsProvider.disable_agent_metrics_merge', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='disableAgentMetricsMerge', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_MESHCONFIG_EXTENSIONPROVIDER_PROMETHEUSMETRICSPROVIDER.fields_by_name['disable_agent_metrics_merge'].message_type = google_dot_protobuf_dot_wrappers__pb2._BOOLVALUE
