...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='preserve_header_key_casing', full_name='istio.mesh.v1alpha1.MeshConfig.preserve_header_key_casing', index=41,
      number=62, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='preserveHeaderKeyCasing', file=DESCRIPTOR),
  ],
  extensions=[
  ],
