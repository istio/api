...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='ca_certificate_pems', full_name='istio.mesh.v1alpha1.MeshConfig.ca_certificate_pems', index=21,
      number=58, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='caCertificatePems', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ca_certificate_urls', full_name='istio.mesh.v1alpha1.MeshConfig.ca_certificate_urls', index=22,
      number=59, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='caCertificateUrls', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
  ...
  nested_types=[_MESHCONFIG_OUTBOUNDTRAFFICPOLICY, _MESHCONFIG_THRIFTCONFIG, _MESHCONFIG_SERVICESETTINGS, _MESHCONFIG_CA, _MESHCONFIG_EXTENSIONPROVIDER, ],
  enum_types=[
