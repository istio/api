...
_MESHCONFIG_EXTENSIONPROVIDER_ENVOYFILEACCESSLOGPROVIDER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='text_format', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyFileAccessLogProvider.text_format', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='textFormat', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
