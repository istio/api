...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='default_tracing_provider', full_name='istio.mesh.v1alpha1.MeshConfig.default_tracing_provider', index=38,
      number=60, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='defaultTracingProvider', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
