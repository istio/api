...
_MESHCONFIG_EXTENSIONPROVIDER_SKYWALKINGTRACINGPROVIDER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='service', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='address', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.SkyWalkingTracingProvider.address', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='address', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='port', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.SkyWalkingTracingProvider.port', index=2,
      number=3, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='port', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='access_token', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.SkyWalkingTracingProvider.access_token', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='receiver', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.SkyWalkingTracingProvider.receiver',
      index=0, containing_type=None, fields=[]),
  ],
...
_MESHCONFIG_EXTENSIONPROVIDER_SKYWALKINGTRACINGPROVIDER.oneofs_by_name['receiver'].fields.append(
  _MESHCONFIG_EXTENSIONPROVIDER_SKYWALKINGTRACINGPROVIDER.fields_by_name['service'])
_MESHCONFIG_EXTENSIONPROVIDER_SKYWALKINGTRACINGPROVIDER.fields_by_name['service'].containing_oneof = _MESHCONFIG_EXTENSIONPROVIDER_SKYWALKINGTRACINGPROVIDER.oneofs_by_name['receiver']
_MESHCONFIG_EXTENSIONPROVIDER_SKYWALKINGTRACINGPROVIDER.oneofs_by_name['receiver'].fields.append(
  _MESHCONFIG_EXTENSIONPROVIDER_SKYWALKINGTRACINGPROVIDER.fields_by_name['address'])
_MESHCONFIG_EXTENSIONPROVIDER_SKYWALKINGTRACINGPROVIDER.fields_by_name['address'].containing_oneof = _MESHCONFIG_EXTENSIONPROVIDER_SKYWALKINGTRACINGPROVIDER.oneofs_by_name['receiver']
