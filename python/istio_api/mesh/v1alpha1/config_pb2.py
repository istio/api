...
_MESHCONFIG_EXTENSIONPROVIDER_STACKDRIVERTELEMETRYPROVIDER = _descriptor.Descriptor(
  name='StackdriverTelemetryProvider',
  full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.StackdriverTelemetryProvider',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='address', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.StackdriverTelemetryProvider.address', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='address', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='project', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.StackdriverTelemetryProvider.project', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MESHCONFIG_EXTENSIONPROVIDER_STACKDRIVERTELEMETRYPROVIDER.containing_type = _MESHCONFIG_EXTENSIONPROVIDER
...
MeshConfig = _reflection.GeneratedProtocolMessageType('MeshConfig', (_message.Message,), {
  ...
  'ExtensionProvider' : _reflection.GeneratedProtocolMessageType('ExtensionProvider', (_message.Message,), {
    ...
    'StackdriverTelemetryProvider' : _reflection.GeneratedProtocolMessageType('StackdriverTelemetryProvider', (_message.Message,), {
      'DESCRIPTOR' : _MESHCONFIG_EXTENSIONPROVIDER_STACKDRIVERTELEMETRYPROVIDER,
      '__module__' : 'mesh.v1alpha1.config_pb2'
      # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.StackdriverTelemetryProvider)
      })
    ,
...
_sym_db.RegisterMessage(MeshConfig.ExtensionProvider.StackdriverTelemetryProvider)
