...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sign_cert_at_kubernetes_ca', full_name='istio.mesh.v1alpha1.MeshConfig.sign_cert_at_kubernetes_ca', index=46,
