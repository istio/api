...
_MESHCONFIG.fields_by_name['galley_address'].has_options = True
_MESHCONFIG.fields_by_name['galley_address']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
