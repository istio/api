...
_MESHCONFIG_CA_INTEGRATIONTYPE = _descriptor.EnumDescriptor(
  name='IntegrationType',
  full_name='istio.mesh.v1alpha1.MeshConfig.CA.IntegrationType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='ISTIOD_RA_KUBERNETES_API', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ISTIOD_RA_ISTIO_API', index=1, number=1,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_MESHCONFIG_CA_INTEGRATIONTYPE)
...
_MESHCONFIG_CA_KUBERNETESCACONFIG = _descriptor.Descriptor(
  name='KubernetesCAConfig',
  full_name='istio.mesh.v1alpha1.MeshConfig.CA.KubernetesCAConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='signer_name', full_name='istio.mesh.v1alpha1.MeshConfig.CA.KubernetesCAConfig.signer_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MESHCONFIG_CA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='kubernetes_config', full_name='istio.mesh.v1alpha1.MeshConfig.CA.kubernetes_config', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='type', full_name='istio.mesh.v1alpha1.MeshConfig.CA.type', index=4,
  ...
  nested_types=[_MESHCONFIG_CA_KUBERNETESCACONFIG, ],
  enum_types=[
    _MESHCONFIG_CA_INTEGRATIONTYPE,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  nested_types=[_MESHCONFIG_OUTBOUNDTRAFFICPOLICY, _MESHCONFIG_THRIFTCONFIG, _MESHCONFIG_SERVICESETTINGS, _MESHCONFIG_CA, ],
  enum_types=[
...
_MESHCONFIG_CA_KUBERNETESCACONFIG.containing_type = _MESHCONFIG_CA
...
_MESHCONFIG_CA.fields_by_name['kubernetes_config'].message_type = _MESHCONFIG_CA_KUBERNETESCACONFIG
_MESHCONFIG_CA.fields_by_name['type'].enum_type = _MESHCONFIG_CA_INTEGRATIONTYPE
_MESHCONFIG_CA.containing_type = _MESHCONFIG
_MESHCONFIG_CA_INTEGRATIONTYPE.containing_type = _MESHCONFIG_CA
...
MeshConfig = _reflection.GeneratedProtocolMessageType('MeshConfig', (_message.Message,), {
  ...
  'CA' : _reflection.GeneratedProtocolMessageType('CA', (_message.Message,), {
    ...
    'KubernetesCAConfig' : _reflection.GeneratedProtocolMessageType('KubernetesCAConfig', (_message.Message,), {
      'DESCRIPTOR' : _MESHCONFIG_CA_KUBERNETESCACONFIG,
      '__module__' : 'mesh.v1alpha1.config_pb2'
      # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.CA.KubernetesCAConfig)
      })
    ,
...
_sym_db.RegisterMessage(MeshConfig.CA.KubernetesCAConfig)
