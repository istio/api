...
_MESHCONFIG_EXTENSIONPROVIDER_ENVOYEXTERNALAUTHORIZATIONHTTPPROVIDER_ADDITIONALHEADERSINCHECKENTRY = _descriptor.Descriptor(
  name='AdditionalHeadersInCheckEntry',
  full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationHttpProvider.AdditionalHeadersInCheckEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationHttpProvider.AdditionalHeadersInCheckEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationHttpProvider.AdditionalHeadersInCheckEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MESHCONFIG_EXTENSIONPROVIDER_ENVOYEXTERNALAUTHORIZATIONHTTPPROVIDER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='include_request_body_in_check', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationHttpProvider.include_request_body_in_check', index=7,
    ...
    _descriptor.FieldDescriptor(
      name='additional_headers_in_check', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationHttpProvider.additional_headers_in_check', index=8,
      number=11, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='additionalHeadersInCheck', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='headers_to_upstream_on_allow', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationHttpProvider.headers_to_upstream_on_allow', index=9,
    ...
    _descriptor.FieldDescriptor(
      name='headers_to_downstream_on_deny', full_name='istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationHttpProvider.headers_to_downstream_on_deny', index=10,
  ...
  nested_types=[_MESHCONFIG_EXTENSIONPROVIDER_ENVOYEXTERNALAUTHORIZATIONHTTPPROVIDER_ADDITIONALHEADERSINCHECKENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_MESHCONFIG_EXTENSIONPROVIDER_ENVOYEXTERNALAUTHORIZATIONHTTPPROVIDER_ADDITIONALHEADERSINCHECKENTRY.containing_type = _MESHCONFIG_EXTENSIONPROVIDER_ENVOYEXTERNALAUTHORIZATIONHTTPPROVIDER
...
_MESHCONFIG_EXTENSIONPROVIDER_ENVOYEXTERNALAUTHORIZATIONHTTPPROVIDER.fields_by_name['additional_headers_in_check'].message_type = _MESHCONFIG_EXTENSIONPROVIDER_ENVOYEXTERNALAUTHORIZATIONHTTPPROVIDER_ADDITIONALHEADERSINCHECKENTRY
...
MeshConfig = _reflection.GeneratedProtocolMessageType('MeshConfig', (_message.Message,), {
  ...
  'ExtensionProvider' : _reflection.GeneratedProtocolMessageType('ExtensionProvider', (_message.Message,), {
    ...
    'EnvoyExternalAuthorizationHttpProvider' : _reflection.GeneratedProtocolMessageType('EnvoyExternalAuthorizationHttpProvider', (_message.Message,), {
      ...
      'AdditionalHeadersInCheckEntry' : _reflection.GeneratedProtocolMessageType('AdditionalHeadersInCheckEntry', (_message.Message,), {
        'DESCRIPTOR' : _MESHCONFIG_EXTENSIONPROVIDER_ENVOYEXTERNALAUTHORIZATIONHTTPPROVIDER_ADDITIONALHEADERSINCHECKENTRY,
        '__module__' : 'mesh.v1alpha1.config_pb2'
        # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationHttpProvider.AdditionalHeadersInCheckEntry)
        })
      ,
...
_sym_db.RegisterMessage(MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationHttpProvider.AdditionalHeadersInCheckEntry)
...
_MESHCONFIG_EXTENSIONPROVIDER_ENVOYEXTERNALAUTHORIZATIONHTTPPROVIDER_ADDITIONALHEADERSINCHECKENTRY._options = None
