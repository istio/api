...
_MESHCONFIG_INBOUNDCLUSTERSTATNAME = _descriptor.EnumDescriptor(
  name='inboundClusterStatName',
  full_name='istio.mesh.v1alpha1.MeshConfig.inboundClusterStatName',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SERVICE_FQDN', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SERVICE_PORT', index=2, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SERVICE_PORT_NAME', index=3, number=3,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_MESHCONFIG_INBOUNDCLUSTERSTATNAME)

_MESHCONFIG_OUTBOUNDCLUSTERSTATNAME = _descriptor.EnumDescriptor(
  name='outboundClusterStatName',
  full_name='istio.mesh.v1alpha1.MeshConfig.outboundClusterStatName',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='SUBSET_NAME', index=0, number=0,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_MESHCONFIG_OUTBOUNDCLUSTERSTATNAME)
...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='service_settings', full_name='istio.mesh.v1alpha1.MeshConfig.service_settings', index=47,
  ...
  enum_types=[
    ...
    _MESHCONFIG_INBOUNDCLUSTERSTATNAME,
    _MESHCONFIG_OUTBOUNDCLUSTERSTATNAME,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_MESHCONFIG_INBOUNDCLUSTERSTATNAME.containing_type = _MESHCONFIG
_MESHCONFIG_OUTBOUNDCLUSTERSTATNAME.containing_type = _MESHCONFIG
