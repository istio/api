...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='outlier_detection', full_name='istio.mesh.v1alpha1.MeshConfig.outlier_detection', index=33,
...
_MESHCONFIG.fields_by_name['outlier_detection'].message_type = networking_dot_v1alpha3_dot_destination__rule__pb2._OUTLIERDETECTION
