...
_MESHCONFIG_EXTERNALSERVER_AUTHZ_HTTP = _descriptor.Descriptor(
  name='HTTP',
  full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz.HTTP',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='path_prefix', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz.HTTP.path_prefix', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='include_headers', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz.HTTP.include_headers', index=1,
      number=2, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='forward_to_upstream', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz.HTTP.forward_to_upstream', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='forward_to_downstream', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz.HTTP.forward_to_downstream', index=3,
...
_MESHCONFIG_EXTERNALSERVER_AUTHZ_GRPC = _descriptor.Descriptor(
  name='GRPC',
  full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz.GRPC',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_MESHCONFIG_EXTERNALSERVER_AUTHZ = _descriptor.Descriptor(
  name='Authz',
  full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='service', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz.service', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timeout', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz.timeout', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='http', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz.http', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='grpc', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz.grpc', index=3,
  ...
  nested_types=[_MESHCONFIG_EXTERNALSERVER_AUTHZ_HTTP, _MESHCONFIG_EXTERNALSERVER_AUTHZ_GRPC, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='external_authz_service_type', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz.external_authz_service_type',
...
_MESHCONFIG_EXTERNALSERVER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='authz', full_name='istio.mesh.v1alpha1.MeshConfig.ExternalServer.authz', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_MESHCONFIG_EXTERNALSERVER_AUTHZ, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_MESHCONFIG_EXTERNALSERVER_AUTHZ_HTTP.containing_type = _MESHCONFIG_EXTERNALSERVER_AUTHZ
_MESHCONFIG_EXTERNALSERVER_AUTHZ_GRPC.containing_type = _MESHCONFIG_EXTERNALSERVER_AUTHZ
_MESHCONFIG_EXTERNALSERVER_AUTHZ.fields_by_name['service'].message_type = networking_dot_v1alpha3_dot_virtual__service__pb2._DESTINATION
_MESHCONFIG_EXTERNALSERVER_AUTHZ.fields_by_name['timeout'].message_type = google_dot_protobuf_dot_duration__pb2._DURATION
_MESHCONFIG_EXTERNALSERVER_AUTHZ.fields_by_name['http'].message_type = _MESHCONFIG_EXTERNALSERVER_AUTHZ_HTTP
_MESHCONFIG_EXTERNALSERVER_AUTHZ.fields_by_name['grpc'].message_type = _MESHCONFIG_EXTERNALSERVER_AUTHZ_GRPC
_MESHCONFIG_EXTERNALSERVER_AUTHZ.containing_type = _MESHCONFIG_EXTERNALSERVER
_MESHCONFIG_EXTERNALSERVER_AUTHZ.oneofs_by_name['external_authz_service_type'].fields.append(
  _MESHCONFIG_EXTERNALSERVER_AUTHZ.fields_by_name['http'])
_MESHCONFIG_EXTERNALSERVER_AUTHZ.fields_by_name['http'].containing_oneof = _MESHCONFIG_EXTERNALSERVER_AUTHZ.oneofs_by_name['external_authz_service_type']
_MESHCONFIG_EXTERNALSERVER_AUTHZ.oneofs_by_name['external_authz_service_type'].fields.append(
  _MESHCONFIG_EXTERNALSERVER_AUTHZ.fields_by_name['grpc'])
_MESHCONFIG_EXTERNALSERVER_AUTHZ.fields_by_name['grpc'].containing_oneof = _MESHCONFIG_EXTERNALSERVER_AUTHZ.oneofs_by_name['external_authz_service_type']
_MESHCONFIG_EXTERNALSERVER.fields_by_name['authz'].message_type = _MESHCONFIG_EXTERNALSERVER_AUTHZ
_MESHCONFIG_EXTERNALSERVER.containing_type = _MESHCONFIG
_MESHCONFIG_EXTERNALSERVER.oneofs_by_name['config'].fields.append(
  _MESHCONFIG_EXTERNALSERVER.fields_by_name['authz'])
_MESHCONFIG_EXTERNALSERVER.fields_by_name['authz'].containing_oneof = _MESHCONFIG_EXTERNALSERVER.oneofs_by_name['config']
  ...
  'ExternalServer' : _reflection.GeneratedProtocolMessageType('ExternalServer', (_message.Message,), {
    ...
    'Authz' : _reflection.GeneratedProtocolMessageType('Authz', (_message.Message,), {
      ...
      'HTTP' : _reflection.GeneratedProtocolMessageType('HTTP', (_message.Message,), {
        'DESCRIPTOR' : _MESHCONFIG_EXTERNALSERVER_AUTHZ_HTTP,
        '__module__' : 'mesh.v1alpha1.config_pb2'
        # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz.HTTP)
        })
      ,

      'GRPC' : _reflection.GeneratedProtocolMessageType('GRPC', (_message.Message,), {
        'DESCRIPTOR' : _MESHCONFIG_EXTERNALSERVER_AUTHZ_GRPC,
        '__module__' : 'mesh.v1alpha1.config_pb2'
        # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz.GRPC)
        })
      ,
      'DESCRIPTOR' : _MESHCONFIG_EXTERNALSERVER_AUTHZ,
      '__module__' : 'mesh.v1alpha1.config_pb2'
      # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz)
      })
    ,
...
_sym_db.RegisterMessage(MeshConfig.ExternalServer.Authz)
_sym_db.RegisterMessage(MeshConfig.ExternalServer.Authz.HTTP)
_sym_db.RegisterMessage(MeshConfig.ExternalServer.Authz.GRPC)
