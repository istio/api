...
_MESHCONFIG_INGRESSSELECTORENTRY = _descriptor.Descriptor(
  name='IngressSelectorEntry',
  full_name='istio.mesh.v1alpha1.MeshConfig.IngressSelectorEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='istio.mesh.v1alpha1.MeshConfig.IngressSelectorEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='istio.mesh.v1alpha1.MeshConfig.IngressSelectorEntry.value', index=1,
...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  nested_types=[_MESHCONFIG_INGRESSSELECTORENTRY, _MESHCONFIG_OUTBOUNDTRAFFICPOLICY, _MESHCONFIG_THRIFTCONFIG, _MESHCONFIG_SERVICESETTINGS, ],
  enum_types=[
...
_MESHCONFIG_INGRESSSELECTORENTRY.containing_type = _MESHCONFIG
...
_MESHCONFIG.fields_by_name['ingress_selector'].message_type = _MESHCONFIG_INGRESSSELECTORENTRY
...
MeshConfig = _reflection.GeneratedProtocolMessageType('MeshConfig', (_message.Message,), {
  ...
  'IngressSelectorEntry' : _reflection.GeneratedProtocolMessageType('IngressSelectorEntry', (_message.Message,), {
    'DESCRIPTOR' : _MESHCONFIG_INGRESSSELECTORENTRY,
    '__module__' : 'mesh.v1alpha1.config_pb2'
    # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.IngressSelectorEntry)
    })
  ,
...
_sym_db.RegisterMessage(MeshConfig.IngressSelectorEntry)
...
_MESHCONFIG_INGRESSSELECTORENTRY._options = None
