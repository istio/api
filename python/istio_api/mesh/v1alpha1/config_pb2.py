...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='topologyKeys', full_name='istio.mesh.v1alpha1.MeshConfig.topologyKeys', index=27,
...
_MESHCONFIG.fields_by_name['topologyKeys'].message_type = networking_dot_v1alpha3_dot_destination__rule__pb2._TOPOLOGYKEYS
