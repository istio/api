...
_AUTHORIZATIONPOLICY_EXTERNAL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='service', full_name='istio.security.v1beta1.AuthorizationPolicy.External.service', index=0,
