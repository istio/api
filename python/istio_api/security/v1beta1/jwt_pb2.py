...
_JWTRULE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='forward_original', full_name='istio.security.v1beta1.JWTRule.forward_original', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='forward_payload_header', full_name='istio.security.v1beta1.JWTRule.forward_payload_header', index=7,
