...
_PEERAUTHENTICATION = _descriptor.Descriptor(
  ...
  nested_types=[_PEERAUTHENTICATION_MUTUALTLS, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
