...
_ISTIOCONDITION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lastProbeTime', full_name='istio.meta.v1beta1.IstioCondition.lastProbeTime', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lastTransitionTime', full_name='istio.meta.v1beta1.IstioCondition.lastTransitionTime', index=3,
