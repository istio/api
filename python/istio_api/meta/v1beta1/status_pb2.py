...
from analysis.v1beta1 import message_pb2 as analysis_dot_v1beta1_dot_message__pb2
...
_ISTIOSTATUS = _descriptor.Descriptor(
  name='IstioStatus',
  full_name='istio.meta.v1beta1.IstioStatus',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='conditions', full_name='istio.meta.v1beta1.IstioStatus.conditions', index=0,
...
_ISTIOCONDITION = _descriptor.Descriptor(
  name='IstioCondition',
  full_name='istio.meta.v1beta1.IstioCondition',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='istio.meta.v1beta1.IstioCondition.type', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='status', full_name='istio.meta.v1beta1.IstioCondition.status', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_probe_time', full_name='istio.meta.v1beta1.IstioCondition.last_probe_time', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_transition_time', full_name='istio.meta.v1beta1.IstioCondition.last_transition_time', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='reason', full_name='istio.meta.v1beta1.IstioCondition.reason', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='message', full_name='istio.meta.v1beta1.IstioCondition.message', index=5,
...
IstioStatus = _reflection.GeneratedProtocolMessageType('IstioStatus', (_message.Message,), {
  ...
  '__module__' : 'meta.v1beta1.status_pb2'
  # @@protoc_insertion_point(class_scope:istio.meta.v1beta1.IstioStatus)
  })
...
IstioCondition = _reflection.GeneratedProtocolMessageType('IstioCondition', (_message.Message,), {
  ...
  '__module__' : 'meta.v1beta1.status_pb2'
  # @@protoc_insertion_point(class_scope:istio.meta.v1beta1.IstioCondition)
  })
