...
_STRINGMATCH = _descriptor.Descriptor(
  name='StringMatch',
  full_name='istio.common.v1beta1.StringMatch',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='exact', full_name='istio.common.v1beta1.StringMatch.exact', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='prefix', full_name='istio.common.v1beta1.StringMatch.prefix', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='suffix', full_name='istio.common.v1beta1.StringMatch.suffix', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='regex', full_name='istio.common.v1beta1.StringMatch.regex', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='match_type', full_name='istio.common.v1beta1.StringMatch.match_type',
...
StringMatch = _reflection.GeneratedProtocolMessageType('StringMatch', (_message.Message,), dict(
  ...
  __module__ = 'common.v1beta1.match_pb2'
  # @@protoc_insertion_point(class_scope:istio.common.v1beta1.StringMatch)
  ))
