...
_LOADBALANCERSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='network_lb_setting', full_name='istio.networking.v1alpha3.LoadBalancerSettings.network_lb_setting', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_OUTLIERDETECTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='consecutive_local_origin_failure', full_name='istio.networking.v1alpha3.OutlierDetection.consecutive_local_origin_failure', index=2,
...
_NETWORKLOADBALANCERSETTING_FAILOVER = _descriptor.Descriptor(
  name='Failover',
  full_name='istio.networking.v1alpha3.NetworkLoadBalancerSetting.Failover',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='from', full_name='istio.networking.v1alpha3.NetworkLoadBalancerSetting.Failover.from', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='from', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='to', full_name='istio.networking.v1alpha3.NetworkLoadBalancerSetting.Failover.to', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_NETWORKLOADBALANCERSETTING = _descriptor.Descriptor(
  name='NetworkLoadBalancerSetting',
  full_name='istio.networking.v1alpha3.NetworkLoadBalancerSetting',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='failover', full_name='istio.networking.v1alpha3.NetworkLoadBalancerSetting.failover', index=0,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='failover', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='enabled', full_name='istio.networking.v1alpha3.NetworkLoadBalancerSetting.enabled', index=1,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_NETWORKLOADBALANCERSETTING_FAILOVER, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_LOADBALANCERSETTINGS.fields_by_name['network_lb_setting'].message_type = _NETWORKLOADBALANCERSETTING
...
_NETWORKLOADBALANCERSETTING_FAILOVER.containing_type = _NETWORKLOADBALANCERSETTING
_NETWORKLOADBALANCERSETTING.fields_by_name['failover'].message_type = _NETWORKLOADBALANCERSETTING_FAILOVER
_NETWORKLOADBALANCERSETTING.fields_by_name['enabled'].message_type = google_dot_protobuf_dot_wrappers__pb2._BOOLVALUE
...
DESCRIPTOR.message_types_by_name['NetworkLoadBalancerSetting'] = _NETWORKLOADBALANCERSETTING
...
NetworkLoadBalancerSetting = _reflection.GeneratedProtocolMessageType('NetworkLoadBalancerSetting', (_message.Message,), {

  'Failover' : _reflection.GeneratedProtocolMessageType('Failover', (_message.Message,), {
    'DESCRIPTOR' : _NETWORKLOADBALANCERSETTING_FAILOVER,
    '__module__' : 'networking.v1alpha3.destination_rule_pb2'
    # @@protoc_insertion_point(class_scope:istio.networking.v1alpha3.NetworkLoadBalancerSetting.Failover)
    })
  ,
  'DESCRIPTOR' : _NETWORKLOADBALANCERSETTING,
  '__module__' : 'networking.v1alpha3.destination_rule_pb2'
  # @@protoc_insertion_point(class_scope:istio.networking.v1alpha3.NetworkLoadBalancerSetting)
  })
_sym_db.RegisterMessage(NetworkLoadBalancerSetting)
_sym_db.RegisterMessage(NetworkLoadBalancerSetting.Failover)
