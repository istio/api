...
_PROTOCOLOPTIONS_HTTP1OPTIONS = _descriptor.Descriptor(
  name='Http1Options',
  full_name='istio.networking.v1alpha3.ProtocolOptions.Http1Options',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='allow_absolute_url', full_name='istio.networking.v1alpha3.ProtocolOptions.Http1Options.allow_absolute_url', index=0,
...
_PROTOCOLOPTIONS_HTTP2OPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='initial_connection_window_size', full_name='istio.networking.v1alpha3.ProtocolOptions.Http2Options.initial_connection_window_size', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='allow_connect', full_name='istio.networking.v1alpha3.ProtocolOptions.Http2Options.allow_connect', index=3,
...
_PROTOCOLOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='http1', full_name='istio.networking.v1alpha3.ProtocolOptions.http1', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='http2', full_name='istio.networking.v1alpha3.ProtocolOptions.http2', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_PROTOCOLOPTIONS_HTTPOPTIONS, _PROTOCOLOPTIONS_HTTP1OPTIONS, _PROTOCOLOPTIONS_HTTP2OPTIONS, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_PROTOCOLOPTIONS_HTTP1OPTIONS.containing_type = _PROTOCOLOPTIONS
...
_PROTOCOLOPTIONS.fields_by_name['http1'].message_type = _PROTOCOLOPTIONS_HTTP1OPTIONS
...
ProtocolOptions = _reflection.GeneratedProtocolMessageType('ProtocolOptions', (_message.Message,), dict(
  ...
  Http1Options = _reflection.GeneratedProtocolMessageType('Http1Options', (_message.Message,), dict(
    DESCRIPTOR = _PROTOCOLOPTIONS_HTTP1OPTIONS,
    __module__ = 'networking.v1alpha3.destination_rule_pb2'
    # @@protoc_insertion_point(class_scope:istio.networking.v1alpha3.ProtocolOptions.Http1Options)
    ))
  ,
...
_sym_db.RegisterMessage(ProtocolOptions.Http1Options)
