...
_DESTINATIONRULE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='inbound_stat_name', full_name='istio.networking.v1alpha3.DestinationRule.inbound_stat_name', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='outbound_stat_name', full_name='istio.networking.v1alpha3.DestinationRule.outbound_stat_name', index=5,
