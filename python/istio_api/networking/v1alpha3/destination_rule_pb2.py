...
_TLSSETTINGS.fields_by_name['subject_alt_names'].has_options = True
_TLSSETTINGS.fields_by_name['subject_alt_names']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
