...
_LOADBALANCERSUBSETSETTING_SUBSETSELECTOR_SUBSETSELECTORFALLBACKPOLICY = _descriptor.EnumDescriptor(
  ...
  full_name='istio.networking.v1alpha3.LoadBalancerSubsetSetting.SubsetSelector.SubsetSelectorFallbackPolicy',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_LOADBALANCERSUBSETSETTING_LBSUBSETFALLBACKPOLICY = _descriptor.EnumDescriptor(
  ...
  full_name='istio.networking.v1alpha3.LoadBalancerSubsetSetting.LbSubsetFallbackPolicy',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_LOADBALANCERSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='lb_subset_setting', full_name='istio.networking.v1alpha3.LoadBalancerSettings.lb_subset_setting', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOADBALANCERSUBSETSETTING_METADATAENTRY = _descriptor.Descriptor(
  name='MetadataEntry',
  full_name='istio.networking.v1alpha3.LoadBalancerSubsetSetting.MetadataEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='istio.networking.v1alpha3.LoadBalancerSubsetSetting.MetadataEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='key', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='istio.networking.v1alpha3.LoadBalancerSubsetSetting.MetadataEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOADBALANCERSUBSETSETTING_SUBSETSELECTOR = _descriptor.Descriptor(
  name='SubsetSelector',
  full_name='istio.networking.v1alpha3.LoadBalancerSubsetSetting.SubsetSelector',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='keys', full_name='istio.networking.v1alpha3.LoadBalancerSubsetSetting.SubsetSelector.keys', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='fallback_policy', full_name='istio.networking.v1alpha3.LoadBalancerSubsetSetting.SubsetSelector.fallback_policy', index=1,
...
_LOADBALANCERSUBSETSETTING = _descriptor.Descriptor(
  ...
  full_name='istio.networking.v1alpha3.LoadBalancerSubsetSetting',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='fallback_policy', full_name='istio.networking.v1alpha3.LoadBalancerSubsetSetting.fallback_policy', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='fallbackPolicy', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='istio.networking.v1alpha3.LoadBalancerSubsetSetting.metadata', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='subset_selectors', full_name='istio.networking.v1alpha3.LoadBalancerSubsetSetting.subset_selectors', index=2,
      number=3, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
LoadBalancerSubsetSetting = _reflection.GeneratedProtocolMessageType('LoadBalancerSubsetSetting', (_message.Message,), {
  ...
  'MetadataEntry' : _reflection.GeneratedProtocolMessageType('MetadataEntry', (_message.Message,), {
    ...
    '__module__' : 'networking.v1alpha3.destination_rule_pb2'
    # @@protoc_insertion_point(class_scope:istio.networking.v1alpha3.LoadBalancerSubsetSetting.MetadataEntry)
    })
  ,
  ...
  'SubsetSelector' : _reflection.GeneratedProtocolMessageType('SubsetSelector', (_message.Message,), {
    ...
    '__module__' : 'networking.v1alpha3.destination_rule_pb2'
    # @@protoc_insertion_point(class_scope:istio.networking.v1alpha3.LoadBalancerSubsetSetting.SubsetSelector)
    })
  ,
  'DESCRIPTOR' : _LOADBALANCERSUBSETSETTING,
  '__module__' : 'networking.v1alpha3.destination_rule_pb2'
  # @@protoc_insertion_point(class_scope:istio.networking.v1alpha3.LoadBalancerSubsetSetting)
  })
