...
_CLIENTTLSSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=_b('\340A\002'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='verify_certificate_at_client', full_name='istio.networking.v1alpha3.ClientTLSSettings.verify_certificate_at_client', index=1,
