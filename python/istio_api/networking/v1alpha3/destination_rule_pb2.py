...
_OUTLIERDETECTION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='consecutive_5xx_errors', full_name='istio.networking.v1alpha3.OutlierDetection.consecutive_5xx_errors', index=1,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='min_health_percent', full_name='istio.networking.v1alpha3.OutlierDetection.min_health_percent', index=5,
