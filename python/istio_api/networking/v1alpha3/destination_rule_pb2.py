...
_TRAFFICPOLICY_PORTTRAFFICPOLICY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='healthy_check', full_name='istio.networking.v1alpha3.TrafficPolicy.PortTrafficPolicy.healthy_check', index=4,
...
_TRAFFICPOLICY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='outlierDetection', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='healthy_check', full_name='istio.networking.v1alpha3.TrafficPolicy.healthy_check', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_HEALTHYCHECK_HTTP_HEALTH_CHECK = _descriptor.Descriptor(
  ...
  full_name='istio.networking.v1alpha3.HealthyCheck.http_health_check',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='host', full_name='istio.networking.v1alpha3.HealthyCheck.http_health_check.host', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='path', full_name='istio.networking.v1alpha3.HealthyCheck.http_health_check.path', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_HEALTHYCHECK = _descriptor.Descriptor(
  name='HealthyCheck',
  full_name='istio.networking.v1alpha3.HealthyCheck',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='interval', full_name='istio.networking.v1alpha3.HealthyCheck.interval', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='interval', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timeout', full_name='istio.networking.v1alpha3.HealthyCheck.timeout', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='healthy_threshold', full_name='istio.networking.v1alpha3.HealthyCheck.healthy_threshold', index=2,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='unhealthy_threshold', full_name='istio.networking.v1alpha3.HealthyCheck.unhealthy_threshold', index=3,
      number=4, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='HttpHealthyCheck', full_name='istio.networking.v1alpha3.HealthyCheck.HttpHealthyCheck', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
HealthyCheck = _reflection.GeneratedProtocolMessageType('HealthyCheck', (_message.Message,), {
  ...
  'http_health_check' : _reflection.GeneratedProtocolMessageType('http_health_check', (_message.Message,), {
    ...
    '__module__' : 'networking.v1alpha3.destination_rule_pb2'
    # @@protoc_insertion_point(class_scope:istio.networking.v1alpha3.HealthyCheck.http_health_check)
    })
  ,
  'DESCRIPTOR' : _HEALTHYCHECK,
  '__module__' : 'networking.v1alpha3.destination_rule_pb2'
  # @@protoc_insertion_point(class_scope:istio.networking.v1alpha3.HealthyCheck)
  })
