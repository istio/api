...
_STRINGMATCH = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='case_sensitive', full_name='istio.networking.v1alpha3.StringMatch.case_sensitive', index=3,
