...
_HTTPREDIRECT = _descriptor.Descriptor(
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='port_type', full_name='istio.networking.v1alpha3.HTTPRedirect.port_type',
