...
_HEADERS_HEADEROPERATIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tracing_tags_from_headers', full_name='istio.networking.v1alpha3.Headers.HeaderOperations.tracing_tags_from_headers', index=3,
