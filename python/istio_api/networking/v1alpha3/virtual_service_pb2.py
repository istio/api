...
_FRACTIONALPERCENT = _descriptor.Descriptor(
  ...
  full_name='istio.networking.v1alpha3.FractionalPercent',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='numerator', full_name='istio.networking.v1alpha3.FractionalPercent.numerator', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='denominator', full_name='istio.networking.v1alpha3.FractionalPercent.denominator', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_HTTPFAULTINJECTION_DELAY.fields_by_name['percentage'].message_type = _FRACTIONALPERCENT
...
_HTTPFAULTINJECTION_ABORT.fields_by_name['percentage'].message_type = _FRACTIONALPERCENT
...
FractionalPercent = _reflection.GeneratedProtocolMessageType('FractionalPercent', (_message.Message,), dict(
  ...
  __module__ = 'networking.v1alpha3.virtual_service_pb2'
  # @@protoc_insertion_point(class_scope:istio.networking.v1alpha3.FractionalPercent)
  ))
