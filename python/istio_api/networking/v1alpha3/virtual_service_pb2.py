...
_HTTPRETRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='retriable_status_codes', full_name='istio.networking.v1alpha3.HTTPRetry.retriable_status_codes', index=4,
