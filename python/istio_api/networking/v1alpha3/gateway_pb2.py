...
_SERVER_TLSOPTIONS_CREDENTIALSTORE = _descriptor.Descriptor(
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='credentialStore', full_name='istio.networking.v1alpha3.Server.TLSOptions.CredentialStore.credentialStore',
...
_SERVER_TLSOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ca_certificates', full_name='istio.networking.v1alpha3.Server.TLSOptions.ca_certificates', index=5,
...
_SERVER_TLSOPTIONS_CREDENTIALSTORE.oneofs_by_name['credentialStore'].fields.append(
  _SERVER_TLSOPTIONS_CREDENTIALSTORE.fields_by_name['files'])
_SERVER_TLSOPTIONS_CREDENTIALSTORE.fields_by_name['files'].containing_oneof = _SERVER_TLSOPTIONS_CREDENTIALSTORE.oneofs_by_name['credentialStore']
_SERVER_TLSOPTIONS_CREDENTIALSTORE.oneofs_by_name['credentialStore'].fields.append(
  _SERVER_TLSOPTIONS_CREDENTIALSTORE.fields_by_name['remote'])
_SERVER_TLSOPTIONS_CREDENTIALSTORE.fields_by_name['remote'].containing_oneof = _SERVER_TLSOPTIONS_CREDENTIALSTORE.oneofs_by_name['credentialStore']
