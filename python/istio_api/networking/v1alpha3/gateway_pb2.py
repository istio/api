...
_SERVER_TLSOPTIONS_TLSMODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ISTIO_REGISTRY_PASSTHROUGH', index=3, number=3,
      options=None,
      type=None),
  ],
