...
_GATEWAY_HTTPOPTIONS = _descriptor.Descriptor(
  name='HTTPOptions',
  full_name='istio.networking.v1alpha3.Gateway.HTTPOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='xff_num_trusted_hops', full_name='istio.networking.v1alpha3.Gateway.HTTPOptions.xff_num_trusted_hops', index=0,
...
_GATEWAY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='http', full_name='istio.networking.v1alpha3.Gateway.http', index=2,
  ...
  nested_types=[_GATEWAY_SELECTORENTRY, _GATEWAY_HTTPOPTIONS, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
Gateway = _reflection.GeneratedProtocolMessageType('Gateway', (_message.Message,), dict(
  ...
  HTTPOptions = _reflection.GeneratedProtocolMessageType('HTTPOptions', (_message.Message,), dict(
    DESCRIPTOR = _GATEWAY_HTTPOPTIONS,
    __module__ = 'networking.v1alpha3.gateway_pb2'
    # @@protoc_insertion_point(class_scope:istio.networking.v1alpha3.Gateway.HTTPOptions)
    ))
  ,
  DESCRIPTOR = _GATEWAY,
  __module__ = 'networking.v1alpha3.gateway_pb2'
...
_sym_db.RegisterMessage(Gateway.HTTPOptions)
