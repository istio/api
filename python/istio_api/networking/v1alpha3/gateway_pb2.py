...
_SERVER_TLSOPTIONS_CERTIFICATEVALIDATIONCONTEXT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='crl', full_name='istio.networking.v1alpha3.Server.TLSOptions.CertificateValidationContext.crl', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='allow_expired_certificate', full_name='istio.networking.v1alpha3.Server.TLSOptions.CertificateValidationContext.allow_expired_certificate', index=3,
