...
_SERVER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stats_prefix', full_name='istio.networking.v1alpha3.Server.stats_prefix', index=5,
