...
_SERVER_TLSOPTIONS_TLSVERSION = _descriptor.EnumDescriptor(
  name='TLSVersion',
  full_name='istio.networking.v1alpha3.Server.TLSOptions.TLSVersion',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_SERVER_TLSOPTIONS_TLSVERSION)
...
_SERVER_TLSOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tls_minimum_protocol_version', full_name='istio.networking.v1alpha3.Server.TLSOptions.tls_minimum_protocol_version', index=6,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tls_maximum_protocol_version', full_name='istio.networking.v1alpha3.Server.TLSOptions.tls_maximum_protocol_version', index=7,
...
_SERVER_TLSOPTIONS.fields_by_name['tls_minimum_protocol_version'].enum_type = _SERVER_TLSOPTIONS_TLSVERSION
_SERVER_TLSOPTIONS.fields_by_name['tls_maximum_protocol_version'].enum_type = _SERVER_TLSOPTIONS_TLSVERSION
_SERVER_TLSOPTIONS.containing_type = _SERVER
_SERVER_TLSOPTIONS_TLSMODE.containing_type = _SERVER_TLSOPTIONS
_SERVER_TLSOPTIONS_TLSVERSION.containing_type = _SERVER_TLSOPTIONS
