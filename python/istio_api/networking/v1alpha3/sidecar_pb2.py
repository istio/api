...
_OUTBOUNDTRAFFICPOLICY_MODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ALLOW_ANY_VIA_EGRESS_GATWEAY', index=2, number=2,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_OUTBOUNDTRAFFICPOLICY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='egress_gateway_host', full_name='istio.networking.v1alpha3.OutboundTrafficPolicy.egress_gateway_host', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='egress_gateway_port', full_name='istio.networking.v1alpha3.OutboundTrafficPolicy.egress_gateway_port', index=2,
