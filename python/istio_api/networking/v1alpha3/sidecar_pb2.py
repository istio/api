...
_SIDECAR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='connection_pool', full_name='istio.networking.v1alpha3.Sidecar.connection_pool', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='outbound_traffic_policy', full_name='istio.networking.v1alpha3.Sidecar.outbound_traffic_policy', index=4,
...
_SIDECAR.fields_by_name['connection_pool'].message_type = networking_dot_v1alpha3_dot_destination__rule__pb2._CONNECTIONPOOLSETTINGS
