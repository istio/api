...
_ISTIOINGRESSLISTENER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='tls', full_name='istio.networking.v1alpha3.IstioIngressListener.tls', index=4,
...
_ISTIOINGRESSLISTENER.fields_by_name['tls'].message_type = networking_dot_v1alpha3_dot_gateway__pb2._SERVERTLSSETTINGS
