...
_HTTPRETRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='retriable_status_codes', full_name='istio.networking.v1beta1.HTTPRetry.retriable_status_codes', index=4,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='retriableStatusCodes', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
