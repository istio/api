...
_HTTPREDIRECT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='port', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='scheme', full_name='istio.networking.v1beta1.HTTPRedirect.scheme', index=3,
      ...
      serialized_options=None, json_name='scheme', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='redirect_code', full_name='istio.networking.v1beta1.HTTPRedirect.redirect_code', index=4,
      number=3, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_HTTPREDIRECT.fields_by_name['port'].message_type = google_dot_protobuf_dot_wrappers__pb2._UINT32VALUE
