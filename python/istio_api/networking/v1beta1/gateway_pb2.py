...
_SERVER_TLSOPTIONS_TLSMODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ISTIO_MUTUAL_AND_PLAINTEXT', index=5, number=5,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DISABLED', index=6, number=6,
      serialized_options=None,
      type=None),
  ],
