...
_OUTLIERDETECTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='consecutive_local_origin_failure', full_name='istio.networking.v1beta1.OutlierDetection.consecutive_local_origin_failure', index=2,
      number=9, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='consecutiveLocalOriginFailure', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
