...
_CONNECTIONPOOLSETTINGS_HTTPSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='max_requests', full_name='istio.networking.v1beta1.ConnectionPoolSettings.HTTPSettings.max_requests', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='maxRequests', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
