...
_INBOUNDTRAFFICPOLICY_ISTIOPEERAUTHENTICATION = _descriptor.EnumDescriptor(
  ...
  full_name='istio.networking.v1beta1.InboundTrafficPolicy.IstioPeerAuthentication',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_ISTIOINGRESSLISTENER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=_b('\340A\002'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='traffic_policy', full_name='istio.networking.v1beta1.IstioIngressListener.traffic_policy', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INBOUNDTRAFFICPOLICY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='istio_peer_authentication', full_name='istio.networking.v1beta1.InboundTrafficPolicy.istio_peer_authentication', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tls', full_name='istio.networking.v1beta1.InboundTrafficPolicy.tls', index=1,
...
_INBOUNDTRAFFICPOLICY.fields_by_name['tls'].message_type = networking_dot_v1beta1_dot_gateway__pb2._SERVER_TLSOPTIONS
