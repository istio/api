...
_ISTIOINGRESSLISTENER_MODE = _descriptor.EnumDescriptor(
  name='Mode',
  full_name='istio.networking.v1beta1.IstioIngressListener.Mode',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
