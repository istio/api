...
_OUTBOUNDTRAFFICPOLICY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='egress_proxy_host', full_name='istio.networking.v1beta1.OutboundTrafficPolicy.egress_proxy_host', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='egress_proxy_port', full_name='istio.networking.v1beta1.OutboundTrafficPolicy.egress_proxy_port', index=2,
