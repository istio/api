...
_ANALYSISMESSAGEBASE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='documentationUrl', full_name='istio.analysis.v1alpha1.AnalysisMessageBase.documentationUrl', index=2,
