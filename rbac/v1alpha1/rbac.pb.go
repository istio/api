...
func (*ServiceRole) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*AccessRule) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*AccessRule_Constraint) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1, 0} }
...
func (*ServiceRoleBinding) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func (*Subject) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{3} }
...
func (*RoleRef) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{4} }
...
func init() { proto.RegisterFile("rbac/v1alpha1/rbac.proto", fileDescriptor1) }
