...
func (RbacConfig_Mode) EnumDescriptor() ([]byte, []int) { return fileDescriptorRbac, []int{6, 0} }
...
func (*AuthorizationPolicy) Descriptor() ([]byte, []int) { return fileDescriptorRbac, []int{0} }

func (m *AuthorizationPolicy) GetWorkloadSelector() *istio_common_v1alpha1.WorkloadSelector {
	if m != nil {
...
func (*ServiceRole) Descriptor() ([]byte, []int) { return fileDescriptorRbac, []int{1} }
...
func (*AccessRule) Descriptor() ([]byte, []int) { return fileDescriptorRbac, []int{2} }
...
func (*AccessRule_Constraint) Descriptor() ([]byte, []int) { return fileDescriptorRbac, []int{2, 0} }
...
func (*ServiceRoleBinding) Descriptor() ([]byte, []int) { return fileDescriptorRbac, []int{3} }
...
func (*Subject) Descriptor() ([]byte, []int) { return fileDescriptorRbac, []int{4} }
...
func (*RoleRef) Descriptor() ([]byte, []int) { return fileDescriptorRbac, []int{5} }
...
func (*RbacConfig) Descriptor() ([]byte, []int) { return fileDescriptorRbac, []int{6} }
...
type RbacConfig_Target struct {
	...
	// $hide_from_docs
	// A list of workloads.
	WorkloadSelectors []*istio_common_v1alpha1.WorkloadSelector `protobuf:"bytes,3,rep,name=workload_selectors,json=workloadSelectors" json:"workload_selectors,omitempty"`
...
func (*RbacConfig_Target) Descriptor() ([]byte, []int) { return fileDescriptorRbac, []int{6, 0} }
...
func (m *RbacConfig_Target) GetWorkloadSelectors() []*istio_common_v1alpha1.WorkloadSelector {
	if m != nil {
...
func (m *RbacConfig_Target) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.WorkloadSelectors = append(m.WorkloadSelectors, &istio_common_v1alpha1.WorkloadSelector{})
...
var fileDescriptorRbac = []byte{
	...
	,
}
