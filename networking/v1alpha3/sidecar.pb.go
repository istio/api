...
const (
	...
	// Outbound traffic to unknown destinations will be captured and
	// forwarded to the specified proxy. Applicable only for HTTP and
	// TLS traffic.
	OutboundTrafficPolicy_ALLOW_ANY_VIA_PROXY OutboundTrafficPolicy_Mode = 2
)

var OutboundTrafficPolicy_Mode_name = map[int32]string{
	0: "REGISTRY_ONLY",
	1: "ALLOW_ANY",
	2: "ALLOW_ANY_VIA_PROXY",
}

var OutboundTrafficPolicy_Mode_value = map[string]int32{
	"REGISTRY_ONLY":       0,
	"ALLOW_ANY":           1,
	"ALLOW_ANY_VIA_PROXY": 2,
}
...
type OutboundTrafficPolicy struct {
	...
	// Specifies the details of the proxy through which unknown traffic
	// should be sent. This field is applicable only when the mode is
	// set to ALLOW_ANY_VIA_PROXY. If omitted, defaults to
	// istio-egressgateway.istio-system.svc.cluster.local:15443 when
	// applicable.
	Proxy                *OutboundTrafficPolicy_Proxy `protobuf:"bytes,2,opt,name=proxy,proto3" json:"proxy,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_unrecognized     []byte                       `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}
...
func (m *OutboundTrafficPolicy) GetProxy() *OutboundTrafficPolicy_Proxy {
	if m != nil {
		return m.Proxy
	}
	return nil
...
type OutboundTrafficPolicy_Proxy struct {
	// The hostname of the proxy to which the traffic should be
	// forwarded to. The hostname should be in the namespace/fqdn
	// format, corresponding to a service in the mesh. Traffic to the
	// proxy from the sidecar will automatically use Istio mutual
	// TLS.
	Host string `protobuf:"bytes,1,opt,name=host,proto3" json:"host,omitempty"`
	// The port to which the traffic should be forwarded to. Defaults to
	// 15443 if omitted.
...
func (m *OutboundTrafficPolicy_Proxy) Reset()         { *m = OutboundTrafficPolicy_Proxy{} }
func (m *OutboundTrafficPolicy_Proxy) String() string { return proto.CompactTextString(m) }
func (*OutboundTrafficPolicy_Proxy) ProtoMessage()    {}
func (*OutboundTrafficPolicy_Proxy) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c11342f04ad3d1, []int{4, 0}
}
func (m *OutboundTrafficPolicy_Proxy) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *OutboundTrafficPolicy_Proxy) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_OutboundTrafficPolicy_Proxy.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *OutboundTrafficPolicy_Proxy) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OutboundTrafficPolicy_Proxy.Merge(m, src)
}
func (m *OutboundTrafficPolicy_Proxy) XXX_Size() int {
	return m.Size()
}
func (m *OutboundTrafficPolicy_Proxy) XXX_DiscardUnknown() {
	xxx_messageInfo_OutboundTrafficPolicy_Proxy.DiscardUnknown(m)
}

var xxx_messageInfo_OutboundTrafficPolicy_Proxy proto.InternalMessageInfo

func (m *OutboundTrafficPolicy_Proxy) GetHost() string {
	if m != nil {
		return m.Host
	}
	return ""
...
func (m *OutboundTrafficPolicy_Proxy) GetPort() uint32 {
	if m != nil {
		return m.Port
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*OutboundTrafficPolicy_Proxy)(nil), "istio.networking.v1alpha3.OutboundTrafficPolicy.Proxy")
}
...
var fileDescriptor_b5c11342f04ad3d1 = []byte{
	...
	,
}
...
func (m *OutboundTrafficPolicy_Proxy) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *OutboundTrafficPolicy_Proxy) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OutboundTrafficPolicy_Proxy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *OutboundTrafficPolicy_Proxy) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *OutboundTrafficPolicy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Proxy == nil {
				m.Proxy = &OutboundTrafficPolicy_Proxy{}
			}
...
func (m *OutboundTrafficPolicy_Proxy) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
