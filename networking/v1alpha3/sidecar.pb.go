...
type IstioIngressListener_Mode int32

const (
	IstioIngressListener_DEFAULT IstioIngressListener_Mode = 0
	IstioIngressListener_GATEWAY IstioIngressListener_Mode = 1
)

var IstioIngressListener_Mode_name = map[int32]string{
	0: "DEFAULT",
	1: "GATEWAY",
}

var IstioIngressListener_Mode_value = map[string]int32{
	"DEFAULT": 0,
	"GATEWAY": 1,
}

func (x IstioIngressListener_Mode) String() string {
	return proto.EnumName(IstioIngressListener_Mode_name, int32(x))
}

func (IstioIngressListener_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b5c11342f04ad3d1, []int{1, 0}
}
...
type IstioIngressListener struct {
	...
	Mode                 IstioIngressListener_Mode `protobuf:"varint,7,opt,name=mode,proto3,enum=istio.networking.v1alpha3.IstioIngressListener_Mode" json:"mode,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (m *IstioIngressListener) GetMode() IstioIngressListener_Mode {
	if m != nil {
		return m.Mode
	}
	return IstioIngressListener_DEFAULT
}
...
func init() {
	...
	proto.RegisterEnum("istio.networking.v1alpha3.IstioIngressListener_Mode", IstioIngressListener_Mode_name, IstioIngressListener_Mode_value)
...
var fileDescriptor_b5c11342f04ad3d1 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Mode |= IstioIngressListener_Mode(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
