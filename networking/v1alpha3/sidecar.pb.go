...
type OutboundTrafficPolicy struct {
	...
	// TLS. This field is applicable only when the mode is set to
	// ALLOW_ANY_VIA_PROXY. If omitted, defaults to
	// istio-egressgateway.istio-system.svc.cluster.local when
	// applicable.
	EgressProxyHost string `protobuf:"bytes,2,opt,name=egress_proxy_host,json=egressProxyHost,proto3" json:"egress_proxy_host,omitempty"`
	// The port to which the traffic should be forwarded to. Defaults to
	// 15443 if omitted.
	EgressProxyPort      uint32   `protobuf:"varint,3,opt,name=egress_proxy_port,json=egressProxyPort,proto3" json:"egress_proxy_port,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *OutboundTrafficPolicy) GetEgressProxyHost() string {
	if m != nil {
		return m.EgressProxyHost
	}
	return ""
}

func (m *OutboundTrafficPolicy) GetEgressProxyPort() uint32 {
	if m != nil {
		return m.EgressProxyPort
	}
	return 0
}
...
var fileDescriptor_b5c11342f04ad3d1 = []byte{
	...
	,
}
...
func (m *OutboundTrafficPolicy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.EgressProxyPort != 0 {
		i = encodeVarintSidecar(dAtA, i, uint64(m.EgressProxyPort))
		i--
		dAtA[i] = 0x18
	}
	if len(m.EgressProxyHost) > 0 {
		i -= len(m.EgressProxyHost)
		copy(dAtA[i:], m.EgressProxyHost)
		i = encodeVarintSidecar(dAtA, i, uint64(len(m.EgressProxyHost)))
		i--
		dAtA[i] = 0x12
	}
	if m.Mode != 0 {
...
func (m *OutboundTrafficPolicy) Size() (n int) {
	...
	l = len(m.EgressProxyHost)
	if l > 0 {
		n += 1 + l + sovSidecar(uint64(l))
	}
	if m.EgressProxyPort != 0 {
		n += 1 + sovSidecar(uint64(m.EgressProxyPort))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *OutboundTrafficPolicy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EgressProxyHost", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EgressProxyHost = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EgressProxyPort", wireType)
			}
			m.EgressProxyPort = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EgressProxyPort |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
