...
// DeepCopyInto supports using RetryBudget within kubernetes types, where deepcopy-gen is used.
func (in *RetryBudget) DeepCopyInto(out *RetryBudget) {
	p := proto.Clone(in).(*RetryBudget)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RetryBudget. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new RetryBudget. Required by controller-gen.
func (in *RetryBudget) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
