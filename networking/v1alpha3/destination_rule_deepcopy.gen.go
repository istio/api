...
// DeepCopyInto supports using LoadBalancerSettingsAggression within kubernetes types, where deepcopy-gen is used.
func (in *LoadBalancerSettingsAggression) DeepCopyInto(out *LoadBalancerSettingsAggression) {
	p := proto.Clone(in).(*LoadBalancerSettingsAggression)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettingsAggression. Required by controller-gen.
func (in *LoadBalancerSettingsAggression) DeepCopy() *LoadBalancerSettingsAggression {
	if in == nil {
		return nil
	}
	out := new(LoadBalancerSettingsAggression)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettingsAggression. Required by controller-gen.
func (in *LoadBalancerSettingsAggression) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
