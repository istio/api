...
// DeepCopyInto supports using HealthCheckHttpHealthCheck within kubernetes types, where deepcopy-gen is used.
func (in *HealthCheckHttpHealthCheck) DeepCopyInto(out *HealthCheckHttpHealthCheck) {
	p := proto.Clone(in).(*HealthCheckHttpHealthCheck)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HealthCheckHttpHealthCheck. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new HealthCheckHttpHealthCheck. Required by controller-gen.
func (in *HealthCheckHttpHealthCheck) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
