...
// DeepCopyInto supports using ConnectionPoolSettings_PerHostLimits within kubernetes types, where deepcopy-gen is used.
func (in *ConnectionPoolSettings_PerHostLimits) DeepCopyInto(out *ConnectionPoolSettings_PerHostLimits) {
	p := proto.Clone(in).(*ConnectionPoolSettings_PerHostLimits)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConnectionPoolSettings_PerHostLimits. Required by controller-gen.
func (in *ConnectionPoolSettings_PerHostLimits) DeepCopy() *ConnectionPoolSettings_PerHostLimits {
	if in == nil {
		return nil
	}
	out := new(ConnectionPoolSettings_PerHostLimits)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new ConnectionPoolSettings_PerHostLimits. Required by controller-gen.
func (in *ConnectionPoolSettings_PerHostLimits) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
