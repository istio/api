...
// DeepCopyInto supports using TopologyKeys within kubernetes types, where deepcopy-gen is used.
func (in *TopologyKeys) DeepCopyInto(out *TopologyKeys) {
	p := proto.Clone(in).(*TopologyKeys)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TopologyKeys. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new TopologyKeys. Required by controller-gen.
func (in *TopologyKeys) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
