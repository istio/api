...
// DeepCopyInto supports using LoadBalancerSettings_SessionPersistence within kubernetes types, where deepcopy-gen is used.
func (in *LoadBalancerSettings_SessionPersistence) DeepCopyInto(out *LoadBalancerSettings_SessionPersistence) {
	p := proto.Clone(in).(*LoadBalancerSettings_SessionPersistence)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_SessionPersistence. Required by controller-gen.
func (in *LoadBalancerSettings_SessionPersistence) DeepCopy() *LoadBalancerSettings_SessionPersistence {
	if in == nil {
		return nil
	}
	out := new(LoadBalancerSettings_SessionPersistence)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_SessionPersistence. Required by controller-gen.
func (in *LoadBalancerSettings_SessionPersistence) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using LoadBalancerSettings_SessionPersistence_Cookie within kubernetes types, where deepcopy-gen is used.
func (in *LoadBalancerSettings_SessionPersistence_Cookie) DeepCopyInto(out *LoadBalancerSettings_SessionPersistence_Cookie) {
	p := proto.Clone(in).(*LoadBalancerSettings_SessionPersistence_Cookie)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_SessionPersistence_Cookie. Required by controller-gen.
func (in *LoadBalancerSettings_SessionPersistence_Cookie) DeepCopy() *LoadBalancerSettings_SessionPersistence_Cookie {
	if in == nil {
		return nil
	}
	out := new(LoadBalancerSettings_SessionPersistence_Cookie)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_SessionPersistence_Cookie. Required by controller-gen.
func (in *LoadBalancerSettings_SessionPersistence_Cookie) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
