...
// DeepCopyInto supports using LoadBalancerSettingsSlowStart within kubernetes types, where deepcopy-gen is used.
func (in *LoadBalancerSettingsSlowStart) DeepCopyInto(out *LoadBalancerSettingsSlowStart) {
	p := proto.Clone(in).(*LoadBalancerSettingsSlowStart)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettingsSlowStart. Required by controller-gen.
func (in *LoadBalancerSettingsSlowStart) DeepCopy() *LoadBalancerSettingsSlowStart {
	if in == nil {
		return nil
	}
	out := new(LoadBalancerSettingsSlowStart)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettingsSlowStart. Required by controller-gen.
func (in *LoadBalancerSettingsSlowStart) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using LoadBalancerSettingsSlowStartAggression within kubernetes types, where deepcopy-gen is used.
func (in *LoadBalancerSettingsSlowStartAggression) DeepCopyInto(out *LoadBalancerSettingsSlowStartAggression) {
	p := proto.Clone(in).(*LoadBalancerSettingsSlowStartAggression)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettingsSlowStartAggression. Required by controller-gen.
func (in *LoadBalancerSettingsSlowStartAggression) DeepCopy() *LoadBalancerSettingsSlowStartAggression {
	if in == nil {
		return nil
	}
	out := new(LoadBalancerSettingsSlowStartAggression)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettingsSlowStartAggression. Required by controller-gen.
func (in *LoadBalancerSettingsSlowStartAggression) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
