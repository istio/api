...
// DeepCopyInto supports using LoadBalancerSettings_ConsistentHashLB_RingHashConfig within kubernetes types, where deepcopy-gen is used.
func (in *LoadBalancerSettings_ConsistentHashLB_RingHashConfig) DeepCopyInto(out *LoadBalancerSettings_ConsistentHashLB_RingHashConfig) {
	p := proto.Clone(in).(*LoadBalancerSettings_ConsistentHashLB_RingHashConfig)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_ConsistentHashLB_RingHashConfig. Required by controller-gen.
func (in *LoadBalancerSettings_ConsistentHashLB_RingHashConfig) DeepCopy() *LoadBalancerSettings_ConsistentHashLB_RingHashConfig {
	if in == nil {
		return nil
	}
	out := new(LoadBalancerSettings_ConsistentHashLB_RingHashConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_ConsistentHashLB_RingHashConfig. Required by controller-gen.
func (in *LoadBalancerSettings_ConsistentHashLB_RingHashConfig) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using LoadBalancerSettings_ConsistentHashLB_MagLevConfig within kubernetes types, where deepcopy-gen is used.
func (in *LoadBalancerSettings_ConsistentHashLB_MagLevConfig) DeepCopyInto(out *LoadBalancerSettings_ConsistentHashLB_MagLevConfig) {
	p := proto.Clone(in).(*LoadBalancerSettings_ConsistentHashLB_MagLevConfig)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_ConsistentHashLB_MagLevConfig. Required by controller-gen.
func (in *LoadBalancerSettings_ConsistentHashLB_MagLevConfig) DeepCopy() *LoadBalancerSettings_ConsistentHashLB_MagLevConfig {
	if in == nil {
		return nil
	}
	out := new(LoadBalancerSettings_ConsistentHashLB_MagLevConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_ConsistentHashLB_MagLevConfig. Required by controller-gen.
func (in *LoadBalancerSettings_ConsistentHashLB_MagLevConfig) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
