...
// DeepCopyInto supports using ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions within kubernetes types, where deepcopy-gen is used.
func (in *ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions) DeepCopyInto(out *ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions) {
	p := proto.Clone(in).(*ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions. Required by controller-gen.
func (in *ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions) DeepCopy() *ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions {
	if in == nil {
		return nil
	}
	out := new(ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions. Required by controller-gen.
func (in *ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions_ConnectionKeepalive within kubernetes types, where deepcopy-gen is used.
func (in *ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions_ConnectionKeepalive) DeepCopyInto(out *ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions_ConnectionKeepalive) {
	p := proto.Clone(in).(*ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions_ConnectionKeepalive)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions_ConnectionKeepalive. Required by controller-gen.
func (in *ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions_ConnectionKeepalive) DeepCopy() *ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions_ConnectionKeepalive {
	if in == nil {
		return nil
	}
	out := new(ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions_ConnectionKeepalive)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions_ConnectionKeepalive. Required by controller-gen.
func (in *ConnectionPoolSettings_HTTPSettings_Http2ProtocolOptions_ConnectionKeepalive) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
