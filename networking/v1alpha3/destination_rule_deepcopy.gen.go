...
// DeepCopyInto supports using NetworkLoadBalancerSetting within kubernetes types, where deepcopy-gen is used.
func (in *NetworkLoadBalancerSetting) DeepCopyInto(out *NetworkLoadBalancerSetting) {
	p := proto.Clone(in).(*NetworkLoadBalancerSetting)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkLoadBalancerSetting. Required by controller-gen.
func (in *NetworkLoadBalancerSetting) DeepCopy() *NetworkLoadBalancerSetting {
	if in == nil {
		return nil
	}
	out := new(NetworkLoadBalancerSetting)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new NetworkLoadBalancerSetting. Required by controller-gen.
func (in *NetworkLoadBalancerSetting) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using NetworkLoadBalancerSetting_Failover within kubernetes types, where deepcopy-gen is used.
func (in *NetworkLoadBalancerSetting_Failover) DeepCopyInto(out *NetworkLoadBalancerSetting_Failover) {
	p := proto.Clone(in).(*NetworkLoadBalancerSetting_Failover)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkLoadBalancerSetting_Failover. Required by controller-gen.
func (in *NetworkLoadBalancerSetting_Failover) DeepCopy() *NetworkLoadBalancerSetting_Failover {
	if in == nil {
		return nil
	}
	out := new(NetworkLoadBalancerSetting_Failover)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new NetworkLoadBalancerSetting_Failover. Required by controller-gen.
func (in *NetworkLoadBalancerSetting_Failover) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
