...
type ConnectionPoolSettings_HTTPSettings struct {
	...
	HpackTableSize uint32 `protobuf:"varint,7,opt,name=hpack_table_size,json=hpackTableSize,proto3" json:"hpack_table_size,omitempty"`
	// Maximum concurrent streams allowed for peer on one HTTP2 connection.
	// Valid values range from 1 to 2^31-1.
	MaxConcurrentStreams uint32 `protobuf:"varint,8,opt,name=max_concurrent_streams,json=maxConcurrentStreams,proto3" json:"max_concurrent_streams,omitempty"`
	...
	// the codec buffers.
	InitialStreamWindowSize uint32 `protobuf:"varint,9,opt,name=initial_stream_window_size,json=initialStreamWindowSize,proto3" json:"initial_stream_window_size,omitempty"`
	// Similar to initial_stream_window_size, but for connection-level
	// flow-control window.
	InitialConnectionWindowSize uint32 `protobuf:"varint,10,opt,name=initial_connection_window_size,json=initialConnectionWindowSize,proto3" json:"initial_connection_window_size,omitempty"`
	// Allow proxying websocket and other upgrades over H2 connect.
	AllowConnect         bool     `protobuf:"varint,11,opt,name=allow_connect,json=allowConnect,proto3" json:"allow_connect,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ConnectionPoolSettings_HTTPSettings) GetHpackTableSize() uint32 {
	if m != nil {
...
func (m *ConnectionPoolSettings_HTTPSettings) GetMaxConcurrentStreams() uint32 {
	if m != nil {
...
func (m *ConnectionPoolSettings_HTTPSettings) GetInitialStreamWindowSize() uint32 {
	if m != nil {
...
func (m *ConnectionPoolSettings_HTTPSettings) GetInitialConnectionWindowSize() uint32 {
	if m != nil {
...
func (m *ConnectionPoolSettings_HTTPSettings) GetAllowConnect() bool {
	if m != nil {
...
var fileDescriptor_12899beb695152c8 = []byte{
	...
	,
}
