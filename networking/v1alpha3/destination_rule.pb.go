...
type LoadBalancerSubsetSetting_LbSubsetFallbackPolicy int32

const (
	LoadBalancerSubsetSetting_NO_FALLBACK    LoadBalancerSubsetSetting_LbSubsetFallbackPolicy = 0
	LoadBalancerSubsetSetting_ANY_ENDPOINT   LoadBalancerSubsetSetting_LbSubsetFallbackPolicy = 1
	LoadBalancerSubsetSetting_DEFAULT_SUBSET LoadBalancerSubsetSetting_LbSubsetFallbackPolicy = 2
)

var LoadBalancerSubsetSetting_LbSubsetFallbackPolicy_name = map[int32]string{
	0: "NO_FALLBACK",
	1: "ANY_ENDPOINT",
	2: "DEFAULT_SUBSET",
}

var LoadBalancerSubsetSetting_LbSubsetFallbackPolicy_value = map[string]int32{
	"NO_FALLBACK":    0,
	"ANY_ENDPOINT":   1,
	"DEFAULT_SUBSET": 2,
}

func (x LoadBalancerSubsetSetting_LbSubsetFallbackPolicy) String() string {
	return proto.EnumName(LoadBalancerSubsetSetting_LbSubsetFallbackPolicy_name, int32(x))
}

func (LoadBalancerSubsetSetting_LbSubsetFallbackPolicy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_12899beb695152c8, []int{8, 0}
}

// Allows to override top level fallback policy per selector.
type LoadBalancerSubsetSetting_SubsetSelector_SubsetSelectorFallbackPolicy int32

const (
	// If NOT_DEFINED top level config fallback policy is used instead.
	LoadBalancerSubsetSetting_SubsetSelector_NOT_DEFINED LoadBalancerSubsetSetting_SubsetSelector_SubsetSelectorFallbackPolicy = 0
	// If NO_FALLBACK is selected, a result equivalent to no healthy hosts is reported.
	LoadBalancerSubsetSetting_SubsetSelector_NO_FALLBACK LoadBalancerSubsetSetting_SubsetSelector_SubsetSelectorFallbackPolicy = 1
	// If ANY_ENDPOINT is selected, any cluster endpoint may be returned
	// (subject to policy, health checks, etc).
	LoadBalancerSubsetSetting_SubsetSelector_ANY_ENDPOINT LoadBalancerSubsetSetting_SubsetSelector_SubsetSelectorFallbackPolicy = 2
	// If DEFAULT_SUBSET is selected, load balancing is performed over the
	// endpoints matching the values from the default_subset field.
	LoadBalancerSubsetSetting_SubsetSelector_DEFAULT_SUBSET LoadBalancerSubsetSetting_SubsetSelector_SubsetSelectorFallbackPolicy = 3
)

var LoadBalancerSubsetSetting_SubsetSelector_SubsetSelectorFallbackPolicy_name = map[int32]string{
	0: "NOT_DEFINED",
	1: "NO_FALLBACK",
	2: "ANY_ENDPOINT",
	3: "DEFAULT_SUBSET",
...
var LoadBalancerSubsetSetting_SubsetSelector_SubsetSelectorFallbackPolicy_value = map[string]int32{
	"NOT_DEFINED":    0,
	"NO_FALLBACK":    1,
	"ANY_ENDPOINT":   2,
	"DEFAULT_SUBSET": 3,
...
func (x LoadBalancerSubsetSetting_SubsetSelector_SubsetSelectorFallbackPolicy) String() string {
	return proto.EnumName(LoadBalancerSubsetSetting_SubsetSelector_SubsetSelectorFallbackPolicy_name, int32(x))
}

func (LoadBalancerSubsetSetting_SubsetSelector_SubsetSelectorFallbackPolicy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_12899beb695152c8, []int{8, 1, 0}
}
...
type LoadBalancerSettings struct {
	...
	LbSubsetSetting      *LoadBalancerSubsetSetting   `protobuf:"bytes,4,opt,name=lb_subset_setting,json=lbSubsetSetting,proto3" json:"lb_subset_setting,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_unrecognized     []byte                       `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}
...
func (m *LoadBalancerSettings) GetLbSubsetSetting() *LoadBalancerSubsetSetting {
	if m != nil {
		return m.LbSubsetSetting
	}
	return nil
}
...
// Locality load balancing settings.
type LoadBalancerSubsetSetting struct {
	FallbackPolicy LoadBalancerSubsetSetting_LbSubsetFallbackPolicy `protobuf:"varint,1,opt,name=fallback_policy,json=fallbackPolicy,proto3,enum=istio.networking.v1alpha3.LoadBalancerSubsetSetting_LbSubsetFallbackPolicy" json:"fallback_policy,omitempty"`
	// Metadata on endpoint
	Metadata map[string]string `protobuf:"bytes,2,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// One or more subset selectors
	SubsetSelectors      []*LoadBalancerSubsetSetting_SubsetSelector `protobuf:"bytes,3,rep,name=subset_selectors,json=subsetSelectors,proto3" json:"subset_selectors,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                    `json:"-"`
	XXX_unrecognized     []byte                                      `json:"-"`
	XXX_sizecache        int32                                       `json:"-"`
}

func (m *LoadBalancerSubsetSetting) Reset()         { *m = LoadBalancerSubsetSetting{} }
func (m *LoadBalancerSubsetSetting) String() string { return proto.CompactTextString(m) }
func (*LoadBalancerSubsetSetting) ProtoMessage()    {}
func (*LoadBalancerSubsetSetting) Descriptor() ([]byte, []int) {
	return fileDescriptor_12899beb695152c8, []int{8}
}
func (m *LoadBalancerSubsetSetting) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LoadBalancerSubsetSetting) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LoadBalancerSubsetSetting.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LoadBalancerSubsetSetting) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LoadBalancerSubsetSetting.Merge(m, src)
}
func (m *LoadBalancerSubsetSetting) XXX_Size() int {
	return m.Size()
}
func (m *LoadBalancerSubsetSetting) XXX_DiscardUnknown() {
	xxx_messageInfo_LoadBalancerSubsetSetting.DiscardUnknown(m)
}

var xxx_messageInfo_LoadBalancerSubsetSetting proto.InternalMessageInfo

func (m *LoadBalancerSubsetSetting) GetFallbackPolicy() LoadBalancerSubsetSetting_LbSubsetFallbackPolicy {
	if m != nil {
		return m.FallbackPolicy
	}
	return LoadBalancerSubsetSetting_NO_FALLBACK
}

func (m *LoadBalancerSubsetSetting) GetMetadata() map[string]string {
	if m != nil {
		return m.Metadata
	}
	return nil
...
func (m *LoadBalancerSubsetSetting) GetSubsetSelectors() []*LoadBalancerSubsetSetting_SubsetSelector {
	if m != nil {
...
type LoadBalancerSubsetSetting_SubsetSelector struct {
	// List of keys to match with the weighted cluster metadata.
	Keys []string `protobuf:"bytes,1,rep,name=keys,proto3" json:"keys,omitempty"`
	// The behavior used when no endpoint subset matches the selected route's
	// metadata.
	FallbackPolicy       LoadBalancerSubsetSetting_SubsetSelector_SubsetSelectorFallbackPolicy `protobuf:"varint,2,opt,name=fallback_policy,json=fallbackPolicy,proto3,enum=istio.networking.v1alpha3.LoadBalancerSubsetSetting_SubsetSelector_SubsetSelectorFallbackPolicy" json:"fallback_policy,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                                              `json:"-"`
	XXX_unrecognized     []byte                                                                `json:"-"`
	XXX_sizecache        int32                                                                 `json:"-"`
}

func (m *LoadBalancerSubsetSetting_SubsetSelector) Reset() {
	*m = LoadBalancerSubsetSetting_SubsetSelector{}
}
func (m *LoadBalancerSubsetSetting_SubsetSelector) String() string { return proto.CompactTextString(m) }
func (*LoadBalancerSubsetSetting_SubsetSelector) ProtoMessage()    {}
func (*LoadBalancerSubsetSetting_SubsetSelector) Descriptor() ([]byte, []int) {
	return fileDescriptor_12899beb695152c8, []int{8, 1}
}
func (m *LoadBalancerSubsetSetting_SubsetSelector) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LoadBalancerSubsetSetting_SubsetSelector) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LoadBalancerSubsetSetting_SubsetSelector.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LoadBalancerSubsetSetting_SubsetSelector) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LoadBalancerSubsetSetting_SubsetSelector.Merge(m, src)
}
func (m *LoadBalancerSubsetSetting_SubsetSelector) XXX_Size() int {
	return m.Size()
}
func (m *LoadBalancerSubsetSetting_SubsetSelector) XXX_DiscardUnknown() {
	xxx_messageInfo_LoadBalancerSubsetSetting_SubsetSelector.DiscardUnknown(m)
}

var xxx_messageInfo_LoadBalancerSubsetSetting_SubsetSelector proto.InternalMessageInfo

func (m *LoadBalancerSubsetSetting_SubsetSelector) GetKeys() []string {
	if m != nil {
		return m.Keys
	}
	return nil
...
func (m *LoadBalancerSubsetSetting_SubsetSelector) GetFallbackPolicy() LoadBalancerSubsetSetting_SubsetSelector_SubsetSelectorFallbackPolicy {
	if m != nil {
		return m.FallbackPolicy
	}
	return LoadBalancerSubsetSetting_SubsetSelector_NOT_DEFINED
}
...
func init() {
	...
	proto.RegisterEnum("istio.networking.v1alpha3.LoadBalancerSubsetSetting_LbSubsetFallbackPolicy", LoadBalancerSubsetSetting_LbSubsetFallbackPolicy_name, LoadBalancerSubsetSetting_LbSubsetFallbackPolicy_value)
	proto.RegisterEnum("istio.networking.v1alpha3.LoadBalancerSubsetSetting_SubsetSelector_SubsetSelectorFallbackPolicy", LoadBalancerSubsetSetting_SubsetSelector_SubsetSelectorFallbackPolicy_name, LoadBalancerSubsetSetting_SubsetSelector_SubsetSelectorFallbackPolicy_value)
	...
	proto.RegisterType((*LoadBalancerSubsetSetting)(nil), "istio.networking.v1alpha3.LoadBalancerSubsetSetting")
	proto.RegisterMapType((map[string]string)(nil), "istio.networking.v1alpha3.LoadBalancerSubsetSetting.MetadataEntry")
	proto.RegisterType((*LoadBalancerSubsetSetting_SubsetSelector)(nil), "istio.networking.v1alpha3.LoadBalancerSubsetSetting.SubsetSelector")
}
...
var fileDescriptor_12899beb695152c8 = []byte{
	...
	,
}
...
func (m *LoadBalancerSettings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LbSubsetSetting != nil {
		{
			size, err := m.LbSubsetSetting.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *LoadBalancerSubsetSetting) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LoadBalancerSubsetSetting) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LoadBalancerSubsetSetting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.FallbackPolicy != 0 {
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.FallbackPolicy))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *LoadBalancerSubsetSetting_SubsetSelector) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LoadBalancerSubsetSetting_SubsetSelector) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LoadBalancerSubsetSetting_SubsetSelector) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Keys) > 0 {
		for iNdEx := len(m.Keys) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintDestinationRule(dAtA, i, uint64(len(m.Keys[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *LoadBalancerSubsetSetting) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.FallbackPolicy != 0 {
		n += 1 + sovDestinationRule(uint64(m.FallbackPolicy))
	}
	if len(m.Metadata) > 0 {
...
func (m *LoadBalancerSubsetSetting_SubsetSelector) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LoadBalancerSettings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LbSubsetSetting", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.LbSubsetSetting == nil {
				m.LbSubsetSetting = &LoadBalancerSubsetSetting{}
			}
			if err := m.LbSubsetSetting.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *LoadBalancerSubsetSetting) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LoadBalancerSubsetSetting: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LoadBalancerSubsetSetting: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FallbackPolicy |= LoadBalancerSubsetSetting_LbSubsetFallbackPolicy(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 3:
			...
			m.SubsetSelectors = append(m.SubsetSelectors, &LoadBalancerSubsetSetting_SubsetSelector{})
...
func (m *LoadBalancerSubsetSetting_SubsetSelector) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SubsetSelector: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SubsetSelector: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FallbackPolicy |= LoadBalancerSubsetSetting_SubsetSelector_SubsetSelectorFallbackPolicy(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
