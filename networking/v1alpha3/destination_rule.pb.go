...
const (
	...
	ROUND_ROBIN LoadBalancerSettings_SimpleLB = 0
	// The least request load balancer uses an O(1) algorithm which selects
	// two random healthy hosts and picks the host which has fewer active
	// requests.
	LEAST_CONN LoadBalancerSettings_SimpleLB = 1
	// The random load balancer selects a random healthy host. The random
	// load balancer generally performs better than round robin if no health
	// checking policy is configured.
	RANDOM LoadBalancerSettings_SimpleLB = 2
	// This option will forward the connection to the original IP address
	// requested by the caller without doing any form of load
	// balancing. This option must be used with care. It is meant for
	// advanced use cases. Refer to Original Destination load balancer in
	// Envoy for further details.
	PASSTHROUGH LoadBalancerSettings_SimpleLB = 3
)
...
type DestinationRule struct {
	...
	Subsets []Subset `protobuf:"bytes,3,rep,name=subsets" json:"subsets"`
}
...
type ConnectionPoolSettings_TCPSettings struct {
	...
	ConnectTimeout *time.Duration `protobuf:"bytes,2,opt,name=connect_timeout,json=connectTimeout,stdduration" json:"connect_timeout,omitempty"`
}
...
func (m *ConnectionPoolSettings_TCPSettings) GetConnectTimeout() *time.Duration {
	if m != nil {
...
func (m *ConnectionPoolSettings_TCPSettings) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ConnectTimeout != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(*m.ConnectTimeout)))
		n11, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.ConnectTimeout, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func encodeFixed64DestinationRule(dAtA []byte, offset int, v uint64) int {
	dAtA[offset] = uint8(v)
...
func encodeFixed32DestinationRule(dAtA []byte, offset int, v uint32) int {
	dAtA[offset] = uint8(v)
	dAtA[offset+1] = uint8(v >> 8)
	dAtA[offset+2] = uint8(v >> 16)
	dAtA[offset+3] = uint8(v >> 24)
...
var fileDescriptorDestinationRule = []byte{
	...
	,
}
