...
type TrafficPolicy struct {
	...
	// Protocol options for HTTP and HTTP2 envoy configuration in upstream
	// clusters.
...
//       initialConnectionWindowSize: 4096
//       allowConnect: true
// ```
type ProtocolOptions struct {
	...
	// HTTP2 options
	Http2                *ProtocolOptions_Http2Options `protobuf:"bytes,2,opt,name=http2,proto3" json:"http2,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_unrecognized     []byte                        `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}
...
type ProtocolOptions_Http2Options struct {
	...
	// the codec buffers.
	InitialStreamWindowSize uint32 `protobuf:"varint,3,opt,name=initial_stream_window_size,json=initialStreamWindowSize,proto3" json:"initial_stream_window_size,omitempty"`
	// Similar to initial_stream_window_size, but for connection-level
	// flow-control window.
	InitialConnectionWindowSize uint32 `protobuf:"varint,4,opt,name=initial_connection_window_size,json=initialConnectionWindowSize,proto3" json:"initial_connection_window_size,omitempty"`
...
func (m *ProtocolOptions_Http2Options) GetInitialStreamWindowSize() uint32 {
	if m != nil {
...
var fileDescriptor_12899beb695152c8 = []byte{
	...
	,
}
...
func (m *TrafficPolicy) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ProtocolOptions != nil {
		...
		n6, err6 := m.ProtocolOptions.MarshalTo(dAtA[i:])
		if err6 != nil {
			return 0, err6
		}
		i += n6
...
func (m *TrafficPolicy_PortTrafficPolicy) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Port != nil {
		...
		n7, err7 := m.Port.MarshalTo(dAtA[i:])
		if err7 != nil {
			return 0, err7
		}
		i += n7
	...
	if m.LoadBalancer != nil {
		...
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.LoadBalancer.Size()))
		n8, err8 := m.LoadBalancer.MarshalTo(dAtA[i:])
		if err8 != nil {
			return 0, err8
		}
		i += n8
	...
	if m.ConnectionPool != nil {
		...
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.ConnectionPool.Size()))
		n9, err9 := m.ConnectionPool.MarshalTo(dAtA[i:])
		if err9 != nil {
			return 0, err9
		}
		i += n9
	...
	if m.OutlierDetection != nil {
		...
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.OutlierDetection.Size()))
		n10, err10 := m.OutlierDetection.MarshalTo(dAtA[i:])
		if err10 != nil {
			return 0, err10
		}
		i += n10
	...
	if m.Tls != nil {
		...
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.Tls.Size()))
		n11, err11 := m.Tls.MarshalTo(dAtA[i:])
		if err11 != nil {
			return 0, err11
		}
		i += n11
...
func (m *Subset) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TrafficPolicy != nil {
		...
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.TrafficPolicy.Size()))
		n12, err12 := m.TrafficPolicy.MarshalTo(dAtA[i:])
		if err12 != nil {
			return 0, err12
		}
		i += n12
...
func (m *LoadBalancerSettings) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.LbPolicy != nil {
		nn13, err13 := m.LbPolicy.MarshalTo(dAtA[i:])
		if err13 != nil {
			return 0, err13
		}
		i += nn13
...
func (m *LoadBalancerSettings_ConsistentHash) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ConsistentHash != nil {
		...
		n14, err14 := m.ConsistentHash.MarshalTo(dAtA[i:])
		if err14 != nil {
			return 0, err14
		}
		i += n14
...
func (m *LoadBalancerSettings_ConsistentHashLB) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.HashKey != nil {
		nn15, err15 := m.HashKey.MarshalTo(dAtA[i:])
		if err15 != nil {
			return 0, err15
		}
		i += nn15
...
func (m *LoadBalancerSettings_ConsistentHashLB_HttpCookie) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.HttpCookie != nil {
		...
		n16, err16 := m.HttpCookie.MarshalTo(dAtA[i:])
		if err16 != nil {
			return 0, err16
		}
		i += n16
...
func (m *LoadBalancerSettings_ConsistentHashLB_HTTPCookie) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Ttl != nil {
		...
		n17, err17 := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.Ttl, dAtA[i:])
		if err17 != nil {
			return 0, err17
		}
		i += n17
...
func (m *ConnectionPoolSettings) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Tcp != nil {
		...
		n18, err18 := m.Tcp.MarshalTo(dAtA[i:])
		if err18 != nil {
			return 0, err18
		}
		i += n18
	...
	if m.Http != nil {
		...
		n19, err19 := m.Http.MarshalTo(dAtA[i:])
		if err19 != nil {
			return 0, err19
		}
		i += n19
...
func (m *ConnectionPoolSettings_TCPSettings) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ConnectTimeout != nil {
		...
		n20, err20 := m.ConnectTimeout.MarshalTo(dAtA[i:])
		if err20 != nil {
			return 0, err20
		}
		i += n20
	...
	if m.TcpKeepalive != nil {
		...
		n21, err21 := m.TcpKeepalive.MarshalTo(dAtA[i:])
		if err21 != nil {
			return 0, err21
		}
		i += n21
...
func (m *ConnectionPoolSettings_TCPSettings_TcpKeepalive) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Time != nil {
		...
		n22, err22 := m.Time.MarshalTo(dAtA[i:])
		if err22 != nil {
			return 0, err22
		}
		i += n22
	...
	if m.Interval != nil {
		...
		n23, err23 := m.Interval.MarshalTo(dAtA[i:])
		if err23 != nil {
			return 0, err23
		}
		i += n23
...
func (m *ConnectionPoolSettings_HTTPSettings) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IdleTimeout != nil {
		...
		n24, err24 := m.IdleTimeout.MarshalTo(dAtA[i:])
		if err24 != nil {
			return 0, err24
		}
		i += n24
...
func (m *OutlierDetection) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Interval != nil {
		...
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.Interval.Size()))
		n25, err25 := m.Interval.MarshalTo(dAtA[i:])
		if err25 != nil {
			return 0, err25
		}
		i += n25
	...
	if m.BaseEjectionTime != nil {
		...
		n26, err26 := m.BaseEjectionTime.MarshalTo(dAtA[i:])
		if err26 != nil {
			return 0, err26
		}
		i += n26
...
func (m *ProtocolOptions) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Http != nil {
		...
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.Http.Size()))
		n27, err27 := m.Http.MarshalTo(dAtA[i:])
		if err27 != nil {
			return 0, err27
		}
		i += n27
	...
	if m.Http2 != nil {
		...
		n28, err28 := m.Http2.MarshalTo(dAtA[i:])
		if err28 != nil {
			return 0, err28
		}
		i += n28
...
func (m *ProtocolOptions_HttpOptions) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IdleTimeout != nil {
		...
		n29, err29 := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.IdleTimeout, dAtA[i:])
		if err29 != nil {
			return 0, err29
		}
		i += n29
...
func (m *ProtocolOptions_Http2Options) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.InitialStreamWindowSize != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.InitialStreamWindowSize))
	}
...
func (m *ProtocolOptions_Http2Options) Size() (n int) {
	...
	if m.InitialStreamWindowSize != 0 {
		n += 1 + sovDestinationRule(uint64(m.InitialStreamWindowSize))
	}
	if m.InitialConnectionWindowSize != 0 {
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.InitialStreamWindowSize |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
