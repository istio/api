...
type OutlierDetection struct {
	// Number of gateway errors (502, 503 or 504) before a host is ejected
	// from the connection pool. When the upstream host is accessed over an
	// opaque TCP connection, connect timeouts and connection error/failure
	// events qualify as a gateway error. Defaults to 5.
	...
	// to HTTP 5xx codes and treated as such. Default is 0, which disables this
	// feature. consecutive_errors and consecutive_5xx_errors can be used
	// separately or together. The errors counted by consecutive_errors are also
	// included in consecutive_5xx_errors, so consecutive_errors should be less
	// than consecutive_5xx_errors when both are used.
	Consecutive_5XxErrors int32 `protobuf:"varint,6,opt,name=consecutive_5xx_errors,json=consecutive5xxErrors,proto3" json:"consecutive_5xx_errors,omitempty"`
...
func (m *OutlierDetection) GetConsecutive_5XxErrors() int32 {
	if m != nil {
...
var fileDescriptor_12899beb695152c8 = []byte{
	...
	,
}
...
func (m *OutlierDetection) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Consecutive_5XxErrors != 0 {
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.Consecutive_5XxErrors))
		i--
		dAtA[i] = 0x30
	}
...
func (m *OutlierDetection) Size() (n int) {
	...
	if m.Consecutive_5XxErrors != 0 {
		n += 1 + sovDestinationRule(uint64(m.Consecutive_5XxErrors))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Consecutive_5XxErrors |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
