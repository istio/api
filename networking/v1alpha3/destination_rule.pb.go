...
type TrafficPolicy struct {
	...
	// Settings controlling healthy check hosts from the load balancing pool
	HealthyCheck *HealthyCheck `protobuf:"bytes,4,opt,name=healthy_check,json=healthyCheck,proto3" json:"healthy_check,omitempty"`
	...
	PortLevelSettings    []*TrafficPolicy_PortTrafficPolicy `protobuf:"bytes,6,rep,name=port_level_settings,json=portLevelSettings,proto3" json:"port_level_settings,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                           `json:"-"`
	XXX_unrecognized     []byte                             `json:"-"`
	XXX_sizecache        int32                              `json:"-"`
}
...
func (m *TrafficPolicy) GetHealthyCheck() *HealthyCheck {
	if m != nil {
		return m.HealthyCheck
	}
	return nil
}
...
type TrafficPolicy_PortTrafficPolicy struct {
	...
	// Settings controlling healthy check hosts from the load balancing pool
	HealthyCheck *HealthyCheck `protobuf:"bytes,5,opt,name=healthy_check,json=healthyCheck,proto3" json:"healthy_check,omitempty"`
	// TLS related settings for connections to the upstream service.
	Tls                  *ClientTLSSettings `protobuf:"bytes,6,opt,name=tls,proto3" json:"tls,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (m *TrafficPolicy_PortTrafficPolicy) GetHealthyCheck() *HealthyCheck {
	if m != nil {
		return m.HealthyCheck
	}
	return nil
...
type HealthyCheck struct {
	...
	// Note that for http health checking if a host responds with a code not in expected_statuses or retriable_statuses,
	...
	// HTTP health check.
	HttpHealthyCheck     *HealthyCheckHttpHealthCheck `protobuf:"bytes,5,opt,name=HttpHealthyCheck,proto3" json:"HttpHealthyCheck,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_unrecognized     []byte                       `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}

func (m *HealthyCheck) Reset()         { *m = HealthyCheck{} }
func (m *HealthyCheck) String() string { return proto.CompactTextString(m) }
func (*HealthyCheck) ProtoMessage()    {}
func (*HealthyCheck) Descriptor() ([]byte, []int) {
	return fileDescriptor_12899beb695152c8, []int{6}
}
func (m *HealthyCheck) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HealthyCheck) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HealthyCheck.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HealthyCheck) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HealthyCheck.Merge(m, src)
}
func (m *HealthyCheck) XXX_Size() int {
	return m.Size()
}
func (m *HealthyCheck) XXX_DiscardUnknown() {
	xxx_messageInfo_HealthyCheck.DiscardUnknown(m)
}

var xxx_messageInfo_HealthyCheck proto.InternalMessageInfo

func (m *HealthyCheck) GetInterval() *types.Duration {
	if m != nil {
		return m.Interval
	}
	return nil
...
func (m *HealthyCheck) GetTimeout() *types.Duration {
	if m != nil {
		return m.Timeout
	}
	return nil
...
func (m *HealthyCheck) GetHealthyThreshold() int32 {
	if m != nil {
...
func (m *HealthyCheck) GetUnhealthyThreshold() int32 {
	if m != nil {
...
func (m *HealthyCheck) GetHttpHealthyCheck() *HealthyCheckHttpHealthCheck {
	if m != nil {
		return m.HttpHealthyCheck
	}
	return nil
}

type HealthyCheckHttpHealthCheck struct {
	// The value of the host header in the HTTP health check request. If left empty (default value),
	// the name of the cluster this health check is associated with will be used.
	// The host header can be customized for a specific endpoint by setting the hostname field.
	Host string `protobuf:"bytes,1,opt,name=host,proto3" json:"host,omitempty"`
...
func (m *HealthyCheckHttpHealthCheck) Reset()         { *m = HealthyCheckHttpHealthCheck{} }
func (m *HealthyCheckHttpHealthCheck) String() string { return proto.CompactTextString(m) }
func (*HealthyCheckHttpHealthCheck) ProtoMessage()    {}
func (*HealthyCheckHttpHealthCheck) Descriptor() ([]byte, []int) {
	return fileDescriptor_12899beb695152c8, []int{6, 0}
}
func (m *HealthyCheckHttpHealthCheck) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HealthyCheckHttpHealthCheck) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HealthyCheckHttpHealthCheck.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HealthyCheckHttpHealthCheck) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HealthyCheckHttpHealthCheck.Merge(m, src)
}
func (m *HealthyCheckHttpHealthCheck) XXX_Size() int {
	return m.Size()
}
func (m *HealthyCheckHttpHealthCheck) XXX_DiscardUnknown() {
	xxx_messageInfo_HealthyCheckHttpHealthCheck.DiscardUnknown(m)
}

var xxx_messageInfo_HealthyCheckHttpHealthCheck proto.InternalMessageInfo

func (m *HealthyCheckHttpHealthCheck) GetHost() string {
	if m != nil {
		return m.Host
	}
	return ""
...
func (m *HealthyCheckHttpHealthCheck) GetPath() string {
	if m != nil {
		return m.Path
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*HealthyCheck)(nil), "istio.networking.v1alpha3.HealthyCheck")
	proto.RegisterType((*HealthyCheckHttpHealthCheck)(nil), "istio.networking.v1alpha3.HealthyCheck.http_health_check")
...
var fileDescriptor_12899beb695152c8 = []byte{
	...
	,
}
...
func (m *TrafficPolicy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.HealthyCheck != nil {
		{
			size, err := m.HealthyCheck.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *HealthyCheck) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HealthyCheck) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HealthyCheck) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.HttpHealthyCheck != nil {
		{
			size, err := m.HttpHealthyCheck.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.UnhealthyThreshold != 0 {
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.UnhealthyThreshold))
		i--
		dAtA[i] = 0x20
	}
	if m.HealthyThreshold != 0 {
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.HealthyThreshold))
		i--
		dAtA[i] = 0x18
	}
	if m.Timeout != nil {
...
func (m *HealthyCheckHttpHealthCheck) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HealthyCheckHttpHealthCheck) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HealthyCheckHttpHealthCheck) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *HealthyCheck) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.HealthyThreshold != 0 {
		n += 1 + sovDestinationRule(uint64(m.HealthyThreshold))
	}
	if m.UnhealthyThreshold != 0 {
		n += 1 + sovDestinationRule(uint64(m.UnhealthyThreshold))
	}
	if m.HttpHealthyCheck != nil {
		l = m.HttpHealthyCheck.Size()
		n += 1 + l + sovDestinationRule(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *HealthyCheckHttpHealthCheck) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TrafficPolicy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HealthyCheck", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.HealthyCheck == nil {
				m.HealthyCheck = &HealthyCheck{}
			}
			if err := m.HealthyCheck.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
...
func (m *HealthyCheck) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HealthyCheck: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HealthyCheck: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HealthyThreshold |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.UnhealthyThreshold |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HttpHealthyCheck", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.HttpHealthyCheck == nil {
				m.HttpHealthyCheck = &HealthyCheckHttpHealthCheck{}
			}
			if err := m.HttpHealthyCheck.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *HealthyCheckHttpHealthCheck) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: http_health_check: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: http_health_check: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
