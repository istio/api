...
func (m *LoadBalancerSettings_ConsistentHashLB) GetSourceIp() bool {
...
func _LoadBalancerSettings_ConsistentHashLB_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 3: // hash_key.source_ip
		...
		x, err := b.DecodeVarint()
		m.HashKey = &LoadBalancerSettings_ConsistentHashLB_SourceIp{x != 0}
		return true, err
	default:
		return false, nil
	}
...
func (m *LoadBalancerSettings_ConsistentHashLB) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			b := bool(v != 0)
			m.HashKey = &LoadBalancerSettings_ConsistentHashLB_SourceIp{b}
		case 4:
			if wireType != 0 {
...
var fileDescriptorDestinationRule = []byte{
	...
	,
	...
	0xd9, 0x8d, 0xe2, 0xd6, 0xc7, 0x17, 0x30, 0x75, 0x8d, 0x27, 0x4e, 0x11, 0xd5, 0x3f, 0xf2, 0x70,
	...
	,
}
