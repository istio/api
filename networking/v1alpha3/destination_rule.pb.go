...
type ConnectionPoolSettings_TCPSettings struct {
	...
	// TCP keepalive.
	Keepalive *ConnectionPoolSettings_TCPSettings_TcpKeepalive `protobuf:"bytes,3,opt,name=keepalive" json:"keepalive,omitempty"`
}
...
func (m *ConnectionPoolSettings_TCPSettings) GetKeepalive() *ConnectionPoolSettings_TCPSettings_TcpKeepalive {
	if m != nil {
		return m.Keepalive
	}
	return nil
...
type ConnectionPoolSettings_TCPSettings_TcpKeepalive struct {
	// TCP keepalive time.
	Time *google_protobuf.Duration `protobuf:"bytes,1,opt,name=time" json:"time,omitempty"`
...
func (m *ConnectionPoolSettings_TCPSettings) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Keepalive != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.Keepalive.Size()))
		n20, err := m.Keepalive.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *ConnectionPoolSettings_TCPSettings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Keepalive == nil {
				m.Keepalive = &ConnectionPoolSettings_TCPSettings_TcpKeepalive{}
			}
...
var fileDescriptorDestinationRule = []byte{
	...
	,
}
