...
type LoadBalancerSettings struct {
	...
	// Network load balancer settings, this will override mesh wide settings in entirety, meaning no merging would be performed
	// between this object and the object one in MeshConfig
	NetworkLbSetting     *NetworkLoadBalancerSetting `protobuf:"bytes,4,opt,name=network_lb_setting,json=networkLbSetting,proto3" json:"network_lb_setting,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
func (m *LoadBalancerSettings) GetNetworkLbSetting() *NetworkLoadBalancerSetting {
	if m != nil {
...
type OutlierDetection struct {
	...
	// is set to true.
	ConsecutiveLocalOriginFailure *types.UInt32Value `protobuf:"bytes,9,opt,name=consecutive_local_origin_failure,json=consecutiveLocalOriginFailure,proto3" json:"consecutive_local_origin_failure,omitempty"`
...
// The following example sets up a network failover policy for regions.
// Assume a service resides in networks within network1, network2 & network3
// this example specifies that when endpoints within network1 become unhealthy
// traffic should failover to endpoints within network2
// and similarly network2 should failover to network1.
//
// ```yaml
//  failover:
//    - from: network1
...
// When it is specified simultaneously with locality load balancing, the priority order is network > locality.
// e.g. if both service A and B resides in two networks{`network1`, `network2`} and two az{`az-1`, `az-2`}
// for service A instance in `network1/us-east`, the expected endpoints priority will be:
// ```
//   `network1/az-1`: 0
//   `network1/az-2`: 1
//   `network2/az-1`: 2
//   `network2/az-2`: 3
// ```
type NetworkLoadBalancerSetting struct {
	// Explicitly specify the `network` traffic will land on when endpoints in local network becomes unhealthy.
	// Should be used together with OutlierDetection to detect unhealthy endpoints.
	// Note: if no OutlierDetection specified, this will not take effect.
	Failover []*NetworkLoadBalancerSetting_Failover `protobuf:"bytes,2,rep,name=failover,proto3" json:"failover,omitempty"`
	// enable network load balancing, this is DestinationRule-level and will override mesh wide settings in entirety.
	// e.g. true means that turn on network load balancing for this DestinationRule no matter what mesh wide settings is.
	Enabled              *types.BoolValue `protobuf:"bytes,3,opt,name=enabled,proto3" json:"enabled,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
...
func (m *NetworkLoadBalancerSetting) Reset()         { *m = NetworkLoadBalancerSetting{} }
func (m *NetworkLoadBalancerSetting) String() string { return proto.CompactTextString(m) }
func (*NetworkLoadBalancerSetting) ProtoMessage()    {}
func (*NetworkLoadBalancerSetting) Descriptor() ([]byte, []int) {
	return fileDescriptor_12899beb695152c8, []int{8}
}
func (m *NetworkLoadBalancerSetting) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *NetworkLoadBalancerSetting) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_NetworkLoadBalancerSetting.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *NetworkLoadBalancerSetting) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NetworkLoadBalancerSetting.Merge(m, src)
}
func (m *NetworkLoadBalancerSetting) XXX_Size() int {
	return m.Size()
}
func (m *NetworkLoadBalancerSetting) XXX_DiscardUnknown() {
	xxx_messageInfo_NetworkLoadBalancerSetting.DiscardUnknown(m)
}

var xxx_messageInfo_NetworkLoadBalancerSetting proto.InternalMessageInfo

func (m *NetworkLoadBalancerSetting) GetFailover() []*NetworkLoadBalancerSetting_Failover {
	if m != nil {
		return m.Failover
	}
	return nil
...
func (m *NetworkLoadBalancerSetting) GetEnabled() *types.BoolValue {
	if m != nil {
		return m.Enabled
	}
	return nil
...
// Specify the traffic failover policy across networks.
type NetworkLoadBalancerSetting_Failover struct {
	// Originating network.
	From string `protobuf:"bytes,1,opt,name=from,proto3" json:"from,omitempty"`
	// Destination network the traffic will fail over to when endpoints in
	// the 'from' network becomes unhealthy.
	To                   string   `protobuf:"bytes,2,opt,name=to,proto3" json:"to,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *NetworkLoadBalancerSetting_Failover) Reset()         { *m = NetworkLoadBalancerSetting_Failover{} }
func (m *NetworkLoadBalancerSetting_Failover) String() string { return proto.CompactTextString(m) }
func (*NetworkLoadBalancerSetting_Failover) ProtoMessage()    {}
func (*NetworkLoadBalancerSetting_Failover) Descriptor() ([]byte, []int) {
	return fileDescriptor_12899beb695152c8, []int{8, 0}
}
func (m *NetworkLoadBalancerSetting_Failover) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *NetworkLoadBalancerSetting_Failover) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_NetworkLoadBalancerSetting_Failover.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *NetworkLoadBalancerSetting_Failover) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NetworkLoadBalancerSetting_Failover.Merge(m, src)
}
func (m *NetworkLoadBalancerSetting_Failover) XXX_Size() int {
	return m.Size()
}
func (m *NetworkLoadBalancerSetting_Failover) XXX_DiscardUnknown() {
	xxx_messageInfo_NetworkLoadBalancerSetting_Failover.DiscardUnknown(m)
}

var xxx_messageInfo_NetworkLoadBalancerSetting_Failover proto.InternalMessageInfo

func (m *NetworkLoadBalancerSetting_Failover) GetFrom() string {
	if m != nil {
		return m.From
	}
	return ""
...
func (m *NetworkLoadBalancerSetting_Failover) GetTo() string {
	if m != nil {
		return m.To
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*NetworkLoadBalancerSetting)(nil), "istio.networking.v1alpha3.NetworkLoadBalancerSetting")
	proto.RegisterType((*NetworkLoadBalancerSetting_Failover)(nil), "istio.networking.v1alpha3.NetworkLoadBalancerSetting.Failover")
}
...
var fileDescriptor_12899beb695152c8 = []byte{
	...
	,
}
...
func (m *NetworkLoadBalancerSetting) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *NetworkLoadBalancerSetting) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *NetworkLoadBalancerSetting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *NetworkLoadBalancerSetting_Failover) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *NetworkLoadBalancerSetting_Failover) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *NetworkLoadBalancerSetting_Failover) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *NetworkLoadBalancerSetting) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *NetworkLoadBalancerSetting_Failover) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LoadBalancerSettings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.NetworkLbSetting == nil {
				m.NetworkLbSetting = &NetworkLoadBalancerSetting{}
			}
...
func (m *NetworkLoadBalancerSetting) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NetworkLoadBalancerSetting: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NetworkLoadBalancerSetting: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
			...
			m.Failover = append(m.Failover, &NetworkLoadBalancerSetting_Failover{})
			if err := m.Failover[len(m.Failover)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *NetworkLoadBalancerSetting_Failover) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
