...
type TrafficPolicy struct {
	...
	// Protocol options for HTTP, HTTP1 and HTTP2 envoy configuration in upstream
	// clusters.
	ProtocolOptions      *ProtocolOptions `protobuf:"bytes,6,opt,name=protocol_options,json=protocolOptions,proto3" json:"protocol_options,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *TrafficPolicy) GetProtocolOptions() *ProtocolOptions {
	if m != nil {
...
// Protocol settings for specific protocols for upstream connections. See
// Envoy's [Protocol
// options](https://www.envoyproxy.io/docs/envoy/latest/api-v2/api/v2/core/protocol.proto)
// for more details. These settings are common to all upstream hosts in a
// cluster.
//
// For example, the following rule configures a client to use specific HTTP
// and HTTP2 settings.
//
// ```yaml
// apiVersion: networking.istio.io/v1alpha3
// kind: DestinationRule
// metadata:
//   name: db-protocol-options-http2
// spec:
//   host: mydbserver.prod.svc.cluster.local
//   protocolOptions:
//     http:
...
// ```
//
// The following rule configures a client to use HTTP and  HTTP1 settings.
//
// ```yaml
// apiVersion: networking.istio.io/v1alpha3
// kind: DestinationRule
// metadata:
//   name: db-protocol-options-http1
// spec:
//   host: "*.foo.com"
//   protocolOptions:
//     http:
...
type ProtocolOptions struct {
	// Common HTTP options
	Http *ProtocolOptions_HttpOptions `protobuf:"bytes,1,opt,name=http,proto3" json:"http,omitempty"`
	// HTTP1 options
	Http1 *ProtocolOptions_Http1Options `protobuf:"bytes,2,opt,name=http1,proto3" json:"http1,omitempty"`
	// HTTP2 options
	Http2                *ProtocolOptions_Http2Options `protobuf:"bytes,3,opt,name=http2,proto3" json:"http2,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_unrecognized     []byte                        `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}

func (m *ProtocolOptions) Reset()         { *m = ProtocolOptions{} }
func (m *ProtocolOptions) String() string { return proto.CompactTextString(m) }
func (*ProtocolOptions) ProtoMessage()    {}
func (*ProtocolOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_12899beb695152c8, []int{7}
}
func (m *ProtocolOptions) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ProtocolOptions) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ProtocolOptions.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *ProtocolOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProtocolOptions.Merge(m, src)
}
func (m *ProtocolOptions) XXX_Size() int {
	return m.Size()
}
func (m *ProtocolOptions) XXX_DiscardUnknown() {
	xxx_messageInfo_ProtocolOptions.DiscardUnknown(m)
}

var xxx_messageInfo_ProtocolOptions proto.InternalMessageInfo

func (m *ProtocolOptions) GetHttp() *ProtocolOptions_HttpOptions {
	if m != nil {
		return m.Http
	}
	return nil
...
func (m *ProtocolOptions) GetHttp1() *ProtocolOptions_Http1Options {
	if m != nil {
		return m.Http1
	}
	return nil
...
func (m *ProtocolOptions) GetHttp2() *ProtocolOptions_Http2Options {
	if m != nil {
		return m.Http2
	}
	return nil
...
// Http general options
type ProtocolOptions_HttpOptions struct {
	...
	// If not set, there is no idle timeout. When the idle timeout is reached
	// the connection will be closed. Note that request based timeouts mean
	// that HTTP2 PINGs will not keep the connection alive.
...
func (m *ProtocolOptions_HttpOptions) Reset()         { *m = ProtocolOptions_HttpOptions{} }
func (m *ProtocolOptions_HttpOptions) String() string { return proto.CompactTextString(m) }
func (*ProtocolOptions_HttpOptions) ProtoMessage()    {}
func (*ProtocolOptions_HttpOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_12899beb695152c8, []int{7, 0}
}
func (m *ProtocolOptions_HttpOptions) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ProtocolOptions_HttpOptions) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ProtocolOptions_HttpOptions.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *ProtocolOptions_HttpOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProtocolOptions_HttpOptions.Merge(m, src)
}
func (m *ProtocolOptions_HttpOptions) XXX_Size() int {
	return m.Size()
}
func (m *ProtocolOptions_HttpOptions) XXX_DiscardUnknown() {
	xxx_messageInfo_ProtocolOptions_HttpOptions.DiscardUnknown(m)
}

var xxx_messageInfo_ProtocolOptions_HttpOptions proto.InternalMessageInfo

func (m *ProtocolOptions_HttpOptions) GetIdleTimeout() *time.Duration {
	if m != nil {
...
// HTTP1 options
type ProtocolOptions_Http1Options struct {
	// Handle HTTP requests with absolute URLs in the requests. These requests
	// are generally sent by clients to forward/explicit proxies. This allows
	// clients to configure envoy as their HTTP proxy. In Unix, for example,
	// this is typically done by setting the http_proxy environment variable.
	AllowAbsoluteUrl     bool     `protobuf:"varint,1,opt,name=allow_absolute_url,json=allowAbsoluteUrl,proto3" json:"allow_absolute_url,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ProtocolOptions_Http1Options) Reset()         { *m = ProtocolOptions_Http1Options{} }
func (m *ProtocolOptions_Http1Options) String() string { return proto.CompactTextString(m) }
func (*ProtocolOptions_Http1Options) ProtoMessage()    {}
func (*ProtocolOptions_Http1Options) Descriptor() ([]byte, []int) {
	return fileDescriptor_12899beb695152c8, []int{7, 1}
}
func (m *ProtocolOptions_Http1Options) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ProtocolOptions_Http1Options) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ProtocolOptions_Http1Options.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *ProtocolOptions_Http1Options) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProtocolOptions_Http1Options.Merge(m, src)
}
func (m *ProtocolOptions_Http1Options) XXX_Size() int {
	return m.Size()
}
func (m *ProtocolOptions_Http1Options) XXX_DiscardUnknown() {
	xxx_messageInfo_ProtocolOptions_Http1Options.DiscardUnknown(m)
}

var xxx_messageInfo_ProtocolOptions_Http1Options proto.InternalMessageInfo

func (m *ProtocolOptions_Http1Options) GetAllowAbsoluteUrl() bool {
	if m != nil {
...
// HTTP2 options
type ProtocolOptions_Http2Options struct {
	// Maximum table size (in octets) that the encoder is permitted to use for
	// the dynamic HPACK table. Valid values range from 0 to 2^32-1. 0
	// disables header compression.
	HpackTableSize uint32 `protobuf:"varint,1,opt,name=hpack_table_size,json=hpackTableSize,proto3" json:"hpack_table_size,omitempty"`
	// Maximum concurrent streams allowed for peer on one HTTP2 connection.
	// Valid values range from 1 to 2^31-1.
	MaxConcurrentStreams uint32 `protobuf:"varint,2,opt,name=max_concurrent_streams,json=maxConcurrentStreams,proto3" json:"max_concurrent_streams,omitempty"`
	// This field also acts as a soft limit on the number of bytes Envoy will
	// buffer per stream in the HTTP2 codec buffers. Once the buffer reaches
	// this pointer, watermark callbacks will fire to stop the flow of data to
	// the codec buffers.
	InitialConnectionWindowSize uint32 `protobuf:"varint,3,opt,name=initial_connection_window_size,json=initialConnectionWindowSize,proto3" json:"initial_connection_window_size,omitempty"`
	// Allow proxying websocket and other upgrades over H2 connect.
	AllowConnect         bool     `protobuf:"varint,4,opt,name=allow_connect,json=allowConnect,proto3" json:"allow_connect,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ProtocolOptions_Http2Options) Reset()         { *m = ProtocolOptions_Http2Options{} }
func (m *ProtocolOptions_Http2Options) String() string { return proto.CompactTextString(m) }
func (*ProtocolOptions_Http2Options) ProtoMessage()    {}
func (*ProtocolOptions_Http2Options) Descriptor() ([]byte, []int) {
	return fileDescriptor_12899beb695152c8, []int{7, 2}
}
func (m *ProtocolOptions_Http2Options) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ProtocolOptions_Http2Options) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ProtocolOptions_Http2Options.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *ProtocolOptions_Http2Options) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProtocolOptions_Http2Options.Merge(m, src)
}
func (m *ProtocolOptions_Http2Options) XXX_Size() int {
	return m.Size()
}
func (m *ProtocolOptions_Http2Options) XXX_DiscardUnknown() {
	xxx_messageInfo_ProtocolOptions_Http2Options.DiscardUnknown(m)
}

var xxx_messageInfo_ProtocolOptions_Http2Options proto.InternalMessageInfo

func (m *ProtocolOptions_Http2Options) GetHpackTableSize() uint32 {
	if m != nil {
...
func (m *ProtocolOptions_Http2Options) GetMaxConcurrentStreams() uint32 {
	if m != nil {
...
func (m *ProtocolOptions_Http2Options) GetInitialConnectionWindowSize() uint32 {
	if m != nil {
...
func (m *ProtocolOptions_Http2Options) GetAllowConnect() bool {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*ProtocolOptions)(nil), "istio.networking.v1alpha3.ProtocolOptions")
	proto.RegisterType((*ProtocolOptions_HttpOptions)(nil), "istio.networking.v1alpha3.ProtocolOptions.HttpOptions")
	proto.RegisterType((*ProtocolOptions_Http1Options)(nil), "istio.networking.v1alpha3.ProtocolOptions.Http1Options")
	proto.RegisterType((*ProtocolOptions_Http2Options)(nil), "istio.networking.v1alpha3.ProtocolOptions.Http2Options")
}
...
var fileDescriptor_12899beb695152c8 = []byte{
	...
	,
}
...
func (m *TrafficPolicy) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ProtocolOptions != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.ProtocolOptions.Size()))
		n6, err := m.ProtocolOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func (m *Subset) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TrafficPolicy != nil {
		...
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.TrafficPolicy.Size()))
		n12, err := m.TrafficPolicy.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
func (m *LoadBalancerSettings) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.LbPolicy != nil {
		nn13, err := m.LbPolicy.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn13
...
func (m *LoadBalancerSettings_ConsistentHash) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ConsistentHash != nil {
		...
		n14, err := m.ConsistentHash.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
...
func (m *LoadBalancerSettings_ConsistentHashLB) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.HashKey != nil {
		nn15, err := m.HashKey.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn15
...
func (m *LoadBalancerSettings_ConsistentHashLB_HttpCookie) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.HttpCookie != nil {
		...
		n16, err := m.HttpCookie.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *LoadBalancerSettings_ConsistentHashLB_HTTPCookie) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Ttl != nil {
		...
		n17, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.Ttl, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
...
func (m *ConnectionPoolSettings_TCPSettings) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ConnectTimeout != nil {
		...
		n20, err := m.ConnectTimeout.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
	...
	if m.TcpKeepalive != nil {
		...
		n21, err := m.TcpKeepalive.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
...
func (m *ProtocolOptions) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ProtocolOptions) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.Http1 != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.Http1.Size()))
		n27, err := m.Http1.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
	...
	if m.Http2 != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.Http2.Size()))
		n28, err := m.Http2.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
...
func (m *ProtocolOptions_HttpOptions) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ProtocolOptions_HttpOptions) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.IdleTimeout != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(*m.IdleTimeout)))
		n29, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.IdleTimeout, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n29
...
func (m *ProtocolOptions_Http1Options) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ProtocolOptions_Http1Options) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.AllowAbsoluteUrl {
		dAtA[i] = 0x8
		i++
		if m.AllowAbsoluteUrl {
			dAtA[i] = 1
...
func (m *ProtocolOptions_Http2Options) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ProtocolOptions_Http2Options) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.HpackTableSize != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.HpackTableSize))
	}
	if m.MaxConcurrentStreams != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.MaxConcurrentStreams))
	}
	if m.InitialConnectionWindowSize != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintDestinationRule(dAtA, i, uint64(m.InitialConnectionWindowSize))
	}
	if m.AllowConnect {
		dAtA[i] = 0x20
		i++
...
func (m *ProtocolOptions) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ProtocolOptions_HttpOptions) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ProtocolOptions_Http1Options) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ProtocolOptions_Http2Options) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.HpackTableSize != 0 {
		n += 1 + sovDestinationRule(uint64(m.HpackTableSize))
	}
	if m.MaxConcurrentStreams != 0 {
		n += 1 + sovDestinationRule(uint64(m.MaxConcurrentStreams))
	}
	if m.InitialConnectionWindowSize != 0 {
		n += 1 + sovDestinationRule(uint64(m.InitialConnectionWindowSize))
	}
	if m.AllowConnect {
		n += 2
	}
...
func (m *TrafficPolicy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProtocolOptions", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ProtocolOptions == nil {
				m.ProtocolOptions = &ProtocolOptions{}
			}
			if err := m.ProtocolOptions.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ProtocolOptions) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ProtocolOptions: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ProtocolOptions: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.Http == nil {
				m.Http = &ProtocolOptions_HttpOptions{}
			}
			if err := m.Http.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Http1", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.Http1 == nil {
				m.Http1 = &ProtocolOptions_Http1Options{}
			}
			if err := m.Http1.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Http2", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.Http2 == nil {
				m.Http2 = &ProtocolOptions_Http2Options{}
			}
			if err := m.Http2.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ProtocolOptions_HttpOptions) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *ProtocolOptions_Http1Options) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Http1Options: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Http1Options: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *ProtocolOptions_Http2Options) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Http2Options: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Http2Options: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HpackTableSize |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 3:
			...
			m.InitialConnectionWindowSize = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowDestinationRule
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.InitialConnectionWindowSize |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
