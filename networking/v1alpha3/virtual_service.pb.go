...
type VirtualService struct {
	...
	Http []HTTPRoute `protobuf:"bytes,3,rep,name=http" json:"http"`
	// An ordered list of route rules for TCP traffic.
	// The first rule matching an incoming request is used.
	Tcp []TCPRoute `protobuf:"bytes,4,rep,name=tcp" json:"tcp"`
}
...
type HTTPRoute struct {
	...
	Match []HTTPMatchRequest `protobuf:"bytes,1,rep,name=match" json:"match"`
	// A http rule can either redirect or forward (default) traffic. The
	// forwarding target can be one of several versions of a service (see
	// glossary in beginning of document). Weights associated with the
	// service version determine the proportion of traffic it receives.
	Route []DestinationWeight `protobuf:"bytes,2,rep,name=route" json:"route"`
	...
	Timeout *time.Duration `protobuf:"bytes,6,opt,name=timeout,stdduration" json:"timeout,omitempty"`
...
func (m *HTTPRoute) GetTimeout() *time.Duration {
	if m != nil {
		return m.Timeout
	}
	return nil
...
type TCPRoute struct {
	...
	// semantics, while the list of match blocks have OR semantics. The rule
	// is matched if any one of the match blocks succeed.
	Match []L4MatchAttributes `protobuf:"bytes,1,rep,name=match" json:"match"`
...
type DestinationWeight struct {
	...
	Destination Destination `protobuf:"bytes,1,opt,name=destination" json:"destination"`
...
type HTTPRetry struct {
	...
	PerTryTimeout *time.Duration `protobuf:"bytes,2,opt,name=per_try_timeout,json=perTryTimeout,stdduration" json:"per_try_timeout,omitempty"`
}
...
func (m *HTTPRetry) GetPerTryTimeout() *time.Duration {
	if m != nil {
...
func (m *HTTPRoute) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Timeout != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintVirtualService(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(*m.Timeout)))
...
func (m *HTTPRetry) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PerTryTimeout != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintVirtualService(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(*m.PerTryTimeout)))
		n18, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.PerTryTimeout, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
...
func (m *CorsPolicy) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MaxAge != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintVirtualService(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(*m.MaxAge)))
		n19, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.MaxAge, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
...
func encodeFixed64VirtualService(dAtA []byte, offset int, v uint64) int {
	dAtA[offset] = uint8(v)
...
func encodeFixed32VirtualService(dAtA []byte, offset int, v uint32) int {
	dAtA[offset] = uint8(v)
	dAtA[offset+1] = uint8(v >> 8)
	dAtA[offset+2] = uint8(v >> 16)
	dAtA[offset+3] = uint8(v >> 24)
...
var fileDescriptorVirtualService = []byte{
	...
	,
}
