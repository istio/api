...
type VirtualService struct {
	...
	// An ordered list of scripts associated with the VirtualService.
	Scripts []*Script `protobuf:"bytes,5,rep,name=scripts" json:"scripts,omitempty"`
}
...
func (m *VirtualService) GetScripts() []*Script {
	if m != nil {
		return m.Scripts
	}
	return nil
...
type HTTPRoute struct {
	...
	// An ordered list of scripts associated with the HTTPRoute.
	Scripts []*Script `protobuf:"bytes,12,rep,name=scripts" json:"scripts,omitempty"`
}
...
func (m *HTTPRoute) GetScripts() []*Script {
	if m != nil {
		return m.Scripts
	}
	return nil
...
type TCPRoute struct {
	...
	Route []*DestinationWeight `protobuf:"bytes,2,rep,name=route" json:"route,omitempty"`
	// An ordered list of scripts associated with the TCPRoute.
	Scripts []*Script `protobuf:"bytes,3,rep,name=scripts" json:"scripts,omitempty"`
}
...
func (m *TCPRoute) GetScripts() []*Script {
	if m != nil {
		return m.Scripts
	}
	return nil
...
// Script specifies a script to insert at the given context.
// The context can be VirtualService, HTTPRoute, or TCPRoute.
// The exact script API is proxy implementation dependant.
// For example:
// Envoy defines `envoy_on_request` and `envoy_on_response` functions.
// Nginx uses the `ngx` top level lua object. ex: ngx.socket.connect along with
// specific directives like `access_by_lua` and `body_filter_by_lua`
//
// Control plane ensures that the script is dispatched only in the context.
type Script struct {
	// type is the type of script
	// examples: lua, cel, ...
	// default: lua
	Type string `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"`
	// proxy is the type of proxy that can excute this script.
	// examples: envoy, nginx
	// default: envoy
	Proxy string `protobuf:"bytes,2,opt,name=proxy,proto3" json:"proxy,omitempty"`
	// phase is the phase of proxy processing.
	// This is proxy dependant. Envoy has a request and a response phase.
	// nginx has by_lua variations of `rewrite`, `access`, `header_filter` and other phases.
	Phase string `protobuf:"bytes,3,opt,name=phase,proto3" json:"phase,omitempty"`
	// contents of the script. Required.
...
func (*Script) Descriptor() ([]byte, []int) { return fileDescriptorVirtualService, []int{14} }
...
func init() {
	...
	proto.RegisterType((*Script)(nil), "istio.networking.v1alpha3.Script")
}
...
func (m *Script) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Type) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintVirtualService(dAtA, i, uint64(len(m.Type)))
		i += copy(dAtA[i:], m.Type)
	}
	if len(m.Proxy) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintVirtualService(dAtA, i, uint64(len(m.Proxy)))
		i += copy(dAtA[i:], m.Proxy)
	}
	if len(m.Phase) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintVirtualService(dAtA, i, uint64(len(m.Phase)))
		i += copy(dAtA[i:], m.Phase)
	}
	if len(m.Contents) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintVirtualService(dAtA, i, uint64(len(m.Contents)))
...
var fileDescriptorVirtualService = []byte{
	...
	,
}
