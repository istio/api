...
func (m *HTTPRoute) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Timeout != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintVirtualService(dAtA, i, uint64(types.SizeOfStdDuration(*m.Timeout)))
		n4, err := types.StdDurationMarshalTo(*m.Timeout, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
func (m *HTTPRetry) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PerTryTimeout != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintVirtualService(dAtA, i, uint64(types.SizeOfStdDuration(*m.PerTryTimeout)))
		n18, err := types.StdDurationMarshalTo(*m.PerTryTimeout, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
...
func (m *CorsPolicy) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MaxAge != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintVirtualService(dAtA, i, uint64(types.SizeOfStdDuration(*m.MaxAge)))
		n19, err := types.StdDurationMarshalTo(*m.MaxAge, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
...
func (m *CorsPolicy) Size() (n int) {
	...
	if m.MaxAge != nil {
		l = types.SizeOfStdDuration(*m.MaxAge)
		n += 1 + l + sovVirtualService(uint64(l))
	}
	if m.AllowCredentials != nil {
...
func (m *CorsPolicy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if err := types.StdDurationUnmarshal(m.MaxAge, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
