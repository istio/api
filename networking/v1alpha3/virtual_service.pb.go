...
func (m *HTTPRoute) GetRemoveHeaders() map[string]string {
	if m != nil {
		return m.RemoveHeaders
	}
	return nil
}
...
func (m *HTTPRoute) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RemoveHeaders", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RemoveHeaders == nil {
				m.RemoveHeaders = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.RemoveHeaders[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipVirtualService(dAtA[iNdEx:])
...
var fileDescriptorVirtualService = []byte{
	...
	,
}
