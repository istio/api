...
import fmt "fmt"
import math "math"
import istio_envoy_types "istio.io/api/envoy/types"
...
type HTTPFaultInjection_Delay struct {
	...
	Percentage *istio_envoy_types.Percent `protobuf:"bytes,5,opt,name=percentage" json:"percentage,omitempty"`
}
...
func (m *HTTPFaultInjection_Delay) GetPercentage() *istio_envoy_types.Percent {
	if m != nil {
		return m.Percentage
	}
	return nil
...
func (m *HTTPFaultInjection_Abort) GetPercentage() *istio_envoy_types.Percent {
	if m != nil {
		return m.Percentage
	}
	return nil
...
func (m *HTTPFaultInjection_Delay) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.Percentage == nil {
				m.Percentage = &istio_envoy_types.Percent{}
			}
...
var fileDescriptorVirtualService = []byte{
	...
	,
}
