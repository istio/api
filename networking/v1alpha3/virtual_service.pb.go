...
type VirtualService struct {
	...
	// using HTTP/HTTP2/GRPC protocols.  The first rule matching an incoming
	// request is used.
	...
	// ports named https-*, tcptls-*, gateway ports with HTTPS/TCP_TLS using
	// "passthrough" TLS mode, and service entry ports using HTTPS/TCP_TLS
	// protocols.  The first rule matching an incoming request is used.
	// NOTE: Traffic https-* or tcptls-* ports without associated virtual
	// service will be treated as opaque TCP traffic.
...
// Describes match conditions and actions for routing TCP+TLS or HTTPS traffic. The
// following routing rule forwards traffic arriving at port 443 for
// reviews.prod.svc.cluster.local service with SNI value bookinfo.com to
// monolith.prod.svc.cluster.local service, and traffic with SNI value "reviews" to
...
func (m *TLSMatchAttributes) GetSni() string {
	if m != nil {
		return m.Sni
	}
	return ""
...
func (m *TLSMatchAttributes) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Sni) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintVirtualService(dAtA, i, uint64(len(m.Sni)))
		i += copy(dAtA[i:], m.Sni)
	}
	if len(m.SourceLabels) > 0 {
		for k, _ := range m.SourceLabels {
...
var fileDescriptorVirtualService = []byte{
	...
	,
}
