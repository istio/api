...
// following routing rule forwards TLS traffic arriving at port 27017,
// with SNI equal mongo.prod.svc.cluster.local ,from 172.17.16.* subnet,
...
type TCPRoute struct {
	// Match the SNI of the TLS connection with the hosts value of the VirtualService.
	// The semantics of match_sni and match variable is AND.
	MatchSni bool `protobuf:"varint,1,opt,name=match_sni,json=matchSni,proto3" json:"match_sni,omitempty"`
	// Match conditions to be satisfied for the rule to be
	// activated. All conditions inside a single match block have AND
	// semantics, while the list of match blocks have OR semantics. The rule
	// is matched if any one of the match blocks succeed.
	Match []*L4MatchAttributes `protobuf:"bytes,2,rep,name=match" json:"match,omitempty"`
...
func (m *TCPRoute) GetMatchSni() bool {
	if m != nil {
		return m.MatchSni
	}
	return false
...
func (m *TCPRoute) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MatchSni", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorVirtualService = []byte{
	...
	,
}
