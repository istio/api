...
type HTTPMirrorPolicy struct {
	...
	// This is equivalent to setting Envoy's
	// `host_rewrite_literal <https://www.envoyproxy.io/docs/envoy/latest/api-v3/config/route/v3/route_components.proto#envoy-v3-api-field-config-route-v3-routeaction-requestmirrorpolicy-host-rewrite-literal>`_
	// on the mirror policy. When set, Envoy will not append the default
	// “-shadow“ suffix to the Host header.
	Authority string `protobuf:"bytes,3,opt,name=authority,proto3" json:"authority,omitempty"`
	// Header manipulation rules applied to the mirrored request. Only the
	// “request“ side is honored; “response“ mutations have no effect
	// since the mirrored response is discarded. This maps to Envoy's
	// `request_headers_mutations <https://www.envoyproxy.io/docs/envoy/latest/api-v3/config/route/v3/route_components.proto#envoy-v3-api-field-config-route-v3-routeaction-requestmirrorpolicy-request-headers-mutations>`_
...
func (x *HTTPMirrorPolicy) GetHeaders() *Headers {
	if x != nil {
		return x.Headers
	}
	return nil
...
var file_networking_v1alpha3_virtual_service_proto_rawDesc = []byte{
	...
	0x79, 0x70, 0x65, 0x22, 0xe9, 0x02, 0x0a, 0x09, 0x48, 0x54, 0x54, 0x50, 0x52, 0x65, 0x74, 0x72,
	...
	0x76, 0x69, 0x6f, 0x75, 0x73, 0x48, 0x6f, 0x73, 0x74, 0x73, 0x12, 0x33, 0x0a, 0x07, 0x62, 0x61,
	0x63, 0x6b, 0x6f, 0x66, 0x66, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x44, 0x75,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x07, 0x62, 0x61, 0x63, 0x6b, 0x6f, 0x66, 0x66, 0x22,
	...
	0x70, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x22, 0x82, 0x02, 0x0a, 0x10, 0x48, 0x54, 0x54, 0x50,
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x12, 0x3c,
	0x0a, 0x07, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x22, 0x2e, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x69,
	0x6e, 0x67, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x33, 0x2e, 0x48, 0x65, 0x61, 0x64,
	0x65, 0x72, 0x73, 0x52, 0x07, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x22, 0x32, 0x0a, 0x0c,
...
var file_networking_v1alpha3_virtual_service_proto_depIdxs = []int32{
	...
	6,  // 53: istio.networking.v1alpha3.HTTPMirrorPolicy.headers:type_name -> istio.networking.v1alpha3.Headers
