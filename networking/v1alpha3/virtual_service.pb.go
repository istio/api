...
type HTTPMatchRequest struct {
	...
	// Allows specifying a percentage of requests that will be matches by this route
	// in addition to other match conditions.
	// This can be used to route a percentage of traffic to a different service
	// or to apply different configurations (tieouts, retries) on a percentage
	// of requests.
	Percentage *Percent `protobuf:"bytes,15,opt,name=percentage,proto3" json:"percentage,omitempty"`
}
...
func (x *HTTPMatchRequest) GetPercentage() *Percent {
	if x != nil {
		return x.Percentage
	}
	return nil
...
var file_networking_v1alpha3_virtual_service_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x65, 0x22, 0x89, 0x0a, 0x0a, 0x10, 0x48, 0x54, 0x54, 0x50, 0x4d, 0x61, 0x74, 0x63,
	...
	0x66, 0x69, 0x78, 0x12, 0x42, 0x0a, 0x0a, 0x70, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x61, 0x67,
	0x65, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e,
	...
	0x63, 0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x1a, 0x62, 0x0a, 0x0c, 0x48, 0x65, 0x61, 0x64, 0x65,
	...
	0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b,
	0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x66, 0x0a, 0x10,
	...
	0x3a, 0x02, 0x38, 0x01, 0x1a, 0x69, 0x0a, 0x13, 0x57, 0x69, 0x74, 0x68, 0x6f, 0x75, 0x74, 0x48,
	...
	0xa4, 0x02, 0x0a, 0x14, 0x48, 0x54, 0x54, 0x50, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x44, 0x65, 0x73,
	0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x4e, 0x0a, 0x0b, 0x64, 0x65, 0x73, 0x74,
...
var file_networking_v1alpha3_virtual_service_proto_depIdxs = []int32{
	...
	25, // 33: istio.networking.v1alpha3.HTTPMatchRequest.percentage:type_name -> istio.networking.v1alpha3.Percent
