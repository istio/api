...
type Server struct {
	...
	// Configuration for custom extensions to the Istio Gateway. Custom
	// plugins can be compiled into Pilot to process the extension
	// configuration in the OnOutboundListener callback and generate
	// appropriate Envoy configuration in the listener or the HTTP
	// Connection manager. For example, an extension could configure the
	// Gateway with filters that perform custom JWT validation per
	// server.
	Extensions           *types.Any `protobuf:"bytes,6,opt,name=extensions,proto3" json:"extensions,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (m *Server) GetExtensions() *types.Any {
	if m != nil {
		return m.Extensions
	}
	return nil
...
var fileDescriptor_067d98d02f84cc0b = []byte{
	...
	,
}
