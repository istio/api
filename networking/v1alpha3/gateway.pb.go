...
type Server_TLSOptions struct {
	...
	// Optional: If specified, use these options for default tls
	// validation. Will be merged with the validation context from
	// SDS.
...
// Options for validatating a certificate
type Server_TLSOptions_CertificateValidationContext struct {
	...
	// server certificate for clusters or client certificate for listeners).
	// If not specified and a peer certificate is presented it will not be
	// verified. By default, a client certificate is optional, unless one of
	// the additional options (
	// :ref:`require_client_certificate`
	// :ref:`verify_certificate_spki`
	// is also specified.
	//
	// See :ref:`the TLS overview <arch_overview_ssl_enabling_verification>`
	...
	// An optional list of base64-encoded SHA-256 hashes. If specified, Envoy
	// will verify that the SHA-256 of the DER-encoded Subject Public Key
	// Information (SPKI) of the presented certificate matches one of the
	// specified values.
	//
	// A base64-encoded SHA-256 of the Subject Public Key Information (SPKI)
	// of the certificate can be generated with the following command:
	//
	// .. code-block:: bash
	//
	...
	// (in PEM format). If specified, Envoy will verify that the presented
	// peer certificate has not been revoked by this CRL. If this DataSource
	// contains multiple CRLs, all of them will be used.
	Crl []string `protobuf:"bytes,3,rep,name=crl,proto3" json:"crl,omitempty"`
...
func (m *Server_TLSOptions_CertificateValidationContext) GetCrl() []string {
	if m != nil {
		return m.Crl
	}
	return nil
...
func (m *Server_TLSOptions_CertificateValidationContext) GetAllowExpiredCertificate() bool {
	if m != nil {
...
var fileDescriptor_067d98d02f84cc0b = []byte{
	...
	,
}
...
func (m *Server_TLSOptions_CertificateValidationContext) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Crl = append(m.Crl, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 4:
			if wireType != 0 {
