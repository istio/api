...
type Server_TLSOptions struct {
	...
	// Optional: Indicates whether the source of TLS key and certificate is from
	// K8s secret.
	Source string `protobuf:"bytes,10,opt,name=source,proto3" json:"source,omitempty"`
	// REQUIRED if source is `KUBE_SECRET`. Specifies the secret name that stores
	// the key and cert, in the same namespace the ingress gateway runs.
...
func (m *Server_TLSOptions) GetSource() string {
	if m != nil {
		return m.Source
	}
	return ""
...
func (m *Server_TLSOptions) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
var fileDescriptorGateway = []byte{
	...
	,
}
