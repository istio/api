...
// The type of the server. Currently, ingress or egress.
type Server_ServerType int32

const (
	// The server is a front-end proxy for the mesh
	Server_INGRESS Server_ServerType = 0
	// The server is a back-end proxy for the mesh
	Server_EGRESS Server_ServerType = 1
)

var Server_ServerType_name = map[int32]string{
	0: "INGRESS",
	1: "EGRESS",
}
var Server_ServerType_value = map[string]int32{
	"INGRESS": 0,
	"EGRESS":  1,
}

func (x Server_ServerType) String() string {
	return proto.EnumName(Server_ServerType_name, int32(x))
}
func (Server_ServerType) EnumDescriptor() ([]byte, []int) { return fileDescriptorGateway, []int{1, 0} }
...
type Server struct {
	...
	Type Server_ServerType  `protobuf:"varint,4,opt,name=type,proto3,enum=istio.networking.v1alpha3.Server_ServerType" json:"type,omitempty"`
}
...
func (m *Server) GetType() Server_ServerType {
	if m != nil {
		return m.Type
	}
...
func init() {
	...
	proto.RegisterEnum("istio.networking.v1alpha3.Server_ServerType", Server_ServerType_name, Server_ServerType_value)
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= (Server_ServerType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorGateway = []byte{
	...
	,
}
