...
const (
	...
	// applicable in Sidecar's inbound traffic policy.
	...
	// fields in `TLSOptions` should be empty. Not applicable in a
	// sidecar's inbound traffic policy.
...
type Server_TLSOptions struct {
	...
	// applicable in Sidecar inbound traffic policy context.
