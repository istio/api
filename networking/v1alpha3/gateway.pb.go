...
const (
	...
	//
	// NOTE: A gateway workload with a server using this TLS mode cannot
	// have any other server applied to it. Use of this mode assumes that
	// both the source and the destination are using Istio mTLS to secure
	// traffic.
	Server_TLSOptions_ISTIO_REGISTRY_PASSTHROUGH Server_TLSOptions_TLSmode = 3
)
...
var Server_TLSOptions_TLSmode_name = map[int32]string{
	...
	1: "SIMPLE",
	2: "MUTUAL",
	3: "ISTIO_REGISTRY_PASSTHROUGH",
}
var Server_TLSOptions_TLSmode_value = map[string]int32{
	"PASSTHROUGH":                0,
	"SIMPLE":                     1,
	"MUTUAL":                     2,
	"ISTIO_REGISTRY_PASSTHROUGH": 3,
}
...
var fileDescriptorGateway = []byte{
	...
	,
}
