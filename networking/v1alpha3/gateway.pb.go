...
type Server_TLSOptions struct {
	...
	// If credential_store is specified, server_certificate, private_key and
	// ca_certificates will be obtained via an API call to the credential store.
	CredentialStore *Server_TLSOptions_TLSCredStore `protobuf:"bytes,10,opt,name=credential_store,json=credentialStore" json:"credential_store,omitempty"`
}
...
func (m *Server_TLSOptions) GetCredentialStore() *Server_TLSOptions_TLSCredStore {
	if m != nil {
...
type Server_TLSOptions_TLSCredStore struct {
	// Optional: Specifies address of the credentialStore which provisions credentials.
	// Default value is "/var/run/sds/gateway_uds_path".
	Address string `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
	// REQUIRED name of credential to be queried by gateway.
...
func (m *Server_TLSOptions_TLSCredStore) Reset()         { *m = Server_TLSOptions_TLSCredStore{} }
func (m *Server_TLSOptions_TLSCredStore) String() string { return proto.CompactTextString(m) }
func (*Server_TLSOptions_TLSCredStore) ProtoMessage()    {}
func (*Server_TLSOptions_TLSCredStore) Descriptor() ([]byte, []int) {
	return fileDescriptorGateway, []int{1, 0, 0}
}

func (m *Server_TLSOptions_TLSCredStore) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *Server_TLSOptions_TLSCredStore) GetCredentialName() string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*Server_TLSOptions_TLSCredStore)(nil), "istio.networking.v1alpha3.Server.TLSOptions.TLSCredStore")
...
func (m *Server_TLSOptions_TLSCredStore) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *Server_TLSOptions_TLSCredStore) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *Server_TLSOptions_TLSCredStore) Size() (n int) {
	var l int
	_ = l
	l = len(m.Address)
	if l > 0 {
...
func (m *Server_TLSOptions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			if m.CredentialStore == nil {
				m.CredentialStore = &Server_TLSOptions_TLSCredStore{}
			}
...
func (m *Server_TLSOptions_TLSCredStore) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TLSCredStore: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TLSCredStore: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorGateway = []byte{
	...
	,
}
