...
// DeepCopyInto supports using RegexMatch within kubernetes types, where deepcopy-gen is used.
func (in *RegexMatch) DeepCopyInto(out *RegexMatch) {
	p := proto.Clone(in).(*RegexMatch)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RegexMatch. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new RegexMatch. Required by controller-gen.
func (in *RegexMatch) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
