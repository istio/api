...
// DeepCopyInto supports using SessionPersistence within kubernetes types, where deepcopy-gen is used.
func (in *SessionPersistence) DeepCopyInto(out *SessionPersistence) {
	p := proto.Clone(in).(*SessionPersistence)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SessionPersistence. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new SessionPersistence. Required by controller-gen.
func (in *SessionPersistence) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using SessionPersistence_Cookie within kubernetes types, where deepcopy-gen is used.
func (in *SessionPersistence_Cookie) DeepCopyInto(out *SessionPersistence_Cookie) {
	p := proto.Clone(in).(*SessionPersistence_Cookie)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SessionPersistence_Cookie. Required by controller-gen.
func (in *SessionPersistence_Cookie) DeepCopy() *SessionPersistence_Cookie {
	if in == nil {
		return nil
	}
	out := new(SessionPersistence_Cookie)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new SessionPersistence_Cookie. Required by controller-gen.
func (in *SessionPersistence_Cookie) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using SessionPersistence_Header within kubernetes types, where deepcopy-gen is used.
func (in *SessionPersistence_Header) DeepCopyInto(out *SessionPersistence_Header) {
	p := proto.Clone(in).(*SessionPersistence_Header)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SessionPersistence_Header. Required by controller-gen.
func (in *SessionPersistence_Header) DeepCopy() *SessionPersistence_Header {
	if in == nil {
		return nil
	}
	out := new(SessionPersistence_Header)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new SessionPersistence_Header. Required by controller-gen.
func (in *SessionPersistence_Header) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
