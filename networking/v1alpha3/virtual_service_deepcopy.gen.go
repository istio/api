...
// DeepCopyInto supports using GatewayReference within kubernetes types, where deepcopy-gen is used.
func (in *GatewayReference) DeepCopyInto(out *GatewayReference) {
	p := proto.Clone(in).(*GatewayReference)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GatewayReference. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new GatewayReference. Required by controller-gen.
func (in *GatewayReference) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
