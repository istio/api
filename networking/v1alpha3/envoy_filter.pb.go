...
// FILTER_CLASS determines the filter insertion point in the filter chain
...
const (
	// For backwards compatiblity, control plane decides where to insert.
	EnvoyFilter_Patch_UNSPECIFIED EnvoyFilter_Patch_FilterClass = 0
	// Insert filter before authentication filters inserted by the controlplane.
	EnvoyFilter_Patch_PRE_AUTHN EnvoyFilter_Patch_FilterClass = 1
	// Insert filter after authentication filters inserted by the controlplane.
	EnvoyFilter_Patch_POST_AUTHN EnvoyFilter_Patch_FilterClass = 2
	// Insert filter before authorization filters inserted by the controlplane.
	EnvoyFilter_Patch_PRE_AUTHZ EnvoyFilter_Patch_FilterClass = 3
	// Insert filter after authorization filters inserted by the controlplane.
	EnvoyFilter_Patch_POST_AUTHZ EnvoyFilter_Patch_FilterClass = 4
	// Insert filter before stats filters inserted by the controlplane.
	EnvoyFilter_Patch_PRE_STATS EnvoyFilter_Patch_FilterClass = 5
	// Insert filter after stats filters inserted by the controlplane.
	EnvoyFilter_Patch_POST_STATS EnvoyFilter_Patch_FilterClass = 6
)
...
var fileDescriptor_16d9b2922bd3e4a9 = []byte{
	...
	,
}
