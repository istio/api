...
type EnvoyFilter struct {
	...
	// The order in which patch sets are applied within a context.
	...
	//
	// The default value for order is 0 and the range is [ min-int32, max-int32 ].
	// A patch set with a negative order is processed before the default. A patch
	// set with a positive order is processed after the default.
	//
	// It is recommended to start with order values that are multiples of 10
	// to leave room for further insertion.
	//
	// Patch sets are sorted in the following key order:
	// order, creation time, fully qualified resource name.
...
func (m *EnvoyFilter) GetOrder() int32 {
	if m != nil {
		return m.Order
	}
	return 0
...
var fileDescriptor_16d9b2922bd3e4a9 = []byte{
	...
	,
}
...
func (m *EnvoyFilter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Order != 0 {
		i = encodeVarintEnvoyFilter(dAtA, i, uint64(m.Order))
		i--
		dAtA[i] = 0x28
	}
...
func (m *EnvoyFilter) Size() (n int) {
	...
	if m.Order != 0 {
		n += 1 + sovEnvoyFilter(uint64(m.Order))
	}
	if m.XXX_unrecognized != nil {
