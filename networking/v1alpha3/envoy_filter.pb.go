...
// and X-Forward-For trusted hops) in the HTTP connection manager on
// the ingress gateway while leaving the rest as is, using filter
// merge.
//
// ```yaml
// apiVersion: networking.istio.io/v1alpha3
...
//     merge: true # merges the provided config with the one generated by Pilot
...
var fileDescriptor_16d9b2922bd3e4a9 = []byte{
	...
	,
}
