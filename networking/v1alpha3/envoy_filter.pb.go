...
type EnvoyFilter_RouteConfigurationMatch_RouteMatch struct {
	// The Route objects generated by Istio are named as "default"
	// for the default route, or name-number.namespace, where name
	// and namespace correspond to the Istio virtual service used to
	// generate that route, and the number assigned to that route in
	// the list of routes for a virtual host. If omitted, the patch
	// will be applied to all routes in a virtual host, including
	// redirect routes and direct response routes.
