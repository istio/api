...
type EnvoyFilter_Patch struct {
	...
	// A `should_override` patch is used to provide filter ordering with
	// optional default values. A later MERGE or REPLACE operation
	// should override the contents of the configuration or the
	// operation is a NOOP. This allows for an empty or a partial
	// configuration to be specified in the config root namespace which
	// is elided from the final output unless overridden by a
	// subsequent operation.
	ShouldOverride       bool     `protobuf:"varint,3,opt,name=should_override,json=shouldOverride,proto3" json:"should_override,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *EnvoyFilter_Patch) GetShouldOverride() bool {
	if m != nil {
		return m.ShouldOverride
	}
	return false
}
...
var fileDescriptor_16d9b2922bd3e4a9 = []byte{
	...
	,
}
...
func (m *EnvoyFilter_Patch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ShouldOverride", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
