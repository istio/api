...
const (
	...
	// Replace contents of a named filter object with new contents.
	// Replace should be used when you do not need to or cannot use
	// json merge semantics.
	// A typical use case for REPLACE is when an EnvoyFilter in the
	// config root namespace specifies the order of filters but you want
	// a completely different configuration for a specific filter.
	// Since JSON merge cannot remove elements, REPLACE operation should
	// be used. REPLACE operation is only valid for HTTP_FILTER and
...
type EnvoyFilter_Patch struct {
	...
	// A `use_if_overridden` patch can partially specify a named filter
	// configuration. The patch value may be empty apart from the filter name.
	// The patch only has effect if a subsequent MERGE or REPLACE patch
	// operates on the same named filter.
	// A `use_if_overridden` patch in the config root namespace can be used
	// to specify filter order without specifying full configuration.
	// An example is an optional OpenApiSpec filter that populates request
	// operations. An EnvoyFilter in the config root namespace can insert
	// the OpenApiSpec filter in the correct spot before the stats filter.
	// Since every service may not have an OpenApiSpec, a workload specific
	// EnvoyFilter will provide configuration for the filter using a REPLACE
	// patch, without specifying an order.
	UseIfOverridden      bool     `protobuf:"varint,3,opt,name=use_if_overridden,json=useIfOverridden,proto3" json:"use_if_overridden,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *EnvoyFilter_Patch) GetUseIfOverridden() bool {
	if m != nil {
		return m.UseIfOverridden
	}
	return false
}
...
var fileDescriptor_16d9b2922bd3e4a9 = []byte{
	...
	,
}
...
func (m *EnvoyFilter_Patch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseIfOverridden", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
