...
type EnvoyFilter_ProxyVersion struct {
	...
	//	*EnvoyFilter_ProxyVersion_Eq
	VersionMatch         isEnvoyFilter_ProxyVersion_VersionMatch `protobuf_oneof:"version_match"`
	XXX_NoUnkeyedLiteral struct{}                                `json:"-"`
	XXX_unrecognized     []byte                                  `json:"-"`
	XXX_sizecache        int32                                   `json:"-"`
}

func (m *EnvoyFilter_ProxyVersion) Reset()         { *m = EnvoyFilter_ProxyVersion{} }
func (m *EnvoyFilter_ProxyVersion) String() string { return proto.CompactTextString(m) }
func (*EnvoyFilter_ProxyVersion) ProtoMessage()    {}
func (*EnvoyFilter_ProxyVersion) Descriptor() ([]byte, []int) {
	return fileDescriptor_16d9b2922bd3e4a9, []int{0, 3}
}
func (m *EnvoyFilter_ProxyVersion) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EnvoyFilter_ProxyVersion) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EnvoyFilter_ProxyVersion.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EnvoyFilter_ProxyVersion) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EnvoyFilter_ProxyVersion.Merge(m, src)
}
func (m *EnvoyFilter_ProxyVersion) XXX_Size() int {
	return m.Size()
}
func (m *EnvoyFilter_ProxyVersion) XXX_DiscardUnknown() {
	xxx_messageInfo_EnvoyFilter_ProxyVersion.DiscardUnknown(m)
}

var xxx_messageInfo_EnvoyFilter_ProxyVersion proto.InternalMessageInfo

type isEnvoyFilter_ProxyVersion_VersionMatch interface {
	isEnvoyFilter_ProxyVersion_VersionMatch()
	MarshalTo([]byte) (int, error)
	Size() int
}

type EnvoyFilter_ProxyVersion_Ge struct {
	Ge string `protobuf:"bytes,1,opt,name=ge,proto3,oneof"`
}
type EnvoyFilter_ProxyVersion_Eq struct {
	Eq string `protobuf:"bytes,2,opt,name=eq,proto3,oneof"`
}

func (*EnvoyFilter_ProxyVersion_Ge) isEnvoyFilter_ProxyVersion_VersionMatch() {}
func (*EnvoyFilter_ProxyVersion_Eq) isEnvoyFilter_ProxyVersion_VersionMatch() {}

func (m *EnvoyFilter_ProxyVersion) GetVersionMatch() isEnvoyFilter_ProxyVersion_VersionMatch {
	if m != nil {
...
func (m *EnvoyFilter_ProxyVersion) GetGe() string {
	if x, ok := m.GetVersionMatch().(*EnvoyFilter_ProxyVersion_Ge); ok {
		return x.Ge
	}
	return ""
}

func (m *EnvoyFilter_ProxyVersion) GetEq() string {
	if x, ok := m.GetVersionMatch().(*EnvoyFilter_ProxyVersion_Eq); ok {
		return x.Eq
	}
	return ""
}
...
func (*EnvoyFilter_ProxyVersion) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _EnvoyFilter_ProxyVersion_OneofMarshaler, _EnvoyFilter_ProxyVersion_OneofUnmarshaler, _EnvoyFilter_ProxyVersion_OneofSizer, []interface{}{
		(*EnvoyFilter_ProxyVersion_Ge)(nil),
		(*EnvoyFilter_ProxyVersion_Eq)(nil),
	}
}

func _EnvoyFilter_ProxyVersion_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*EnvoyFilter_ProxyVersion)
	// version_match
	switch x := m.VersionMatch.(type) {
	case *EnvoyFilter_ProxyVersion_Ge:
		_ = b.EncodeVarint(1<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.Ge)
	case *EnvoyFilter_ProxyVersion_Eq:
		_ = b.EncodeVarint(2<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.Eq)
	case nil:
	default:
		return fmt.Errorf("EnvoyFilter_ProxyVersion.VersionMatch has unexpected type %T", x)
	}
	return nil
}

func _EnvoyFilter_ProxyVersion_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*EnvoyFilter_ProxyVersion)
	switch tag {
	case 1: // version_match.ge
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.VersionMatch = &EnvoyFilter_ProxyVersion_Ge{x}
		return true, err
	case 2: // version_match.eq
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.VersionMatch = &EnvoyFilter_ProxyVersion_Eq{x}
		return true, err
	default:
		return false, nil
	}
...
func _EnvoyFilter_ProxyVersion_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*EnvoyFilter_ProxyVersion)
	// version_match
	switch x := m.VersionMatch.(type) {
	case *EnvoyFilter_ProxyVersion_Ge:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(len(x.Ge)))
		n += len(x.Ge)
	case *EnvoyFilter_ProxyVersion_Eq:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(len(x.Eq)))
		n += len(x.Eq)
	case nil:
	default:
...
type EnvoyFilter_EnvoyConfigObjectMatch struct {
	...
	ProxyVersion *EnvoyFilter_ProxyVersion `protobuf:"bytes,2,opt,name=proxy_version,json=proxyVersion,proto3" json:"proxy_version,omitempty"`
...
func (m *EnvoyFilter_EnvoyConfigObjectMatch) GetProxyVersion() *EnvoyFilter_ProxyVersion {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*EnvoyFilter_ProxyVersion)(nil), "istio.networking.v1alpha3.EnvoyFilter.ProxyVersion")
...
var fileDescriptor_16d9b2922bd3e4a9 = []byte{
	...
	,
}
...
func (m *EnvoyFilter_ProxyVersion) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EnvoyFilter_ProxyVersion) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EnvoyFilter_ProxyVersion) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EnvoyFilter_ProxyVersion_Ge) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *EnvoyFilter_ProxyVersion_Ge) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Ge)
	copy(dAtA[i:], m.Ge)
	i = encodeVarintEnvoyFilter(dAtA, i, uint64(len(m.Ge)))
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}
func (m *EnvoyFilter_ProxyVersion_Eq) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *EnvoyFilter_ProxyVersion_Eq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Eq)
	copy(dAtA[i:], m.Eq)
	i = encodeVarintEnvoyFilter(dAtA, i, uint64(len(m.Eq)))
	i--
	dAtA[i] = 0x12
	return len(dAtA) - i, nil
}
...
func (m *EnvoyFilter_EnvoyConfigObjectMatch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ProxyVersion != nil {
		{
			size, err := m.ProxyVersion.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *EnvoyFilter_ProxyVersion) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EnvoyFilter_ProxyVersion_Ge) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EnvoyFilter_ProxyVersion_Eq) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EnvoyFilter_ProxyVersion) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ProxyVersion: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ProxyVersion: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Ge", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.VersionMatch = &EnvoyFilter_ProxyVersion_Ge{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.VersionMatch = &EnvoyFilter_ProxyVersion_Eq{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEnvoyFilter(dAtA[iNdEx:])
...
func (m *EnvoyFilter_EnvoyConfigObjectMatch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.ProxyVersion == nil {
				m.ProxyVersion = &EnvoyFilter_ProxyVersion{}
			}
			if err := m.ProxyVersion.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
