...
type ServiceEntry struct {
	...
	// One or more spiffe IDs associated with the endpoints of this
	// service. The spiffee IDs will be used to verify the identity of the
	// endpoints when the destination rule for the service uses ISTIO_MUTUAL
	// as the TLS mode.
	SpiffeeIdentities []string `protobuf:"bytes,7,rep,name=spiffee_identities,json=spiffeeIdentities" json:"spiffee_identities,omitempty"`
}
...
func (m *ServiceEntry) GetSpiffeeIdentities() []string {
	if m != nil {
		return m.SpiffeeIdentities
	}
	return nil
}
...
type ServiceEntry_Endpoint struct {
	...
	// Network names allow to group endpoints resident in the same
	// failure domain/administrative boundry/rfc1918 network (e.g., a
	// kubernetes cluster, availability zone, etc.). The network name
	// can be used for a variety of purposes, one of which is zone-aware
	// routing.
...
func (m *ServiceEntry) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.SpiffeeIdentities) > 0 {
		for _, s := range m.SpiffeeIdentities {
			dAtA[i] = 0x3a
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *ServiceEntry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SpiffeeIdentities", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SpiffeeIdentities = append(m.SpiffeeIdentities, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
var fileDescriptorServiceEntry = []byte{
	...
	,
}
