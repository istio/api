...
type ServiceEntry struct {
	...
	// ISTIO_MUTUAL.
	SubjectAlternateNames []string `protobuf:"bytes,7,rep,name=subject_alternate_names,json=subjectAlternateNames" json:"subject_alternate_names,omitempty"`
}
...
func (m *ServiceEntry) GetSubjectAlternateNames() []string {
	if m != nil {
		return m.SubjectAlternateNames
	}
	return nil
}

// FailureDomain describes the location of the endpoint in a
// hierarchy of failure domains (country > region > zone).
type ServiceEntry_FailureDomain struct {
	// The country where the endpoint is present.
	Country string `protobuf:"bytes,1,opt,name=country,proto3" json:"country,omitempty"`
	// The region in the country (or the data center).
	Region string `protobuf:"bytes,2,opt,name=region,proto3" json:"region,omitempty"`
	// The availability zone within the region.
	Zone string `protobuf:"bytes,3,opt,name=zone,proto3" json:"zone,omitempty"`
}

func (m *ServiceEntry_FailureDomain) Reset()         { *m = ServiceEntry_FailureDomain{} }
func (m *ServiceEntry_FailureDomain) String() string { return proto.CompactTextString(m) }
func (*ServiceEntry_FailureDomain) ProtoMessage()    {}
func (*ServiceEntry_FailureDomain) Descriptor() ([]byte, []int) {
	return fileDescriptorServiceEntry, []int{0, 0}
}

func (m *ServiceEntry_FailureDomain) GetCountry() string {
	if m != nil {
		return m.Country
	}
	return ""
...
func (m *ServiceEntry_FailureDomain) GetRegion() string {
	if m != nil {
		return m.Region
	}
	return ""
...
func (m *ServiceEntry_FailureDomain) GetZone() string {
	if m != nil {
		return m.Zone
	}
	return ""
...
type ServiceEntry_Endpoint struct {
	...
	// Network names allow to group endpoints resident in the same L3
	// domain/network. All endpoints in the same network are assumed to be
	// directly reachable from one another. When endpoints in different
	// networks cannot reach each other directly, an Istio Gateway can be
	// used to establish connectivity (usually using the
	// ISTIO_REGISTRY_PASSTHROUGH mode in a Gateway Server).
	NetworkName string `protobuf:"bytes,4,opt,name=network_name,json=networkName,proto3" json:"network_name,omitempty"`
	// The failure domain associated with the endpoint.  All endpoints
	// within the same failure domain and the same network should be
	// directly routable. Endpoints in same failure domain across different
	// networks need to be routable via the Gateway attached to each
	// network.
	FailureDomain *ServiceEntry_FailureDomain `protobuf:"bytes,5,opt,name=failure_domain,json=failureDomain" json:"failure_domain,omitempty"`
}
...
func (m *ServiceEntry_Endpoint) GetNetworkName() string {
	if m != nil {
...
func (m *ServiceEntry_Endpoint) GetFailureDomain() *ServiceEntry_FailureDomain {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*ServiceEntry_FailureDomain)(nil), "istio.networking.v1alpha3.ServiceEntry.FailureDomain")
...
func (m *ServiceEntry) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.SubjectAlternateNames) > 0 {
		for _, s := range m.SubjectAlternateNames {
			dAtA[i] = 0x3a
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *ServiceEntry_FailureDomain) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ServiceEntry_FailureDomain) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Country) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintServiceEntry(dAtA, i, uint64(len(m.Country)))
		i += copy(dAtA[i:], m.Country)
	}
	if len(m.Region) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintServiceEntry(dAtA, i, uint64(len(m.Region)))
		i += copy(dAtA[i:], m.Region)
	}
	if len(m.Zone) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintServiceEntry(dAtA, i, uint64(len(m.Zone)))
...
func (m *ServiceEntry_Endpoint) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.NetworkName) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintServiceEntry(dAtA, i, uint64(len(m.NetworkName)))
		i += copy(dAtA[i:], m.NetworkName)
	}
	if m.FailureDomain != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintServiceEntry(dAtA, i, uint64(m.FailureDomain.Size()))
		n1, err := m.FailureDomain.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n1
...
func (m *ServiceEntry_FailureDomain) Size() (n int) {
	var l int
	_ = l
	l = len(m.Country)
	if l > 0 {
...
func (m *ServiceEntry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SubjectAlternateNames", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SubjectAlternateNames = append(m.SubjectAlternateNames, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *ServiceEntry_FailureDomain) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FailureDomain: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FailureDomain: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ServiceEntry_Endpoint) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FailureDomain", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.FailureDomain == nil {
				m.FailureDomain = &ServiceEntry_FailureDomain{}
			}
			if err := m.FailureDomain.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorServiceEntry = []byte{
	...
	,
}
