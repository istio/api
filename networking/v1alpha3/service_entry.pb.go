...
type ServiceEntry_Endpoint struct {
	...
	// Network ID enables Istio to group endpoints resident in the same L3
	...
	// The locality ID associated with the endpoint. A locality corresponds
	...
	LocalityId string `protobuf:"bytes,5,opt,name=locality_id,json=localityId,proto3" json:"locality_id,omitempty"`
}
...
func (m *ServiceEntry_Endpoint) GetNetworkId() string {
	if m != nil {
		return m.NetworkId
	}
	return ""
...
func (m *ServiceEntry_Endpoint) GetLocalityId() string {
	if m != nil {
		return m.LocalityId
	}
	return ""
...
func (m *ServiceEntry_Endpoint) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.NetworkId) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintServiceEntry(dAtA, i, uint64(len(m.NetworkId)))
		i += copy(dAtA[i:], m.NetworkId)
	}
	if len(m.LocalityId) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintServiceEntry(dAtA, i, uint64(len(m.LocalityId)))
		i += copy(dAtA[i:], m.LocalityId)
	}
	return i, nil
}
...
func (m *ServiceEntry_Endpoint) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LocalityId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LocalityId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipServiceEntry(dAtA[iNdEx:])
...
var fileDescriptorServiceEntry = []byte{
	...
	,
}
