...
type ServiceEntry struct {
	...
	// endpoints. Care must be taken when setting the resolution mode to NONE
	// for a TCP port without accompanying IP addresses. In such cases,
	// traffic to any IP on the said port will be allowed
	// (i.e. 0.0.0.0:<port>).
