...
type ServiceEntry struct {
	...
	// One or more endpoints associated with the service, which are currently
	...
	// One or more endpoints associated with the service, which are not yet
	// ready to handle traffic.
	NotReadyEndpoints    []*ServiceEntry_Endpoint `protobuf:"bytes,9,rep,name=not_ready_endpoints,json=notReadyEndpoints,proto3" json:"not_ready_endpoints,omitempty"`
...
func (m *ServiceEntry) GetNotReadyEndpoints() []*ServiceEntry_Endpoint {
	if m != nil {
		return m.NotReadyEndpoints
	}
	return nil
}
...
var fileDescriptor_9220e0fa673c4bf8 = []byte{
	...
	,
}
...
func (m *ServiceEntry) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.NotReadyEndpoints) > 0 {
		for _, msg := range m.NotReadyEndpoints {
			dAtA[i] = 0x4a
			i++
			i = encodeVarintServiceEntry(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *ServiceEntry) Size() (n int) {
	...
	if len(m.NotReadyEndpoints) > 0 {
		for _, e := range m.NotReadyEndpoints {
			l = e.Size()
			n += 1 + l + sovServiceEntry(uint64(l))
		}
	}
...
func (m *ServiceEntry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NotReadyEndpoints", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NotReadyEndpoints = append(m.NotReadyEndpoints, &ServiceEntry_Endpoint{})
			if err := m.NotReadyEndpoints[len(m.NotReadyEndpoints)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
