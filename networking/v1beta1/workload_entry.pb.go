...
// HealthStatus is an enum specifying the health of a VM. Health is
//determined by istio-agent/envoy and the application itself.
type HealthStatus int32

const (
	// UNSPECIFIED behaves like healthy - default enum value.
	HealthStatus_UNSPECIFIED HealthStatus = 0
	// UNHEALTHY means either istio-agent/envoy or the application is unhealthy.
	HealthStatus_UNHEALTHY HealthStatus = 1
	// HEALTHY means the workload is healthy.
...
type WorkloadEntry struct {
	...
	// Associated Health of the Workload.
	// HealthStatus is only sent when the associated WorkloadEntry
	// is registered with istiod. If HealthStatus is UNHEALTHY,
	// the Workload is excluded from the EDS response.
	HealthStatus         HealthStatus `protobuf:"varint,8,opt,name=health_status,json=healthStatus,proto3,enum=istio.networking.v1beta1.HealthStatus" json:"health_status,omitempty"`
...
func (m *WorkloadEntry) GetHealthStatus() HealthStatus {
	if m != nil {
		return m.HealthStatus
	}
	return HealthStatus_UNSPECIFIED
}
...
var fileDescriptor_82f01b2f412f1f06 = []byte{
	...
	,
}
...
func (m *WorkloadEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.HealthStatus != 0 {
		i = encodeVarintWorkloadEntry(dAtA, i, uint64(m.HealthStatus))
		i--
		dAtA[i] = 0x40
	}
...
func (m *WorkloadEntry) Size() (n int) {
	...
	if m.HealthStatus != 0 {
		n += 1 + sovWorkloadEntry(uint64(m.HealthStatus))
	}
	if m.XXX_unrecognized != nil {
