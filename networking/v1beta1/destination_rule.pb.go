...
type ClientTLSSettings struct {
	...
	// ValidateServerCertificate decide how the presented peer certificate during TLS handshake
	// at the client-side proxy is validated when `SIMPLE` TLS or `MUTUAL` TLS (non ISTIO_MUTUAL)
	// origination modes are used. This setting overrides the mesh global default.
	// By default, ValidateServerCertificate is true.
	//
	// When ValidateServerCertificate is set to false, certificate and SAN
	// validation at the client-side proxy is skipped.
	//
	...
	// presented server certificate during TLS handshake.
	//
	// When ValidateServerCertificate is set to true, client-side proxy will verify CA signature
	...
	ValidateServerCertificate *types.BoolValue `protobuf:"bytes,8,opt,name=validate_server_certificate,json=validateServerCertificate,proto3" json:"validate_server_certificate,omitempty"`
...
func (m *ClientTLSSettings) GetValidateServerCertificate() *types.BoolValue {
	if m != nil {
		return m.ValidateServerCertificate
	}
	return nil
}
...
var fileDescriptor_31054629b619ca4b = []byte{
	...
	,
}
...
func (m *ClientTLSSettings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ValidateServerCertificate != nil {
		{
			size, err := m.ValidateServerCertificate.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ClientTLSSettings) Size() (n int) {
	...
	if m.ValidateServerCertificate != nil {
		l = m.ValidateServerCertificate.Size()
		n += 1 + l + sovDestinationRule(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *ClientTLSSettings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValidateServerCertificate", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ValidateServerCertificate == nil {
				m.ValidateServerCertificate = &types.BoolValue{}
			}
			if err := m.ValidateServerCertificate.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
