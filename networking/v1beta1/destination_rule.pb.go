...
type LoadBalancerSettings struct {
	...
	// StatefulSession enforces stable session stickiness.
	// ConsistentHash LB policy does not enforce stable sessions because any time
	// a backend host is removed or added, the hash mapping of 1/N client sessions
	// gets affected (where N is the total number of backends) which would lead to
	// dropped requests in some cases which is unacceptable.
	// StatefulSession enforces session stickiness by routing requests to the same
	// backend till the backend host on which the session lives goes down or is not available
	// in the load balaner pool.
	// When the backend host that hosts the session goes down, sesion is recreated
	// on another backend host. A new backend host is selected based on the the configured
	// load balancer policy.
	StatefulSession *LoadBalancerSettings_StatefulSession `protobuf:"bytes,5,opt,name=stateful_session,json=statefulSession,proto3" json:"stateful_session,omitempty"`
}
...
type LoadBalancerSettings_StatefulSession struct {
	...
	//
	//	*LoadBalancerSettings_StatefulSession_SessionCookie_
...
func (x *LoadBalancerSettings_StatefulSession) GetSessionCookie() *LoadBalancerSettings_StatefulSession_SessionCookie {
	if x, ok := x.GetSessionState().(*LoadBalancerSettings_StatefulSession_SessionCookie_); ok {
...
type LoadBalancerSettings_StatefulSession_SessionCookie_ struct {
	// State based on HTTP cookie.
	SessionCookie *LoadBalancerSettings_StatefulSession_SessionCookie `protobuf:"bytes,1,opt,name=session_cookie,json=sessionCookie,proto3,oneof"`
}

func (*LoadBalancerSettings_StatefulSession_SessionCookie_) isLoadBalancerSettings_StatefulSession_SessionState() {
}
...
type LoadBalancerSettings_StatefulSession_SessionCookie struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// Duration of cookie. If not specified, a duration of 1 hour is used.
	Duration *duration.Duration `protobuf:"bytes,2,opt,name=duration,proto3" json:"duration,omitempty"`
}

func (x *LoadBalancerSettings_StatefulSession_SessionCookie) Reset() {
	*x = LoadBalancerSettings_StatefulSession_SessionCookie{}
	if protoimpl.UnsafeEnabled {
...
func (x *LoadBalancerSettings_StatefulSession_SessionCookie) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoadBalancerSettings_StatefulSession_SessionCookie) ProtoMessage() {}

func (x *LoadBalancerSettings_StatefulSession_SessionCookie) ProtoReflect() protoreflect.Message {
	mi := &file_networking_v1beta1_destination_rule_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoadBalancerSettings_StatefulSession_SessionCookie.ProtoReflect.Descriptor instead.
func (*LoadBalancerSettings_StatefulSession_SessionCookie) Descriptor() ([]byte, []int) {
	return file_networking_v1beta1_destination_rule_proto_rawDescGZIP(), []int{3, 1, 0}
}

func (x *LoadBalancerSettings_StatefulSession_SessionCookie) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *LoadBalancerSettings_StatefulSession_SessionCookie) GetDuration() *duration.Duration {
	if x != nil {
		return x.Duration
	}
	return nil
...
var file_networking_v1beta1_destination_rule_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xe7, 0x0c, 0x0a, 0x14, 0x4c, 0x6f, 0x61,
	...
	,
	...
	0x01, 0x28, 0x04, 0x52, 0x09, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x1a, 0x6d,
	0x0a, 0x0a, 0x48, 0x54, 0x54, 0x50, 0x43, 0x6f, 0x6f, 0x6b, 0x69, 0x65, 0x12, 0x18, 0x0a, 0x04,
	...
	,
	...
	0x6f, 0x6e, 0x42, 0x0f, 0x0a, 0x0d, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x74,
	0x61, 0x74, 0x65, 0x22, 0x70, 0x0a, 0x08, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x4c, 0x42, 0x12,
	...
	0x63, 0x79, 0x22, 0x90, 0x09, 0x0a, 0x16, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f,
	...
	0x1a, 0xcc, 0x03, 0x0a, 0x0b, 0x54, 0x43, 0x50, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73,
	...
	0x1a, 0x8c, 0x01, 0x0a, 0x0c, 0x54, 0x63, 0x70, 0x4b, 0x65, 0x65, 0x70, 0x61, 0x6c, 0x69, 0x76,
	...
	,
	...
	0x6c, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x12, 0x79, 0x0a, 0x11, 0x68, 0x32, 0x5f,
	0x75, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x5f, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x18, 0x06,
	...
	0x6e, 0x67, 0x73, 0x2e, 0x54, 0x4c, 0x53, 0x6d, 0x6f, 0x64, 0x65, 0x42, 0x04, 0xe2, 0x41, 0x01,
	...
	0x55, 0x54, 0x55, 0x41, 0x4c, 0x10, 0x03, 0x22, 0xa2, 0x04, 0x0a, 0x1b, 0x4c, 0x6f, 0x63, 0x61,
	0x6c, 0x69, 0x74, 0x79, 0x4c, 0x6f, 0x61, 0x64, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x72,
	0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x60, 0x0a, 0x0a, 0x64, 0x69, 0x73, 0x74, 0x72,
	0x69, 0x62, 0x75, 0x74, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x40, 0x2e, 0x69, 0x73,
	0x74, 0x69, 0x6f, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x76,
	...
	0x69, 0x73, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x12, 0x5a, 0x0a, 0x08, 0x66, 0x61, 0x69,
	0x6c, 0x6f, 0x76, 0x65, 0x72, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3e, 0x2e, 0x69, 0x73,
	0x74, 0x69, 0x6f, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x76,
	0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x69, 0x74, 0x79, 0x4c,
	0x6f, 0x61, 0x64, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x72, 0x53, 0x65, 0x74, 0x74, 0x69,
	...
	0x07, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x1a, 0xb1, 0x01, 0x0a, 0x0a, 0x44, 0x69, 0x73,
	0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x66, 0x72, 0x6f, 0x6d, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x66, 0x72, 0x6f, 0x6d, 0x12, 0x58, 0x0a, 0x02, 0x74,
	0x6f, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x48, 0x2e, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e,
	0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74,
	...
	0x74, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x74, 0x6f, 0x42, 0x21, 0x5a, 0x1f,
...
var file_networking_v1beta1_destination_rule_proto_goTypes = []interface{}{
	...
	(*LoadBalancerSettings_StatefulSession)(nil),               // 15: istio.networking.v1beta1.LoadBalancerSettings.StatefulSession
	...
	(*LoadBalancerSettings_StatefulSession_SessionCookie)(nil), // 19: istio.networking.v1beta1.LoadBalancerSettings.StatefulSession.SessionCookie
...
var file_networking_v1beta1_destination_rule_proto_depIdxs = []int32{
	...
	15, // 15: istio.networking.v1beta1.LoadBalancerSettings.stateful_session:type_name -> istio.networking.v1beta1.LoadBalancerSettings.StatefulSession
	...
	2,  // 23: istio.networking.v1beta1.ClientTLSSettings.mode:type_name -> istio.networking.v1beta1.ClientTLSSettings.TLSmode
	...
	6,  // 29: istio.networking.v1beta1.TrafficPolicy.PortTrafficPolicy.load_balancer:type_name -> istio.networking.v1beta1.LoadBalancerSettings
	7,  // 30: istio.networking.v1beta1.TrafficPolicy.PortTrafficPolicy.connection_pool:type_name -> istio.networking.v1beta1.ConnectionPoolSettings
	8,  // 31: istio.networking.v1beta1.TrafficPolicy.PortTrafficPolicy.outlier_detection:type_name -> istio.networking.v1beta1.OutlierDetection
	9,  // 32: istio.networking.v1beta1.TrafficPolicy.PortTrafficPolicy.tls:type_name -> istio.networking.v1beta1.ClientTLSSettings
	18, // 33: istio.networking.v1beta1.LoadBalancerSettings.ConsistentHashLB.http_cookie:type_name -> istio.networking.v1beta1.LoadBalancerSettings.ConsistentHashLB.HTTPCookie
	16, // 34: istio.networking.v1beta1.LoadBalancerSettings.ConsistentHashLB.ring_hash:type_name -> istio.networking.v1beta1.LoadBalancerSettings.ConsistentHashLB.RingHash
	17, // 35: istio.networking.v1beta1.LoadBalancerSettings.ConsistentHashLB.maglev:type_name -> istio.networking.v1beta1.LoadBalancerSettings.ConsistentHashLB.MagLev
	19, // 36: istio.networking.v1beta1.LoadBalancerSettings.StatefulSession.session_cookie:type_name -> istio.networking.v1beta1.LoadBalancerSettings.StatefulSession.SessionCookie
	27, // 37: istio.networking.v1beta1.LoadBalancerSettings.ConsistentHashLB.HTTPCookie.ttl:type_name -> google.protobuf.Duration
	27, // 38: istio.networking.v1beta1.LoadBalancerSettings.StatefulSession.SessionCookie.duration:type_name -> google.protobuf.Duration
	27, // 39: istio.networking.v1beta1.ConnectionPoolSettings.TCPSettings.connect_timeout:type_name -> google.protobuf.Duration
	22, // 40: istio.networking.v1beta1.ConnectionPoolSettings.TCPSettings.tcp_keepalive:type_name -> istio.networking.v1beta1.ConnectionPoolSettings.TCPSettings.TcpKeepalive
	27, // 41: istio.networking.v1beta1.ConnectionPoolSettings.TCPSettings.max_connection_duration:type_name -> google.protobuf.Duration
...
func file_networking_v1beta1_destination_rule_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_networking_v1beta1_destination_rule_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LoadBalancerSettings_StatefulSession_SessionCookie); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_networking_v1beta1_destination_rule_proto_msgTypes[12].OneofWrappers = []interface{}{
		(*LoadBalancerSettings_StatefulSession_SessionCookie_)(nil),
	}
	type x struct{}
