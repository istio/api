...
const (
	...
	SimpleLB_ROUND_ROBIN SimpleLB = 4
	...
	SimpleLB_LEAST_REQUEST SimpleLB = 5
)

// Enum value maps for SimpleLB.
var (
	SimpleLB_name = map[int32]string{
		0: "UNSPECIFIED",
		1: "LEAST_CONN",
		2: "RANDOM",
		3: "PASSTHROUGH",
	...
	SimpleLB_value = map[string]int32{
		"UNSPECIFIED":   0,
		"LEAST_CONN":    1,
		"RANDOM":        2,
		"PASSTHROUGH":   3,
...
func (x SimpleLB) Enum() *SimpleLB {
	p := new(SimpleLB)
	*p = x
	return p
}

func (x SimpleLB) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SimpleLB) Descriptor() protoreflect.EnumDescriptor {
	return file_networking_v1beta1_destination_rule_proto_enumTypes[0].Descriptor()
}

func (SimpleLB) Type() protoreflect.EnumType {
	return &file_networking_v1beta1_destination_rule_proto_enumTypes[0]
}

func (x SimpleLB) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SimpleLB.Descriptor instead.
func (SimpleLB) EnumDescriptor() ([]byte, []int) {
...
// Describes a HTTP cookie that will be used for session stickiness.
// If the cookie is not present, it will be generated.
...
func (x *HTTPCookie) GetTtl() *duration.Duration {
	if x != nil {
		return x.Ttl
	}
	return nil
...
type LoadBalancerSettings struct {
	...
	//	*LoadBalancerSettings_StatefulSession_
...
func (x *LoadBalancerSettings) GetSimple() SimpleLB {
	if x, ok := x.GetLbPolicy().(*LoadBalancerSettings_Simple); ok {
		return x.Simple
	}
	return SimpleLB_UNSPECIFIED
}
...
func (x *LoadBalancerSettings) GetStatefulSession() *LoadBalancerSettings_StatefulSession {
	if x, ok := x.GetLbPolicy().(*LoadBalancerSettings_StatefulSession_); ok {
...
type LoadBalancerSettings_Simple struct {
	Simple SimpleLB `protobuf:"varint,1,opt,name=simple,proto3,enum=istio.networking.v1beta1.SimpleLB,oneof"`
}
...
type LoadBalancerSettings_StatefulSession_ struct {
	StatefulSession *LoadBalancerSettings_StatefulSession `protobuf:"bytes,5,opt,name=stateful_session,json=statefulSession,proto3,oneof"`
}
...
func (*LoadBalancerSettings_StatefulSession_) isLoadBalancerSettings_LbPolicy() {}
...
func (x *LoadBalancerSettings_ConsistentHashLB) GetHttpCookie() *HTTPCookie {
...
type LoadBalancerSettings_ConsistentHashLB_HttpCookie struct {
	...
	HttpCookie *HTTPCookie `protobuf:"bytes,2,opt,name=http_cookie,json=httpCookie,proto3,oneof"`
}
...
// consistently till the backend host on which the session lives goes down.
type LoadBalancerSettings_StatefulSession struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Load balancer to use for the initial request, before a session is established.
	LoadBalancer SimpleLB `protobuf:"varint,1,opt,name=load_balancer,json=loadBalancer,proto3,enum=istio.networking.v1beta1.SimpleLB" json:"load_balancer,omitempty"`
	// The session state to use.
	//
	// Types that are assignable to SessionState:
	//
	//	*LoadBalancerSettings_StatefulSession_HttpCookie
	SessionState isLoadBalancerSettings_StatefulSession_SessionState `protobuf_oneof:"session_state"`
}

func (x *LoadBalancerSettings_StatefulSession) Reset() {
	*x = LoadBalancerSettings_StatefulSession{}
	if protoimpl.UnsafeEnabled {
...
func (x *LoadBalancerSettings_StatefulSession) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoadBalancerSettings_StatefulSession) ProtoMessage() {}

func (x *LoadBalancerSettings_StatefulSession) ProtoReflect() protoreflect.Message {
	mi := &file_networking_v1beta1_destination_rule_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoadBalancerSettings_StatefulSession.ProtoReflect.Descriptor instead.
func (*LoadBalancerSettings_StatefulSession) Descriptor() ([]byte, []int) {
	return file_networking_v1beta1_destination_rule_proto_rawDescGZIP(), []int{4, 1}
}

func (x *LoadBalancerSettings_StatefulSession) GetLoadBalancer() SimpleLB {
	if x != nil {
		return x.LoadBalancer
	}
	return SimpleLB_UNSPECIFIED
...
func (m *LoadBalancerSettings_StatefulSession) GetSessionState() isLoadBalancerSettings_StatefulSession_SessionState {
	if m != nil {
...
func (x *LoadBalancerSettings_StatefulSession) GetHttpCookie() *HTTPCookie {
	if x, ok := x.GetSessionState().(*LoadBalancerSettings_StatefulSession_HttpCookie); ok {
		return x.HttpCookie
	}
	return nil
}

type isLoadBalancerSettings_StatefulSession_SessionState interface {
	isLoadBalancerSettings_StatefulSession_SessionState()
}

type LoadBalancerSettings_StatefulSession_HttpCookie struct {
	// State based on HTTP cookie.
	HttpCookie *HTTPCookie `protobuf:"bytes,2,opt,name=http_cookie,json=httpCookie,proto3,oneof"`
}

func (*LoadBalancerSettings_StatefulSession_HttpCookie) isLoadBalancerSettings_StatefulSession_SessionState() {
}
...
func (*LoadBalancerSettings_ConsistentHashLB_MagLev) Descriptor() ([]byte, []int) {
	return file_networking_v1beta1_destination_rule_proto_rawDescGZIP(), []int{4, 0, 1}
}
...
var file_networking_v1beta1_destination_rule_proto_rawDesc = []byte{
	...
	,
	...
	0x69, 0x73, 0x74, 0x65, 0x6e, 0x74, 0x48, 0x61, 0x73, 0x68, 0x12, 0x6b, 0x0a, 0x10, 0x73, 0x74,
	0x61, 0x74, 0x65, 0x66, 0x75, 0x6c, 0x5f, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x05,
	...
	0x69, 0x6e, 0x67, 0x73, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x66, 0x75, 0x6c, 0x53, 0x65, 0x73,
	0x73, 0x69, 0x6f, 0x6e, 0x48, 0x00, 0x52, 0x0f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x66, 0x75, 0x6c,
	0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x65, 0x0a, 0x13, 0x6c, 0x6f, 0x63, 0x61, 0x6c,
	...
	0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x63, 0x73, 0x1a, 0xe4, 0x04, 0x0a, 0x10,
	...
	0x74, 0x70, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x47, 0x0a, 0x0b,
	...
	,
	...
	0x68, 0x12, 0x60, 0x0a, 0x06, 0x6d, 0x61, 0x67, 0x6c, 0x65, 0x76, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x46, 0x2e, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72,
	...
	0x4c, 0x42, 0x2e, 0x4d, 0x61, 0x67, 0x4c, 0x65, 0x76, 0x48, 0x01, 0x52, 0x06, 0x6d, 0x61, 0x67,
	0x6c, 0x65, 0x76, 0x12, 0x2e, 0x0a, 0x11, 0x6d, 0x69, 0x6e, 0x69, 0x6d, 0x75, 0x6d, 0x5f, 0x72,
	0x69, 0x6e, 0x67, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x42, 0x02,
	0x18, 0x01, 0x52, 0x0f, 0x6d, 0x69, 0x6e, 0x69, 0x6d, 0x75, 0x6d, 0x52, 0x69, 0x6e, 0x67, 0x53,
	0x69, 0x7a, 0x65, 0x1a, 0x36, 0x0a, 0x08, 0x52, 0x69, 0x6e, 0x67, 0x48, 0x61, 0x73, 0x68, 0x12,
	...
	,
	...
	0x74, 0x70, 0x43, 0x6f, 0x6f, 0x6b, 0x69, 0x65, 0x42, 0x0f, 0x0a, 0x0d, 0x73, 0x65, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x42, 0x0b, 0x0a, 0x09, 0x6c, 0x62, 0x5f,
	0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x22, 0x90, 0x09, 0x0a, 0x16, 0x43, 0x6f, 0x6e, 0x6e, 0x65,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x6f, 0x6f, 0x6c, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67,
	0x73, 0x12, 0x4e, 0x0a, 0x03, 0x74, 0x63, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3c,
	0x2e, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x69, 0x6e,
	...
	0x70, 0x12, 0x51, 0x0a, 0x04, 0x68, 0x74, 0x74, 0x70, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x68, 0x74, 0x74, 0x70, 0x1a, 0xcc, 0x03, 0x0a, 0x0b, 0x54, 0x43, 0x50, 0x53, 0x65, 0x74, 0x74,
	...
	0x74, 0x12, 0x6e, 0x0a, 0x0d, 0x74, 0x63, 0x70, 0x5f, 0x6b, 0x65, 0x65, 0x70, 0x61, 0x6c, 0x69,
	0x76, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x49, 0x2e, 0x69, 0x73, 0x74, 0x69, 0x6f,
	...
	0x76, 0x61, 0x6c, 0x1a, 0x83, 0x04, 0x0a, 0x0c, 0x48, 0x54, 0x54, 0x50, 0x53, 0x65, 0x74, 0x74,
	...
	0x04, 0xe2, 0x41, 0x01, 0x02, 0x52, 0x04, 0x6d, 0x6f, 0x64, 0x65, 0x12, 0x2d, 0x0a, 0x12, 0x63,
	...
	0x2a, 0x70, 0x0a, 0x08, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x4c, 0x42, 0x12, 0x0f, 0x0a, 0x0b,
	...
	0x10, 0x05, 0x42, 0x21, 0x5a, 0x1f, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x69, 0x6f, 0x2f, 0x61,
...
var file_networking_v1beta1_destination_rule_proto_goTypes = []interface{}{
	(SimpleLB)(0), // 0: istio.networking.v1beta1.SimpleLB
	...
	(*HTTPCookie)(nil),                                       // 6: istio.networking.v1beta1.HTTPCookie
	...
	(*LoadBalancerSettings_StatefulSession)(nil),             // 16: istio.networking.v1beta1.LoadBalancerSettings.StatefulSession
...
var file_networking_v1beta1_destination_rule_proto_depIdxs = []int32{
	...
	26, // 11: istio.networking.v1beta1.HTTPCookie.ttl:type_name -> google.protobuf.Duration
	0,  // 12: istio.networking.v1beta1.LoadBalancerSettings.simple:type_name -> istio.networking.v1beta1.SimpleLB
	15, // 13: istio.networking.v1beta1.LoadBalancerSettings.consistent_hash:type_name -> istio.networking.v1beta1.LoadBalancerSettings.ConsistentHashLB
	16, // 14: istio.networking.v1beta1.LoadBalancerSettings.stateful_session:type_name -> istio.networking.v1beta1.LoadBalancerSettings.StatefulSession
	11, // 15: istio.networking.v1beta1.LoadBalancerSettings.locality_lb_setting:type_name -> istio.networking.v1beta1.LocalityLoadBalancerSetting
	26, // 16: istio.networking.v1beta1.LoadBalancerSettings.warmup_duration_secs:type_name -> google.protobuf.Duration
	19, // 17: istio.networking.v1beta1.ConnectionPoolSettings.tcp:type_name -> istio.networking.v1beta1.ConnectionPoolSettings.TCPSettings
	20, // 18: istio.networking.v1beta1.ConnectionPoolSettings.http:type_name -> istio.networking.v1beta1.ConnectionPoolSettings.HTTPSettings
	27, // 19: istio.networking.v1beta1.OutlierDetection.consecutive_local_origin_failures:type_name -> google.protobuf.UInt32Value
	27, // 20: istio.networking.v1beta1.OutlierDetection.consecutive_gateway_errors:type_name -> google.protobuf.UInt32Value
	27, // 21: istio.networking.v1beta1.OutlierDetection.consecutive_5xx_errors:type_name -> google.protobuf.UInt32Value
	26, // 22: istio.networking.v1beta1.OutlierDetection.interval:type_name -> google.protobuf.Duration
	26, // 23: istio.networking.v1beta1.OutlierDetection.base_ejection_time:type_name -> google.protobuf.Duration
	2,  // 24: istio.networking.v1beta1.ClientTLSSettings.mode:type_name -> istio.networking.v1beta1.ClientTLSSettings.TLSmode
	28, // 25: istio.networking.v1beta1.ClientTLSSettings.insecure_skip_verify:type_name -> google.protobuf.BoolValue
	22, // 26: istio.networking.v1beta1.LocalityLoadBalancerSetting.distribute:type_name -> istio.networking.v1beta1.LocalityLoadBalancerSetting.Distribute
	23, // 27: istio.networking.v1beta1.LocalityLoadBalancerSetting.failover:type_name -> istio.networking.v1beta1.LocalityLoadBalancerSetting.Failover
	28, // 28: istio.networking.v1beta1.LocalityLoadBalancerSetting.enabled:type_name -> google.protobuf.BoolValue
	29, // 29: istio.networking.v1beta1.TrafficPolicy.PortTrafficPolicy.port:type_name -> istio.networking.v1beta1.PortSelector
	7,  // 30: istio.networking.v1beta1.TrafficPolicy.PortTrafficPolicy.load_balancer:type_name -> istio.networking.v1beta1.LoadBalancerSettings
	8,  // 31: istio.networking.v1beta1.TrafficPolicy.PortTrafficPolicy.connection_pool:type_name -> istio.networking.v1beta1.ConnectionPoolSettings
	9,  // 32: istio.networking.v1beta1.TrafficPolicy.PortTrafficPolicy.outlier_detection:type_name -> istio.networking.v1beta1.OutlierDetection
	10, // 33: istio.networking.v1beta1.TrafficPolicy.PortTrafficPolicy.tls:type_name -> istio.networking.v1beta1.ClientTLSSettings
	6,  // 34: istio.networking.v1beta1.LoadBalancerSettings.ConsistentHashLB.http_cookie:type_name -> istio.networking.v1beta1.HTTPCookie
	...
	0,  // 37: istio.networking.v1beta1.LoadBalancerSettings.StatefulSession.load_balancer:type_name -> istio.networking.v1beta1.SimpleLB
	6,  // 38: istio.networking.v1beta1.LoadBalancerSettings.StatefulSession.http_cookie:type_name -> istio.networking.v1beta1.HTTPCookie
	26, // 39: istio.networking.v1beta1.ConnectionPoolSettings.TCPSettings.connect_timeout:type_name -> google.protobuf.Duration
	21, // 40: istio.networking.v1beta1.ConnectionPoolSettings.TCPSettings.tcp_keepalive:type_name -> istio.networking.v1beta1.ConnectionPoolSettings.TCPSettings.TcpKeepalive
	26, // 41: istio.networking.v1beta1.ConnectionPoolSettings.TCPSettings.max_connection_duration:type_name -> google.protobuf.Duration
	26, // 42: istio.networking.v1beta1.ConnectionPoolSettings.HTTPSettings.idle_timeout:type_name -> google.protobuf.Duration
	1,  // 43: istio.networking.v1beta1.ConnectionPoolSettings.HTTPSettings.h2_upgrade_policy:type_name -> istio.networking.v1beta1.ConnectionPoolSettings.HTTPSettings.H2UpgradePolicy
	26, // 44: istio.networking.v1beta1.ConnectionPoolSettings.TCPSettings.TcpKeepalive.time:type_name -> google.protobuf.Duration
	26, // 45: istio.networking.v1beta1.ConnectionPoolSettings.TCPSettings.TcpKeepalive.interval:type_name -> google.protobuf.Duration
	24, // 46: istio.networking.v1beta1.LocalityLoadBalancerSetting.Distribute.to:type_name -> istio.networking.v1beta1.LocalityLoadBalancerSetting.Distribute.ToEntry
...
func file_networking_v1beta1_destination_rule_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_networking_v1beta1_destination_rule_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LoadBalancerSettings_StatefulSession); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_networking_v1beta1_destination_rule_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*LoadBalancerSettings_Simple)(nil),
		(*LoadBalancerSettings_ConsistentHash)(nil),
		(*LoadBalancerSettings_StatefulSession_)(nil),
	}
	...
	file_networking_v1beta1_destination_rule_proto_msgTypes[13].OneofWrappers = []interface{}{
		(*LoadBalancerSettings_StatefulSession_HttpCookie)(nil),
	}
	type x struct{}
