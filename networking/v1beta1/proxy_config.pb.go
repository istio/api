...
type ProxyConfig struct {
	...
	StatefulFormatter *StatefulFormatter `protobuf:"bytes,5,opt,name=stateful_formatter,json=statefulFormatter,proto3" json:"stateful_formatter,omitempty"`
}
...
func (x *ProxyConfig) GetStatefulFormatter() *StatefulFormatter {
	if x != nil {
...
// StatefulFormatter defines options for stateful header formatters, which allow
// headers to retain specific formatting across requests within Envoy.
// Stateful formatters maintain formatting state from decoding to encoding,
// providing consistency in header transformations for HTTP/1.x traffic.
type StatefulFormatter struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// When true, the formatter will preserve the original case of HTTP/1.x headers
	...
	// standards.
	PreserveCase bool `protobuf:"varint,1,opt,name=preserve_case,json=preserveCase,proto3" json:"preserve_case,omitempty"`
}

func (x *StatefulFormatter) Reset() {
	*x = StatefulFormatter{}
	mi := &file_networking_v1beta1_proxy_config_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StatefulFormatter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StatefulFormatter) ProtoMessage() {}

func (x *StatefulFormatter) ProtoReflect() protoreflect.Message {
	mi := &file_networking_v1beta1_proxy_config_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StatefulFormatter.ProtoReflect.Descriptor instead.
func (*StatefulFormatter) Descriptor() ([]byte, []int) {
	return file_networking_v1beta1_proxy_config_proto_rawDescGZIP(), []int{2}
}

func (x *StatefulFormatter) GetPreserveCase() bool {
	if x != nil {
...
var file_networking_v1beta1_proxy_config_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe5,
	...
	0x65, 0x12, 0x5a, 0x0a, 0x12, 0x73, 0x74, 0x61, 0x74, 0x65, 0x66, 0x75, 0x6c, 0x5f, 0x66, 0x6f,
	0x72, 0x6d, 0x61, 0x74, 0x74, 0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e,
	0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x69, 0x6e, 0x67,
	0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x66, 0x75,
	0x6c, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x74, 0x65, 0x72, 0x52, 0x11, 0x73, 0x74, 0x61, 0x74,
	0x65, 0x66, 0x75, 0x6c, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x74, 0x65, 0x72, 0x1a, 0x47, 0x0a,
	...
	0x79, 0x70, 0x65, 0x22, 0x38, 0x0a, 0x11, 0x53, 0x74, 0x61, 0x74, 0x65, 0x66, 0x75, 0x6c, 0x46,
	0x6f, 0x72, 0x6d, 0x61, 0x74, 0x74, 0x65, 0x72, 0x12, 0x23, 0x0a, 0x0d, 0x70, 0x72, 0x65, 0x73,
	0x65, 0x72, 0x76, 0x65, 0x5f, 0x63, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x0c, 0x70, 0x72, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x43, 0x61, 0x73, 0x65, 0x42, 0x21, 0x5a,
...
var file_networking_v1beta1_proxy_config_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_networking_v1beta1_proxy_config_proto_goTypes = []any{
	...
	(*StatefulFormatter)(nil),        // 2: istio.networking.v1beta1.StatefulFormatter
	nil,                              // 3: istio.networking.v1beta1.ProxyConfig.EnvironmentVariablesEntry
...
var file_networking_v1beta1_proxy_config_proto_depIdxs = []int32{
	4, // 0: istio.networking.v1beta1.ProxyConfig.selector:type_name -> istio.type.v1beta1.WorkloadSelector
	5, // 1: istio.networking.v1beta1.ProxyConfig.concurrency:type_name -> google.protobuf.Int32Value
	3, // 2: istio.networking.v1beta1.ProxyConfig.environment_variables:type_name -> istio.networking.v1beta1.ProxyConfig.EnvironmentVariablesEntry
	1, // 3: istio.networking.v1beta1.ProxyConfig.image:type_name -> istio.networking.v1beta1.ProxyImage
	2, // 4: istio.networking.v1beta1.ProxyConfig.stateful_formatter:type_name -> istio.networking.v1beta1.StatefulFormatter
