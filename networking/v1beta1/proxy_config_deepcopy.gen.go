...
// DeepCopyInto supports using StatefulFormatter within kubernetes types, where deepcopy-gen is used.
func (in *StatefulFormatter) DeepCopyInto(out *StatefulFormatter) {
	p := proto.Clone(in).(*StatefulFormatter)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StatefulFormatter. Required by controller-gen.
func (in *StatefulFormatter) DeepCopy() *StatefulFormatter {
	if in == nil {
		return nil
	}
	out := new(StatefulFormatter)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new StatefulFormatter. Required by controller-gen.
func (in *StatefulFormatter) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
