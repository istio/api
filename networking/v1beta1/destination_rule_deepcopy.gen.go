...
// DeepCopyInto supports using LoadBalancerSubsetSetting within kubernetes types, where deepcopy-gen is used.
func (in *LoadBalancerSubsetSetting) DeepCopyInto(out *LoadBalancerSubsetSetting) {
	p := proto.Clone(in).(*LoadBalancerSubsetSetting)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSubsetSetting. Required by controller-gen.
func (in *LoadBalancerSubsetSetting) DeepCopy() *LoadBalancerSubsetSetting {
	if in == nil {
		return nil
	}
	out := new(LoadBalancerSubsetSetting)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSubsetSetting. Required by controller-gen.
func (in *LoadBalancerSubsetSetting) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using LoadBalancerSubsetSetting_SubsetSelector within kubernetes types, where deepcopy-gen is used.
func (in *LoadBalancerSubsetSetting_SubsetSelector) DeepCopyInto(out *LoadBalancerSubsetSetting_SubsetSelector) {
	p := proto.Clone(in).(*LoadBalancerSubsetSetting_SubsetSelector)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSubsetSetting_SubsetSelector. Required by controller-gen.
func (in *LoadBalancerSubsetSetting_SubsetSelector) DeepCopy() *LoadBalancerSubsetSetting_SubsetSelector {
	if in == nil {
		return nil
	}
	out := new(LoadBalancerSubsetSetting_SubsetSelector)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSubsetSetting_SubsetSelector. Required by controller-gen.
func (in *LoadBalancerSubsetSetting_SubsetSelector) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
