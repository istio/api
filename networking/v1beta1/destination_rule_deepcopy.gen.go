...
// DeepCopyInto supports using HTTPCookie within kubernetes types, where deepcopy-gen is used.
func (in *HTTPCookie) DeepCopyInto(out *HTTPCookie) {
	p := proto.Clone(in).(*HTTPCookie)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPCookie. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new HTTPCookie. Required by controller-gen.
func (in *HTTPCookie) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
