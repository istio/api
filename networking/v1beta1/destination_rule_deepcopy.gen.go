...
// DeepCopyInto supports using LoadBalancerSettings_StatefulSession within kubernetes types, where deepcopy-gen is used.
func (in *LoadBalancerSettings_StatefulSession) DeepCopyInto(out *LoadBalancerSettings_StatefulSession) {
	p := proto.Clone(in).(*LoadBalancerSettings_StatefulSession)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_StatefulSession. Required by controller-gen.
func (in *LoadBalancerSettings_StatefulSession) DeepCopy() *LoadBalancerSettings_StatefulSession {
	if in == nil {
		return nil
	}
	out := new(LoadBalancerSettings_StatefulSession)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_StatefulSession. Required by controller-gen.
func (in *LoadBalancerSettings_StatefulSession) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using LoadBalancerSettings_StatefulSession_SessionCookie within kubernetes types, where deepcopy-gen is used.
func (in *LoadBalancerSettings_StatefulSession_SessionCookie) DeepCopyInto(out *LoadBalancerSettings_StatefulSession_SessionCookie) {
	p := proto.Clone(in).(*LoadBalancerSettings_StatefulSession_SessionCookie)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_StatefulSession_SessionCookie. Required by controller-gen.
func (in *LoadBalancerSettings_StatefulSession_SessionCookie) DeepCopy() *LoadBalancerSettings_StatefulSession_SessionCookie {
	if in == nil {
		return nil
	}
	out := new(LoadBalancerSettings_StatefulSession_SessionCookie)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_StatefulSession_SessionCookie. Required by controller-gen.
func (in *LoadBalancerSettings_StatefulSession_SessionCookie) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
