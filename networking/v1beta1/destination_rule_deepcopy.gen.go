...
// DeepCopyInto supports using LoadBalancerSettings_ConsistentHashLB_CookieAttribute within kubernetes types, where deepcopy-gen is used.
func (in *LoadBalancerSettings_ConsistentHashLB_CookieAttribute) DeepCopyInto(out *LoadBalancerSettings_ConsistentHashLB_CookieAttribute) {
	p := proto.Clone(in).(*LoadBalancerSettings_ConsistentHashLB_CookieAttribute)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_ConsistentHashLB_CookieAttribute. Required by controller-gen.
func (in *LoadBalancerSettings_ConsistentHashLB_CookieAttribute) DeepCopy() *LoadBalancerSettings_ConsistentHashLB_CookieAttribute {
	if in == nil {
		return nil
	}
	out := new(LoadBalancerSettings_ConsistentHashLB_CookieAttribute)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_ConsistentHashLB_CookieAttribute. Required by controller-gen.
func (in *LoadBalancerSettings_ConsistentHashLB_CookieAttribute) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
