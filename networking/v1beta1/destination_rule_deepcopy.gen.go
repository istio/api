...
// DeepCopyInto supports using HealthyCheck within kubernetes types, where deepcopy-gen is used.
func (in *HealthyCheck) DeepCopyInto(out *HealthyCheck) {
	p := proto.Clone(in).(*HealthyCheck)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HealthyCheck. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new HealthyCheck. Required by controller-gen.
func (in *HealthyCheck) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using HealthyCheckHttpHealthCheck within kubernetes types, where deepcopy-gen is used.
func (in *HealthyCheckHttpHealthCheck) DeepCopyInto(out *HealthyCheckHttpHealthCheck) {
	p := proto.Clone(in).(*HealthyCheckHttpHealthCheck)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HealthyCheckHttpHealthCheck. Required by controller-gen.
func (in *HealthyCheckHttpHealthCheck) DeepCopy() *HealthyCheckHttpHealthCheck {
	if in == nil {
		return nil
	}
	out := new(HealthyCheckHttpHealthCheck)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new HealthyCheckHttpHealthCheck. Required by controller-gen.
func (in *HealthyCheckHttpHealthCheck) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
