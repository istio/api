...
// DeepCopyInto supports using LoadBalancerSettings_PersistentSession within kubernetes types, where deepcopy-gen is used.
func (in *LoadBalancerSettings_PersistentSession) DeepCopyInto(out *LoadBalancerSettings_PersistentSession) {
	p := proto.Clone(in).(*LoadBalancerSettings_PersistentSession)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_PersistentSession. Required by controller-gen.
func (in *LoadBalancerSettings_PersistentSession) DeepCopy() *LoadBalancerSettings_PersistentSession {
	if in == nil {
		return nil
	}
	out := new(LoadBalancerSettings_PersistentSession)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_PersistentSession. Required by controller-gen.
func (in *LoadBalancerSettings_PersistentSession) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
...
// DeepCopyInto supports using PersistentCookie within kubernetes types, where deepcopy-gen is used.
func (in *PersistentCookie) DeepCopyInto(out *PersistentCookie) {
	p := proto.Clone(in).(*PersistentCookie)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PersistentCookie. Required by controller-gen.
func (in *PersistentCookie) DeepCopy() *PersistentCookie {
	if in == nil {
		return nil
	}
	out := new(PersistentCookie)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new PersistentCookie. Required by controller-gen.
func (in *PersistentCookie) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
