...
type InboundTrafficPolicy struct {
	...
	IstioPeerAuthentication InboundTrafficPolicy_IstioPeerAuthentication `protobuf:"varint,1,opt,name=istio_peer_authentication,json=istioPeerAuthentication,proto3,enum=istio.networking.v1beta1.InboundTrafficPolicy_IstioPeerAuthentication" json:"istio_peer_authentication,omitempty"`
...
func init() {
	...
	proto.RegisterEnum("istio.networking.v1beta1.InboundTrafficPolicy_IstioPeerAuthentication", InboundTrafficPolicy_IstioPeerAuthentication_name, InboundTrafficPolicy_IstioPeerAuthentication_value)
	...
	proto.RegisterType((*InboundTrafficPolicy)(nil), "istio.networking.v1beta1.InboundTrafficPolicy")
}
...
var fileDescriptor_e7023408fb338e10 = []byte{
	...
	,
}
