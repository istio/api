...
type OutboundTrafficPolicy struct {
	...
	// $hide_from_docs
	EgressProxy          *OutboundTrafficPolicy_EgressProxy `protobuf:"bytes,2,opt,name=egress_proxy,json=egressProxy,proto3" json:"egress_proxy,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                           `json:"-"`
	XXX_unrecognized     []byte                             `json:"-"`
	XXX_sizecache        int32                              `json:"-"`
}
...
func (m *OutboundTrafficPolicy) GetEgressProxy() *OutboundTrafficPolicy_EgressProxy {
	if m != nil {
...
// $hide_from_docs
type OutboundTrafficPolicy_EgressProxy struct {
	// REQUIRED: The hostname of the proxy to which the unknown
	// traffic should be forwarded to. If the hostname is in the
	// namespace/fqdn format, it will be assumed to be a service in
	// the mesh and Envoy will load balance the traffic to one of the
	// endpoints of the service. If the hostname is simply a FQDN
	// corresponding to a service outside the mesh, Envoy will resolve
	// the host using DNS and forward the traffic to the IP address
	// returned by the DNS.
	Host string `protobuf:"bytes,1,opt,name=host,proto3" json:"host,omitempty"`
	// REQUIRED: The port to which the traffic should be forwarded to.
	Port uint32 `protobuf:"varint,2,opt,name=port,proto3" json:"port,omitempty"`
	// Use the tls_settings to specify the tls mode to use when
	// talking to the egress proxy. If the egress proxy is an Envoy
	// gateway managed by Pilot, specify the TLS mode as ISTIO_MUTUAL.
	TlsSettings          *TLSSettings `protobuf:"bytes,3,opt,name=tls_settings,json=tlsSettings,proto3" json:"tls_settings,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}

func (m *OutboundTrafficPolicy_EgressProxy) Reset()         { *m = OutboundTrafficPolicy_EgressProxy{} }
func (m *OutboundTrafficPolicy_EgressProxy) String() string { return proto.CompactTextString(m) }
func (*OutboundTrafficPolicy_EgressProxy) ProtoMessage()    {}
func (*OutboundTrafficPolicy_EgressProxy) Descriptor() ([]byte, []int) {
	return fileDescriptor_e7023408fb338e10, []int{4, 0}
}
func (m *OutboundTrafficPolicy_EgressProxy) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *OutboundTrafficPolicy_EgressProxy) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_OutboundTrafficPolicy_EgressProxy.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *OutboundTrafficPolicy_EgressProxy) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OutboundTrafficPolicy_EgressProxy.Merge(m, src)
}
func (m *OutboundTrafficPolicy_EgressProxy) XXX_Size() int {
	return m.Size()
}
func (m *OutboundTrafficPolicy_EgressProxy) XXX_DiscardUnknown() {
	xxx_messageInfo_OutboundTrafficPolicy_EgressProxy.DiscardUnknown(m)
}

var xxx_messageInfo_OutboundTrafficPolicy_EgressProxy proto.InternalMessageInfo

func (m *OutboundTrafficPolicy_EgressProxy) GetHost() string {
	if m != nil {
		return m.Host
	}
	return ""
...
func (m *OutboundTrafficPolicy_EgressProxy) GetPort() uint32 {
	if m != nil {
		return m.Port
	}
	return 0
...
func (m *OutboundTrafficPolicy_EgressProxy) GetTlsSettings() *TLSSettings {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*OutboundTrafficPolicy_EgressProxy)(nil), "istio.networking.v1beta1.OutboundTrafficPolicy.EgressProxy")
}
...
var fileDescriptor_e7023408fb338e10 = []byte{
	...
	,
}
...
func (m *OutboundTrafficPolicy_EgressProxy) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *OutboundTrafficPolicy_EgressProxy) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OutboundTrafficPolicy_EgressProxy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Port != 0 {
		i = encodeVarintSidecar(dAtA, i, uint64(m.Port))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Host) > 0 {
...
func (m *OutboundTrafficPolicy_EgressProxy) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *OutboundTrafficPolicy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.EgressProxy == nil {
				m.EgressProxy = &OutboundTrafficPolicy_EgressProxy{}
			}
...
func (m *OutboundTrafficPolicy_EgressProxy) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EgressProxy: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EgressProxy: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
