...
func (IstioIngressListener_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e7023408fb338e10, []int{1, 0}
}
...
type IstioIngressListener struct {
	...
	Mode                 IstioIngressListener_Mode `protobuf:"varint,7,opt,name=mode,proto3,enum=istio.networking.v1beta1.IstioIngressListener_Mode" json:"mode,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func init() {
	...
	proto.RegisterEnum("istio.networking.v1beta1.IstioIngressListener_Mode", IstioIngressListener_Mode_name, IstioIngressListener_Mode_value)
...
var fileDescriptor_e7023408fb338e10 = []byte{
	...
	,
}
