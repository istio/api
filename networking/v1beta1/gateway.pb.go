...
type ServerTLSSettings struct {
	...
	// Default to `Server.Hosts` when unset.
	Snis []string `protobuf:"bytes,13,rep,name=snis,proto3" json:"snis,omitempty"`
}
...
func (x *ServerTLSSettings) GetSnis() []string {
	if x != nil {
		return x.Snis
	}
	return nil
...
var file_networking_v1beta1_gateway_proto_rawDesc = []byte{
	...
	0x72, 0x74, 0x22, 0xfd, 0x06, 0x0a, 0x11, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x54, 0x4c, 0x53,
	...
	0x73, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x6e, 0x69, 0x73, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x04, 0x73, 0x6e, 0x69, 0x73, 0x22, 0x5a, 0x0a, 0x07, 0x54, 0x4c, 0x53, 0x6d, 0x6f, 0x64, 0x65,
