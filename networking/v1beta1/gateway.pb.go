...
type OCSP_Stapling_StaplingMode int32

const (
	// Matches the LENIENT_STAPLING mode of Envoy
	OCSP_Stapling_OPTIONAL OCSP_Stapling_StaplingMode = 0
	// Matches the STRICT_STAPLING mode of Envoy
	OCSP_Stapling_PREFERRED OCSP_Stapling_StaplingMode = 1
	// Matches the MUST_STAPLE mode of Envoy
	OCSP_Stapling_MANDATORY OCSP_Stapling_StaplingMode = 2
)

// Enum value maps for OCSP_Stapling_StaplingMode.
var (
	OCSP_Stapling_StaplingMode_name = map[int32]string{
		0: "OPTIONAL",
		1: "PREFERRED",
		2: "MANDATORY",
	}
	OCSP_Stapling_StaplingMode_value = map[string]int32{
		"OPTIONAL":  0,
		"PREFERRED": 1,
		"MANDATORY": 2,
	}
...
func (x OCSP_Stapling_StaplingMode) Enum() *OCSP_Stapling_StaplingMode {
	p := new(OCSP_Stapling_StaplingMode)
	*p = x
	return p
}

func (x OCSP_Stapling_StaplingMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (OCSP_Stapling_StaplingMode) Descriptor() protoreflect.EnumDescriptor {
	return file_networking_v1beta1_gateway_proto_enumTypes[2].Descriptor()
}

func (OCSP_Stapling_StaplingMode) Type() protoreflect.EnumType {
	return &file_networking_v1beta1_gateway_proto_enumTypes[2]
}

func (x OCSP_Stapling_StaplingMode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use OCSP_Stapling_StaplingMode.Descriptor instead.
func (OCSP_Stapling_StaplingMode) EnumDescriptor() ([]byte, []int) {
	return file_networking_v1beta1_gateway_proto_rawDescGZIP(), []int{4, 0, 0}
}
...
type ServerTLSSettings struct {
	...
	Ocsp *OCSP `protobuf:"bytes,13,opt,name=ocsp,proto3" json:"ocsp,omitempty"`
}
...
func (x *ServerTLSSettings) GetOcsp() *OCSP {
	if x != nil {
		return x.Ocsp
	}
	return nil
...
func (x *OCSP) Reset() {
	*x = OCSP{}
	if protoimpl.UnsafeEnabled {
		mi := &file_networking_v1beta1_gateway_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *OCSP) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OCSP) ProtoMessage() {}

func (x *OCSP) ProtoReflect() protoreflect.Message {
	mi := &file_networking_v1beta1_gateway_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OCSP.ProtoReflect.Descriptor instead.
func (*OCSP) Descriptor() ([]byte, []int) {
	return file_networking_v1beta1_gateway_proto_rawDescGZIP(), []int{4}
}

// Settings for OCSP Stapling
type OCSP_Stapling struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// OCSP Stapling mode for Envoy
	Mode OCSP_Stapling_StaplingMode `protobuf:"varint,1,opt,name=mode,proto3,enum=istio.networking.v1beta1.OCSP_Stapling_StaplingMode" json:"mode,omitempty"`
	// Path at which the staple bytes will be stored in the Secret
	Path string `protobuf:"bytes,2,opt,name=path,proto3" json:"path,omitempty"`
}

func (x *OCSP_Stapling) Reset() {
	*x = OCSP_Stapling{}
	if protoimpl.UnsafeEnabled {
...
func (x *OCSP_Stapling) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OCSP_Stapling) ProtoMessage() {}

func (x *OCSP_Stapling) ProtoReflect() protoreflect.Message {
	mi := &file_networking_v1beta1_gateway_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OCSP_Stapling.ProtoReflect.Descriptor instead.
func (*OCSP_Stapling) Descriptor() ([]byte, []int) {
	return file_networking_v1beta1_gateway_proto_rawDescGZIP(), []int{4, 0}
}

func (x *OCSP_Stapling) GetMode() OCSP_Stapling_StaplingMode {
	if x != nil {
		return x.Mode
	}
	return OCSP_Stapling_OPTIONAL
}

func (x *OCSP_Stapling) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
var file_networking_v1beta1_gateway_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x50, 0x6f, 0x72, 0x74, 0x22, 0x9d, 0x07, 0x0a, 0x11, 0x53, 0x65, 0x72, 0x76, 0x65,
	...
	0x75, 0x69, 0x74, 0x65, 0x73, 0x12, 0x32, 0x0a, 0x04, 0x6f, 0x63, 0x73, 0x70, 0x18, 0x0d, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x6e, 0x65, 0x74, 0x77,
	0x6f, 0x72, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x4f,
	0x43, 0x53, 0x50, 0x52, 0x04, 0x6f, 0x63, 0x73, 0x70, 0x22, 0x5a, 0x0a, 0x07, 0x54, 0x4c, 0x53,
	...
	,
...
var file_networking_v1beta1_gateway_proto_goTypes = []interface{}{
	...
	(OCSP_Stapling_StaplingMode)(0),    // 2: istio.networking.v1beta1.OCSP.Stapling.StaplingMode
	...
	(*OCSP)(nil),                       // 7: istio.networking.v1beta1.OCSP
	nil,                                // 8: istio.networking.v1beta1.Gateway.SelectorEntry
	(*OCSP_Stapling)(nil),              // 9: istio.networking.v1beta1.OCSP.Stapling
}
var file_networking_v1beta1_gateway_proto_depIdxs = []int32{
	...
	8, // 1: istio.networking.v1beta1.Gateway.selector:type_name -> istio.networking.v1beta1.Gateway.SelectorEntry
	...
	7, // 7: istio.networking.v1beta1.ServerTLSSettings.ocsp:type_name -> istio.networking.v1beta1.OCSP
	2, // 8: istio.networking.v1beta1.OCSP.Stapling.mode:type_name -> istio.networking.v1beta1.OCSP.Stapling.StaplingMode
...
func file_networking_v1beta1_gateway_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_networking_v1beta1_gateway_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OCSP); i {
			case 0:
				return &v.state
			case 1:
