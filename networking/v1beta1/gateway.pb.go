...
type Server struct {
	...
	// An optional stat prefix to be applied while generating proxy statistics
	// for the requests that flow via this server configuration.
	StatsPrefix          string   `protobuf:"bytes,6,opt,name=stats_prefix,json=statsPrefix,proto3" json:"stats_prefix,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Server) GetStatsPrefix() string {
	if m != nil {
		return m.StatsPrefix
	}
	return ""
}
...
var fileDescriptor_6ed1f6b211144a0d = []byte{
	...
	,
}
...
func (m *Server) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.StatsPrefix) > 0 {
		...
		i = encodeVarintGateway(dAtA, i, uint64(len(m.StatsPrefix)))
		i--
		dAtA[i] = 0x32
	}
...
func (m *Server) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StatsPrefix", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StatsPrefix = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGateway(dAtA[iNdEx:])
