...
generate-mixer-go: \
	...
	$(policy_v1beta_pb_gos) $(policy_v1beta_pb_doc) \
...
clean-mixer-generated:
	rm -f $(mixer_v1_pb_gos) $(mixer_config_client_pb_gos) $(mixer_config_descriptor_pb_gos) $(mixer_template_pb_gos) $(mixer_adapter_model_v1beta_pb_gos) $(policy_v1beta_pb_gos) mixer/v1/config/fixed_cfg.pb.go
	rm -f $(mixer_v1_pb_doc) $(mixer_config_client_pb_doc) $(mixer_config_descriptor_pb_doc) $(mixer_template_pb_doc) $(mixer_adapter_model_v1beta_pb_doc) $(policy_v1beta_pb_doc) mixer/v1/config/istio.mixer.v1.config.pb.html
