...
ROUTING_V1ALPHA2_FOREIGN_SERVICE_PROTO := $(ROUTING_V1ALPHA2)/foreign_service.proto
ROUTING_V1ALPHA2_PROTOS := $(ROUTING_V1ALPHA2_DESTINATION_RULE_PROTO) $(ROUTING_V1ALPHA2_GATEWAY_PROTO) $(ROUTING_V1ALPHA2_ROUTE_PROTO) $(ROUTING_V1ALPHA2_FOREIGN_SERVICE_PROTO)
