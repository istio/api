...
ROUTING_V1ALPHA2_UNSAFE_ENVOY_CONFIG_PROTO := $(ROUTING_V1ALPHA2)/unsafe_envoy_config.proto
ROUTING_V1ALPHA2_PROTOS := $(ROUTING_V1ALPHA2_DESTINATION_RULE_PROTO) $(ROUTING_V1ALPHA2_GATEWAY_PROTO) $(ROUTING_V1ALPHA2_ROUTE_PROTO) $(ROUTING_V1ALPHA2_FOREIGN_SERVICES_PROTO) $(ROUTING_V1ALPHA2_UNSAFE_ENVOY_CONFIG_PROTO)
