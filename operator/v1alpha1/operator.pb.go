...
func (IstioOperatorSpec_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_8023ebf2dcfea843, []int{0, 0}
}
...
type IstioOperatorSpec struct {
	...
	Status IstioOperatorSpec_Status `protobuf:"varint,200,opt,name=status,proto3,enum=istio.operator.v1alpha1.IstioOperatorSpec_Status" json:"status,omitempty"`
...
type IstioOperatorSpec_VersionStatus struct {
	...
	Status               IstioOperatorSpec_Status `protobuf:"varint,2,opt,name=status,proto3,enum=istio.operator.v1alpha1.IstioOperatorSpec_Status" json:"status,omitempty"`
...
func (*IstioOperatorSpec_VersionStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_8023ebf2dcfea843, []int{0, 1}
}
...
func init() {
	proto.RegisterEnum("istio.operator.v1alpha1.IstioOperatorSpec_Status", IstioOperatorSpec_Status_name, IstioOperatorSpec_Status_value)
	...
	proto.RegisterMapType((map[string]*IstioOperatorSpec_VersionStatus)(nil), "istio.operator.v1alpha1.IstioOperatorSpec.ComponentStatusEntry")
	proto.RegisterType((*IstioOperatorSpec_VersionStatus)(nil), "istio.operator.v1alpha1.IstioOperatorSpec.VersionStatus")
}
...
var fileDescriptor_8023ebf2dcfea843 = []byte{
	...
	,
}
