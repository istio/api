...
const (
	...
	Status_UPDATING Status = 1
	// Controller has started but not yet completed reconciliation loop for the component.
	Status_RECONCILING Status = 2
	// Component is healthy.
	Status_HEALTHY Status = 3
	// Component is in an error state.
	Status_ERROR Status = 4
	// Overall status only and would not be set as a component status.
	// Action is needed from user for reconciliation loop to proceed
	// e.g. There are proxies still pointing to the control plane revision when try to remove IstioOperator CR.
...
type InstallStatus struct {
	...
	Status *OverallStatus `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`
...
func (m *InstallStatus) GetStatus() *OverallStatus {
	if m != nil {
		return m.Status
	}
	return nil
...
type InstallStatus_VersionStatus struct {
	...
	Status               Status   `protobuf:"varint,2,opt,name=status,proto3,enum=istio.operator.v1alpha1.Status" json:"status,omitempty"`
...
func (m *InstallStatus_VersionStatus) GetStatus() Status {
	if m != nil {
		return m.Status
	}
	return Status_NONE
...
// Overall status of all components.
type OverallStatus struct {
	...
	// - If further action is needed for reconciliation to proceed, overall status is PENDING.
	Status Status `protobuf:"varint,1,opt,name=status,proto3,enum=istio.operator.v1alpha1.Status" json:"status,omitempty"`
	// Optional message explains the reason and actions needed for the existing overall status.
...
func (m *OverallStatus) Reset()         { *m = OverallStatus{} }
func (m *OverallStatus) String() string { return proto.CompactTextString(m) }
func (*OverallStatus) ProtoMessage()    {}
func (*OverallStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_8023ebf2dcfea843, []int{2}
}
func (m *OverallStatus) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_OverallStatus.Unmarshal(m, b)
}
func (m *OverallStatus) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_OverallStatus.Marshal(b, m, deterministic)
}
func (m *OverallStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OverallStatus.Merge(m, src)
}
func (m *OverallStatus) XXX_Size() int {
	return xxx_messageInfo_OverallStatus.Size(m)
}
func (m *OverallStatus) XXX_DiscardUnknown() {
	xxx_messageInfo_OverallStatus.DiscardUnknown(m)
}

var xxx_messageInfo_OverallStatus proto.InternalMessageInfo

func (m *OverallStatus) GetStatus() Status {
	if m != nil {
		return m.Status
	}
	return Status_NONE
...
func (m *OverallStatus) GetMessage() string {
	if m != nil {
		return m.Message
	}
	return ""
...
func init() {
	proto.RegisterEnum("istio.operator.v1alpha1.Status", Status_name, Status_value)
	...
	proto.RegisterType((*OverallStatus)(nil), "istio.operator.v1alpha1.OverallStatus")
...
var fileDescriptor_8023ebf2dcfea843 = []byte{
	...
	,
}
