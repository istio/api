...
type IstioComponentSetSpec struct {
	...
	// Resources on a remote cluster using an external control plane.
	Remote *ComponentSpec `protobuf:"bytes,42,opt,name=remote,proto3" json:"remote,omitempty"`
	// Resources on a config cluster for an external control plane.
	Config               *ComponentSpec `protobuf:"bytes,43,opt,name=config,proto3" json:"config,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *IstioComponentSetSpec) GetRemote() *ComponentSpec {
	if m != nil {
		return m.Remote
	}
	return nil
...
func (m *IstioComponentSetSpec) GetConfig() *ComponentSpec {
	if m != nil {
		return m.Config
	}
	return nil
...
var fileDescriptor_8023ebf2dcfea843 = []byte{
	...
	,
}
