...
// MarshalJSON is a custom marshaler for WasmExtension
func (this *WasmExtension) MarshalJSON() ([]byte, error) {
	str, err := WasmMarshaler.MarshalToString(this)
	return []byte(str), err
}

// UnmarshalJSON is a custom unmarshaler for WasmExtension
func (this *WasmExtension) UnmarshalJSON(b []byte) error {
