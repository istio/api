...
const (
	...
	// this plugin. Note that this chance includes `annotations` field as well.
...
type WasmPlugin struct {
	...
	// Deprecated. Please use `pull_policy` which is generalized for dealing
	// with `http[s]://` or `file://` as well.
	...
	// The pull behaviour to be applied when fetching Wasm module.
	// Only relevant when referencing Wasm module without any digest,
	// including the digest in OCI image URL or sha256 field in `vm_config`.
	// Defaults to IfNotPresent, except when an OCI image is referenced in the `url`
	// and the `latest` tag is used, in which case `Always` is the default,
	// mirroring K8s behaviour.
	PullPolicy PullPolicy `protobuf:"varint,12,opt,name=pull_policy,json=pullPolicy,proto3,enum=istio.extensions.v1alpha1.PullPolicy" json:"pull_policy,omitempty"`
}
...
func (x *WasmPlugin) GetPullPolicy() PullPolicy {
	if x != nil {
		return x.PullPolicy
	}
	return PullPolicy_UNSPECIFIED_POLICY
...
var file_extensions_v1alpha1_wasm_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x86, 0x05, 0x0a, 0x0a, 0x57, 0x61, 0x73, 0x6d, 0x50,
	...
	0x36, 0x12, 0x55, 0x0a, 0x11, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x5f, 0x70, 0x75, 0x6c, 0x6c, 0x5f,
	...
	0x69, 0x63, 0x79, 0x42, 0x02, 0x18, 0x01, 0x52, 0x0f, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x50, 0x75,
	...
	0x6d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x46, 0x0a, 0x0b, 0x70, 0x75, 0x6c, 0x6c, 0x5f,
	0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x25, 0x2e, 0x69,
	0x73, 0x74, 0x69, 0x6f, 0x2e, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e,
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x50, 0x75, 0x6c, 0x6c, 0x50, 0x6f, 0x6c,
	0x69, 0x63, 0x79, 0x52, 0x0a, 0x70, 0x75, 0x6c, 0x6c, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x22,
	...
	0x01, 0x42, 0x22, 0x5a, 0x20, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x69, 0x6f, 0x2f, 0x61, 0x70,
	0x69, 0x2f, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x76, 0x31, 0x61,
...
var file_extensions_v1alpha1_wasm_proto_depIdxs = []int32{
	...
	1, // 6: istio.extensions.v1alpha1.WasmPlugin.pull_policy:type_name -> istio.extensions.v1alpha1.PullPolicy
