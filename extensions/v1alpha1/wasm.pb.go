...
// $hide_from_docs
// PortSelector specifies the criteria used to determine if a policy can be
// applied to a listener having a specific port.
//
// This is copied from authentication/v1alpha1/policy.proto since it is
// deprecated now.
// networking/v1beta1/gateway.proto also define "Port", but there are too
// many inadequate fields (e.g., target_port or protocol) and no notion
// of "oneof".
...
type WasmPlugin_TrafficSelector struct {
	...
	// direction.
	Mode v1alpha1.WorkloadMode `protobuf:"varint,1,opt,name=mode,proto3,enum=istio.telemetry.v1alpha1.WorkloadMode" json:"mode,omitempty"`
	// $hide_from_docs
	// Hide this from the doc until implementing this.
	//
...
func (x *WasmPlugin_TrafficSelector) GetMode() v1alpha1.WorkloadMode {
	if x != nil {
		return x.Mode
	}
	return v1alpha1.WorkloadMode(0)
}

func (x *WasmPlugin_TrafficSelector) GetPorts() []*PortSelector {
	if x != nil {
		return x.Ports
	}
	return nil
...
var file_extensions_v1alpha1_wasm_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x22, 0x74, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72,
	0x79, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2f, 0x74, 0x65, 0x6c, 0x65, 0x6d,
	0x65, 0x74, 0x72, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x96, 0x06, 0x0a, 0x0a, 0x57,
	0x61, 0x73, 0x6d, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x12, 0x40, 0x0a, 0x08, 0x73, 0x65, 0x6c,
	...
	0x72, 0x52, 0x08, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x75,
	...
	,
	...
	0x50, 0x68, 0x61, 0x73, 0x65, 0x52, 0x05, 0x70, 0x68, 0x61, 0x73, 0x65, 0x12, 0x37, 0x0a, 0x08,
	...
	,
	...
	0x6d, 0x6f, 0x64, 0x65, 0x12, 0x3d, 0x0a, 0x05, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18, 0x02, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x65, 0x78, 0x74, 0x65,
	0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e,
	0x50, 0x6f, 0x72, 0x74, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x52, 0x05, 0x70, 0x6f,
	0x72, 0x74, 0x73, 0x22, 0x3f, 0x0a, 0x08, 0x56, 0x6d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12,
	...
	,
...
var file_extensions_v1alpha1_wasm_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_extensions_v1alpha1_wasm_proto_goTypes = []interface{}{
	...
	(*PortSelector)(nil),               // 6: istio.extensions.v1alpha1.PortSelector
	...
	(v1alpha1.WorkloadMode)(0),         // 11: istio.telemetry.v1alpha1.WorkloadMode
}
var file_extensions_v1alpha1_wasm_proto_depIdxs = []int32{
	...
	10, // 4: istio.extensions.v1alpha1.WasmPlugin.priority:type_name -> google.protobuf.Int64Value
	4,  // 5: istio.extensions.v1alpha1.WasmPlugin.vm_config:type_name -> istio.extensions.v1alpha1.VmConfig
	7,  // 6: istio.extensions.v1alpha1.WasmPlugin.match:type_name -> istio.extensions.v1alpha1.WasmPlugin.TrafficSelector
	...
	11, // 9: istio.extensions.v1alpha1.WasmPlugin.TrafficSelector.mode:type_name -> istio.telemetry.v1alpha1.WorkloadMode
	6,  // 10: istio.extensions.v1alpha1.WasmPlugin.TrafficSelector.ports:type_name -> istio.extensions.v1alpha1.PortSelector
...
func file_extensions_v1alpha1_wasm_proto_init() {
	...
	file_extensions_v1alpha1_wasm_proto_msgTypes[3].OneofWrappers = []interface{}{
