...
func file_security_v1beta1_peer_authentication_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_security_v1beta1_peer_authentication_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_security_v1beta1_peer_authentication_proto_msgTypes[1].Exporter = func(v any, i int) any {
