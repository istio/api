...
// DeepCopyInto supports using AuthorizationPolicy_External within kubernetes types, where deepcopy-gen is used.
func (in *AuthorizationPolicy_External) DeepCopyInto(out *AuthorizationPolicy_External) {
	p := proto.Clone(in).(*AuthorizationPolicy_External)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuthorizationPolicy_External. Required by controller-gen.
func (in *AuthorizationPolicy_External) DeepCopy() *AuthorizationPolicy_External {
	if in == nil {
		return nil
	}
	out := new(AuthorizationPolicy_External)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new AuthorizationPolicy_External. Required by controller-gen.
func (in *AuthorizationPolicy_External) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
