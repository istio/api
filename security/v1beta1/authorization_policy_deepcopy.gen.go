...
// DeepCopyInto supports using AuthorizationPolicy_CustomizeDeny within kubernetes types, where deepcopy-gen is used.
func (in *AuthorizationPolicy_CustomizeDeny) DeepCopyInto(out *AuthorizationPolicy_CustomizeDeny) {
	p := proto.Clone(in).(*AuthorizationPolicy_CustomizeDeny)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuthorizationPolicy_CustomizeDeny. Required by controller-gen.
func (in *AuthorizationPolicy_CustomizeDeny) DeepCopy() *AuthorizationPolicy_CustomizeDeny {
	if in == nil {
		return nil
	}
	out := new(AuthorizationPolicy_CustomizeDeny)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new AuthorizationPolicy_CustomizeDeny. Required by controller-gen.
func (in *AuthorizationPolicy_CustomizeDeny) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
