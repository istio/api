...
// DeepCopyInto supports using External_Destination within kubernetes types, where deepcopy-gen is used.
func (in *External_Destination) DeepCopyInto(out *External_Destination) {
	p := proto.Clone(in).(*External_Destination)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new External_Destination. Required by controller-gen.
func (in *External_Destination) DeepCopy() *External_Destination {
	if in == nil {
		return nil
	}
	out := new(External_Destination)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new External_Destination. Required by controller-gen.
func (in *External_Destination) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using External_PortSelector within kubernetes types, where deepcopy-gen is used.
func (in *External_PortSelector) DeepCopyInto(out *External_PortSelector) {
	p := proto.Clone(in).(*External_PortSelector)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new External_PortSelector. Required by controller-gen.
func (in *External_PortSelector) DeepCopy() *External_PortSelector {
	if in == nil {
		return nil
	}
	out := new(External_PortSelector)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new External_PortSelector. Required by controller-gen.
func (in *External_PortSelector) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
...
// DeepCopyInto supports using External_GRPCConfig within kubernetes types, where deepcopy-gen is used.
func (in *External_GRPCConfig) DeepCopyInto(out *External_GRPCConfig) {
	p := proto.Clone(in).(*External_GRPCConfig)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new External_GRPCConfig. Required by controller-gen.
func (in *External_GRPCConfig) DeepCopy() *External_GRPCConfig {
	if in == nil {
		return nil
	}
	out := new(External_GRPCConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new External_GRPCConfig. Required by controller-gen.
func (in *External_GRPCConfig) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
