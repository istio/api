...
type Condition struct {
	...
	// Optional. A list of contained strings to match for the attribute.
	Contains []string `protobuf:"bytes,4,rep,name=contains,proto3" json:"contains,omitempty"`
}
...
func (x *Condition) GetContains() []string {
	if x != nil {
		return x.Contains
	}
	return nil
...
var file_security_v1beta1_authorization_policy_proto_rawDesc = []byte{
	...
	0x50, 0x61, 0x74, 0x68, 0x73, 0x22, 0x76, 0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69,
	...
	0x73, 0x12, 0x1a, 0x0a, 0x08, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x73, 0x18, 0x04, 0x20,
	0x03, 0x28, 0x09, 0x52, 0x08, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x73, 0x42, 0x1f, 0x5a,
