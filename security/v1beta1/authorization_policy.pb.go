...
type Operation struct {
	...
	// If set, paths and not_paths will be matched case-insensitively
	IgnorePathCase *bool `protobuf:"varint,9,opt,name=ignore_path_case,json=ignorePathCase,proto3,oneof" json:"ignore_path_case,omitempty"`
}
...
func (x *Operation) GetIgnorePathCase() bool {
	if x != nil && x.IgnorePathCase != nil {
		return *x.IgnorePathCase
	}
	return false
}
...
var file_security_v1beta1_authorization_policy_proto_rawDesc = []byte{
	...
	0x63, 0x6b, 0x73, 0x22, 0xa3, 0x02, 0x0a, 0x09, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f,
	...
	0x50, 0x61, 0x74, 0x68, 0x73, 0x12, 0x2d, 0x0a, 0x10, 0x69, 0x67, 0x6e, 0x6f, 0x72, 0x65, 0x5f,
	0x70, 0x61, 0x74, 0x68, 0x5f, 0x63, 0x61, 0x73, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x48,
	0x00, 0x52, 0x0e, 0x69, 0x67, 0x6e, 0x6f, 0x72, 0x65, 0x50, 0x61, 0x74, 0x68, 0x43, 0x61, 0x73,
	0x65, 0x88, 0x01, 0x01, 0x42, 0x13, 0x0a, 0x11, 0x5f, 0x69, 0x67, 0x6e, 0x6f, 0x72, 0x65, 0x5f,
	0x70, 0x61, 0x74, 0x68, 0x5f, 0x63, 0x61, 0x73, 0x65, 0x22, 0x5a, 0x0a, 0x09, 0x43, 0x6f, 0x6e,
...
func file_security_v1beta1_authorization_policy_proto_init() {
	...
	file_security_v1beta1_authorization_policy_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
