...
type Operation struct {
	...
	// Optional. A list of paths matchers as specified in the HTTP request. See the [Authorization Policy Normalization](https://istio.io/latest/docs/reference/config/security/normalization/)
	// for details of the path normalization.
	// For gRPC service, this will be the fully-qualified name in the form of
	// "/package.service/method".
	//
	// If not set, any path is allowed Must be used only with HTTP.
	MatchPaths []*v1beta11.StringMatch `protobuf:"bytes,9,rep,name=match_paths,json=matchPaths,proto3" json:"match_paths,omitempty"`
	...
	// Optional. A list of negative match of paths.
	NotMatchPaths        []*v1beta11.StringMatch `protobuf:"bytes,10,rep,name=not_match_paths,json=notMatchPaths,proto3" json:"not_match_paths,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
func (m *Operation) GetMatchPaths() []*v1beta11.StringMatch {
	if m != nil {
		return m.MatchPaths
	}
	return nil
...
func (m *Operation) GetNotMatchPaths() []*v1beta11.StringMatch {
	if m != nil {
		return m.NotMatchPaths
	}
	return nil
}
...
type Condition struct {
	...
	// Optional. A list of allowed matchers for the attribute value.
	// Note: at least one of values, matches, not_values or not_matches must be set.
	Matches []*v1beta11.StringMatch `protobuf:"bytes,4,rep,name=matches,proto3" json:"matches,omitempty"`
	...
	// Optional. A list of negative match of values for the attribute.
	// Note: at least one of values, matches, not_values or not_matches must be set.
	NotMatches           []*v1beta11.StringMatch `protobuf:"bytes,5,rep,name=not_matches,json=notMatches,proto3" json:"not_matches,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
func (m *Condition) GetMatches() []*v1beta11.StringMatch {
	if m != nil {
		return m.Matches
	}
	return nil
...
func (m *Condition) GetNotMatches() []*v1beta11.StringMatch {
	if m != nil {
		return m.NotMatches
	}
	return nil
...
var fileDescriptor_438e25379256bb35 = []byte{
	...
	,
}
...
func (m *Operation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NotMatchPaths) > 0 {
		for iNdEx := len(m.NotMatchPaths) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.NotMatchPaths[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.MatchPaths) > 0 {
		for iNdEx := len(m.MatchPaths) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.MatchPaths[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Condition) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NotMatches) > 0 {
		for iNdEx := len(m.NotMatches) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.NotMatches[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Operation) Size() (n int) {
	...
	if len(m.MatchPaths) > 0 {
		for _, e := range m.MatchPaths {
			l = e.Size()
			n += 1 + l + sovAuthorizationPolicy(uint64(l))
		}
	}
	if len(m.NotMatchPaths) > 0 {
		for _, e := range m.NotMatchPaths {
			l = e.Size()
			n += 1 + l + sovAuthorizationPolicy(uint64(l))
		}
	}
...
func (m *Operation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			m.MatchPaths = append(m.MatchPaths, &v1beta11.StringMatch{})
			if err := m.MatchPaths[len(m.MatchPaths)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NotMatchPaths", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NotMatchPaths = append(m.NotMatchPaths, &v1beta11.StringMatch{})
			if err := m.NotMatchPaths[len(m.NotMatchPaths)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Condition) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Matches = append(m.Matches, &v1beta11.StringMatch{})
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NotMatches", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NotMatches = append(m.NotMatches, &v1beta11.StringMatch{})
			if err := m.NotMatches[len(m.NotMatches)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
