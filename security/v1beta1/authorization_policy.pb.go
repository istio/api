...
type External struct {
	// Specifies to use the HTTP authorization check API to talk to the external authorization server.
	// Note, the HTTP authorization check API can only be used with HTTP traffic.
	//
	// At least one of http and grpc must be set.
	// If only http field is set, the HTTP traffic will be enforced with HTTP API and there will be no external authorization
	// enforced for TCP traffic.
	Http *External_HTTPConfig `protobuf:"bytes,1,opt,name=http,proto3" json:"http,omitempty"`
	// Specifies to use the gRPC authorization check API to talk to the external authorization server.
	// Note, the gRPC authorization check API can be used with both HTTP and TCP (non-HTTP) traffic.
	//
	// At least one of http and grpc must be set.
	// If only grpc field is set, both HTTP and TCP (non-HTTP) traffic will be enforced with the gRPC API.
	// Normally only one of http and grpc field is good enough but if both fields are set, the HTTP traffic will be enforced
	// with the HTTP API and the TCP (non-HTTP) traffic will be enforced with the gRPC API.
	Grpc *External_GRPCConfig `protobuf:"bytes,2,opt,name=grpc,proto3" json:"grpc,omitempty"`
	// Specifies if the peer certificate is included in the authorization check request.
...
func (m *External) GetGrpc() *External_GRPCConfig {
	if m != nil {
		return m.Grpc
	}
	return nil
...
func (m *External) GetIncludePeerCertificate() bool {
	if m != nil {
...
type External_Destination struct {
	...
	// port.
	Port                 *External_PortSelector `protobuf:"bytes,3,opt,name=port,proto3" json:"port,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}

func (m *External_Destination) Reset()         { *m = External_Destination{} }
func (m *External_Destination) String() string { return proto.CompactTextString(m) }
func (*External_Destination) ProtoMessage()    {}
func (*External_Destination) Descriptor() ([]byte, []int) {
	return fileDescriptor_438e25379256bb35, []int{1, 0}
}
func (m *External_Destination) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *External_Destination) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_External_Destination.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *External_Destination) XXX_Merge(src proto.Message) {
	xxx_messageInfo_External_Destination.Merge(m, src)
}
func (m *External_Destination) XXX_Size() int {
	return m.Size()
}
func (m *External_Destination) XXX_DiscardUnknown() {
	xxx_messageInfo_External_Destination.DiscardUnknown(m)
}

var xxx_messageInfo_External_Destination proto.InternalMessageInfo

func (m *External_Destination) GetHost() string {
	if m != nil {
		return m.Host
	}
	return ""
...
func (m *External_Destination) GetSubset() string {
	if m != nil {
		return m.Subset
	}
	return ""
...
func (m *External_Destination) GetPort() *External_PortSelector {
	if m != nil {
		return m.Port
	}
	return nil
...
func (m *External_PortSelector) Reset()         { *m = External_PortSelector{} }
func (m *External_PortSelector) String() string { return proto.CompactTextString(m) }
func (*External_PortSelector) ProtoMessage()    {}
func (*External_PortSelector) Descriptor() ([]byte, []int) {
	return fileDescriptor_438e25379256bb35, []int{1, 1}
}
func (m *External_PortSelector) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *External_PortSelector) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_External_PortSelector.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *External_PortSelector) XXX_Merge(src proto.Message) {
	xxx_messageInfo_External_PortSelector.Merge(m, src)
}
func (m *External_PortSelector) XXX_Size() int {
	return m.Size()
}
func (m *External_PortSelector) XXX_DiscardUnknown() {
	xxx_messageInfo_External_PortSelector.DiscardUnknown(m)
}

var xxx_messageInfo_External_PortSelector proto.InternalMessageInfo

func (m *External_PortSelector) GetNumber() uint32 {
	if m != nil {
		return m.Number
	}
	return 0
...
// HTTPConfig supplies detail configurations of the HTTP authorization check request.
type External_HTTPConfig struct {
	// Specifies the external authorization service that implements the Envoy ext_authz filter HTTP check request API.
...
func (*External_HTTPConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_438e25379256bb35, []int{1, 2}
}
...
func (m *External_HTTPConfig) GetService() *External_Destination {
	if m != nil {
		return m.Service
	}
	return nil
...
func (m *External_HTTPConfig) GetPathPrefix() string {
	if m != nil {
		return m.PathPrefix
	}
	return ""
...
func (*External_HTTPConfig_AuthorizationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_438e25379256bb35, []int{1, 2, 0}
}
...
func (*External_HTTPConfig_AuthorizationResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_438e25379256bb35, []int{1, 2, 1}
}
...
// GRPCConfig supplies detail configurations of the gRPC authorization check request.
type External_GRPCConfig struct {
	// Specifies the external authorization service that implements the Envoy ext_authz filter gRPC check request API.
	Service *External_Destination `protobuf:"bytes,1,opt,name=service,proto3" json:"service,omitempty"`
	// Sets the maximum duration in milliseconds for connection to the external server (default is 200ms).
	Timeout              *types.Duration `protobuf:"bytes,2,opt,name=timeout,proto3" json:"timeout,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
...
func (m *External_GRPCConfig) Reset()         { *m = External_GRPCConfig{} }
func (m *External_GRPCConfig) String() string { return proto.CompactTextString(m) }
func (*External_GRPCConfig) ProtoMessage()    {}
func (*External_GRPCConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_438e25379256bb35, []int{1, 3}
}
func (m *External_GRPCConfig) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *External_GRPCConfig) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_External_GRPCConfig.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *External_GRPCConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_External_GRPCConfig.Merge(m, src)
}
func (m *External_GRPCConfig) XXX_Size() int {
	return m.Size()
}
func (m *External_GRPCConfig) XXX_DiscardUnknown() {
	xxx_messageInfo_External_GRPCConfig.DiscardUnknown(m)
}

var xxx_messageInfo_External_GRPCConfig proto.InternalMessageInfo

func (m *External_GRPCConfig) GetService() *External_Destination {
	if m != nil {
		return m.Service
	}
	return nil
...
func (m *External_GRPCConfig) GetTimeout() *types.Duration {
	if m != nil {
		return m.Timeout
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*External_Destination)(nil), "istio.security.v1beta1.External.Destination")
	proto.RegisterType((*External_PortSelector)(nil), "istio.security.v1beta1.External.PortSelector")
	...
	proto.RegisterType((*External_GRPCConfig)(nil), "istio.security.v1beta1.External.GRPCConfig")
...
var fileDescriptor_438e25379256bb35 = []byte{
	...
	,
}
...
func (m *External_Destination) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *External_Destination) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *External_Destination) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Subset) > 0 {
		...
		i = encodeVarintAuthorizationPolicy(dAtA, i, uint64(len(m.Subset)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Host) > 0 {
		i -= len(m.Host)
		copy(dAtA[i:], m.Host)
		i = encodeVarintAuthorizationPolicy(dAtA, i, uint64(len(m.Host)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *External_PortSelector) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *External_PortSelector) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *External_PortSelector) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Number != 0 {
		i = encodeVarintAuthorizationPolicy(dAtA, i, uint64(m.Number))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *External_HTTPConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PathPrefix) > 0 {
		...
		i = encodeVarintAuthorizationPolicy(dAtA, i, uint64(len(m.PathPrefix)))
		i--
		dAtA[i] = 0x2a
	}
...
func (m *External_GRPCConfig) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *External_GRPCConfig) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *External_GRPCConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *External_Destination) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *External_PortSelector) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.Number != 0 {
		n += 1 + sovAuthorizationPolicy(uint64(m.Number))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *External_GRPCConfig) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *External_Destination) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *External_PortSelector) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *External_HTTPConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Service == nil {
				m.Service = &External_Destination{}
			}
...
func (m *External_GRPCConfig) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GRPCConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GRPCConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
