...
const (
	...
	//
	// The following authorization policy applies to ingress gateway to call the external authorization service of name
	// "default" (defined in MeshConfig) if the request path has prefix "/admin/".
	//
	// ```yaml
	// apiVersion: security.istio.io/v1beta1
	// kind: AuthorizationPolicy
...
type AuthorizationPolicy_External struct {
	// Specifies the name of the external service to call. This is currently defined in the MeshConfig.
...
func (m *AuthorizationPolicy_External) GetService() string {
	if m != nil {
		return m.Service
	}
	return ""
...
var fileDescriptor_438e25379256bb35 = []byte{
	...
	,
}
...
func (m *AuthorizationPolicy_External) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Service) > 0 {
		...
		i = encodeVarintAuthorizationPolicy(dAtA, i, uint64(len(m.Service)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
