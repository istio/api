...
const (
	...
	// $hide_from_docs
	// THe EXTERNAL action delegates the authorization decision to an external authorizer. An authorization check request
	// will be sent to the external authorizer and the response will decide whether or not the original request should be
	// allowed or denied.
	//
	// The EXTERNAL action is evaluated before the ALLOW and DENY action and is currently an **experimental feature** in Istio.
	// See the `external_providers` in MeshConfig for the supported external authorizers (currently only Envoy ext_authz).
	//
	// The following authorization policy applies to ingress gateway and delegates the authorization decision to the external
	// provider named "default" (defined in MeshConfig) when the request path has prefix "/admin/".
	//
	// ```yaml
	// apiVersion: security.istio.io/v1beta1
	// kind: AuthorizationPolicy
...
type AuthorizationPolicy_External_ struct {
	External *AuthorizationPolicy_External `protobuf:"bytes,4,opt,name=external,proto3,oneof"`
}

func (*AuthorizationPolicy_External_) isAuthorizationPolicy_ActionDetail() {}
...
func (m *AuthorizationPolicy) GetExternal() *AuthorizationPolicy_External {
	if x, ok := m.GetActionDetail().(*AuthorizationPolicy_External_); ok {
		return x.External
	}
	return nil
}
...
func (*AuthorizationPolicy) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*AuthorizationPolicy_External_)(nil),
	}
}

// $hide_from_docs
type AuthorizationPolicy_External struct {
	// Specifies the name of the external provider. The list of available providers are defined in the MeshConfig.
...
func (m *AuthorizationPolicy_External) Reset()         { *m = AuthorizationPolicy_External{} }
func (m *AuthorizationPolicy_External) String() string { return proto.CompactTextString(m) }
func (*AuthorizationPolicy_External) ProtoMessage()    {}
func (*AuthorizationPolicy_External) Descriptor() ([]byte, []int) {
	return fileDescriptor_438e25379256bb35, []int{0, 0}
}
func (m *AuthorizationPolicy_External) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AuthorizationPolicy_External) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AuthorizationPolicy_External.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AuthorizationPolicy_External) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AuthorizationPolicy_External.Merge(m, src)
}
func (m *AuthorizationPolicy_External) XXX_Size() int {
	return m.Size()
}
func (m *AuthorizationPolicy_External) XXX_DiscardUnknown() {
	xxx_messageInfo_AuthorizationPolicy_External.DiscardUnknown(m)
}

var xxx_messageInfo_AuthorizationPolicy_External proto.InternalMessageInfo

func (m *AuthorizationPolicy_External) GetProvider() string {
	if m != nil {
		return m.Provider
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*AuthorizationPolicy_External)(nil), "istio.security.v1beta1.AuthorizationPolicy.External")
...
var fileDescriptor_438e25379256bb35 = []byte{
	...
	,
}
...
func (m *AuthorizationPolicy_External_) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *AuthorizationPolicy_External_) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.External != nil {
		{
...
func (m *AuthorizationPolicy_External) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AuthorizationPolicy_External) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Provider) > 0 {
		...
		i = encodeVarintAuthorizationPolicy(dAtA, i, uint64(len(m.Provider)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *AuthorizationPolicy_External_) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AuthorizationPolicy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			v := &AuthorizationPolicy_External{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.ActionDetail = &AuthorizationPolicy_External_{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *AuthorizationPolicy_External) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
