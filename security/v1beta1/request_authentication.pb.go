...
func (m *RequestAuthentication) GetJwtRules() []*JWT {
	if m != nil {
		return m.JwtRules
	}
	return nil
...
var fileDescriptor_4a3374592471772b = []byte{
	...
	0x44, 0x4e, 0x69, 0x32, 0x23, 0x97, 0x68, 0x10, 0xc4, 0x46, 0x47, 0x14, 0x0b, 0x85, 0x1c, 0xb8,
	...
	0xae, 0x4b, 0xc8, 0x82, 0x8b, 0x33, 0xab, 0xbc, 0x24, 0xbe, 0xa8, 0x34, 0x27, 0xb5, 0x58, 0x82,
	0x49, 0x81, 0x59, 0x83, 0xdb, 0x48, 0x5a, 0x0f, 0xbb, 0x07, 0xf4, 0xbc, 0xc2, 0x43, 0x82, 0x38,
	0xb2, 0xca, 0x4b, 0x82, 0x40, 0x8a, 0x9d, 0xb4, 0x4f, 0x3c, 0x92, 0x63, 0xbc, 0xf0, 0x48, 0x8e,
	0xf1, 0xc1, 0x23, 0x39, 0xc6, 0x28, 0x59, 0x88, 0x9e, 0xcc, 0x7c, 0xfd, 0xc4, 0x82, 0x4c, 0x7d,
	0x74, 0xcf, 0x24, 0xb1, 0x81, 0x7d, 0x62, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xe3, 0x69, 0x95,
	0x9d, 0x4b, 0x01, 0x00, 0x00,
}
...
func (m *RequestAuthentication) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.JwtRules = append(m.JwtRules, &JWT{})
