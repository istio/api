...
type RequestAuthentication struct {
	...
	//
	//	*RequestAuthentication_Selector
	//	*RequestAuthentication_TargetRef
	TypeSelector isRequestAuthentication_TypeSelector `protobuf_oneof:"type_selector"`
...
func (m *RequestAuthentication) GetTypeSelector() isRequestAuthentication_TypeSelector {
	if m != nil {
...
func (x *RequestAuthentication) GetSelector() *v1beta1.WorkloadSelector {
	if x, ok := x.GetTypeSelector().(*RequestAuthentication_Selector); ok {
		return x.Selector
	}
	return nil
}
...
func (x *RequestAuthentication) GetTargetRef() *v1beta1.PolicyTargetReference {
	if x, ok := x.GetTypeSelector().(*RequestAuthentication_TargetRef); ok {
		return x.TargetRef
	}
	return nil
}
...
type isRequestAuthentication_TypeSelector interface {
	isRequestAuthentication_TypeSelector()
}

type RequestAuthentication_Selector struct {
...
type RequestAuthentication_TargetRef struct {
	...
	// the request authentication policy.
	//
	// If not set, the policy is applied as defined by the selector.
	TargetRef *v1beta1.PolicyTargetReference `protobuf:"bytes,3,opt,name=targetRef,proto3,oneof"`
}

func (*RequestAuthentication_Selector) isRequestAuthentication_TypeSelector() {}

func (*RequestAuthentication_TargetRef) isRequestAuthentication_TypeSelector() {}
...
var file_security_v1beta1_request_authentication_proto_rawDesc = []byte{
	...
	0x22, 0xf5, 0x01, 0x0a, 0x15, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x41, 0x75, 0x74, 0x68,
	0x65, 0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x42, 0x0a, 0x08, 0x73, 0x65,
	...
	0x0a, 0x09, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x52, 0x65, 0x66, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x52, 0x65, 0x66, 0x12, 0x3c, 0x0a, 0x09, 0x6a, 0x77, 0x74,
	0x5f, 0x72, 0x75, 0x6c, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x69,
	0x73, 0x74, 0x69, 0x6f, 0x2e, 0x73, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x2e, 0x76, 0x31,
	0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x4a, 0x57, 0x54, 0x52, 0x75, 0x6c, 0x65, 0x52, 0x08, 0x6a,
	0x77, 0x74, 0x52, 0x75, 0x6c, 0x65, 0x73, 0x42, 0x0f, 0x0a, 0x0d, 0x74, 0x79, 0x70, 0x65, 0x5f,
	0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x42, 0x1f, 0x5a, 0x1d, 0x69, 0x73, 0x74, 0x69,
...
var file_security_v1beta1_request_authentication_proto_goTypes = []interface{}{
	...
	(*JWTRule)(nil),                       // 3: istio.security.v1beta1.JWTRule
}
var file_security_v1beta1_request_authentication_proto_depIdxs = []int32{
	...
	2, // 1: istio.security.v1beta1.RequestAuthentication.targetRef:type_name -> istio.type.v1beta1.PolicyTargetReference
	3, // 2: istio.security.v1beta1.RequestAuthentication.jwt_rules:type_name -> istio.security.v1beta1.JWTRule
...
func file_security_v1beta1_request_authentication_proto_init() {
	...
	file_security_v1beta1_request_authentication_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*RequestAuthentication_Selector)(nil),
		(*RequestAuthentication_TargetRef)(nil),
	}
	type x struct{}
