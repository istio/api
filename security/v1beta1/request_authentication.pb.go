...
func file_security_v1beta1_request_authentication_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_security_v1beta1_request_authentication_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_security_v1beta1_request_authentication_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_security_v1beta1_request_authentication_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_security_v1beta1_request_authentication_proto_msgTypes[3].Exporter = func(v any, i int) any {
