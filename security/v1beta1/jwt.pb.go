...
type JWTRule struct {
	...
	ForwardPayloadToHeader string   `protobuf:"bytes,8,opt,name=forward_payload_to_header,json=forwardPayloadToHeader,proto3" json:"forward_payload_to_header,omitempty"`
...
func (m *JWTRule) GetForwardPayloadToHeader() string {
	if m != nil {
		return m.ForwardPayloadToHeader
	}
	return ""
}
...
var fileDescriptor_163ab6fd32fb6b15 = []byte{
	...
	,
}
...
func (m *JWTRule) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ForwardPayloadToHeader) > 0 {
		i -= len(m.ForwardPayloadToHeader)
		copy(dAtA[i:], m.ForwardPayloadToHeader)
		i = encodeVarintJwt(dAtA, i, uint64(len(m.ForwardPayloadToHeader)))
		i--
		dAtA[i] = 0x42
	}
...
func (m *JWTRule) Size() (n int) {
	...
	l = len(m.ForwardPayloadToHeader)
	if l > 0 {
		n += 1 + l + sovJwt(uint64(l))
	}
	l = len(m.Jwks)
...
func (m *JWTRule) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ForwardPayloadToHeader", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ForwardPayloadToHeader = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
