...
type JWTRule_FailureMode int32

const (
	// The requirement is satisfied if JWT is missing, but failed if JWT is presented but invalid.
	// This is the default behavior.
	JWTRule_PERMISSIVE JWTRule_FailureMode = 0
	// The requirement is always satisfied even if JWT is missing or the JWT verification fails.
	JWTRule_IGNORE JWTRule_FailureMode = 1
	// The requirement is satisfied only if JWT is presented and verification successful.
	JWTRule_STRICT JWTRule_FailureMode = 2
)

// Enum value maps for JWTRule_FailureMode.
var (
	JWTRule_FailureMode_name = map[int32]string{
		0: "PERMISSIVE",
		1: "IGNORE",
		2: "STRICT",
	}
	JWTRule_FailureMode_value = map[string]int32{
		"PERMISSIVE": 0,
		"IGNORE":     1,
		"STRICT":     2,
	}
...
func (x JWTRule_FailureMode) Enum() *JWTRule_FailureMode {
	p := new(JWTRule_FailureMode)
	*p = x
	return p
}

func (x JWTRule_FailureMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (JWTRule_FailureMode) Descriptor() protoreflect.EnumDescriptor {
	return file_security_v1_jwt_proto_enumTypes[0].Descriptor()
}

func (JWTRule_FailureMode) Type() protoreflect.EnumType {
	return &file_security_v1_jwt_proto_enumTypes[0]
}

func (x JWTRule_FailureMode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use JWTRule_FailureMode.Descriptor instead.
func (JWTRule_FailureMode) EnumDescriptor() ([]byte, []int) {
	return file_security_v1_jwt_proto_rawDescGZIP(), []int{0, 0}
}
...
type JWTRule struct {
	...
	FailureMode JWTRule_FailureMode `protobuf:"varint,14,opt,name=failure_mode,json=failureMode,proto3,enum=istio.security.v1.JWTRule_FailureMode" json:"failure_mode,omitempty"`
}
...
func (x *JWTRule) GetFailureMode() JWTRule_FailureMode {
	if x != nil {
		return x.FailureMode
	}
	return JWTRule_PERMISSIVE
}
...
var file_security_v1_jwt_proto_rawDesc = []byte{
	...
	0x61, 0x76, 0x69, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf7, 0x04, 0x0a, 0x07,
	...
	,
	...
	0x63, 0x6c, 0x61, 0x69, 0x6d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x63, 0x6c, 0x61,
	0x69, 0x6d, 0x42, 0x1a, 0x5a, 0x18, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x69, 0x6f, 0x2f, 0x61,
...
var file_security_v1_jwt_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_security_v1_jwt_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_security_v1_jwt_proto_goTypes = []interface{}{
	(JWTRule_FailureMode)(0),  // 0: istio.security.v1.JWTRule.FailureMode
...
var file_security_v1_jwt_proto_depIdxs = []int32{
	2, // 0: istio.security.v1.JWTRule.from_headers:type_name -> istio.security.v1.JWTHeader
	3, // 1: istio.security.v1.JWTRule.output_claim_to_headers:type_name -> istio.security.v1.ClaimToHeader
	4, // 2: istio.security.v1.JWTRule.timeout:type_name -> google.protobuf.Duration
	0, // 3: istio.security.v1.JWTRule.failure_mode:type_name -> istio.security.v1.JWTRule.FailureMode
...
func file_security_v1_jwt_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_security_v1_jwt_proto_enumTypes,
