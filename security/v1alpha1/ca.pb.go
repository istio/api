...
type IstioCertificateResponse struct {
	...
	RootCert      *Roots `protobuf:"bytes,2,opt,name=root_cert,json=rootCert,proto3" json:"root_cert,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *IstioCertificateResponse) GetRootCert() *Roots {
	if x != nil {
		return x.RootCert
	}
	return nil
...
type Roots struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CaCert        []string               `protobuf:"bytes,1,rep,name=ca_cert,json=caCert,proto3" json:"ca_cert,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Roots) Reset() {
	*x = Roots{}
	mi := &file_security_v1alpha1_ca_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Roots) Descriptor() ([]byte, []int) {
	return file_security_v1alpha1_ca_proto_rawDescGZIP(), []int{2}
}

func (x *Roots) GetCaCert() []string {
	if x != nil {
		return x.CaCert
	}
	return nil
...
var file_security_v1alpha1_ca_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_security_v1alpha1_ca_proto_goTypes = []any{
	...
	(*Roots)(nil),                    // 2: istio.v1.auth.Roots
	(*_struct.Struct)(nil),           // 3: google.protobuf.Struct
}
var file_security_v1alpha1_ca_proto_depIdxs = []int32{
	3, // 0: istio.v1.auth.IstioCertificateRequest.metadata:type_name -> google.protobuf.Struct
	2, // 1: istio.v1.auth.IstioCertificateResponse.root_cert:type_name -> istio.v1.auth.Roots
	0, // 2: istio.v1.auth.IstioCertificateService.CreateCertificate:input_type -> istio.v1.auth.IstioCertificateRequest
