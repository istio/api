...
// DeepCopyInto supports using Roots within kubernetes types, where deepcopy-gen is used.
func (in *Roots) DeepCopyInto(out *Roots) {
	p := proto.Clone(in).(*Roots)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Roots. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new Roots. Required by controller-gen.
func (in *Roots) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
