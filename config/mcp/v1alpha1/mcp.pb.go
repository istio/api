...
type Client struct {
	...
	// Opaque metadata extending the client identifier. The client will
	...
	// This is motivated by informing a management server during canary
	// which version of the client is being tested in a heterogeneous
	// fleet. This will be set by the client in management server RPCs.
...
func (m *Client) GetBuildVersion() string {
	if m != nil {
...
func (m *Client) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.BuildVersion) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintMcp(dAtA, i, uint64(len(m.BuildVersion)))
...
var fileDescriptorMcp = []byte{
	...
	,
}
