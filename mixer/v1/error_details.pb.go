...
// source: mixer/v1/error_details.proto
// DO NOT EDIT!
...
func init() {
	proto.RegisterType((*RetryInfo)(nil), "istio.mixer.v1.RetryInfo")
	proto.RegisterType((*DebugInfo)(nil), "istio.mixer.v1.DebugInfo")
	proto.RegisterType((*QuotaFailure)(nil), "istio.mixer.v1.QuotaFailure")
	proto.RegisterType((*QuotaFailure_Violation)(nil), "istio.mixer.v1.QuotaFailure.Violation")
	proto.RegisterType((*PreconditionFailure)(nil), "istio.mixer.v1.PreconditionFailure")
	proto.RegisterType((*PreconditionFailure_Violation)(nil), "istio.mixer.v1.PreconditionFailure.Violation")
	proto.RegisterType((*BadRequest)(nil), "istio.mixer.v1.BadRequest")
	proto.RegisterType((*BadRequest_FieldViolation)(nil), "istio.mixer.v1.BadRequest.FieldViolation")
	proto.RegisterType((*RequestInfo)(nil), "istio.mixer.v1.RequestInfo")
	proto.RegisterType((*ResourceInfo)(nil), "istio.mixer.v1.ResourceInfo")
	proto.RegisterType((*Help)(nil), "istio.mixer.v1.Help")
	proto.RegisterType((*Help_Link)(nil), "istio.mixer.v1.Help.Link")
	proto.RegisterType((*LocalizedMessage)(nil), "istio.mixer.v1.LocalizedMessage")
}
...
func (this *RetryInfo) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&istio_mixer_v1.RetryInfo{")
...
func (this *DebugInfo) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&istio_mixer_v1.DebugInfo{")
...
func (this *QuotaFailure) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&istio_mixer_v1.QuotaFailure{")
...
func (this *QuotaFailure_Violation) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&istio_mixer_v1.QuotaFailure_Violation{")
...
func (this *PreconditionFailure) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&istio_mixer_v1.PreconditionFailure{")
	if this.Violations != nil {
		s = append(s, "Violations: "+fmt.Sprintf("%#v", this.Violations)+",\n")
	}
	s = append(s, "}")
...
func (this *PreconditionFailure_Violation) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&istio_mixer_v1.PreconditionFailure_Violation{")
...
func (this *BadRequest) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&istio_mixer_v1.BadRequest{")
...
func (this *BadRequest_FieldViolation) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&istio_mixer_v1.BadRequest_FieldViolation{")
...
func (this *RequestInfo) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&istio_mixer_v1.RequestInfo{")
...
func (this *ResourceInfo) GoString() string {
	...
	s := make([]string, 0, 8)
	s = append(s, "&istio_mixer_v1.ResourceInfo{")
...
func (this *Help) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&istio_mixer_v1.Help{")
	if this.Links != nil {
...
func (this *Help_Link) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&istio_mixer_v1.Help_Link{")
	s = append(s, "Description: "+fmt.Sprintf("%#v", this.Description)+",\n")
...
func (this *LocalizedMessage) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&istio_mixer_v1.LocalizedMessage{")
...
func init() { proto.RegisterFile("mixer/v1/error_details.proto", fileDescriptorErrorDetails) }
...
var fileDescriptorErrorDetails = []byte{
	...
	,
}
