...
type CheckResponse_PreconditionResult struct {
	...
	// An optional directive, used to override the default route action
	// when all pre-conditions are satisfied.
	Directive *Directive `protobuf:"bytes,6,opt,name=directive" json:"directive,omitempty"`
}
...
func (*Directive) Descriptor() ([]byte, []int) { return fileDescriptorCheck, []int{4} }
...
func init() {
	...
	proto.RegisterType((*Directive)(nil), "istio.mixer.v1.Directive")
...
func (m *Directive) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *Directive) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (this *CheckResponse_PreconditionResult) String() string {
	...
	s := strings.Join([]string{`&CheckResponse_PreconditionResult{`,
		...
		`Directive:` + strings.Replace(fmt.Sprintf("%v", this.Directive), "Directive", "Directive", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *Directive) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Directive{`,
...
func (m *Directive) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Directive: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Directive: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorCheck = []byte{
	...
	,
}
