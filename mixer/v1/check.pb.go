...
type CheckResponse_PreconditionResult struct {
	...
	AuditDirective *AuditDirective `protobuf:"bytes,7,opt,name=audit_directive,json=auditDirective" json:"audit_directive,omitempty"`
}
...
type AuditDirective struct {
	...
	Level istio_audit_v1alpha1.AuditLevel `protobuf:"varint,1,opt,name=level,proto3,enum=istio.audit.v1alpha1.AuditLevel" json:"level,omitempty"`
}

func (m *AuditDirective) Reset()                    { *m = AuditDirective{} }
func (*AuditDirective) ProtoMessage()               {}
func (*AuditDirective) Descriptor() ([]byte, []int) { return fileDescriptorCheck, []int{5} }
...
func init() {
	...
	proto.RegisterType((*AuditDirective)(nil), "istio.mixer.v1.AuditDirective")
...
func (m *AuditDirective) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Level != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintCheck(dAtA, i, uint64(m.Level))
	}
	return i, nil
}
...
func (this *CheckResponse_PreconditionResult) String() string {
	...
	s := strings.Join([]string{`&CheckResponse_PreconditionResult{`,
		...
		`AuditDirective:` + strings.Replace(fmt.Sprintf("%v", this.AuditDirective), "AuditDirective", "AuditDirective", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *AuditDirective) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AuditDirective{`,
...
func (m *CheckResponse_PreconditionResult) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.AuditDirective == nil {
				m.AuditDirective = &AuditDirective{}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Level |= (istio_audit_v1alpha1.AuditLevel(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorCheck = []byte{
	...
	,
}
