...
type TransportConfig struct {
	...
	// includes the "source.ip" and "source.uid" attributes.
	ControlForwardAttributes *istio_mixer_v1.Attributes `protobuf:"bytes,8,opt,name=control_forward_attributes,json=controlForwardAttributes" json:"control_forward_attributes,omitempty"`
}
...
func (m *TransportConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ControlForwardAttributes != nil {
		dAtA[i] = 0x42
		i++
		i = encodeVarintClientConfig(dAtA, i, uint64(m.ControlForwardAttributes.Size()))
		n5, err := m.ControlForwardAttributes.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *TransportConfig) Size() (n int) {
	...
	if m.ControlForwardAttributes != nil {
		l = m.ControlForwardAttributes.Size()
		n += 1 + l + sovClientConfig(uint64(l))
	}
	return n
}
...
func (this *TransportConfig) String() string {
	...
	s := strings.Join([]string{`&TransportConfig{`,
		...
		`ControlForwardAttributes:` + strings.Replace(fmt.Sprintf("%v", this.ControlForwardAttributes), "Attributes", "istio_mixer_v1.Attributes", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *TransportConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ControlForwardAttributes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ControlForwardAttributes == nil {
				m.ControlForwardAttributes = &istio_mixer_v1.Attributes{}
			}
			if err := m.ControlForwardAttributes.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
