...
func (m *ServiceConfig) GetMixerAttributes() *v1.Attributes {
	if m != nil {
...
func (m *ServiceConfig) GetForwardAttributes() *v1.Attributes {
	if m != nil {
...
func (m *TransportConfig) GetAttributesForMixerProxy() *v1.Attributes {
	if m != nil {
...
func (m *HttpClientConfig) GetMixerAttributes() *v1.Attributes {
	if m != nil {
		return m.MixerAttributes
	}
	return nil
...
func (m *HttpClientConfig) GetForwardAttributes() *v1.Attributes {
	if m != nil {
		return m.ForwardAttributes
	}
	return nil
...
func (m *TcpClientConfig) GetMixerAttributes() *v1.Attributes {
	if m != nil {
		return m.MixerAttributes
	}
	return nil
