...
// DeepCopyInto supports using Telemetry_ReportingInterval within kubernetes types, where deepcopy-gen is used.
func (in *Telemetry_ReportingInterval) DeepCopyInto(out *Telemetry_ReportingInterval) {
	p := proto.Clone(in).(*Telemetry_ReportingInterval)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Telemetry_ReportingInterval. Required by controller-gen.
func (in *Telemetry_ReportingInterval) DeepCopy() *Telemetry_ReportingInterval {
	if in == nil {
		return nil
	}
	out := new(Telemetry_ReportingInterval)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new Telemetry_ReportingInterval. Required by controller-gen.
func (in *Telemetry_ReportingInterval) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
