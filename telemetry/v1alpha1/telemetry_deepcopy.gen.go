...
// DeepCopyInto supports using MetricDefinition within kubernetes types, where deepcopy-gen is used.
func (in *MetricDefinition) DeepCopyInto(out *MetricDefinition) {
	p := proto.Clone(in).(*MetricDefinition)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricDefinition. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new MetricDefinition. Required by controller-gen.
func (in *MetricDefinition) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
