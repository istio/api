...
// DeepCopyInto supports using AccessLogging_LogOption within kubernetes types, where deepcopy-gen is used.
func (in *AccessLogging_LogOption) DeepCopyInto(out *AccessLogging_LogOption) {
	p := proto.Clone(in).(*AccessLogging_LogOption)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AccessLogging_LogOption. Required by controller-gen.
func (in *AccessLogging_LogOption) DeepCopy() *AccessLogging_LogOption {
	if in == nil {
		return nil
	}
	out := new(AccessLogging_LogOption)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new AccessLogging_LogOption. Required by controller-gen.
func (in *AccessLogging_LogOption) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using AccessLogging_LogOption_EnvoyFileAccessLogOption within kubernetes types, where deepcopy-gen is used.
func (in *AccessLogging_LogOption_EnvoyFileAccessLogOption) DeepCopyInto(out *AccessLogging_LogOption_EnvoyFileAccessLogOption) {
	p := proto.Clone(in).(*AccessLogging_LogOption_EnvoyFileAccessLogOption)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AccessLogging_LogOption_EnvoyFileAccessLogOption. Required by controller-gen.
func (in *AccessLogging_LogOption_EnvoyFileAccessLogOption) DeepCopy() *AccessLogging_LogOption_EnvoyFileAccessLogOption {
	if in == nil {
		return nil
	}
	out := new(AccessLogging_LogOption_EnvoyFileAccessLogOption)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new AccessLogging_LogOption_EnvoyFileAccessLogOption. Required by controller-gen.
func (in *AccessLogging_LogOption_EnvoyFileAccessLogOption) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption within kubernetes types, where deepcopy-gen is used.
func (in *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) DeepCopyInto(out *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) {
	p := proto.Clone(in).(*AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption. Required by controller-gen.
func (in *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) DeepCopy() *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption {
	if in == nil {
		return nil
	}
	out := new(AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption. Required by controller-gen.
func (in *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
