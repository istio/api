...
type Tracing struct {
	...
	SkipIstioTags bool `protobuf:"varint,8,opt,name=skip_istio_tags,json=skipIstioTags,proto3" json:"skip_istio_tags,omitempty"`
}
...
func (x *Tracing) GetSkipIstioTags() bool {
	if x != nil {
		return x.SkipIstioTags
	}
	return false
}
...
var file_telemetry_v1alpha1_telemetry_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x73, 0x4c, 0x6f, 0x67, 0x67, 0x69, 0x6e, 0x67, 0x22, 0xa1, 0x09, 0x0a, 0x07, 0x54,
	...
	0x61, 0x63, 0x65, 0x53, 0x61, 0x6d, 0x70, 0x6c, 0x69, 0x6e, 0x67, 0x12, 0x26, 0x0a, 0x0f, 0x73,
	0x6b, 0x69, 0x70, 0x5f, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x5f, 0x74, 0x61, 0x67, 0x73, 0x18, 0x08,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x73, 0x6b, 0x69, 0x70, 0x49, 0x73, 0x74, 0x69, 0x6f, 0x54,
...
func file_telemetry_v1alpha1_telemetry_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_telemetry_v1alpha1_telemetry_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_telemetry_v1alpha1_telemetry_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_telemetry_v1alpha1_telemetry_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_telemetry_v1alpha1_telemetry_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_telemetry_v1alpha1_telemetry_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_telemetry_v1alpha1_telemetry_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_telemetry_v1alpha1_telemetry_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_telemetry_v1alpha1_telemetry_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_telemetry_v1alpha1_telemetry_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_telemetry_v1alpha1_telemetry_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_telemetry_v1alpha1_telemetry_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_telemetry_v1alpha1_telemetry_proto_msgTypes[15].Exporter = func(v any, i int) any {
		...
		file_telemetry_v1alpha1_telemetry_proto_msgTypes[16].Exporter = func(v any, i int) any {
