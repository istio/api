...
func (MetricsOverrides_TagOverride_Operation) Descriptor() protoreflect.EnumDescriptor {
	return file_telemetry_v1alpha1_telemetry_proto_enumTypes[3].Descriptor()
}

func (MetricsOverrides_TagOverride_Operation) Type() protoreflect.EnumType {
	return &file_telemetry_v1alpha1_telemetry_proto_enumTypes[3]
}
...
type Metrics struct {
	...
	// Optional. List of definitions of metrics to be generated.
	// $hide_from_docs
	Definitions []*MetricDefinition `protobuf:"bytes,4,rep,name=definitions,proto3" json:"definitions,omitempty"`
}
...
func (x *Metrics) GetDefinitions() []*MetricDefinition {
	if x != nil {
...
type MetricDefinition struct {
	...
	// Name of the metric.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// Metric value expresion.
	Value string `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"`
	// Type of the metric.
	Type MetricType `protobuf:"varint,4,opt,name=type,proto3,enum=istio.telemetry.v1alpha1.MetricType" json:"type,omitempty"`
}
...
func (*MetricDefinition) Descriptor() ([]byte, []int) {
	return file_telemetry_v1alpha1_telemetry_proto_rawDescGZIP(), []int{7}
}
...
var file_telemetry_v1alpha1_telemetry_proto_rawDesc = []byte{
	...
	0x41, 0x01, 0x02, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0xb0, 0x02, 0x0a, 0x07, 0x4d, 0x65,
	...
	0x6f, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x12, 0x4c,
	...
	0x0b, 0x64, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xdd, 0x03, 0x0a,
	...
	,
	...
	0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x53, 0x45, 0x52, 0x56, 0x45, 0x52, 0x10, 0x02, 0x2a, 0x33,
	...
	0x4d, 0x10, 0x02, 0x42, 0x21, 0x5a, 0x1f, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x69, 0x6f, 0x2f,
	0x61, 0x70, 0x69, 0x2f, 0x74, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x2f, 0x76, 0x31,
...
var file_telemetry_v1alpha1_telemetry_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_telemetry_v1alpha1_telemetry_proto_goTypes = []interface{}{
	...
	(MetricType)(0),                             // 1: istio.telemetry.v1alpha1.MetricType
	(MetricSelector_IstioMetric)(0),             // 2: istio.telemetry.v1alpha1.MetricSelector.IstioMetric
	(MetricsOverrides_TagOverride_Operation)(0), // 3: istio.telemetry.v1alpha1.MetricsOverrides.TagOverride.Operation
	(*Telemetry)(nil),                           // 4: istio.telemetry.v1alpha1.Telemetry
	(*Tracing)(nil),                             // 5: istio.telemetry.v1alpha1.Tracing
	(*ProviderRef)(nil),                         // 6: istio.telemetry.v1alpha1.ProviderRef
	(*Metrics)(nil),                             // 7: istio.telemetry.v1alpha1.Metrics
	(*MetricSelector)(nil),                      // 8: istio.telemetry.v1alpha1.MetricSelector
	(*MetricsOverrides)(nil),                    // 9: istio.telemetry.v1alpha1.MetricsOverrides
	(*AccessLogging)(nil),                       // 10: istio.telemetry.v1alpha1.AccessLogging
	(*MetricDefinition)(nil),                    // 11: istio.telemetry.v1alpha1.MetricDefinition
	(*Tracing_TracingSelector)(nil),             // 12: istio.telemetry.v1alpha1.Tracing.TracingSelector
	(*Tracing_CustomTag)(nil),                   // 13: istio.telemetry.v1alpha1.Tracing.CustomTag
	(*Tracing_Literal)(nil),                     // 14: istio.telemetry.v1alpha1.Tracing.Literal
	(*Tracing_Environment)(nil),                 // 15: istio.telemetry.v1alpha1.Tracing.Environment
	(*Tracing_RequestHeader)(nil),               // 16: istio.telemetry.v1alpha1.Tracing.RequestHeader
	nil,                                         // 17: istio.telemetry.v1alpha1.Tracing.CustomTagsEntry
	(*MetricsOverrides_TagOverride)(nil),        // 18: istio.telemetry.v1alpha1.MetricsOverrides.TagOverride
	nil,                                         // 19: istio.telemetry.v1alpha1.MetricsOverrides.TagOverridesEntry
	(*AccessLogging_LogSelector)(nil),           // 20: istio.telemetry.v1alpha1.AccessLogging.LogSelector
	(*AccessLogging_Filter)(nil),                // 21: istio.telemetry.v1alpha1.AccessLogging.Filter
...
var file_telemetry_v1alpha1_telemetry_proto_depIdxs = []int32{
	22, // 0: istio.telemetry.v1alpha1.Telemetry.selector:type_name -> istio.type.v1beta1.WorkloadSelector
	5,  // 1: istio.telemetry.v1alpha1.Telemetry.tracing:type_name -> istio.telemetry.v1alpha1.Tracing
	7,  // 2: istio.telemetry.v1alpha1.Telemetry.metrics:type_name -> istio.telemetry.v1alpha1.Metrics
	10, // 3: istio.telemetry.v1alpha1.Telemetry.access_logging:type_name -> istio.telemetry.v1alpha1.AccessLogging
	12, // 4: istio.telemetry.v1alpha1.Tracing.match:type_name -> istio.telemetry.v1alpha1.Tracing.TracingSelector
	6,  // 5: istio.telemetry.v1alpha1.Tracing.providers:type_name -> istio.telemetry.v1alpha1.ProviderRef
	23, // 6: istio.telemetry.v1alpha1.Tracing.random_sampling_percentage:type_name -> google.protobuf.DoubleValue
	24, // 7: istio.telemetry.v1alpha1.Tracing.disable_span_reporting:type_name -> google.protobuf.BoolValue
	17, // 8: istio.telemetry.v1alpha1.Tracing.custom_tags:type_name -> istio.telemetry.v1alpha1.Tracing.CustomTagsEntry
	24, // 9: istio.telemetry.v1alpha1.Tracing.use_request_id_for_trace_sampling:type_name -> google.protobuf.BoolValue
	6,  // 10: istio.telemetry.v1alpha1.Metrics.providers:type_name -> istio.telemetry.v1alpha1.ProviderRef
	9,  // 11: istio.telemetry.v1alpha1.Metrics.overrides:type_name -> istio.telemetry.v1alpha1.MetricsOverrides
	25, // 12: istio.telemetry.v1alpha1.Metrics.reporting_interval:type_name -> google.protobuf.Duration
	11, // 13: istio.telemetry.v1alpha1.Metrics.definitions:type_name -> istio.telemetry.v1alpha1.MetricDefinition
	2,  // 14: istio.telemetry.v1alpha1.MetricSelector.metric:type_name -> istio.telemetry.v1alpha1.MetricSelector.IstioMetric
	0,  // 15: istio.telemetry.v1alpha1.MetricSelector.mode:type_name -> istio.telemetry.v1alpha1.WorkloadMode
	8,  // 16: istio.telemetry.v1alpha1.MetricsOverrides.match:type_name -> istio.telemetry.v1alpha1.MetricSelector
	24, // 17: istio.telemetry.v1alpha1.MetricsOverrides.disabled:type_name -> google.protobuf.BoolValue
	19, // 18: istio.telemetry.v1alpha1.MetricsOverrides.tag_overrides:type_name -> istio.telemetry.v1alpha1.MetricsOverrides.TagOverridesEntry
	20, // 19: istio.telemetry.v1alpha1.AccessLogging.match:type_name -> istio.telemetry.v1alpha1.AccessLogging.LogSelector
	6,  // 20: istio.telemetry.v1alpha1.AccessLogging.providers:type_name -> istio.telemetry.v1alpha1.ProviderRef
	24, // 21: istio.telemetry.v1alpha1.AccessLogging.disabled:type_name -> google.protobuf.BoolValue
	21, // 22: istio.telemetry.v1alpha1.AccessLogging.filter:type_name -> istio.telemetry.v1alpha1.AccessLogging.Filter
	1,  // 23: istio.telemetry.v1alpha1.MetricDefinition.type:type_name -> istio.telemetry.v1alpha1.MetricType
	0,  // 24: istio.telemetry.v1alpha1.Tracing.TracingSelector.mode:type_name -> istio.telemetry.v1alpha1.WorkloadMode
	14, // 25: istio.telemetry.v1alpha1.Tracing.CustomTag.literal:type_name -> istio.telemetry.v1alpha1.Tracing.Literal
	15, // 26: istio.telemetry.v1alpha1.Tracing.CustomTag.environment:type_name -> istio.telemetry.v1alpha1.Tracing.Environment
	16, // 27: istio.telemetry.v1alpha1.Tracing.CustomTag.header:type_name -> istio.telemetry.v1alpha1.Tracing.RequestHeader
	13, // 28: istio.telemetry.v1alpha1.Tracing.CustomTagsEntry.value:type_name -> istio.telemetry.v1alpha1.Tracing.CustomTag
	3,  // 29: istio.telemetry.v1alpha1.MetricsOverrides.TagOverride.operation:type_name -> istio.telemetry.v1alpha1.MetricsOverrides.TagOverride.Operation
	18, // 30: istio.telemetry.v1alpha1.MetricsOverrides.TagOverridesEntry.value:type_name -> istio.telemetry.v1alpha1.MetricsOverrides.TagOverride
