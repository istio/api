...
type AccessLogging struct {
	...
	Option               *AccessLogging_LogOption `protobuf:"bytes,4,opt,name=option,proto3" json:"option,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
func (m *AccessLogging) GetOption() *AccessLogging_LogOption {
	if m != nil {
		return m.Option
	}
	return nil
...
type AccessLogging_LogOption struct {
	// Types that are valid to be assigned to Option:
	//	*AccessLogging_LogOption_EnvoyFileAccessLog
	//	*AccessLogging_LogOption_EnvoyHttpGrpcLog
	Option               isAccessLogging_LogOption_Option `protobuf_oneof:"option"`
	XXX_NoUnkeyedLiteral struct{}                         `json:"-"`
	XXX_unrecognized     []byte                           `json:"-"`
	XXX_sizecache        int32                            `json:"-"`
}

func (m *AccessLogging_LogOption) Reset()         { *m = AccessLogging_LogOption{} }
func (m *AccessLogging_LogOption) String() string { return proto.CompactTextString(m) }
func (*AccessLogging_LogOption) ProtoMessage()    {}
func (*AccessLogging_LogOption) Descriptor() ([]byte, []int) {
	return fileDescriptor_991c84745e2b7651, []int{6, 1}
}
func (m *AccessLogging_LogOption) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AccessLogging_LogOption) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AccessLogging_LogOption.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AccessLogging_LogOption) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AccessLogging_LogOption.Merge(m, src)
}
func (m *AccessLogging_LogOption) XXX_Size() int {
	return m.Size()
}
func (m *AccessLogging_LogOption) XXX_DiscardUnknown() {
	xxx_messageInfo_AccessLogging_LogOption.DiscardUnknown(m)
}

var xxx_messageInfo_AccessLogging_LogOption proto.InternalMessageInfo

type isAccessLogging_LogOption_Option interface {
	isAccessLogging_LogOption_Option()
	MarshalTo([]byte) (int, error)
	Size() int
}

type AccessLogging_LogOption_EnvoyFileAccessLog struct {
	EnvoyFileAccessLog *AccessLogging_LogOption_EnvoyFileAccessLogOption `protobuf:"bytes,1,opt,name=envoy_file_access_log,json=envoyFileAccessLog,proto3,oneof" json:"envoy_file_access_log,omitempty"`
}
type AccessLogging_LogOption_EnvoyHttpGrpcLog struct {
	EnvoyHttpGrpcLog *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption `protobuf:"bytes,2,opt,name=envoy_http_grpc_log,json=envoyHttpGrpcLog,proto3,oneof" json:"envoy_http_grpc_log,omitempty"`
}

func (*AccessLogging_LogOption_EnvoyFileAccessLog) isAccessLogging_LogOption_Option() {}
func (*AccessLogging_LogOption_EnvoyHttpGrpcLog) isAccessLogging_LogOption_Option()   {}

func (m *AccessLogging_LogOption) GetOption() isAccessLogging_LogOption_Option {
	if m != nil {
		return m.Option
	}
	return nil
...
func (m *AccessLogging_LogOption) GetEnvoyFileAccessLog() *AccessLogging_LogOption_EnvoyFileAccessLogOption {
	if x, ok := m.GetOption().(*AccessLogging_LogOption_EnvoyFileAccessLog); ok {
		return x.EnvoyFileAccessLog
	}
	return nil
}

func (m *AccessLogging_LogOption) GetEnvoyHttpGrpcLog() *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption {
	if x, ok := m.GetOption().(*AccessLogging_LogOption_EnvoyHttpGrpcLog); ok {
		return x.EnvoyHttpGrpcLog
	}
	return nil
}

// XXX_OneofWrappers is for the internal use of the proto package.
func (*AccessLogging_LogOption) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*AccessLogging_LogOption_EnvoyFileAccessLog)(nil),
		(*AccessLogging_LogOption_EnvoyHttpGrpcLog)(nil),
	}
}

type AccessLogging_LogOption_EnvoyFileAccessLogOption struct {
...
func (m *AccessLogging_LogOption_EnvoyFileAccessLogOption) Reset() {
	*m = AccessLogging_LogOption_EnvoyFileAccessLogOption{}
}
func (m *AccessLogging_LogOption_EnvoyFileAccessLogOption) String() string {
	return proto.CompactTextString(m)
}
func (*AccessLogging_LogOption_EnvoyFileAccessLogOption) ProtoMessage() {}
func (*AccessLogging_LogOption_EnvoyFileAccessLogOption) Descriptor() ([]byte, []int) {
	return fileDescriptor_991c84745e2b7651, []int{6, 1, 0}
}
func (m *AccessLogging_LogOption_EnvoyFileAccessLogOption) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AccessLogging_LogOption_EnvoyFileAccessLogOption) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AccessLogging_LogOption_EnvoyFileAccessLogOption.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AccessLogging_LogOption_EnvoyFileAccessLogOption) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AccessLogging_LogOption_EnvoyFileAccessLogOption.Merge(m, src)
}
func (m *AccessLogging_LogOption_EnvoyFileAccessLogOption) XXX_Size() int {
	return m.Size()
}
func (m *AccessLogging_LogOption_EnvoyFileAccessLogOption) XXX_DiscardUnknown() {
	xxx_messageInfo_AccessLogging_LogOption_EnvoyFileAccessLogOption.DiscardUnknown(m)
}

var xxx_messageInfo_AccessLogging_LogOption_EnvoyFileAccessLogOption proto.InternalMessageInfo

func (m *AccessLogging_LogOption_EnvoyFileAccessLogOption) GetFormat() string {
	if m != nil {
		return m.Format
	}
	return ""
...
type AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption struct {
...
func (m *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) Reset() {
	*m = AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption{}
}
func (m *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) String() string {
	return proto.CompactTextString(m)
}
func (*AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) ProtoMessage() {}
func (*AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) Descriptor() ([]byte, []int) {
	return fileDescriptor_991c84745e2b7651, []int{6, 1, 1}
}
func (m *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption.Merge(m, src)
}
func (m *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) XXX_Size() int {
	return m.Size()
}
func (m *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) XXX_DiscardUnknown() {
	xxx_messageInfo_AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption.DiscardUnknown(m)
}

var xxx_messageInfo_AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption proto.InternalMessageInfo

func (m *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) GetAdditionalRequestHeadersToLog() []string {
	if m != nil {
...
func (m *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) GetAdditionalResponseHeadersToLog() []string {
	if m != nil {
...
func (m *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) GetAdditionalResponseTrailersToLog() []string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*AccessLogging_LogOption)(nil), "istio.telemetry.v1alpha1.AccessLogging.LogOption")
	proto.RegisterType((*AccessLogging_LogOption_EnvoyFileAccessLogOption)(nil), "istio.telemetry.v1alpha1.AccessLogging.LogOption.EnvoyFileAccessLogOption")
	proto.RegisterType((*AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption)(nil), "istio.telemetry.v1alpha1.AccessLogging.LogOption.EnvoyHttpGrpcV3LogOption")
}
...
var fileDescriptor_991c84745e2b7651 = []byte{
	...
	,
}
...
func (m *AccessLogging_LogOption) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AccessLogging_LogOption) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AccessLogging_LogOption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AccessLogging_LogOption_EnvoyFileAccessLog) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AccessLogging_LogOption_EnvoyFileAccessLog) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *AccessLogging_LogOption_EnvoyHttpGrpcLog) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AccessLogging_LogOption_EnvoyHttpGrpcLog) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.EnvoyHttpGrpcLog != nil {
		{
			size, err := m.EnvoyHttpGrpcLog.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *AccessLogging_LogOption_EnvoyFileAccessLogOption) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AccessLogging_LogOption_EnvoyFileAccessLogOption) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AccessLogging_LogOption_EnvoyFileAccessLogOption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.AdditionalResponseTrailersToLog) > 0 {
		for iNdEx := len(m.AdditionalResponseTrailersToLog) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintTelemetry(dAtA, i, uint64(len(m.AdditionalResponseTrailersToLog[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
	if len(m.AdditionalResponseHeadersToLog) > 0 {
		for iNdEx := len(m.AdditionalResponseHeadersToLog) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintTelemetry(dAtA, i, uint64(len(m.AdditionalResponseHeadersToLog[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	if len(m.AdditionalRequestHeadersToLog) > 0 {
		for iNdEx := len(m.AdditionalRequestHeadersToLog) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintTelemetry(dAtA, i, uint64(len(m.AdditionalRequestHeadersToLog[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *AccessLogging_LogOption) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AccessLogging_LogOption_EnvoyFileAccessLog) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AccessLogging_LogOption_EnvoyHttpGrpcLog) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.EnvoyHttpGrpcLog != nil {
		l = m.EnvoyHttpGrpcLog.Size()
		n += 1 + l + sovTelemetry(uint64(l))
	}
	return n
}
func (m *AccessLogging_LogOption_EnvoyFileAccessLogOption) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AccessLogging) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.Option == nil {
				m.Option = &AccessLogging_LogOption{}
			}
...
func (m *AccessLogging_LogOption) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LogOption: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LogOption: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			v := &AccessLogging_LogOption_EnvoyFileAccessLogOption{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Option = &AccessLogging_LogOption_EnvoyFileAccessLog{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnvoyHttpGrpcLog", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Option = &AccessLogging_LogOption_EnvoyHttpGrpcLog{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTelemetry(dAtA[iNdEx:])
...
func (m *AccessLogging_LogOption_EnvoyFileAccessLogOption) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EnvoyFileAccessLogOption: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EnvoyFileAccessLogOption: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AccessLogging_LogOption_EnvoyHttpGrpcV3LogOption) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EnvoyHttpGrpcV3LogOption: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EnvoyHttpGrpcV3LogOption: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
