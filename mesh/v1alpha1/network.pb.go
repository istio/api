...
type Network_NetworkEndpoints struct {
	...
	//	*Network_NetworkEndpoints_FromCluster
...
type Network_NetworkEndpoints_FromCluster struct {
	FromCluster string `protobuf:"bytes,3,opt,name=from_cluster,json=fromCluster,proto3,oneof"`
}
...
func (*Network_NetworkEndpoints_FromCluster) isNetwork_NetworkEndpoints_Ne()  {}
...
func (m *Network_NetworkEndpoints) GetFromCluster() string {
	if x, ok := m.GetNe().(*Network_NetworkEndpoints_FromCluster); ok {
...
func (*Network_NetworkEndpoints) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Network_NetworkEndpoints_FromCluster)(nil),
	}
}
...
var fileDescriptor_a15df2a96e10cd86 = []byte{
	...
	,
}
...
func (m *Network_NetworkEndpoints_FromCluster) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *Network_NetworkEndpoints_FromCluster) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.FromCluster)
	copy(dAtA[i:], m.FromCluster)
	i = encodeVarintNetwork(dAtA, i, uint64(len(m.FromCluster)))
	i--
	dAtA[i] = 0x1a
	return len(dAtA) - i, nil
}
...
func (m *Network_NetworkEndpoints_FromCluster) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Network_NetworkEndpoints) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Ne = &Network_NetworkEndpoints_FromCluster{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipNetwork(dAtA[iNdEx:])
