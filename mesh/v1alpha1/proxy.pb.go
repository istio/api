...
var ProxyConfig_TracingServiceName_name = map[int32]string{
	0: "APP_LABEL_AND_NAMESPACE",
	1: "CANONICAL_NAME_ONLY",
	2: "CANONICAL_NAME_AND_NAMESPACE",
}

var ProxyConfig_TracingServiceName_value = map[string]int32{
...
func (x ProxyConfig_TracingServiceName) String() string {
	return proto.EnumName(ProxyConfig_TracingServiceName_name, int32(x))
}
...
func (ProxyConfig_InboundInterceptionMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5efecd978cf3d28d, []int{4, 1}
}
...
type Tracing_OpenCensusAgent_ struct {
	OpenCensusAgent *Tracing_OpenCensusAgent `protobuf:"bytes,9,opt,name=open_census_agent,json=openCensusAgent,proto3,oneof" json:"open_census_agent,omitempty"`
}
...
type PrivateKeyProvider_Cryptomb struct {
	Cryptomb *PrivateKeyProvider_CryptoMb `protobuf:"bytes,2,opt,name=cryptomb,proto3,oneof" json:"cryptomb,omitempty"`
}
...
func (m *PrivateKeyProvider) GetCryptomb() *PrivateKeyProvider_CryptoMb {
	if x, ok := m.GetProvider().(*PrivateKeyProvider_Cryptomb); ok {
		return x.Cryptomb
	}
	return nil
}
...
type PrivateKeyProvider_CryptoMb struct {
	...
	PollDelay            *types.Duration `protobuf:"bytes,1,opt,name=poll_delay,json=pollDelay,proto3" json:"poll_delay,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}

func (m *PrivateKeyProvider_CryptoMb) Reset()         { *m = PrivateKeyProvider_CryptoMb{} }
func (m *PrivateKeyProvider_CryptoMb) String() string { return proto.CompactTextString(m) }
...
func (m *PrivateKeyProvider_CryptoMb) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PrivateKeyProvider_CryptoMb) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PrivateKeyProvider_CryptoMb.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PrivateKeyProvider_CryptoMb) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PrivateKeyProvider_CryptoMb.Merge(m, src)
}
func (m *PrivateKeyProvider_CryptoMb) XXX_Size() int {
	return m.Size()
}
func (m *PrivateKeyProvider_CryptoMb) XXX_DiscardUnknown() {
	xxx_messageInfo_PrivateKeyProvider_CryptoMb.DiscardUnknown(m)
}

var xxx_messageInfo_PrivateKeyProvider_CryptoMb proto.InternalMessageInfo

func (m *PrivateKeyProvider_CryptoMb) GetPollDelay() *types.Duration {
	if m != nil {
		return m.PollDelay
	}
	return nil
...
type ProxyConfig struct {
	...
	// If positive n, then n worker threads will be used.
	// Otherwise, defaults to 2 worker threads.
	...
	TerminationDrainDuration *types.Duration `protobuf:"bytes,29,opt,name=termination_drain_duration,json=terminationDrainDuration,proto3" json:"termination_drain_duration,omitempty"`
	...
	HoldApplicationUntilProxyStarts *types.BoolValue `protobuf:"bytes,33,opt,name=hold_application_until_proxy_starts,json=holdApplicationUntilProxyStarts,proto3" json:"hold_application_until_proxy_starts,omitempty"`
...
type ProxyConfig_ServiceCluster struct {
	ServiceCluster string `protobuf:"bytes,3,opt,name=service_cluster,json=serviceCluster,proto3,oneof" json:"service_cluster,omitempty"`
}
type ProxyConfig_TracingServiceName_ struct {
	TracingServiceName ProxyConfig_TracingServiceName `protobuf:"varint,36,opt,name=tracing_service_name,json=tracingServiceName,proto3,enum=istio.mesh.v1alpha1.ProxyConfig_TracingServiceName,oneof" json:"tracing_service_name,omitempty"`
}
...
func (m *ProxyConfig) GetServiceCluster() string {
	if x, ok := m.GetClusterName().(*ProxyConfig_ServiceCluster); ok {
		return x.ServiceCluster
	}
	return ""
}

func (m *ProxyConfig) GetTracingServiceName() ProxyConfig_TracingServiceName {
	if x, ok := m.GetClusterName().(*ProxyConfig_TracingServiceName_); ok {
...
func (m *ProxyConfig) GetImage() *v1beta1.ProxyImage {
	if m != nil {
		return m.Image
	}
	return nil
...
func (m *ProxyConfig) GetPrivateKeyProvider() *PrivateKeyProvider {
	if m != nil {
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*ProxyConfig) XXX_OneofWrappers() []interface{} {
	return []interface{}{
...
func init() {
	...
	proto.RegisterEnum("istio.mesh.v1alpha1.ProxyConfig_TracingServiceName", ProxyConfig_TracingServiceName_name, ProxyConfig_TracingServiceName_value)
	...
	proto.RegisterType((*PrivateKeyProvider)(nil), "istio.mesh.v1alpha1.PrivateKeyProvider")
	proto.RegisterType((*PrivateKeyProvider_CryptoMb)(nil), "istio.mesh.v1alpha1.PrivateKeyProvider.CryptoMb")
...
var fileDescriptor_5efecd978cf3d28d = []byte{
	...
	,
}
...
func (m *PrivateKeyProvider_Cryptomb) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PrivateKeyProvider_Cryptomb) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Cryptomb != nil {
		{
			size, err := m.Cryptomb.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *PrivateKeyProvider_CryptoMb) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PrivateKeyProvider_CryptoMb) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PollDelay != nil {
		{
			size, err := m.PollDelay.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ProxyConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ClusterName != nil {
		{
			size := m.ClusterName.Size()
			i -= size
			if _, err := m.ClusterName.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *ProxyConfig_ServiceCluster) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ProxyConfig_ServiceCluster) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *ProxyConfig_TracingServiceName_) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ProxyConfig_TracingServiceName_) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarintProxy(dAtA, i, uint64(m.TracingServiceName))
	i--
	dAtA[i] = 0x2
	i--
	dAtA[i] = 0xa0
...
func (m *PrivateKeyProvider_Cryptomb) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ProxyConfig_ServiceCluster) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ProxyConfig_TracingServiceName_) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 2 + sovProxy(uint64(m.TracingServiceName))
	return n
}
...
func (m *PrivateKeyProvider) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Cryptomb", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &PrivateKeyProvider_CryptoMb{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Provider = &PrivateKeyProvider_Cryptomb{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProxy(dAtA[iNdEx:])
...
func (m *PrivateKeyProvider_CryptoMb) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CryptoMb: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CryptoMb: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PollDelay", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PollDelay == nil {
				m.PollDelay = &types.Duration{}
			}
			if err := m.PollDelay.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ProxyConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.ClusterName = &ProxyConfig_ServiceCluster{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
		...
		case 36:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TracingServiceName", wireType)
			}
			var v ProxyConfig_TracingServiceName
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowProxy
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= ProxyConfig_TracingServiceName(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
			m.ClusterName = &ProxyConfig_TracingServiceName_{v}
		case 37:
			if wireType != 2 {
