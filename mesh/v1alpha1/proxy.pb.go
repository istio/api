...
type ProxyConfig struct {
	...
	// The PEM content of the root certificates used in workload-to-workload communication.
	RootCertPem          []string `protobuf:"bytes,34,rep,name=root_cert_pem,json=rootCertPem,proto3" json:"rootCertPem,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ProxyConfig) GetRootCertPem() []string {
	if m != nil {
...
var fileDescriptor_5efecd978cf3d28d = []byte{
	...
	,
}
...
func (m *ProxyConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RootCertPem) > 0 {
		for iNdEx := len(m.RootCertPem) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.RootCertPem[iNdEx])
			copy(dAtA[i:], m.RootCertPem[iNdEx])
			i = encodeVarintProxy(dAtA, i, uint64(len(m.RootCertPem[iNdEx])))
			i--
			dAtA[i] = 0x2
			i--
			dAtA[i] = 0x92
...
func (m *ProxyConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 34:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RootCertPem", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RootCertPem = append(m.RootCertPem, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProxy(dAtA[iNdEx:])
