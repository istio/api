...
type Tracing_OpenCensus_ struct {
	OpenCensus *Tracing_OpenCensus `protobuf:"bytes,9,opt,name=open_census,json=openCensus,proto3,oneof"`
}
...
func (*Tracing_OpenCensus_) isTracing_Tracer()  {}
...
func (m *Tracing) GetOpenCensus() *Tracing_OpenCensus {
	if x, ok := m.GetTracer().(*Tracing_OpenCensus_); ok {
		return x.OpenCensus
	}
	return nil
}
...
type Tracing_OpenCensus struct {
	// gRPC address for the OpenCensus Agent (e.g. dns://authority/host:port or unix:path).
	// See [gRPC naming docs](https://github.com/grpc/grpc/blob/master/doc/naming.md) for details.
	Address string `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
	// debug enables trace output to stdout
	// $hide_from_docs
	...
	// default is 200.
	// $hide_from_docs
	MaxNumberOfAttributes *types.Int64Value `protobuf:"bytes,3,opt,name=max_number_of_attributes,json=maxNumberOfAttributes,proto3" json:"maxNumberOfAttributes,omitempty"`
	// The global default max number of annotation events per span.
	// default is 200.
	// $hide_from_docs
	MaxNumberOfAnnotations *types.Int64Value `protobuf:"bytes,4,opt,name=max_number_of_annotations,json=maxNumberOfAnnotations,proto3" json:"maxNumberOfAnnotations,omitempty"`
	// The global default max number of message events per span.
	// default is 200.
	// $hide_from_docs
	MaxNumberOfMessageEvents *types.Int64Value `protobuf:"bytes,5,opt,name=max_number_of_message_events,json=maxNumberOfMessageEvents,proto3" json:"maxNumberOfMessageEvents,omitempty"`
	XXX_NoUnkeyedLiteral     struct{}          `json:"-"`
	XXX_unrecognized         []byte            `json:"-"`
	XXX_sizecache            int32             `json:"-"`
}
...
func (m *Tracing_OpenCensus) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *Tracing_OpenCensus) GetDebug() bool {
	if m != nil {
		return m.Debug
	}
	return false
...
func (m *Tracing_OpenCensus) GetMaxNumberOfAttributes() *types.Int64Value {
	if m != nil {
		return m.MaxNumberOfAttributes
	}
	return nil
...
func (m *Tracing_OpenCensus) GetMaxNumberOfAnnotations() *types.Int64Value {
	if m != nil {
		return m.MaxNumberOfAnnotations
	}
	return nil
...
func (m *Tracing_OpenCensus) GetMaxNumberOfMessageEvents() *types.Int64Value {
	if m != nil {
		return m.MaxNumberOfMessageEvents
	}
	return nil
...
var fileDescriptor_5efecd978cf3d28d = []byte{
	...
	,
}
...
func (m *Tracing_OpenCensus_) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *Tracing_OpenCensus_) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.OpenCensus != nil {
		{
...
func (m *Tracing_OpenCensus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Tracing_OpenCensus_) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Tracing) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			m.Tracer = &Tracing_OpenCensus_{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProxy(dAtA[iNdEx:])
