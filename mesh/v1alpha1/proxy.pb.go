...
func (m *ProxyConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.MetricsServiceAddress) > 0 {
		dAtA[i] = 0xa2
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintProxy(dAtA, i, uint64(len(m.MetricsServiceAddress)))
		i += copy(dAtA[i:], m.MetricsServiceAddress)
	}
	return i, nil
}
...
func (m *ProxyConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MetricsServiceAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MetricsServiceAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProxy(dAtA[iNdEx:])
...
var fileDescriptorProxy = []byte{
	...
	,
}
