...
type ProxyConfig struct {
	...
	// Prefix matcher for Envoy stats creation. To reduce memory and CPU
	// overhead from envoy stats system, istio-proxy by default only create and
	// expose a subset of envoy stats. This option is to include extra envoy stats
	// with prefix match.
	StatsInclusionPrefixes []string `protobuf:"bytes,31,rep,name=stats_inclusion_prefixes,json=statsInclusionPrefixes,proto3" json:"statsInclusionPrefixes,omitempty"`
	// Suffix matcher for Envoy stats creation. To reduce memory and CPU
	// overhead from envoy stats system, istio-proxy by default only create and
	// expose a subset of envoy stats. This option is to include extra envoy stats
	// with suffix match.
	...
	// expose a subset of envoy stats. This option is to include extra envoy stats
	// with regex match.
	StatsInclusionRegexps []string `protobuf:"bytes,33,rep,name=stats_inclusion_regexps,json=statsInclusionRegexps,proto3" json:"statsInclusionRegexps,omitempty"`
	XXX_NoUnkeyedLiteral  struct{} `json:"-"`
	XXX_unrecognized      []byte   `json:"-"`
	XXX_sizecache         int32    `json:"-"`
}
...
func (m *ProxyConfig) GetStatsInclusionPrefixes() []string {
	if m != nil {
...
func (m *ProxyConfig) GetStatsInclusionSuffixes() []string {
	if m != nil {
...
func (m *ProxyConfig) GetStatsInclusionRegexps() []string {
	if m != nil {
...
var fileDescriptor_5efecd978cf3d28d = []byte{
	...
	,
}
