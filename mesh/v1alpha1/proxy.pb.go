...
func (x *ProxyConfig_ProxyHeaders_SetCurrentClientCertDetails) GetCert() bool {
	if x != nil {
		return x.Cert
	}
	return false
...
func (x *ProxyConfig_ProxyHeaders_SetCurrentClientCertDetails) GetChain() bool {
	if x != nil {
		return x.Chain
	}
	return false
...
var file_mesh_v1alpha1_proxy_proto_rawDesc = []byte{
	...
	0x0a, 0x08, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x22, 0xb2, 0x22, 0x0a, 0x0b, 0x50,
	...
	0x65, 0x78, 0x70, 0x73, 0x1a, 0xb4, 0x0b, 0x0a, 0x0c, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x48, 0x65,
	...
	0x65, 0x4d, 0x6f, 0x64, 0x65, 0x52, 0x04, 0x6d, 0x6f, 0x64, 0x65, 0x1a, 0xd9, 0x01, 0x0a, 0x1b,
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x12, 0x2c, 0x0a, 0x03, 0x64,
...
var file_mesh_v1alpha1_proxy_proto_depIdxs = []int32{
	...
	36, // 59: istio.mesh.v1alpha1.ProxyConfig.ProxyHeaders.SetCurrentClientCertDetails.dns:type_name -> google.protobuf.BoolValue
	36, // 60: istio.mesh.v1alpha1.ProxyConfig.ProxyHeaders.SetCurrentClientCertDetails.uri:type_name -> google.protobuf.BoolValue
...
func file_mesh_v1alpha1_proxy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mesh_v1alpha1_proxy_proto_msgTypes[28].Exporter = func(v any, i int) any {
			switch v := v.(*ProxyConfig_ProxyHeaders_SetCurrentClientCertDetails); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
