...
type ProxyConfig_InboundInterceptionTechnique int32

const (
	ProxyConfig_PROXY_INIT ProxyConfig_InboundInterceptionTechnique = 0
	ProxyConfig_CNI        ProxyConfig_InboundInterceptionTechnique = 1
)

var ProxyConfig_InboundInterceptionTechnique_name = map[int32]string{
	0: "PROXY_INIT",
	1: "CNI",
}

var ProxyConfig_InboundInterceptionTechnique_value = map[string]int32{
	"PROXY_INIT": 0,
	"CNI":        1,
}

func (x ProxyConfig_InboundInterceptionTechnique) String() string {
	return proto.EnumName(ProxyConfig_InboundInterceptionTechnique_name, int32(x))
}

func (ProxyConfig_InboundInterceptionTechnique) EnumDescriptor() ([]byte, []int) {
...
type ProxyConfig struct {
	...
	ProxyStatusPort int32 `protobuf:"varint,36,opt,name=proxy_status_port,json=proxyStatusPort,proto3" json:"proxyStatusPort,omitempty"`
	// $hide_from_docs
	...
	InterceptionTechnique ProxyConfig_InboundInterceptionTechnique `protobuf:"varint,30,opt,name=interception_technique,json=interceptionTechnique,proto3,enum=istio.mesh.v1alpha1.ProxyConfig_InboundInterceptionTechnique" json:"interceptionTechnique,omitempty"`
	...
	PodDnsSearchNamespaces   []string `protobuf:"bytes,31,rep,name=pod_dns_search_namespaces,json=podDnsSearchNamespaces,proto3" json:"podDnsSearchNamespaces,omitempty"`
	RewriteAppHttpProbe      bool     `protobuf:"varint,32,opt,name=rewrite_app_http_probe,json=rewriteAppHttpProbe,proto3" json:"rewriteAppHttpProbe,omitempty"`
	ProxyInitImage           string   `protobuf:"bytes,33,opt,name=proxy_init_image,json=proxyInitImage,proto3" json:"proxyInitImage,omitempty"`
	ProxyInitImagePullPolicy string   `protobuf:"bytes,39,opt,name=proxy_init_image_pull_policy,json=proxyInitImagePullPolicy,proto3" json:"proxyInitImagePullPolicy,omitempty"`
	IncludeOutboundIpRanges  []string `protobuf:"bytes,34,rep,name=include_outbound_ip_ranges,json=includeOutboundIpRanges,proto3" json:"includeOutboundIpRanges,omitempty"`
	ExcludeOutboundIpRanges  []string `protobuf:"bytes,35,rep,name=exclude_outbound_ip_ranges,json=excludeOutboundIpRanges,proto3" json:"excludeOutboundIpRanges,omitempty"`
	IncludeInboundPorts      []string `protobuf:"bytes,37,rep,name=include_inbound_ports,json=includeInboundPorts,proto3" json:"includeInboundPorts,omitempty"`
	ExcludeInboundPorts      []string `protobuf:"bytes,38,rep,name=exclude_inbound_ports,json=excludeInboundPorts,proto3" json:"excludeInboundPorts,omitempty"`
	IncludeOutboundPorts     []string `protobuf:"bytes,40,rep,name=include_outbound_ports,json=includeOutboundPorts,proto3" json:"includeOutboundPorts,omitempty"`
	ExcludeOutboundPorts     []string `protobuf:"bytes,41,rep,name=exclude_outbound_ports,json=excludeOutboundPorts,proto3" json:"excludeOutboundPorts,omitempty"`
	XXX_NoUnkeyedLiteral     struct{} `json:"-"`
	XXX_unrecognized         []byte   `json:"-"`
	XXX_sizecache            int32    `json:"-"`
}
...
func (m *ProxyConfig) GetProxyStatusPort() int32 {
	if m != nil {
		return m.ProxyStatusPort
	}
	return 0
}
...
func (m *ProxyConfig) GetInterceptionTechnique() ProxyConfig_InboundInterceptionTechnique {
	if m != nil {
		return m.InterceptionTechnique
	}
	return ProxyConfig_PROXY_INIT
}
...
func (m *ProxyConfig) GetRewriteAppHttpProbe() bool {
	if m != nil {
...
func (m *ProxyConfig) GetProxyInitImagePullPolicy() string {
	if m != nil {
		return m.ProxyInitImagePullPolicy
	}
	return ""
}

func (m *ProxyConfig) GetIncludeOutboundIpRanges() []string {
	if m != nil {
		return m.IncludeOutboundIpRanges
	}
	return nil
}

func (m *ProxyConfig) GetExcludeOutboundIpRanges() []string {
	if m != nil {
		return m.ExcludeOutboundIpRanges
	}
	return nil
}
...
func init() {
	...
	proto.RegisterEnum("istio.mesh.v1alpha1.ProxyConfig_InboundInterceptionTechnique", ProxyConfig_InboundInterceptionTechnique_name, ProxyConfig_InboundInterceptionTechnique_value)
...
var fileDescriptor_5efecd978cf3d28d = []byte{
	...
	,
}
...
func (m *ProxyConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExcludeOutboundPorts) > 0 {
		for iNdEx := len(m.ExcludeOutboundPorts) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ExcludeOutboundPorts[iNdEx])
			copy(dAtA[i:], m.ExcludeOutboundPorts[iNdEx])
			i = encodeVarintProxy(dAtA, i, uint64(len(m.ExcludeOutboundPorts[iNdEx])))
			i--
			dAtA[i] = 0x2
			i--
			dAtA[i] = 0xca
	...
	if len(m.IncludeOutboundPorts) > 0 {
		for iNdEx := len(m.IncludeOutboundPorts) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.IncludeOutboundPorts[iNdEx])
			copy(dAtA[i:], m.IncludeOutboundPorts[iNdEx])
			i = encodeVarintProxy(dAtA, i, uint64(len(m.IncludeOutboundPorts[iNdEx])))
			i--
			dAtA[i] = 0x2
			i--
			dAtA[i] = 0xc2
	...
	if len(m.ProxyInitImagePullPolicy) > 0 {
		i -= len(m.ProxyInitImagePullPolicy)
		copy(dAtA[i:], m.ProxyInitImagePullPolicy)
		i = encodeVarintProxy(dAtA, i, uint64(len(m.ProxyInitImagePullPolicy)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xba
	...
	if len(m.ExcludeInboundPorts) > 0 {
		for iNdEx := len(m.ExcludeInboundPorts) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ExcludeInboundPorts[iNdEx])
			copy(dAtA[i:], m.ExcludeInboundPorts[iNdEx])
			i = encodeVarintProxy(dAtA, i, uint64(len(m.ExcludeInboundPorts[iNdEx])))
			i--
			dAtA[i] = 0x2
			i--
			dAtA[i] = 0xb2
	...
	if len(m.IncludeInboundPorts) > 0 {
		for iNdEx := len(m.IncludeInboundPorts) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.IncludeInboundPorts[iNdEx])
			copy(dAtA[i:], m.IncludeInboundPorts[iNdEx])
			i = encodeVarintProxy(dAtA, i, uint64(len(m.IncludeInboundPorts[iNdEx])))
			i--
			dAtA[i] = 0x2
			i--
			dAtA[i] = 0xaa
	...
	if m.ProxyStatusPort != 0 {
		i = encodeVarintProxy(dAtA, i, uint64(m.ProxyStatusPort))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xa0
	}
	if len(m.ExcludeOutboundIpRanges) > 0 {
		for iNdEx := len(m.ExcludeOutboundIpRanges) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ExcludeOutboundIpRanges[iNdEx])
			copy(dAtA[i:], m.ExcludeOutboundIpRanges[iNdEx])
			i = encodeVarintProxy(dAtA, i, uint64(len(m.ExcludeOutboundIpRanges[iNdEx])))
			i--
			dAtA[i] = 0x2
			i--
			dAtA[i] = 0x9a
	...
	if len(m.IncludeOutboundIpRanges) > 0 {
		for iNdEx := len(m.IncludeOutboundIpRanges) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.IncludeOutboundIpRanges[iNdEx])
			copy(dAtA[i:], m.IncludeOutboundIpRanges[iNdEx])
			i = encodeVarintProxy(dAtA, i, uint64(len(m.IncludeOutboundIpRanges[iNdEx])))
			i--
			dAtA[i] = 0x2
			i--
			dAtA[i] = 0x92
	...
	if len(m.ProxyInitImage) > 0 {
		i -= len(m.ProxyInitImage)
		copy(dAtA[i:], m.ProxyInitImage)
		i = encodeVarintProxy(dAtA, i, uint64(len(m.ProxyInitImage)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x8a
	...
	if len(m.PodDnsSearchNamespaces) > 0 {
		for iNdEx := len(m.PodDnsSearchNamespaces) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintProxy(dAtA, i, uint64(len(m.PodDnsSearchNamespaces[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xfa
	...
	if m.InterceptionTechnique != 0 {
		i = encodeVarintProxy(dAtA, i, uint64(m.InterceptionTechnique))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xf0
...
func (m *ProxyConfig) Size() (n int) {
	...
	if m.InterceptionTechnique != 0 {
		n += 2 + sovProxy(uint64(m.InterceptionTechnique))
	}
	if len(m.PodDnsSearchNamespaces) > 0 {
	...
	if len(m.IncludeOutboundIpRanges) > 0 {
		for _, s := range m.IncludeOutboundIpRanges {
			l = len(s)
			n += 2 + l + sovProxy(uint64(l))
		}
	}
	if len(m.ExcludeOutboundIpRanges) > 0 {
		for _, s := range m.ExcludeOutboundIpRanges {
			l = len(s)
			n += 2 + l + sovProxy(uint64(l))
		}
	}
	if m.ProxyStatusPort != 0 {
		n += 2 + sovProxy(uint64(m.ProxyStatusPort))
	}
	if len(m.IncludeInboundPorts) > 0 {
		for _, s := range m.IncludeInboundPorts {
			l = len(s)
			n += 2 + l + sovProxy(uint64(l))
		}
	}
	if len(m.ExcludeInboundPorts) > 0 {
		for _, s := range m.ExcludeInboundPorts {
			l = len(s)
			n += 2 + l + sovProxy(uint64(l))
		}
	}
	l = len(m.ProxyInitImagePullPolicy)
	if l > 0 {
		n += 2 + l + sovProxy(uint64(l))
	}
	if len(m.IncludeOutboundPorts) > 0 {
		for _, s := range m.IncludeOutboundPorts {
			l = len(s)
			n += 2 + l + sovProxy(uint64(l))
		}
	}
	if len(m.ExcludeOutboundPorts) > 0 {
		for _, s := range m.ExcludeOutboundPorts {
			l = len(s)
			n += 2 + l + sovProxy(uint64(l))
		}
	}
...
func (m *ProxyConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 30:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field InterceptionTechnique", wireType)
			}
			m.InterceptionTechnique = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowProxy
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.InterceptionTechnique |= ProxyConfig_InboundInterceptionTechnique(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 33:
			...
			m.ProxyInitImage = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 34:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IncludeOutboundIpRanges", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IncludeOutboundIpRanges = append(m.IncludeOutboundIpRanges, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 35:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExcludeOutboundIpRanges", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExcludeOutboundIpRanges = append(m.ExcludeOutboundIpRanges, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 36:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProxyStatusPort", wireType)
			}
			m.ProxyStatusPort = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ProxyStatusPort |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 37:
			...
			m.IncludeInboundPorts = append(m.IncludeInboundPorts, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 38:
			if wireType != 2 {
			...
			m.ExcludeInboundPorts = append(m.ExcludeInboundPorts, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 39:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProxyInitImagePullPolicy", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ProxyInitImagePullPolicy = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 40:
			if wireType != 2 {
			...
			m.IncludeOutboundPorts = append(m.IncludeOutboundPorts, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 41:
			if wireType != 2 {
			...
			m.ExcludeOutboundPorts = append(m.ExcludeOutboundPorts, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProxy(dAtA[iNdEx:])
