...
type HealthCheckConfig struct {
	...
	InitialDelaySeconds int32 `protobuf:"varint,2,opt,name=initial_delay_seconds,json=initialDelaySeconds,proto3" json:"initialDelaySeconds,omitempty"`
	// Number of seconds after which the probe times out.
	// Defaults to 1 second. Minimum value is 1.
	TimeoutSeconds int32 `protobuf:"varint,3,opt,name=timeout_seconds,json=timeoutSeconds,proto3" json:"timeoutSeconds,omitempty"`
	// How often (in seconds) to perform the probe.
	// Default to 10 seconds. Minimum value is 1.
	PeriodSeconds int32 `protobuf:"varint,4,opt,name=period_seconds,json=periodSeconds,proto3" json:"periodSeconds,omitempty"`
	// Minimum consecutive successes for the probe to be considered successful after having failed.
	// Defaults to 1.
	SuccessThreshold int32 `protobuf:"varint,5,opt,name=success_threshold,json=successThreshold,proto3" json:"successThreshold,omitempty"`
	// Minimum consecutive failures for the probe to be considered failed after having succeeded.
	// Defaults to 3.
	FailureThreshold int32 `protobuf:"varint,6,opt,name=failure_threshold,json=failureThreshold,proto3" json:"failureThreshold,omitempty"`
	...
	//	*HealthCheckConfig_HttpGet
	//	*HealthCheckConfig_TcpSocket
	//	*HealthCheckConfig_Exec
...
type HealthCheckConfig_HttpGet struct {
	HttpGet *HTTPHealthCheckConfig `protobuf:"bytes,7,opt,name=http_get,json=httpGet,proto3,oneof"`
}
type HealthCheckConfig_TcpSocket struct {
	TcpSocket *TCPHealthCheckConfig `protobuf:"bytes,8,opt,name=tcp_socket,json=tcpSocket,proto3,oneof"`
}
type HealthCheckConfig_Exec struct {
	Exec *ExecHealthCheckConfig `protobuf:"bytes,9,opt,name=exec,proto3,oneof"`
}

func (*HealthCheckConfig_HttpGet) isHealthCheckConfig_HealthCheckMethod()   {}
func (*HealthCheckConfig_TcpSocket) isHealthCheckConfig_HealthCheckMethod() {}
func (*HealthCheckConfig_Exec) isHealthCheckConfig_HealthCheckMethod()      {}
...
func (m *HealthCheckConfig) GetInitialDelaySeconds() int32 {
	if m != nil {
...
func (m *HealthCheckConfig) GetTimeoutSeconds() int32 {
	if m != nil {
...
func (m *HealthCheckConfig) GetPeriodSeconds() int32 {
	if m != nil {
...
func (m *HealthCheckConfig) GetHttpGet() *HTTPHealthCheckConfig {
	if x, ok := m.GetHealthCheckMethod().(*HealthCheckConfig_HttpGet); ok {
		return x.HttpGet
	}
	return nil
}

func (m *HealthCheckConfig) GetTcpSocket() *TCPHealthCheckConfig {
	if x, ok := m.GetHealthCheckMethod().(*HealthCheckConfig_TcpSocket); ok {
		return x.TcpSocket
	}
	return nil
}

func (m *HealthCheckConfig) GetExec() *ExecHealthCheckConfig {
	if x, ok := m.GetHealthCheckMethod().(*HealthCheckConfig_Exec); ok {
		return x.Exec
	}
	return nil
}
...
func (*HealthCheckConfig) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*HealthCheckConfig_HttpGet)(nil),
		(*HealthCheckConfig_TcpSocket)(nil),
		(*HealthCheckConfig_Exec)(nil),
	}
}
...
type HTTPHealthCheckConfig struct {
	...
	HttpHeaders          map[string]string `protobuf:"bytes,4,rep,name=http_headers,json=httpHeaders,proto3" json:"httpHeaders,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *HTTPHealthCheckConfig) GetHttpHeaders() map[string]string {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "istio.mesh.v1alpha1.HTTPHealthCheckConfig.HttpHeadersEntry")
...
var fileDescriptor_5efecd978cf3d28d = []byte{
	...
	,
}
...
func (m *HealthCheckConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PeriodSeconds != 0 {
		i = encodeVarintProxy(dAtA, i, uint64(m.PeriodSeconds))
		i--
		dAtA[i] = 0x20
	}
	if m.TimeoutSeconds != 0 {
		i = encodeVarintProxy(dAtA, i, uint64(m.TimeoutSeconds))
		i--
		dAtA[i] = 0x18
	}
	if m.InitialDelaySeconds != 0 {
		i = encodeVarintProxy(dAtA, i, uint64(m.InitialDelaySeconds))
		i--
		dAtA[i] = 0x10
	}
	return len(dAtA) - i, nil
...
func (m *HealthCheckConfig_HttpGet) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *HealthCheckConfig_HttpGet) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.HttpGet != nil {
		{
...
func (m *HealthCheckConfig_TcpSocket) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *HealthCheckConfig_TcpSocket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.TcpSocket != nil {
		{
...
func (m *HealthCheckConfig_Exec) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *HealthCheckConfig_Exec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Exec != nil {
		{
...
func (m *ExecHealthCheckConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Command) > 0 {
		for iNdEx := len(m.Command) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintProxy(dAtA, i, uint64(len(m.Command[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *HealthCheckConfig) Size() (n int) {
	...
	_ = l
	if m.InitialDelaySeconds != 0 {
		n += 1 + sovProxy(uint64(m.InitialDelaySeconds))
	}
	if m.TimeoutSeconds != 0 {
		n += 1 + sovProxy(uint64(m.TimeoutSeconds))
	}
	if m.PeriodSeconds != 0 {
		n += 1 + sovProxy(uint64(m.PeriodSeconds))
	}
	if m.SuccessThreshold != 0 {
...
func (m *HealthCheckConfig_HttpGet) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *HealthCheckConfig_TcpSocket) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *HealthCheckConfig_Exec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *HealthCheckConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.HealthCheckMethod = &HealthCheckConfig_HttpGet{v}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
			...
			m.HealthCheckMethod = &HealthCheckConfig_TcpSocket{v}
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
			...
			m.HealthCheckMethod = &HealthCheckConfig_Exec{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProxy(dAtA[iNdEx:])
