...
type Tracing_OpenCensusAgent struct {
	...
	// default is 200.
	// $hide_from_docs
	MaxNumberOfAttributes *types.Int64Value `protobuf:"bytes,4,opt,name=max_number_of_attributes,json=maxNumberOfAttributes,proto3" json:"maxNumberOfAttributes,omitempty"`
	// The global default max number of annotation events per span.
	// default is 200.
	// $hide_from_docs
	MaxNumberOfAnnotations *types.Int64Value `protobuf:"bytes,5,opt,name=max_number_of_annotations,json=maxNumberOfAnnotations,proto3" json:"maxNumberOfAnnotations,omitempty"`
	// The global default max number of message events per span.
	// default is 200.
	// $hide_from_docs
	MaxNumberOfMessageEvents *types.Int64Value `protobuf:"bytes,6,opt,name=max_number_of_message_events,json=maxNumberOfMessageEvents,proto3" json:"maxNumberOfMessageEvents,omitempty"`
	XXX_NoUnkeyedLiteral     struct{}          `json:"-"`
	XXX_unrecognized         []byte            `json:"-"`
	XXX_sizecache            int32             `json:"-"`
}
...
func (m *Tracing_OpenCensusAgent) GetDebug() bool {
	if m != nil {
		return m.Debug
	}
	return false
...
func (m *Tracing_OpenCensusAgent) GetMaxNumberOfAttributes() *types.Int64Value {
	if m != nil {
		return m.MaxNumberOfAttributes
	}
	return nil
...
func (m *Tracing_OpenCensusAgent) GetMaxNumberOfAnnotations() *types.Int64Value {
	if m != nil {
		return m.MaxNumberOfAnnotations
	}
	return nil
...
func (m *Tracing_OpenCensusAgent) GetMaxNumberOfMessageEvents() *types.Int64Value {
	if m != nil {
		return m.MaxNumberOfMessageEvents
	}
	return nil
...
type ProxyConfig struct {
	...
	// Stats name inclusion matcher for Envoy stats creation. To reduce memory and
	// CPU overhead from envoy stats system, istio-proxy by default only create
	// and expose a subset of envoy stats. This option is to include extra envoy
	// stats with prefix, regex, and regexps match.
	EnvoyStatsInclusion  *ProxyConfig_EnvoyStatsInclusion `protobuf:"bytes,31,opt,name=envoy_stats_inclusion,json=envoyStatsInclusion,proto3" json:"envoyStatsInclusion,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                         `json:"-"`
	XXX_unrecognized     []byte                           `json:"-"`
	XXX_sizecache        int32                            `json:"-"`
}
...
func (m *ProxyConfig) GetEnvoyStatsInclusion() *ProxyConfig_EnvoyStatsInclusion {
	if m != nil {
		return m.EnvoyStatsInclusion
	}
	return nil
}

// Envoy stats name matchers for stats inclusion.
type ProxyConfig_EnvoyStatsInclusion struct {
	// Prefix matcher for Envoy stats creation.
	StatsInclusionPrefixes []string `protobuf:"bytes,1,rep,name=stats_inclusion_prefixes,json=statsInclusionPrefixes,proto3" json:"statsInclusionPrefixes,omitempty"`
	// Suffix matcher for Envoy stats creation.
	StatsInclusionSuffixes []string `protobuf:"bytes,2,rep,name=stats_inclusion_suffixes,json=statsInclusionSuffixes,proto3" json:"statsInclusionSuffixes,omitempty"`
	// Regexp matcher for Envoy stats creation.
	StatsInclusionRegexps []string `protobuf:"bytes,3,rep,name=stats_inclusion_regexps,json=statsInclusionRegexps,proto3" json:"statsInclusionRegexps,omitempty"`
	XXX_NoUnkeyedLiteral  struct{} `json:"-"`
	XXX_unrecognized      []byte   `json:"-"`
	XXX_sizecache         int32    `json:"-"`
}

func (m *ProxyConfig_EnvoyStatsInclusion) Reset()         { *m = ProxyConfig_EnvoyStatsInclusion{} }
func (m *ProxyConfig_EnvoyStatsInclusion) String() string { return proto.CompactTextString(m) }
func (*ProxyConfig_EnvoyStatsInclusion) ProtoMessage()    {}
func (*ProxyConfig_EnvoyStatsInclusion) Descriptor() ([]byte, []int) {
	return fileDescriptor_5efecd978cf3d28d, []int{3, 1}
}
func (m *ProxyConfig_EnvoyStatsInclusion) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ProxyConfig_EnvoyStatsInclusion) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ProxyConfig_EnvoyStatsInclusion.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ProxyConfig_EnvoyStatsInclusion) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProxyConfig_EnvoyStatsInclusion.Merge(m, src)
}
func (m *ProxyConfig_EnvoyStatsInclusion) XXX_Size() int {
	return m.Size()
}
func (m *ProxyConfig_EnvoyStatsInclusion) XXX_DiscardUnknown() {
	xxx_messageInfo_ProxyConfig_EnvoyStatsInclusion.DiscardUnknown(m)
}

var xxx_messageInfo_ProxyConfig_EnvoyStatsInclusion proto.InternalMessageInfo

func (m *ProxyConfig_EnvoyStatsInclusion) GetStatsInclusionPrefixes() []string {
	if m != nil {
		return m.StatsInclusionPrefixes
	}
	return nil
}

func (m *ProxyConfig_EnvoyStatsInclusion) GetStatsInclusionSuffixes() []string {
	if m != nil {
		return m.StatsInclusionSuffixes
	}
	return nil
}

func (m *ProxyConfig_EnvoyStatsInclusion) GetStatsInclusionRegexps() []string {
	if m != nil {
		return m.StatsInclusionRegexps
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*ProxyConfig_EnvoyStatsInclusion)(nil), "istio.mesh.v1alpha1.ProxyConfig.EnvoyStatsInclusion")
...
var fileDescriptor_5efecd978cf3d28d = []byte{
	...
	,
}
...
func (m *Tracing_OpenCensusAgent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Context) > 0 {
		dAtA15 := make([]byte, len(m.Context)*10)
		var j14 int
		...
		i = encodeVarintProxy(dAtA, i, uint64(j14))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Address) > 0 {
...
func (m *ProxyConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.EnvoyStatsInclusion != nil {
		{
			size, err := m.EnvoyStatsInclusion.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ProxyConfig_EnvoyStatsInclusion) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ProxyConfig_EnvoyStatsInclusion) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ProxyConfig_EnvoyStatsInclusion) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.StatsInclusionRegexps) > 0 {
		for iNdEx := len(m.StatsInclusionRegexps) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.StatsInclusionRegexps[iNdEx])
			copy(dAtA[i:], m.StatsInclusionRegexps[iNdEx])
			i = encodeVarintProxy(dAtA, i, uint64(len(m.StatsInclusionRegexps[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
	if len(m.StatsInclusionSuffixes) > 0 {
		for iNdEx := len(m.StatsInclusionSuffixes) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.StatsInclusionSuffixes[iNdEx])
			copy(dAtA[i:], m.StatsInclusionSuffixes[iNdEx])
			i = encodeVarintProxy(dAtA, i, uint64(len(m.StatsInclusionSuffixes[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	if len(m.StatsInclusionPrefixes) > 0 {
		for iNdEx := len(m.StatsInclusionPrefixes) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.StatsInclusionPrefixes[iNdEx])
			copy(dAtA[i:], m.StatsInclusionPrefixes[iNdEx])
			i = encodeVarintProxy(dAtA, i, uint64(len(m.StatsInclusionPrefixes[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *ProxyConfig_EnvoyStatsInclusion) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.StatsInclusionPrefixes) > 0 {
		for _, s := range m.StatsInclusionPrefixes {
			l = len(s)
			n += 1 + l + sovProxy(uint64(l))
		}
	}
	if len(m.StatsInclusionSuffixes) > 0 {
		for _, s := range m.StatsInclusionSuffixes {
			l = len(s)
			n += 1 + l + sovProxy(uint64(l))
		}
	}
	if len(m.StatsInclusionRegexps) > 0 {
		for _, s := range m.StatsInclusionRegexps {
			l = len(s)
			n += 1 + l + sovProxy(uint64(l))
		}
	}
...
func (m *ProxyConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 31:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnvoyStatsInclusion", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.EnvoyStatsInclusion == nil {
				m.EnvoyStatsInclusion = &ProxyConfig_EnvoyStatsInclusion{}
			}
			if err := m.EnvoyStatsInclusion.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ProxyConfig_EnvoyStatsInclusion) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EnvoyStatsInclusion: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EnvoyStatsInclusion: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StatsInclusionPrefixes", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StatsInclusionPrefixes = append(m.StatsInclusionPrefixes, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StatsInclusionSuffixes", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StatsInclusionSuffixes = append(m.StatsInclusionSuffixes, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StatsInclusionRegexps", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StatsInclusionRegexps = append(m.StatsInclusionRegexps, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProxy(dAtA[iNdEx:])
