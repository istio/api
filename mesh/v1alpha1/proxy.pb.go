...
type Topology struct {
	...
	// $hide_from_docs
	// Specifies the fields in the client certificate that should
	// be added to the x-forwarded-client-cert (XFCC) header. This
	// field is only valid when `forward_client_cert_details`
	// is set to APPEND_FORWARD or SANITIZE_SET and the client connection is mTLS.
	SetCurrentClientCertDetails *Topology_SetCurrentClientCertDetails `protobuf:"bytes,3,opt,name=set_current_client_cert_details,json=setCurrentClientCertDetails,proto3" json:"setCurrentClientCertDetails,omitempty"`
	XXX_NoUnkeyedLiteral        struct{}                              `json:"-"`
	XXX_unrecognized            []byte                                `json:"-"`
	XXX_sizecache               int32                                 `json:"-"`
}
...
func (m *Topology) GetSetCurrentClientCertDetails() *Topology_SetCurrentClientCertDetails {
	if m != nil {
...
// $hide_from_docs
// SetCurrentClientCertDetails specifies the fields in the client certificate
// that should be added to the x-forwarded-client-cert (XFCC) header
// See [Envoy XFCC Details](https://www.envoyproxy.io/docs/envoy/latest/configuration/http/http_conn_man/headers#x-forwarded-client-cert)
type Topology_SetCurrentClientCertDetails struct {
	// Adds the subject of the client cert.
	// Defaults to `true`.
	Subject *types.BoolValue `protobuf:"bytes,1,opt,name=subject,proto3" json:"subject,omitempty"`
	// Adds the entire client cert in URL encoded PEM format. This will appear in the
	// XFCC header comma separated from other values with the value Cert="PEM".
	// Defaults to `true`.
	Cert *types.BoolValue `protobuf:"bytes,2,opt,name=cert,proto3" json:"cert,omitempty"`
	// Adds the entire client cert chain (including the leaf cert)
	// in URL encoded PEM format. This will appear in the XFCC header
	// the XFCC header comma separated from other values with the value Chain=”PEM”.
	// Defaults to `true`.
	Chain *types.BoolValue `protobuf:"bytes,3,opt,name=chain,proto3" json:"chain,omitempty"`
	// Adds the DNS type Subject Alternative Names of the client cert.
	// Defaults to `true`.
	Dns *types.BoolValue `protobuf:"bytes,4,opt,name=dns,proto3" json:"dns,omitempty"`
	// Adds the URI type Subject Alternative Name of the client cert.
	// Defaults to `true`.
	Uri                  *types.BoolValue `protobuf:"bytes,5,opt,name=uri,proto3" json:"uri,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}

func (m *Topology_SetCurrentClientCertDetails) Reset()         { *m = Topology_SetCurrentClientCertDetails{} }
func (m *Topology_SetCurrentClientCertDetails) String() string { return proto.CompactTextString(m) }
func (*Topology_SetCurrentClientCertDetails) ProtoMessage()    {}
func (*Topology_SetCurrentClientCertDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_5efecd978cf3d28d, []int{2, 0}
}
func (m *Topology_SetCurrentClientCertDetails) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Topology_SetCurrentClientCertDetails) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Topology_SetCurrentClientCertDetails.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Topology_SetCurrentClientCertDetails) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Topology_SetCurrentClientCertDetails.Merge(m, src)
}
func (m *Topology_SetCurrentClientCertDetails) XXX_Size() int {
	return m.Size()
}
func (m *Topology_SetCurrentClientCertDetails) XXX_DiscardUnknown() {
	xxx_messageInfo_Topology_SetCurrentClientCertDetails.DiscardUnknown(m)
}

var xxx_messageInfo_Topology_SetCurrentClientCertDetails proto.InternalMessageInfo

func (m *Topology_SetCurrentClientCertDetails) GetSubject() *types.BoolValue {
	if m != nil {
		return m.Subject
	}
	return nil
...
func (m *Topology_SetCurrentClientCertDetails) GetCert() *types.BoolValue {
	if m != nil {
		return m.Cert
	}
	return nil
...
func (m *Topology_SetCurrentClientCertDetails) GetChain() *types.BoolValue {
	if m != nil {
		return m.Chain
	}
	return nil
...
func (m *Topology_SetCurrentClientCertDetails) GetDns() *types.BoolValue {
	if m != nil {
		return m.Dns
	}
	return nil
...
func (m *Topology_SetCurrentClientCertDetails) GetUri() *types.BoolValue {
	if m != nil {
		return m.Uri
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Topology_SetCurrentClientCertDetails)(nil), "istio.mesh.v1alpha1.Topology.SetCurrentClientCertDetails")
...
var fileDescriptor_5efecd978cf3d28d = []byte{
	...
	,
}
...
func (m *Topology_SetCurrentClientCertDetails) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Topology_SetCurrentClientCertDetails) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Topology_SetCurrentClientCertDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Topology_SetCurrentClientCertDetails) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Topology) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.SetCurrentClientCertDetails == nil {
				m.SetCurrentClientCertDetails = &Topology_SetCurrentClientCertDetails{}
			}
...
func (m *Topology_SetCurrentClientCertDetails) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
