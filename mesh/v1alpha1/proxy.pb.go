...
type ProxyConfig struct {
	...
	EnvoyHttpGrpcAlsAddress string   `protobuf:"bytes,22,opt,name=envoy_http_grpc_als_address,json=envoyHttpGrpcAlsAddress,proto3" json:"envoy_http_grpc_als_address,omitempty"`
	XXX_NoUnkeyedLiteral    struct{} `json:"-"`
	XXX_unrecognized        []byte   `json:"-"`
	XXX_sizecache           int32    `json:"-"`
}
...
func (m *ProxyConfig) GetEnvoyHttpGrpcAlsAddress() string {
	if m != nil {
		return m.EnvoyHttpGrpcAlsAddress
	}
	return ""
}
...
var fileDescriptor_5efecd978cf3d28d = []byte{
	...
	,
}
...
func (m *ProxyConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.EnvoyHttpGrpcAlsAddress) > 0 {
		dAtA[i] = 0xb2
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintProxy(dAtA, i, uint64(len(m.EnvoyHttpGrpcAlsAddress)))
		i += copy(dAtA[i:], m.EnvoyHttpGrpcAlsAddress)
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *ProxyConfig) Size() (n int) {
	...
	l = len(m.EnvoyHttpGrpcAlsAddress)
	if l > 0 {
		n += 2 + l + sovProxy(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *ProxyConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 22:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnvoyHttpGrpcAlsAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnvoyHttpGrpcAlsAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProxy(dAtA[iNdEx:])
