...
type Tracing_Zipkin struct {
	...
	// Address of the Zipkin service with mTLS connection if configured.
...
func (m *Tracing_Zipkin) GetService() *RemoteService {
	if m != nil {
		return m.Service
	}
	return nil
...
type Tracing_Lightstep struct {
	// Address of the Lightstep Satellite pool with mTLS connection if configured.
	Service *RemoteService `protobuf:"bytes,5,opt,name=service,proto3" json:"service,omitempty"`
	...
	Secure bool `protobuf:"varint,3,opt,name=secure,proto3" json:"secure,omitempty"` // Deprecated: Do not use.
	// Path to the trusted cacert used to authenticate the pool.
	CacertPath           string   `protobuf:"bytes,4,opt,name=cacert_path,json=cacertPath,proto3" json:"cacert_path,omitempty"` // Deprecated: Do not use.
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Tracing_Lightstep) GetService() *RemoteService {
	if m != nil {
		return m.Service
	}
	return nil
...
type Tracing_Datadog struct {
	...
	Address string `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"` // Deprecated: Do not use.
	// Address of the Datadog Agent with mTLS connection if configured.
	Service              *RemoteService `protobuf:"bytes,2,opt,name=service,proto3" json:"service,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
...
func (m *Tracing_Datadog) GetService() *RemoteService {
	if m != nil {
		return m.Service
	}
	return nil
...
type ProxyConfig struct {
	...
	DiscoveryAddress string `protobuf:"bytes,6,opt,name=discovery_address,json=discoveryAddress,proto3" json:"discovery_address,omitempty"` // Deprecated: Do not use.
	// $hide_from_docs
	...
	// This will only be applied for Pilot if discovery_address is used to specify pilot address.
	// If discovery_service is used to specify Pilot address, the TLSSettings in RemoteService
	// drives the authentication policy for Pilot.
	...
	// Address of the discovery service exposing xDS with mTLS connection.
	DiscoveryService     *RemoteService `protobuf:"bytes,24,opt,name=discovery_service,json=discoveryService,proto3" json:"discovery_service,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
type RemoteService struct {
	// Address of a remote service used for various purposes (access log
...
var fileDescriptor_5efecd978cf3d28d = []byte{
	...
	,
}
