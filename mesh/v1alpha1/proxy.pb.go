...
type ProxyConfig struct {
	...
	// The time in seconds that Istio will allow Envoy to complete requests before terminating it.
	// This currently supports all HTTP based protocols (HTTP, HTTP2, GRPC, etc.) but not HTTPS.
	// On receiving SIGTERM or SIGINT Istio instructs Envoy to respond with 503 to any new inbound requests
	// It will continue to allow new outbound and any already open connections. Once the duration is reached,
	// Istio kills the Envoy process. MUST be >=1s (e.g., _1s/1m/1h_)
	TerminationGracePeriodDuration *google_protobuf.Duration `protobuf:"bytes,20,opt,name=termination_grace_period_duration,json=terminationGracePeriodDuration" json:"termination_grace_period_duration,omitempty"`
}
...
func (m *ProxyConfig) GetTerminationGracePeriodDuration() *google_protobuf.Duration {
	if m != nil {
		return m.TerminationGracePeriodDuration
	}
	return nil
}
...
func (m *ProxyConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TerminationGracePeriodDuration != nil {
		dAtA[i] = 0xa2
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintProxy(dAtA, i, uint64(m.TerminationGracePeriodDuration.Size()))
		n9, err := m.TerminationGracePeriodDuration.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func (m *ProxyConfig) Size() (n int) {
	...
	if m.TerminationGracePeriodDuration != nil {
		l = m.TerminationGracePeriodDuration.Size()
		n += 2 + l + sovProxy(uint64(l))
	}
	return n
}
...
func (m *ProxyConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TerminationGracePeriodDuration", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TerminationGracePeriodDuration == nil {
				m.TerminationGracePeriodDuration = &google_protobuf.Duration{}
			}
			if err := m.TerminationGracePeriodDuration.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorProxy = []byte{
	...
	,
}
