...
type ProxyConfig struct {
	...
	Meta                 map[string]string `protobuf:"bytes,24,rep,name=meta,proto3" json:"meta,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *ProxyConfig) GetMeta() map[string]string {
	if m != nil {
		return m.Meta
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "istio.mesh.v1alpha1.ProxyConfig.MetaEntry")
...
var fileDescriptor_5efecd978cf3d28d = []byte{
	...
	,
}
