...
type MeshConfig struct {
	...
	// `proxy_listen_port`.
	ProxyInboundListenPort int32 `protobuf:"varint,37,opt,name=proxy_inbound_listen_port,json=proxyInboundListenPort,proto3" json:"proxy_inbound_listen_port,omitempty"`
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
