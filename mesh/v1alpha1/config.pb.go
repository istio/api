...
const (
	// Sets AmbientMesh to a namespaced configuration. This requires the addition of the
	// istio.io/dataplane-mode=ambient label to be applied to the desired namespaces.
...
type MeshConfig_AmbientMeshConfig struct {
	...
	// Configures a list of namespaces that will be excluded from the ambient mesh.
	// These namespaces will always be excluded. In terms of conflicts, for example
	// when the mode is DEFAULT (namespaced), the namespace in this list, and the
	// namespace receiving the dataplane-mode label, the namespace will be excluded.
	// @TODO Fix label name when decided in the above comment.
...
func (x *MeshConfig_AmbientMeshConfig) GetExcludedNamespaces() []string {
	if x != nil {
...
var file_mesh_v1alpha1_config_proto_rawDesc = []byte{
	...
	0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc6, 0x58, 0x0a, 0x0a, 0x4d, 0x65, 0x73, 0x68,
	...
	0x01, 0x12, 0x0b, 0x0a, 0x07, 0x54, 0x4c, 0x53, 0x56, 0x31, 0x5f, 0x33, 0x10, 0x02, 0x1a, 0xcb,
	...
	0x68, 0x4d, 0x6f, 0x64, 0x65, 0x52, 0x04, 0x6d, 0x6f, 0x64, 0x65, 0x12, 0x2e, 0x0a, 0x12, 0x65,
	...
	0x64, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x73, 0x22, 0x2f, 0x0a, 0x0f, 0x41,
