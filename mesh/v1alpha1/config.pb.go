...
type MeshConfig struct {
	...
	// An ordered namespace list for ambient custom service resolution. Similar to DNS,
	// progress down the list until a match is found. If no match is found then the
	// hostname does not resolve.
	//
	// Namespace-scoped services (i.e. $name.$namespace.svc.* as a k8s service or a
	// ServiceEntry decorator to a k8s service) cannot conflict with other hosts.
	// These services are not "custom", hence ambient_custom_service_resolution_paths
	// does not apply.
	//
	// For users looking for the safest behavior that's most compatible with an
	// external-DNS solution (no per-namespace DNS; global DNS only) they can set:
	// meshConfig:
	//
	//	ambientCustomServiceResolutionPaths:
	//	 - 'istio-system' # or some other mesh admin protected namespace
	//
	// If omitted, this is the default behavior.
	//
	// For safe multi-tenancy and per-namespace DNS flexibility users can set:
	// meshConfig:
	//
	//	ambientCustomServiceResolutionPaths:
	//	 - '.' # local namespace
	//
	// Note: INSECURE -- tenants can hijack traffic destined for hostnames across
	// namespace boundaries.
	// For backwards compatability or classic to ambient migrations users may set:
	// meshConfig:
	//
	//	ambientCustomServiceResolutionPaths:
	//	 - '.' # local namespace
	...
	//
	// Conflicting ServiceEntry hosts tiebreak uses the oldest creation timestamp.
	AmbientCustomServiceResolutionPaths []string `protobuf:"bytes,66,rep,name=ambient_custom_service_resolution_paths,json=ambientCustomServiceResolutionPaths,proto3" json:"ambient_custom_service_resolution_paths,omitempty"`
}
...
func (x *MeshConfig) GetAmbientCustomServiceResolutionPaths() []string {
	if x != nil {
		return x.AmbientCustomServiceResolutionPaths
	}
	return nil
}
...
var file_mesh_v1alpha1_config_proto_rawDesc = []byte{
	...
	0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbe, 0x59, 0x0a, 0x0a, 0x4d, 0x65, 0x73, 0x68,
	...
	,
	...
	0x6c, 0x73, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x12, 0x42, 0x0a, 0x0f, 0x72, 0x65,
	...
	0x0a, 0x0b, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x64, 0x5f, 0x73, 0x69, 0x64, 0x65, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x0a, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x64, 0x53, 0x69, 0x64, 0x65, 0x1a,
	0xb8, 0x2f, 0x0a, 0x11, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f,
	0x76, 0x69, 0x64, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x8b, 0x01, 0x0a, 0x14, 0x65, 0x6e,
	0x76, 0x6f, 0x79, 0x5f, 0x65, 0x78, 0x74, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x7a, 0x5f, 0x68, 0x74,
	0x74, 0x70, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x58, 0x2e, 0x69, 0x73, 0x74, 0x69, 0x6f,
	...
	0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x74, 0x74, 0x70, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64,
	0x65, 0x72, 0x48, 0x00, 0x52, 0x11, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x45, 0x78, 0x74, 0x41, 0x75,
	0x74, 0x68, 0x7a, 0x48, 0x74, 0x74, 0x70, 0x12, 0x8b, 0x01, 0x0a, 0x14, 0x65, 0x6e, 0x76, 0x6f,
	0x79, 0x5f, 0x65, 0x78, 0x74, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x7a, 0x5f, 0x67, 0x72, 0x70, 0x63,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x58, 0x2e, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x6d,
	0x65, 0x73, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x4d, 0x65, 0x73,
	...
	,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x2e, 0x44, 0x61, 0x74,
	0x61, 0x64, 0x6f, 0x67, 0x54, 0x72, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x50, 0x72, 0x6f, 0x76, 0x69,
	0x64, 0x65, 0x72, 0x48, 0x00, 0x52, 0x07, 0x64, 0x61, 0x74, 0x61, 0x64, 0x6f, 0x67, 0x12, 0x69,
	0x0a, 0x0b, 0x73, 0x74, 0x61, 0x63, 0x6b, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x45, 0x2e, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x6d, 0x65, 0x73, 0x68,
	0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x4d, 0x65, 0x73, 0x68, 0x43, 0x6f,
	...
	0x65, 0x72, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x48, 0x00, 0x52, 0x0b, 0x73, 0x74,
	0x61, 0x63, 0x6b, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x12, 0x72, 0x0a, 0x0a, 0x6f, 0x70, 0x65,
	0x6e, 0x63, 0x65, 0x6e, 0x73, 0x75, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x50, 0x2e,
	0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70,
	...
	0x00, 0x52, 0x0a, 0x6f, 0x70, 0x65, 0x6e, 0x63, 0x65, 0x6e, 0x73, 0x75, 0x73, 0x12, 0x6d, 0x0a,
	0x0a, 0x73, 0x6b, 0x79, 0x77, 0x61, 0x6c, 0x6b, 0x69, 0x6e, 0x67, 0x18, 0x09, 0x20, 0x01, 0x28,
	...
	,
	...
	0x72, 0x48, 0x00, 0x52, 0x12, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x46, 0x69, 0x6c, 0x65, 0x41, 0x63,
	0x63, 0x65, 0x73, 0x73, 0x4c, 0x6f, 0x67, 0x12, 0x74, 0x0a, 0x0e, 0x65, 0x6e, 0x76, 0x6f, 0x79,
	0x5f, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x61, 0x6c, 0x73, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x65, 0x72, 0x2e, 0x45, 0x6e, 0x76, 0x6f, 0x79, 0x48, 0x74, 0x74, 0x70, 0x47, 0x72, 0x70, 0x63,
	0x56, 0x33, 0x4c, 0x6f, 0x67, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x48, 0x00, 0x52,
	0x0c, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x48, 0x74, 0x74, 0x70, 0x41, 0x6c, 0x73, 0x12, 0x71, 0x0a,
	0x0d, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x5f, 0x74, 0x63, 0x70, 0x5f, 0x61, 0x6c, 0x73, 0x18, 0x0d,
	...
	,
	...
	0x6f, 0x79, 0x4f, 0x74, 0x65, 0x6c, 0x41, 0x6c, 0x73, 0x1a, 0xab, 0x01, 0x0a, 0x25, 0x45, 0x6e,
	...
	0x6f, 0x64, 0x79, 0x12, 0x2a, 0x0a, 0x11, 0x6d, 0x61, 0x78, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65,
	...
	0x41, 0x73, 0x42, 0x79, 0x74, 0x65, 0x73, 0x1a, 0xf6, 0x07, 0x0a, 0x26, 0x45, 0x6e, 0x76, 0x6f,
	0x79, 0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69,
	0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x74, 0x74, 0x70, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64,
	...
	,
	...
	0x69, 0x64, 0x65, 0x72, 0x2e, 0x49, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x41, 0x64, 0x64, 0x69,
	0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x49, 0x6e, 0x43,
	0x68, 0x65, 0x63, 0x6b, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x1f, 0x69, 0x6e, 0x63, 0x6c, 0x75,
	0x64, 0x65, 0x41, 0x64, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x48, 0x65, 0x61, 0x64,
	0x65, 0x72, 0x73, 0x49, 0x6e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x12, 0x99, 0x01, 0x0a, 0x1d, 0x69,
	0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x62,
	0x6f, 0x64, 0x79, 0x5f, 0x69, 0x6e, 0x5f, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x18, 0x0c, 0x20, 0x01,
	...
	,
	...
	0x1a, 0xec, 0x02, 0x0a, 0x26, 0x45, 0x6e, 0x76, 0x6f, 0x79, 0x45, 0x78, 0x74, 0x65, 0x72, 0x6e,
	0x61, 0x6c, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x47,
	0x72, 0x70, 0x63, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x12, 0x18, 0x0a, 0x07, 0x73,
	...
	,
	...
	0x42, 0x6f, 0x64, 0x79, 0x52, 0x19, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x42, 0x6f, 0x64, 0x79, 0x49, 0x6e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x1a,
	0x9e, 0x01, 0x0a, 0x15, 0x5a, 0x69, 0x70, 0x6b, 0x69, 0x6e, 0x54, 0x72, 0x61, 0x63, 0x69, 0x6e,
	...
	0x0c, 0x6d, 0x61, 0x78, 0x54, 0x61, 0x67, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x12, 0x31, 0x0a,
	0x15, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x36, 0x34, 0x62, 0x69, 0x74, 0x5f, 0x74, 0x72,
	0x61, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x12, 0x65, 0x6e,
	0x61, 0x62, 0x6c, 0x65, 0x36, 0x34, 0x62, 0x69, 0x74, 0x54, 0x72, 0x61, 0x63, 0x65, 0x49, 0x64,
