...
type MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider struct {
	...
	// On timeout, the communication with the authorization service is considered failed, see fail_open for the response
	// in this case.
	...
	// Note that client request of the same key or headers specified in include_headers_in_check will be overridden.
	AdditionalHeadersInCheck map[string]string `protobuf:"bytes,11,rep,name=additional_headers_in_check,json=additionalHeadersInCheck,proto3" json:"additionalHeadersInCheck,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) GetAdditionalHeadersInCheck() map[string]string {
	if m != nil {
		return m.AdditionalHeadersInCheck
	}
	return nil
}
...
type MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationGrpcProvider struct {
	...
	// On timeout, the communication with the authorization service is considered failed, see the fail_open for the response in this case.
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationHttpProvider.AdditionalHeadersInCheckEntry")
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AdditionalHeadersInCheck) > 0 {
		for k := range m.AdditionalHeadersInCheck {
			v := m.AdditionalHeadersInCheck[k]
			baseI := i
			i -= len(v)
			copy(dAtA[i:], v)
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) Size() (n int) {
	...
	if len(m.AdditionalHeadersInCheck) > 0 {
		for k, v := range m.AdditionalHeadersInCheck {
			_ = k
			_ = v
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AdditionalHeadersInCheck", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.AdditionalHeadersInCheck == nil {
				m.AdditionalHeadersInCheck = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.AdditionalHeadersInCheck[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipConfig(dAtA[iNdEx:])
