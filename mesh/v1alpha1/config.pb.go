...
// A shortcut for specifying how to select the node IPs for nodeport Gateways.
type MeshConfig_NodePortGatewayIPSelection_Mode int32

const (
	// Nodeport gateway services will not be routable automatically from other clusters.
	// Note: you can still explicitly specify one or more gateway node IPs in the mesh networks.
	MeshConfig_NodePortGatewayIPSelection_DISALLOW_NODE_IPS MeshConfig_NodePortGatewayIPSelection_Mode = 0
	// Use any node IP in the cluster for routing to nodeport
	// gateway services. Note that
	// `networking.istio.io/gatewayNodeSelector` annotation can be
	// used to further refine the set of nodes that should be used
	// for a particular gateway service.
	MeshConfig_NodePortGatewayIPSelection_USE_ANY_NODE_IP MeshConfig_NodePortGatewayIPSelection_Mode = 1
	// Use only nodes selected by the specified label selector.
	MeshConfig_NodePortGatewayIPSelection_USE_NODES_WITH_LABEL MeshConfig_NodePortGatewayIPSelection_Mode = 2
)

var MeshConfig_NodePortGatewayIPSelection_Mode_name = map[int32]string{
	0: "DISALLOW_NODE_IPS",
	1: "USE_ANY_NODE_IP",
	2: "USE_NODES_WITH_LABEL",
}

var MeshConfig_NodePortGatewayIPSelection_Mode_value = map[string]int32{
	"DISALLOW_NODE_IPS":    0,
	"USE_ANY_NODE_IP":      1,
	"USE_NODES_WITH_LABEL": 2,
}

func (x MeshConfig_NodePortGatewayIPSelection_Mode) String() string {
	return proto.EnumName(MeshConfig_NodePortGatewayIPSelection_Mode_name, int32(x))
}

func (MeshConfig_NodePortGatewayIPSelection_Mode) EnumDescriptor() ([]byte, []int) {
...
type MeshConfig struct {
	...
	// In very large clusters using NodePort type gateways, allowing a
	// VM to route to the gateway via any node in the cluster may not be
	// preferable. In such scenarios, this configuration specifies
	// global defaults that determine the specific set of nodes that
	// should be used for routing to any NodePort type gateway.
	NodeportGatewayIpSelection *MeshConfig_NodePortGatewayIPSelection `protobuf:"bytes,52,opt,name=nodeport_gateway_ip_selection,json=nodeportGatewayIpSelection,proto3" json:"nodeportGatewayIpSelection,omitempty"`
...
func (m *MeshConfig) GetNodeportGatewayIpSelection() *MeshConfig_NodePortGatewayIPSelection {
	if m != nil {
		return m.NodeportGatewayIpSelection
	}
	return nil
}
...
type MeshConfig_NodePortGatewayIPSelection struct {
	// Determines how node IPs will be selected for gateways of NodePort type.
	NodeSelectionMode MeshConfig_NodePortGatewayIPSelection_Mode `protobuf:"varint,1,opt,name=node_selection_mode,json=nodeSelectionMode,proto3,enum=istio.mesh.v1alpha1.MeshConfig_NodePortGatewayIPSelection_Mode" json:"nodeSelectionMode,omitempty"`
	// When the mode is CUSTOM, use the nodeLabels to select a
	// specific set of nodes whose node IPs should be used for
	// Gateways. Note that `networking.istio.io/gatewayNodeSelector`
	// annotation can be used to further refine the set of nodes that
	// should be used for a particular gateway service.
	NodeLabels           map[string]string `protobuf:"bytes,2,rep,name=node_labels,json=nodeLabels,proto3" json:"nodeLabels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}

func (m *MeshConfig_NodePortGatewayIPSelection) Reset()         { *m = MeshConfig_NodePortGatewayIPSelection{} }
func (m *MeshConfig_NodePortGatewayIPSelection) String() string { return proto.CompactTextString(m) }
func (*MeshConfig_NodePortGatewayIPSelection) ProtoMessage()    {}
func (*MeshConfig_NodePortGatewayIPSelection) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 2}
}
func (m *MeshConfig_NodePortGatewayIPSelection) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_NodePortGatewayIPSelection) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_NodePortGatewayIPSelection.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_NodePortGatewayIPSelection) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_NodePortGatewayIPSelection.Merge(m, src)
}
func (m *MeshConfig_NodePortGatewayIPSelection) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_NodePortGatewayIPSelection) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_NodePortGatewayIPSelection.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_NodePortGatewayIPSelection proto.InternalMessageInfo

func (m *MeshConfig_NodePortGatewayIPSelection) GetNodeSelectionMode() MeshConfig_NodePortGatewayIPSelection_Mode {
	if m != nil {
		return m.NodeSelectionMode
	}
	return MeshConfig_NodePortGatewayIPSelection_DISALLOW_NODE_IPS
}

func (m *MeshConfig_NodePortGatewayIPSelection) GetNodeLabels() map[string]string {
	if m != nil {
		return m.NodeLabels
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("istio.mesh.v1alpha1.MeshConfig_NodePortGatewayIPSelection_Mode", MeshConfig_NodePortGatewayIPSelection_Mode_name, MeshConfig_NodePortGatewayIPSelection_Mode_value)
	...
	proto.RegisterType((*MeshConfig_NodePortGatewayIPSelection)(nil), "istio.mesh.v1alpha1.MeshConfig.NodePortGatewayIPSelection")
	proto.RegisterMapType((map[string]string)(nil), "istio.mesh.v1alpha1.MeshConfig.NodePortGatewayIPSelection.NodeLabelsEntry")
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.NodeportGatewayIpSelection != nil {
		{
			size, err := m.NodeportGatewayIpSelection.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MeshConfig_NodePortGatewayIPSelection) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_NodePortGatewayIPSelection) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MeshConfig_NodePortGatewayIPSelection) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.NodeSelectionMode != 0 {
		i = encodeVarintConfig(dAtA, i, uint64(m.NodeSelectionMode))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *MeshConfig) Size() (n int) {
	...
	if m.NodeportGatewayIpSelection != nil {
		l = m.NodeportGatewayIpSelection.Size()
		n += 2 + l + sovConfig(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *MeshConfig_NodePortGatewayIPSelection) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.NodeSelectionMode != 0 {
		n += 1 + sovConfig(uint64(m.NodeSelectionMode))
	}
	if len(m.NodeLabels) > 0 {
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 52:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NodeportGatewayIpSelection", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.NodeportGatewayIpSelection == nil {
				m.NodeportGatewayIpSelection = &MeshConfig_NodePortGatewayIPSelection{}
			}
			if err := m.NodeportGatewayIpSelection.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *MeshConfig_NodePortGatewayIPSelection) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NodePortGatewayIPSelection: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NodePortGatewayIPSelection: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NodeSelectionMode", wireType)
			}
			m.NodeSelectionMode = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowConfig
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NodeSelectionMode |= MeshConfig_NodePortGatewayIPSelection_Mode(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
