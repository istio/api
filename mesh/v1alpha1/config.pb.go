...
func (AuthenticationPolicy) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (MeshConfig_AuthPolicy) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{1, 1} }
...
func (*ProxyConfig) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*MeshConfig) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func init() { proto.RegisterFile("mesh/v1alpha1/config.proto", fileDescriptor1) }
