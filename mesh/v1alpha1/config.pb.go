...
type MeshConfig struct {
	...
	OutlierDetection *istio_networking_v1alpha31.OutlierDetection `protobuf:"bytes,36,opt,name=outlier_detection,json=outlierDetection" json:"outlier_detection,omitempty"`
}
...
func (m *MeshConfig) GetOutlierDetection() *istio_networking_v1alpha31.OutlierDetection {
	if m != nil {
...
func (m *MeshConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OutlierDetection != nil {
		...
		n8, err := m.OutlierDetection.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 36:
			...
			if m.OutlierDetection == nil {
				m.OutlierDetection = &istio_networking_v1alpha31.OutlierDetection{}
			}
...
var fileDescriptorConfig = []byte{
	...
	,
}
