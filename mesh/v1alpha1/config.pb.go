...
type MeshConfig struct {
	...
	// Defines which gateway to use as the Ingress controller. This field corresponds to
	// the Gateway.selector field, meaning these labels will be matched against pod labels.
	// For example, `istio: ingressgateway` will select the default IngressGateway - this is also the
	// default behavior if not specified.
	IngressSelector map[string]string `protobuf:"bytes,52,rep,name=ingress_selector,json=ingressSelector,proto3" json:"ingressSelector,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// $hide_from_docs
...
func (m *MeshConfig) GetIngressSelector() map[string]string {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "istio.mesh.v1alpha1.MeshConfig.IngressSelectorEntry")
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.IngressSelector) > 0 {
		for k := range m.IngressSelector {
			v := m.IngressSelector[k]
			baseI := i
			i -= len(v)
			copy(dAtA[i:], v)
...
func (m *MeshConfig) Size() (n int) {
	...
	if len(m.IngressSelector) > 0 {
		for k, v := range m.IngressSelector {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovConfig(uint64(len(k))) + 1 + len(v) + sovConfig(uint64(len(v)))
			n += mapEntrySize + 2 + sovConfig(uint64(mapEntrySize))
		}
	}
	if m.XXX_unrecognized != nil {
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 52:
			...
			if m.IngressSelector == nil {
				m.IngressSelector = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.IngressSelector[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipConfig(dAtA[iNdEx:])
