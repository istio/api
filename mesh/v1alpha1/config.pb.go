...
type MeshConfig struct {
	...
	// The flag instructs Pilot to allow traffic to ports for which no
	...
	// Service Entry exist.
	AllowTrafficToUnknownPorts bool `protobuf:"varint,31,opt,name=allow_traffic_to_unknown_ports,json=allowTrafficToUnknownPorts,proto3" json:"allow_traffic_to_unknown_ports,omitempty"`
}
...
func (m *MeshConfig) GetAllowTrafficToUnknownPorts() bool {
	if m != nil {
		return m.AllowTrafficToUnknownPorts
	}
	return false
}
...
func (m *MeshConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AllowTrafficToUnknownPorts {
		dAtA[i] = 0xf8
		i++
		dAtA[i] = 0x1
		i++
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 31:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AllowTrafficToUnknownPorts", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AllowTrafficToUnknownPorts = bool(v != 0)
		default:
			iNdEx = preIndex
...
var fileDescriptorConfig = []byte{
	...
	,
}
