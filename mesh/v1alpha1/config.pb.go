...
type MeshConfig struct {
	...
	// $hide_from_docs
	// Set the namespaces whose services will be considered local to the cluster. Cluster
	// local services will not be exported to and will, therefore, not be accessible by
	// workloads residing in other clusters. A common use case is the Kube API Server, where
	...
	CustomTags           []*MeshConfig_CustomTags `protobuf:"bytes,52,rep,name=custom_tags,json=customTags,proto3" json:"customTags,omitempty"`
...
func (m *MeshConfig) GetClusterLocalNamespaces() []string {
	if m != nil {
		return m.ClusterLocalNamespaces
	}
	return nil
}
...
func (m *MeshConfig) GetCustomTags() []*MeshConfig_CustomTags {
	if m != nil {
		return m.CustomTags
	}
	return nil
...
type MeshConfig_CustomTags struct {
	// Used to populate the tag name.
	Tag string `protobuf:"bytes,1,opt,name=tag,proto3" json:"tag,omitempty"`
	// Used to specify what kind of custom tag.
	//
	// Types that are valid to be assigned to Type:
	//	*MeshConfig_CustomTags_Literal
	//	*MeshConfig_CustomTags_Environment
	//	*MeshConfig_CustomTags_Header
	Type                 isMeshConfig_CustomTags_Type `protobuf_oneof:"type"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_unrecognized     []byte                       `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}

func (m *MeshConfig_CustomTags) Reset()         { *m = MeshConfig_CustomTags{} }
func (m *MeshConfig_CustomTags) String() string { return proto.CompactTextString(m) }
func (*MeshConfig_CustomTags) ProtoMessage()    {}
func (*MeshConfig_CustomTags) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 2}
}
func (m *MeshConfig_CustomTags) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_CustomTags) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_CustomTags.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_CustomTags) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_CustomTags.Merge(m, src)
}
func (m *MeshConfig_CustomTags) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_CustomTags) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_CustomTags.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_CustomTags proto.InternalMessageInfo

type isMeshConfig_CustomTags_Type interface {
	isMeshConfig_CustomTags_Type()
	MarshalTo([]byte) (int, error)
	Size() int
}

type MeshConfig_CustomTags_Literal struct {
	Literal *MeshConfig_Literal `protobuf:"bytes,2,opt,name=literal,proto3,oneof"`
}
type MeshConfig_CustomTags_Environment struct {
	Environment *MeshConfig_Environment `protobuf:"bytes,3,opt,name=environment,proto3,oneof"`
}
type MeshConfig_CustomTags_Header struct {
	Header *MeshConfig_Header `protobuf:"bytes,4,opt,name=header,proto3,oneof"`
}

func (*MeshConfig_CustomTags_Literal) isMeshConfig_CustomTags_Type()     {}
func (*MeshConfig_CustomTags_Environment) isMeshConfig_CustomTags_Type() {}
func (*MeshConfig_CustomTags_Header) isMeshConfig_CustomTags_Type()      {}

func (m *MeshConfig_CustomTags) GetType() isMeshConfig_CustomTags_Type {
	if m != nil {
		return m.Type
	}
	return nil
...
func (m *MeshConfig_CustomTags) GetTag() string {
	if m != nil {
		return m.Tag
	}
	return ""
...
func (m *MeshConfig_CustomTags) GetLiteral() *MeshConfig_Literal {
	if x, ok := m.GetType().(*MeshConfig_CustomTags_Literal); ok {
		return x.Literal
	}
	return nil
}

func (m *MeshConfig_CustomTags) GetEnvironment() *MeshConfig_Environment {
	if x, ok := m.GetType().(*MeshConfig_CustomTags_Environment); ok {
		return x.Environment
	}
	return nil
}

func (m *MeshConfig_CustomTags) GetHeader() *MeshConfig_Header {
	if x, ok := m.GetType().(*MeshConfig_CustomTags_Header); ok {
		return x.Header
	}
	return nil
}
...
func (*MeshConfig_CustomTags) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*MeshConfig_CustomTags_Literal)(nil),
		(*MeshConfig_CustomTags_Environment)(nil),
		(*MeshConfig_CustomTags_Header)(nil),
	}
}

// Literal type custom tag with static value for the tag value.
type MeshConfig_Literal struct {
...
func (m *MeshConfig_Literal) Reset()         { *m = MeshConfig_Literal{} }
func (m *MeshConfig_Literal) String() string { return proto.CompactTextString(m) }
func (*MeshConfig_Literal) ProtoMessage()    {}
func (*MeshConfig_Literal) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 3}
}
func (m *MeshConfig_Literal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_Literal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_Literal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_Literal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_Literal.Merge(m, src)
}
func (m *MeshConfig_Literal) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_Literal) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_Literal.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_Literal proto.InternalMessageInfo

func (m *MeshConfig_Literal) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
type MeshConfig_Environment struct {
...
func (m *MeshConfig_Environment) Reset()         { *m = MeshConfig_Environment{} }
func (m *MeshConfig_Environment) String() string { return proto.CompactTextString(m) }
func (*MeshConfig_Environment) ProtoMessage()    {}
func (*MeshConfig_Environment) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 4}
}
func (m *MeshConfig_Environment) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_Environment) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_Environment.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_Environment) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_Environment.Merge(m, src)
}
func (m *MeshConfig_Environment) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_Environment) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_Environment.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_Environment proto.InternalMessageInfo

func (m *MeshConfig_Environment) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *MeshConfig_Environment) GetDefaultValue() string {
	if m != nil {
...
func (m *MeshConfig_Header) Reset()         { *m = MeshConfig_Header{} }
func (m *MeshConfig_Header) String() string { return proto.CompactTextString(m) }
func (*MeshConfig_Header) ProtoMessage()    {}
func (*MeshConfig_Header) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 5}
}
func (m *MeshConfig_Header) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_Header) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_Header.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_Header) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_Header.Merge(m, src)
}
func (m *MeshConfig_Header) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_Header) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_Header.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_Header proto.InternalMessageInfo

func (m *MeshConfig_Header) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *MeshConfig_Header) GetDefaultValue() string {
	if m != nil {
		return m.DefaultValue
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*MeshConfig_CustomTags)(nil), "istio.mesh.v1alpha1.MeshConfig.CustomTags")
	proto.RegisterType((*MeshConfig_Literal)(nil), "istio.mesh.v1alpha1.MeshConfig.Literal")
	proto.RegisterType((*MeshConfig_Environment)(nil), "istio.mesh.v1alpha1.MeshConfig.Environment")
	proto.RegisterType((*MeshConfig_Header)(nil), "istio.mesh.v1alpha1.MeshConfig.Header")
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ClusterLocalNamespaces) > 0 {
		for iNdEx := len(m.ClusterLocalNamespaces) - 1; iNdEx >= 0; iNdEx-- {
			...
			copy(dAtA[i:], m.ClusterLocalNamespaces[iNdEx])
			i = encodeVarintConfig(dAtA, i, uint64(len(m.ClusterLocalNamespaces[iNdEx])))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0x92
...
func (m *MeshConfig_CustomTags) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_CustomTags) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MeshConfig_CustomTags) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Tag) > 0 {
		i -= len(m.Tag)
		copy(dAtA[i:], m.Tag)
		i = encodeVarintConfig(dAtA, i, uint64(len(m.Tag)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *MeshConfig_CustomTags_Literal) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *MeshConfig_CustomTags_Literal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Literal != nil {
		{
...
func (m *MeshConfig_CustomTags_Environment) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *MeshConfig_CustomTags_Environment) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *MeshConfig_CustomTags_Header) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *MeshConfig_CustomTags_Header) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Header != nil {
		{
...
func (m *MeshConfig_Literal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_Literal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MeshConfig_Literal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MeshConfig_Environment) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_Environment) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MeshConfig_Environment) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.DefaultValue) > 0 {
		...
		i = encodeVarintConfig(dAtA, i, uint64(len(m.DefaultValue)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Name) > 0 {
...
func (m *MeshConfig_Header) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_Header) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MeshConfig_Header) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MeshConfig) Size() (n int) {
	...
	if len(m.ClusterLocalNamespaces) > 0 {
		for _, s := range m.ClusterLocalNamespaces {
			l = len(s)
			n += 2 + l + sovConfig(uint64(l))
		}
	}
...
func (m *MeshConfig_CustomTags) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_CustomTags_Literal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_CustomTags_Environment) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_CustomTags_Header) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_Literal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_Environment) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_Header) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 50:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ClusterLocalNamespaces", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 52:
			...
			m.CustomTags = append(m.CustomTags, &MeshConfig_CustomTags{})
...
func (m *MeshConfig_CustomTags) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CustomTags: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CustomTags: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			v := &MeshConfig_Literal{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Type = &MeshConfig_CustomTags_Literal{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			v := &MeshConfig_Environment{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Type = &MeshConfig_CustomTags_Environment{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			m.Type = &MeshConfig_CustomTags_Header{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipConfig(dAtA[iNdEx:])
...
func (m *MeshConfig_Literal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *MeshConfig_Environment) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *MeshConfig_Header) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
