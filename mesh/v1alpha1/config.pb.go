...
type MeshConfig struct {
	...
	// $hide_from_docs
	// Specifies the configuration of the external auth server that will be used by the AuthorizationPolicy EXTERNAL action.
	ExternalAuth         *MeshConfig_ExternalAuth `protobuf:"bytes,56,opt,name=external_auth,json=externalAuth,proto3" json:"externalAuth,omitempty"`
...
func (m *MeshConfig) GetExternalAuth() *MeshConfig_ExternalAuth {
	if m != nil {
		return m.ExternalAuth
	}
	return nil
}
...
// $hide_from_docs
type MeshConfig_ExternalAuth struct {
	// $hide_from_docs
	// Specifies the configuration of the external auth server. The key is the name of the external server and currently
	// only 1 external server is allowed.
	Servers              map[string]*MeshConfig_ExternalAuth_External `protobuf:"bytes,1,rep,name=servers,proto3" json:"servers,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                                     `json:"-"`
	XXX_unrecognized     []byte                                       `json:"-"`
	XXX_sizecache        int32                                        `json:"-"`
}

func (m *MeshConfig_ExternalAuth) Reset()         { *m = MeshConfig_ExternalAuth{} }
func (m *MeshConfig_ExternalAuth) String() string { return proto.CompactTextString(m) }
func (*MeshConfig_ExternalAuth) ProtoMessage()    {}
func (*MeshConfig_ExternalAuth) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 4}
}
func (m *MeshConfig_ExternalAuth) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_ExternalAuth) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_ExternalAuth.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_ExternalAuth) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_ExternalAuth.Merge(m, src)
}
func (m *MeshConfig_ExternalAuth) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_ExternalAuth) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_ExternalAuth.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_ExternalAuth proto.InternalMessageInfo

func (m *MeshConfig_ExternalAuth) GetServers() map[string]*MeshConfig_ExternalAuth_External {
	if m != nil {
		return m.Servers
	}
	return nil
...
// $hide_from_docs
type MeshConfig_ExternalAuth_External struct {
	// REQUIRED. Address of the external server. The external authorization check request will be sent to the external
	// server using either HTTP or gRPC protocol depending on the scheme. For gRPC, the service API is defined by
	// the [Envoy ext_authz check request](https://github.com/envoyproxy/envoy/blob/9dce187eca9aa10e98c0ae81368c078384528801/api/envoy/service/auth/v3/external_auth.proto#L29-L34).
	// e.g. "http://ext-authz.istio-system.svc.cluster.local:8000/", "https://ext-authz.my-company.com:9000" or "grpc://127.0.0.1:9000".
	Address string `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
	...
	// Specifies the TLS mode to use when connecting to the external server.
	TlsSettings *v1alpha3.ClientTLSSettings `protobuf:"bytes,3,opt,name=tls_settings,json=tlsSettings,proto3" json:"tlsSettings,omitempty"`
	...
	IncludeHeaders []string `protobuf:"bytes,4,rep,name=include_headers,json=includeHeaders,proto3" json:"includeHeaders,omitempty"`
	...
	ForwardToUpstream []string `protobuf:"bytes,5,rep,name=forward_to_upstream,json=forwardToUpstream,proto3" json:"forwardToUpstream,omitempty"`
	...
	ForwardToDownstream  []string `protobuf:"bytes,6,rep,name=forward_to_downstream,json=forwardToDownstream,proto3" json:"forwardToDownstream,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *MeshConfig_ExternalAuth_External) Reset()         { *m = MeshConfig_ExternalAuth_External{} }
func (m *MeshConfig_ExternalAuth_External) String() string { return proto.CompactTextString(m) }
func (*MeshConfig_ExternalAuth_External) ProtoMessage()    {}
func (*MeshConfig_ExternalAuth_External) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 4, 0}
}
func (m *MeshConfig_ExternalAuth_External) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_ExternalAuth_External) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_ExternalAuth_External.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_ExternalAuth_External) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_ExternalAuth_External.Merge(m, src)
}
func (m *MeshConfig_ExternalAuth_External) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_ExternalAuth_External) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_ExternalAuth_External.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_ExternalAuth_External proto.InternalMessageInfo

func (m *MeshConfig_ExternalAuth_External) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *MeshConfig_ExternalAuth_External) GetTimeout() *types.Duration {
	if m != nil {
		return m.Timeout
	}
	return nil
...
func (m *MeshConfig_ExternalAuth_External) GetTlsSettings() *v1alpha3.ClientTLSSettings {
	if m != nil {
		return m.TlsSettings
	}
	return nil
...
func (m *MeshConfig_ExternalAuth_External) GetIncludeHeaders() []string {
	if m != nil {
...
func (m *MeshConfig_ExternalAuth_External) GetForwardToUpstream() []string {
	if m != nil {
...
func (m *MeshConfig_ExternalAuth_External) GetForwardToDownstream() []string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*MeshConfig_ExternalAuth)(nil), "istio.mesh.v1alpha1.MeshConfig.ExternalAuth")
	proto.RegisterMapType((map[string]*MeshConfig_ExternalAuth_External)(nil), "istio.mesh.v1alpha1.MeshConfig.ExternalAuth.ServersEntry")
	proto.RegisterType((*MeshConfig_ExternalAuth_External)(nil), "istio.mesh.v1alpha1.MeshConfig.ExternalAuth.External")
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ExternalAuth != nil {
		{
			size, err := m.ExternalAuth.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MeshConfig_ExternalAuth) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_ExternalAuth) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MeshConfig_ExternalAuth) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MeshConfig_ExternalAuth_External) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_ExternalAuth_External) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MeshConfig_ExternalAuth_External) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ConfigSource) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SubscribedResources) > 0 {
		dAtA23 := make([]byte, len(m.SubscribedResources)*10)
		var j22 int
		...
		i = encodeVarintConfig(dAtA, i, uint64(j22))
		i--
		dAtA[i] = 0x1a
	}
	if m.TlsSettings != nil {
...
func (m *MeshConfig_ExternalAuth) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_ExternalAuth_External) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 56:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExternalAuth", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ExternalAuth == nil {
				m.ExternalAuth = &MeshConfig_ExternalAuth{}
			}
			if err := m.ExternalAuth.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *MeshConfig_ExternalAuth) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ExternalAuth: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ExternalAuth: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.Servers == nil {
				m.Servers = make(map[string]*MeshConfig_ExternalAuth_External)
			}
			var mapkey string
			var mapvalue *MeshConfig_ExternalAuth_External
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					mapvalue = &MeshConfig_ExternalAuth_External{}
...
func (m *MeshConfig_ExternalAuth_External) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
