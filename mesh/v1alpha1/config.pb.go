...
type MeshConfig_ExtensionProvider struct {
	...
	//	*MeshConfig_ExtensionProvider_Dynatrace
...
func (x *MeshConfig_ExtensionProvider) GetDynatrace() *MeshConfig_ExtensionProvider_DynatraceTracingProvider {
	if x, ok := x.GetProvider().(*MeshConfig_ExtensionProvider_Dynatrace); ok {
		return x.Dynatrace
	}
	return nil
}
...
type MeshConfig_ExtensionProvider_Dynatrace struct {
	// Configures a Dynatrace-specific OpenTelemetry tracing provider.
	Dynatrace *MeshConfig_ExtensionProvider_DynatraceTracingProvider `protobuf:"bytes,16,opt,name=dynatrace,proto3,oneof"`
}
...
func (*MeshConfig_ExtensionProvider_Dynatrace) isMeshConfig_ExtensionProvider_Provider() {}
...
// Defines configuration for a Dynatrace tracer.
type MeshConfig_ExtensionProvider_DynatraceTracingProvider struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// REQUIRED. Specifies the service for the Dynatrace API.
	// The format is `<Hostname>`. The `<Hostname>` is a fully qualified host name of a
	// service defined by a ServiceEntry.
	//
	// Example: "{your-environment-id}.live.dynatrace.com".
	Service string `protobuf:"bytes,1,opt,name=service,proto3" json:"service,omitempty"`
	// Optional. Specifies the port of the service.
	Port uint32 `protobuf:"varint,2,opt,name=port,proto3" json:"port,omitempty"`
	// Optional. Controls the overall path length allowed in a reported span.
	// NOTE: currently only controls max length of the path tag.
	MaxTagLength uint32 `protobuf:"varint,3,opt,name=max_tag_length,json=maxTagLength,proto3" json:"max_tag_length,omitempty"`
	// REQUIRED. Specifies the Dynatrace API access token.option
	// NOTE: The token needs to have the scopes: `openTelemetryTrace.ingest` and `todo-scope`.
	ApiToken string `protobuf:"bytes,4,opt,name=api_token,json=apiToken,proto3" json:"api_token,omitempty"`
	// REQUIRED. Specifies the Dynatrace cluster identifier.
	ClusterId string `protobuf:"bytes,5,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty"`
	// REQUIRED. Specifies the customer's tenant identifier.
	TenantId string `protobuf:"bytes,6,opt,name=tenant_id,json=tenantId,proto3" json:"tenant_id,omitempty"`
}

func (x *MeshConfig_ExtensionProvider_DynatraceTracingProvider) Reset() {
	*x = MeshConfig_ExtensionProvider_DynatraceTracingProvider{}
	if protoimpl.UnsafeEnabled {
...
func (x *MeshConfig_ExtensionProvider_DynatraceTracingProvider) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MeshConfig_ExtensionProvider_DynatraceTracingProvider) ProtoMessage() {}

func (x *MeshConfig_ExtensionProvider_DynatraceTracingProvider) ProtoReflect() protoreflect.Message {
	mi := &file_mesh_v1alpha1_config_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MeshConfig_ExtensionProvider_DynatraceTracingProvider.ProtoReflect.Descriptor instead.
func (*MeshConfig_ExtensionProvider_DynatraceTracingProvider) Descriptor() ([]byte, []int) {
	return file_mesh_v1alpha1_config_proto_rawDescGZIP(), []int{0, 4, 9}
}

func (x *MeshConfig_ExtensionProvider_DynatraceTracingProvider) GetService() string {
	if x != nil {
		return x.Service
	}
	return ""
...
func (x *MeshConfig_ExtensionProvider_DynatraceTracingProvider) GetPort() uint32 {
	if x != nil {
		return x.Port
	}
	return 0
...
func (x *MeshConfig_ExtensionProvider_DynatraceTracingProvider) GetMaxTagLength() uint32 {
	if x != nil {
		return x.MaxTagLength
	}
	return 0
...
func (x *MeshConfig_ExtensionProvider_DynatraceTracingProvider) GetApiToken() string {
	if x != nil {
		return x.ApiToken
	}
	return ""
...
func (x *MeshConfig_ExtensionProvider_DynatraceTracingProvider) GetClusterId() string {
	if x != nil {
		return x.ClusterId
	}
	return ""
...
func (x *MeshConfig_ExtensionProvider_DynatraceTracingProvider) GetTenantId() string {
	if x != nil {
		return x.TenantId
	}
	return ""
...
func (*MeshConfig_ExtensionProvider_EnvoyFileAccessLogProvider_LogFormat) Descriptor() ([]byte, []int) {
	return file_mesh_v1alpha1_config_proto_rawDescGZIP(), []int{0, 4, 11, 0}
}
...
var file_mesh_v1alpha1_config_proto_rawDesc = []byte{
	...
	0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9e, 0x5b, 0x0a, 0x0a, 0x4d, 0x65, 0x73, 0x68,
	...
	0x73, 0x74, 0x69, 0x6f, 0x64, 0x53, 0x69, 0x64, 0x65, 0x1a, 0xee, 0x31, 0x0a, 0x11, 0x45, 0x78,
	...
	0x61, 0x63, 0x69, 0x6e, 0x67, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x48, 0x00, 0x52,
	0x0d, 0x6f, 0x70, 0x65, 0x6e, 0x74, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x12, 0x6a,
	0x0a, 0x09, 0x64, 0x79, 0x6e, 0x61, 0x74, 0x72, 0x61, 0x63, 0x65, 0x18, 0x10, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x4a, 0x2e, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x76,
	...
	0x69, 0x64, 0x65, 0x72, 0x2e, 0x44, 0x79, 0x6e, 0x61, 0x74, 0x72, 0x61, 0x63, 0x65, 0x54, 0x72,
	0x61, 0x63, 0x69, 0x6e, 0x67, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x48, 0x00, 0x52,
	0x09, 0x64, 0x79, 0x6e, 0x61, 0x74, 0x72, 0x61, 0x63, 0x65, 0x12, 0x6d, 0x0a, 0x0a, 0x70, 0x72,
	...
	0x52, 0x0b, 0x70, 0x61, 0x63, 0x6b, 0x41, 0x73, 0x42, 0x79, 0x74, 0x65, 0x73, 0x1a, 0xf6, 0x07,
	...
	0x77, 0x6e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x4f, 0x6e, 0x44, 0x65, 0x6e, 0x79, 0x12, 0x42,
	0x0a, 0x1e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x5f, 0x74, 0x6f, 0x5f, 0x64, 0x6f, 0x77,
	0x6e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x5f, 0x6f, 0x6e, 0x5f, 0x61, 0x6c, 0x6c, 0x6f, 0x77,
	0x18, 0x0d, 0x20, 0x03, 0x28, 0x09, 0x52, 0x1a, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x54,
	0x6f, 0x44, 0x6f, 0x77, 0x6e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x4f, 0x6e, 0x41, 0x6c, 0x6c,
	0x6f, 0x77, 0x1a, 0x52, 0x0a, 0x24, 0x49, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x41, 0x64, 0x64,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0xec, 0x02, 0x0a, 0x26, 0x45, 0x6e, 0x76, 0x6f, 0x79,
	...
	0x65, 0x6f, 0x75, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x66, 0x61, 0x69, 0x6c, 0x5f, 0x6f, 0x70, 0x65,
	0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x66, 0x61, 0x69, 0x6c, 0x4f, 0x70, 0x65,
	0x6e, 0x12, 0x26, 0x0a, 0x0f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x5f, 0x6f, 0x6e, 0x5f, 0x65,
	0x72, 0x72, 0x6f, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x4f, 0x6e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x99, 0x01, 0x0a, 0x1d, 0x69, 0x6e,
	0x63, 0x6c, 0x75, 0x64, 0x65, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x62, 0x6f,
	0x64, 0x79, 0x5f, 0x69, 0x6e, 0x5f, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x18, 0x06, 0x20, 0x01, 0x28,
	...
	0x43, 0x68, 0x65, 0x63, 0x6b, 0x1a, 0x9e, 0x01, 0x0a, 0x15, 0x5a, 0x69, 0x70, 0x6b, 0x69, 0x6e,
	...
	0x67, 0x74, 0x68, 0x12, 0x31, 0x0a, 0x15, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x36, 0x34,
	0x62, 0x69, 0x74, 0x5f, 0x74, 0x72, 0x61, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x12, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x36, 0x34, 0x62, 0x69, 0x74, 0x54,
	0x72, 0x61, 0x63, 0x65, 0x49, 0x64, 0x1a, 0x91, 0x01, 0x0a, 0x18, 0x4c, 0x69, 0x67, 0x68, 0x74,
	...
	0xc7, 0x01, 0x0a, 0x18, 0x44, 0x79, 0x6e, 0x61, 0x74, 0x72, 0x61, 0x63, 0x65, 0x54, 0x72, 0x61,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x61, 0x70, 0x69, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x1d, 0x0a,
	...
	0x08, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x49, 0x64, 0x1a, 0x1b, 0x0a, 0x19, 0x50, 0x72, 0x6f,
...
var file_mesh_v1alpha1_config_proto_goTypes = []interface{}{
	...
	(*MeshConfig_ExtensionProvider_DynatraceTracingProvider)(nil),                 // 30: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.DynatraceTracingProvider
...
var file_mesh_v1alpha1_config_proto_depIdxs = []int32{
	...
	49, // 25: istio.mesh.v1alpha1.ConfigSource.tls_settings:type_name -> istio.networking.v1alpha3.ClientTLSSettings
	...
	49, // 29: istio.mesh.v1alpha1.MeshConfig.CA.tls_settings:type_name -> istio.networking.v1alpha3.ClientTLSSettings
	42, // 30: istio.mesh.v1alpha1.MeshConfig.CA.request_timeout:type_name -> google.protobuf.Duration
	...
	36, // 39: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.opentelemetry:type_name -> istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.OpenTelemetryTracingProvider
	30, // 40: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.dynatrace:type_name -> istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.DynatraceTracingProvider
	...
	42, // 48: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationHttpProvider.timeout:type_name -> google.protobuf.Duration
	37, // 49: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationHttpProvider.include_additional_headers_in_check:type_name -> istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationHttpProvider.IncludeAdditionalHeadersInCheckEntry
	21, // 50: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationHttpProvider.include_request_body_in_check:type_name -> istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationRequestBody
	42, // 51: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationGrpcProvider.timeout:type_name -> google.protobuf.Duration
	21, // 52: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationGrpcProvider.include_request_body_in_check:type_name -> istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationRequestBody
	50, // 53: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.StackdriverProvider.max_number_of_attributes:type_name -> google.protobuf.Int64Value
	50, // 54: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.StackdriverProvider.max_number_of_annotations:type_name -> google.protobuf.Int64Value
	50, // 55: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.StackdriverProvider.max_number_of_message_events:type_name -> google.protobuf.Int64Value
	38, // 56: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.StackdriverProvider.logging:type_name -> istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.StackdriverProvider.Logging
	6,  // 57: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.OpenCensusAgentTracingProvider.context:type_name -> istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.OpenCensusAgentTracingProvider.TraceContext
	40, // 58: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyFileAccessLogProvider.log_format:type_name -> istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyFileAccessLogProvider.LogFormat
	41, // 59: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyOpenTelemetryLogProvider.log_format:type_name -> istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyOpenTelemetryLogProvider.LogFormat
	39, // 60: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.StackdriverProvider.Logging.labels:type_name -> istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.StackdriverProvider.Logging.LabelsEntry
	51, // 61: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyFileAccessLogProvider.LogFormat.labels:type_name -> google.protobuf.Struct
	51, // 62: istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyOpenTelemetryLogProvider.LogFormat.labels:type_name -> google.protobuf.Struct
...
func file_mesh_v1alpha1_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mesh_v1alpha1_config_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MeshConfig_ExtensionProvider_DynatraceTracingProvider); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_mesh_v1alpha1_config_proto_msgTypes[7].OneofWrappers = []interface{}{
		...
		(*MeshConfig_ExtensionProvider_Dynatrace)(nil),
