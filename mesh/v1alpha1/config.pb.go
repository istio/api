...
const (
	...
	OFF MeshConfig_IngressControllerMode = 0
	...
	DEFAULT MeshConfig_IngressControllerMode = 1
	// Istio ingress controller will only act on ingress resources whose
	// annotations match the value specified in the ingress_class parameter
	// described earlier. Use this mode if Istio ingress controller will be
	// a secondary ingress controller (e.g., in addition to a
	// cloud-provided ingress controller).
	STRICT MeshConfig_IngressControllerMode = 2
)
...
const (
	NONE       MeshConfig_AuthPolicy = 0
	MUTUAL_TLS MeshConfig_AuthPolicy = 1
)
...
const (
	TEXT MeshConfig_AccessLogEncoding = 0
	JSON MeshConfig_AccessLogEncoding = 1
)
...
const (
	...
	DO_NOT_UPGRADE MeshConfig_H2UpgradePolicy = 0
	// Upgrade the connections to http2.
	UPGRADE MeshConfig_H2UpgradePolicy = 1
)
...
const (
	...
	REGISTRY_ONLY MeshConfig_OutboundTrafficPolicy_Mode = 0
	// outbound traffic to unknown destinations will be allowed, in case
	// there are no services or ServiceEntries for the destination port
	ALLOW_ANY MeshConfig_OutboundTrafficPolicy_Mode = 1
)
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (x MeshConfig_IngressControllerMode) String() string {
	s, ok := MeshConfig_IngressControllerMode_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (x MeshConfig_AuthPolicy) String() string {
	s, ok := MeshConfig_AuthPolicy_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (x MeshConfig_AccessLogEncoding) String() string {
	s, ok := MeshConfig_AccessLogEncoding_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (x MeshConfig_H2UpgradePolicy) String() string {
	s, ok := MeshConfig_H2UpgradePolicy_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (x MeshConfig_OutboundTrafficPolicy_Mode) String() string {
	s, ok := MeshConfig_OutboundTrafficPolicy_Mode_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (this *MeshConfig) Equal(that interface{}) bool {
	...
	if this.MixerCheckServer != that1.MixerCheckServer {
		return false
	}
	if this.MixerReportServer != that1.MixerReportServer {
		return false
	}
	if this.DisablePolicyChecks != that1.DisablePolicyChecks {
		return false
	}
	if this.DisableMixerHttpReports != that1.DisableMixerHttpReports {
		return false
	}
	if this.PolicyCheckFailOpen != that1.PolicyCheckFailOpen {
		return false
	}
	if this.SidecarToTelemetrySessionAffinity != that1.SidecarToTelemetrySessionAffinity {
		return false
	}
	if this.ProxyListenPort != that1.ProxyListenPort {
		return false
	}
	if this.ProxyHttpPort != that1.ProxyHttpPort {
		return false
	}
	if !this.ConnectTimeout.Equal(that1.ConnectTimeout) {
		return false
	}
	if !this.ProtocolDetectionTimeout.Equal(that1.ProtocolDetectionTimeout) {
		return false
	}
	if !this.TcpKeepalive.Equal(that1.TcpKeepalive) {
		return false
	}
	if this.IngressClass != that1.IngressClass {
		return false
	}
	if this.IngressService != that1.IngressService {
		return false
	}
	if this.IngressControllerMode != that1.IngressControllerMode {
		return false
	}
	if this.AuthPolicy != that1.AuthPolicy {
		return false
	}
	if !this.RdsRefreshDelay.Equal(that1.RdsRefreshDelay) {
		return false
	}
	if this.EnableTracing != that1.EnableTracing {
		return false
	}
	if this.AccessLogFile != that1.AccessLogFile {
		return false
	}
	if this.AccessLogFormat != that1.AccessLogFormat {
		return false
	}
	if this.AccessLogEncoding != that1.AccessLogEncoding {
		return false
	}
	if this.EnableEnvoyAccessLogService != that1.EnableEnvoyAccessLogService {
		return false
	}
	if !this.DefaultConfig.Equal(that1.DefaultConfig) {
		return false
	}
	if this.MixerAddress != that1.MixerAddress {
		return false
	}
	if !this.OutboundTrafficPolicy.Equal(that1.OutboundTrafficPolicy) {
		return false
	}
	if this.EnableClientSidePolicyCheck != that1.EnableClientSidePolicyCheck {
		return false
	}
	if this.SdsUdsPath != that1.SdsUdsPath {
		return false
	}
	if !this.SdsRefreshDelay.Equal(that1.SdsRefreshDelay) {
		return false
	}
	if len(this.ConfigSources) != len(that1.ConfigSources) {
		return false
	}
	for i := range this.ConfigSources {
		if !this.ConfigSources[i].Equal(that1.ConfigSources[i]) {
			return false
		}
	}
	if !this.EnableAutoMtls.Equal(that1.EnableAutoMtls) {
		return false
	}
	if this.EnableSdsTokenMount != that1.EnableSdsTokenMount {
		return false
	}
	if this.SdsUseK8SSaJwt != that1.SdsUseK8SSaJwt {
		return false
	}
	if this.TrustDomain != that1.TrustDomain {
		return false
	}
	if len(this.TrustDomainAliases) != len(that1.TrustDomainAliases) {
		return false
	}
	for i := range this.TrustDomainAliases {
		if this.TrustDomainAliases[i] != that1.TrustDomainAliases[i] {
			return false
		}
	}
	if len(this.DefaultServiceExportTo) != len(that1.DefaultServiceExportTo) {
		return false
	}
	for i := range this.DefaultServiceExportTo {
		if this.DefaultServiceExportTo[i] != that1.DefaultServiceExportTo[i] {
			return false
		}
	}
	if len(this.DefaultVirtualServiceExportTo) != len(that1.DefaultVirtualServiceExportTo) {
		return false
	}
	for i := range this.DefaultVirtualServiceExportTo {
		if this.DefaultVirtualServiceExportTo[i] != that1.DefaultVirtualServiceExportTo[i] {
			return false
		}
	}
	if len(this.DefaultDestinationRuleExportTo) != len(that1.DefaultDestinationRuleExportTo) {
		return false
	}
	for i := range this.DefaultDestinationRuleExportTo {
		if this.DefaultDestinationRuleExportTo[i] != that1.DefaultDestinationRuleExportTo[i] {
			return false
		}
	}
	if this.RootNamespace != that1.RootNamespace {
		return false
	}
	if !this.LocalityLbSetting.Equal(that1.LocalityLbSetting) {
		return false
	}
	if !this.DnsRefreshRate.Equal(that1.DnsRefreshRate) {
		return false
	}
	if this.DisableReportBatch != that1.DisableReportBatch {
		return false
	}
	if this.ReportBatchMaxEntries != that1.ReportBatchMaxEntries {
		return false
	}
	if !this.ReportBatchMaxTime.Equal(that1.ReportBatchMaxTime) {
		return false
	}
	if this.H2UpgradePolicy != that1.H2UpgradePolicy {
		return false
	}
	if this.InboundClusterStatName != that1.InboundClusterStatName {
		return false
	}
	if this.OutboundClusterStatName != that1.OutboundClusterStatName {
		return false
	}
...
func (this *MeshConfig_OutboundTrafficPolicy) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*MeshConfig_OutboundTrafficPolicy)
	if !ok {
		that2, ok := that.(MeshConfig_OutboundTrafficPolicy)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ConfigSource) Equal(that interface{}) bool {
	...
	if len(this.SubscribedResources) != len(that1.SubscribedResources) {
		return false
	}
	for i := range this.SubscribedResources {
		if this.SubscribedResources[i] != that1.SubscribedResources[i] {
			return false
		}
	}
	return true
...
func (this *Certificate) Equal(that interface{}) bool {
	...
	if len(this.DnsNames) != len(that1.DnsNames) {
		return false
	}
	for i := range this.DnsNames {
		if this.DnsNames[i] != that1.DnsNames[i] {
			return false
		}
	}
	return true
}
func (this *MeshConfig) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 50)
	s = append(s, "&v1alpha1.MeshConfig{")
	s = append(s, "MixerCheckServer: "+fmt.Sprintf("%#v", this.MixerCheckServer)+",\n")
	s = append(s, "MixerReportServer: "+fmt.Sprintf("%#v", this.MixerReportServer)+",\n")
	s = append(s, "DisablePolicyChecks: "+fmt.Sprintf("%#v", this.DisablePolicyChecks)+",\n")
	s = append(s, "DisableMixerHttpReports: "+fmt.Sprintf("%#v", this.DisableMixerHttpReports)+",\n")
	s = append(s, "PolicyCheckFailOpen: "+fmt.Sprintf("%#v", this.PolicyCheckFailOpen)+",\n")
	s = append(s, "SidecarToTelemetrySessionAffinity: "+fmt.Sprintf("%#v", this.SidecarToTelemetrySessionAffinity)+",\n")
	s = append(s, "ProxyListenPort: "+fmt.Sprintf("%#v", this.ProxyListenPort)+",\n")
	s = append(s, "ProxyHttpPort: "+fmt.Sprintf("%#v", this.ProxyHttpPort)+",\n")
	if this.ConnectTimeout != nil {
		s = append(s, "ConnectTimeout: "+fmt.Sprintf("%#v", this.ConnectTimeout)+",\n")
	}
	if this.ProtocolDetectionTimeout != nil {
		s = append(s, "ProtocolDetectionTimeout: "+fmt.Sprintf("%#v", this.ProtocolDetectionTimeout)+",\n")
	}
	if this.TcpKeepalive != nil {
		s = append(s, "TcpKeepalive: "+fmt.Sprintf("%#v", this.TcpKeepalive)+",\n")
	}
	s = append(s, "IngressClass: "+fmt.Sprintf("%#v", this.IngressClass)+",\n")
	s = append(s, "IngressService: "+fmt.Sprintf("%#v", this.IngressService)+",\n")
	s = append(s, "IngressControllerMode: "+fmt.Sprintf("%#v", this.IngressControllerMode)+",\n")
	s = append(s, "AuthPolicy: "+fmt.Sprintf("%#v", this.AuthPolicy)+",\n")
	if this.RdsRefreshDelay != nil {
		s = append(s, "RdsRefreshDelay: "+fmt.Sprintf("%#v", this.RdsRefreshDelay)+",\n")
	}
	s = append(s, "EnableTracing: "+fmt.Sprintf("%#v", this.EnableTracing)+",\n")
	s = append(s, "AccessLogFile: "+fmt.Sprintf("%#v", this.AccessLogFile)+",\n")
	s = append(s, "AccessLogFormat: "+fmt.Sprintf("%#v", this.AccessLogFormat)+",\n")
	s = append(s, "AccessLogEncoding: "+fmt.Sprintf("%#v", this.AccessLogEncoding)+",\n")
	s = append(s, "EnableEnvoyAccessLogService: "+fmt.Sprintf("%#v", this.EnableEnvoyAccessLogService)+",\n")
	if this.DefaultConfig != nil {
		s = append(s, "DefaultConfig: "+fmt.Sprintf("%#v", this.DefaultConfig)+",\n")
	}
	s = append(s, "MixerAddress: "+fmt.Sprintf("%#v", this.MixerAddress)+",\n")
	if this.OutboundTrafficPolicy != nil {
		s = append(s, "OutboundTrafficPolicy: "+fmt.Sprintf("%#v", this.OutboundTrafficPolicy)+",\n")
	}
	s = append(s, "EnableClientSidePolicyCheck: "+fmt.Sprintf("%#v", this.EnableClientSidePolicyCheck)+",\n")
	s = append(s, "SdsUdsPath: "+fmt.Sprintf("%#v", this.SdsUdsPath)+",\n")
	if this.SdsRefreshDelay != nil {
		s = append(s, "SdsRefreshDelay: "+fmt.Sprintf("%#v", this.SdsRefreshDelay)+",\n")
	}
	if this.ConfigSources != nil {
		s = append(s, "ConfigSources: "+fmt.Sprintf("%#v", this.ConfigSources)+",\n")
	}
	if this.EnableAutoMtls != nil {
		s = append(s, "EnableAutoMtls: "+fmt.Sprintf("%#v", this.EnableAutoMtls)+",\n")
	}
	s = append(s, "EnableSdsTokenMount: "+fmt.Sprintf("%#v", this.EnableSdsTokenMount)+",\n")
	s = append(s, "SdsUseK8SSaJwt: "+fmt.Sprintf("%#v", this.SdsUseK8SSaJwt)+",\n")
	s = append(s, "TrustDomain: "+fmt.Sprintf("%#v", this.TrustDomain)+",\n")
	s = append(s, "TrustDomainAliases: "+fmt.Sprintf("%#v", this.TrustDomainAliases)+",\n")
	s = append(s, "DefaultServiceExportTo: "+fmt.Sprintf("%#v", this.DefaultServiceExportTo)+",\n")
	s = append(s, "DefaultVirtualServiceExportTo: "+fmt.Sprintf("%#v", this.DefaultVirtualServiceExportTo)+",\n")
	s = append(s, "DefaultDestinationRuleExportTo: "+fmt.Sprintf("%#v", this.DefaultDestinationRuleExportTo)+",\n")
	s = append(s, "RootNamespace: "+fmt.Sprintf("%#v", this.RootNamespace)+",\n")
	if this.LocalityLbSetting != nil {
		s = append(s, "LocalityLbSetting: "+fmt.Sprintf("%#v", this.LocalityLbSetting)+",\n")
	}
	if this.DnsRefreshRate != nil {
		s = append(s, "DnsRefreshRate: "+fmt.Sprintf("%#v", this.DnsRefreshRate)+",\n")
	}
	s = append(s, "DisableReportBatch: "+fmt.Sprintf("%#v", this.DisableReportBatch)+",\n")
	s = append(s, "ReportBatchMaxEntries: "+fmt.Sprintf("%#v", this.ReportBatchMaxEntries)+",\n")
	if this.ReportBatchMaxTime != nil {
		s = append(s, "ReportBatchMaxTime: "+fmt.Sprintf("%#v", this.ReportBatchMaxTime)+",\n")
	}
	s = append(s, "H2UpgradePolicy: "+fmt.Sprintf("%#v", this.H2UpgradePolicy)+",\n")
	s = append(s, "InboundClusterStatName: "+fmt.Sprintf("%#v", this.InboundClusterStatName)+",\n")
	s = append(s, "OutboundClusterStatName: "+fmt.Sprintf("%#v", this.OutboundClusterStatName)+",\n")
...
func (this *MeshConfig_OutboundTrafficPolicy) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&v1alpha1.MeshConfig_OutboundTrafficPolicy{")
...
func (this *ConfigSource) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&v1alpha1.ConfigSource{")
	s = append(s, "Address: "+fmt.Sprintf("%#v", this.Address)+",\n")
	if this.TlsSettings != nil {
		s = append(s, "TlsSettings: "+fmt.Sprintf("%#v", this.TlsSettings)+",\n")
	}
	s = append(s, "SubscribedResources: "+fmt.Sprintf("%#v", this.SubscribedResources)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *Certificate) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&v1alpha1.Certificate{")
	s = append(s, "SecretName: "+fmt.Sprintf("%#v", this.SecretName)+",\n")
	s = append(s, "DnsNames: "+fmt.Sprintf("%#v", this.DnsNames)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *ConfigSource) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SubscribedResources) > 0 {
		dAtA13 := make([]byte, len(m.SubscribedResources)*10)
		var j12 int
		...
		i = encodeVarintConfig(dAtA, i, uint64(j12))
		i--
		dAtA[i] = 0x1a
	}
...
func (this *MeshConfig) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForConfigSources := "[]*ConfigSource{"
	for _, f := range this.ConfigSources {
		repeatedStringForConfigSources += strings.Replace(f.String(), "ConfigSource", "ConfigSource", 1) + ","
	}
	repeatedStringForConfigSources += "}"
	repeatedStringForCertificates := "[]*Certificate{"
	for _, f := range this.Certificates {
		repeatedStringForCertificates += strings.Replace(f.String(), "Certificate", "Certificate", 1) + ","
	}
	repeatedStringForCertificates += "}"
	s := strings.Join([]string{`&MeshConfig{`,
		`MixerCheckServer:` + fmt.Sprintf("%v", this.MixerCheckServer) + `,`,
		`MixerReportServer:` + fmt.Sprintf("%v", this.MixerReportServer) + `,`,
		`DisablePolicyChecks:` + fmt.Sprintf("%v", this.DisablePolicyChecks) + `,`,
		`ProxyListenPort:` + fmt.Sprintf("%v", this.ProxyListenPort) + `,`,
		`ProxyHttpPort:` + fmt.Sprintf("%v", this.ProxyHttpPort) + `,`,
		`ConnectTimeout:` + strings.Replace(fmt.Sprintf("%v", this.ConnectTimeout), "Duration", "types.Duration", 1) + `,`,
		`IngressClass:` + fmt.Sprintf("%v", this.IngressClass) + `,`,
		`IngressService:` + fmt.Sprintf("%v", this.IngressService) + `,`,
		`IngressControllerMode:` + fmt.Sprintf("%v", this.IngressControllerMode) + `,`,
		`AuthPolicy:` + fmt.Sprintf("%v", this.AuthPolicy) + `,`,
		`RdsRefreshDelay:` + strings.Replace(fmt.Sprintf("%v", this.RdsRefreshDelay), "Duration", "types.Duration", 1) + `,`,
		`EnableTracing:` + fmt.Sprintf("%v", this.EnableTracing) + `,`,
		`AccessLogFile:` + fmt.Sprintf("%v", this.AccessLogFile) + `,`,
		`DefaultConfig:` + strings.Replace(fmt.Sprintf("%v", this.DefaultConfig), "ProxyConfig", "ProxyConfig", 1) + `,`,
		`MixerAddress:` + fmt.Sprintf("%v", this.MixerAddress) + `,`,
		`OutboundTrafficPolicy:` + strings.Replace(fmt.Sprintf("%v", this.OutboundTrafficPolicy), "MeshConfig_OutboundTrafficPolicy", "MeshConfig_OutboundTrafficPolicy", 1) + `,`,
		`EnableClientSidePolicyCheck:` + fmt.Sprintf("%v", this.EnableClientSidePolicyCheck) + `,`,
		`SdsUdsPath:` + fmt.Sprintf("%v", this.SdsUdsPath) + `,`,
		`SdsRefreshDelay:` + strings.Replace(fmt.Sprintf("%v", this.SdsRefreshDelay), "Duration", "types.Duration", 1) + `,`,
		`ConfigSources:` + repeatedStringForConfigSources + `,`,
		`EnableSdsTokenMount:` + fmt.Sprintf("%v", this.EnableSdsTokenMount) + `,`,
		`AccessLogFormat:` + fmt.Sprintf("%v", this.AccessLogFormat) + `,`,
		`PolicyCheckFailOpen:` + fmt.Sprintf("%v", this.PolicyCheckFailOpen) + `,`,
		`TrustDomain:` + fmt.Sprintf("%v", this.TrustDomain) + `,`,
		`AccessLogEncoding:` + fmt.Sprintf("%v", this.AccessLogEncoding) + `,`,
		...
		`SdsUseK8SSaJwt:` + fmt.Sprintf("%v", this.SdsUseK8SSaJwt) + `,`,
		`SidecarToTelemetrySessionAffinity:` + fmt.Sprintf("%v", this.SidecarToTelemetrySessionAffinity) + `,`,
		`DefaultServiceExportTo:` + fmt.Sprintf("%v", this.DefaultServiceExportTo) + `,`,
		`DefaultVirtualServiceExportTo:` + fmt.Sprintf("%v", this.DefaultVirtualServiceExportTo) + `,`,
		`DefaultDestinationRuleExportTo:` + fmt.Sprintf("%v", this.DefaultDestinationRuleExportTo) + `,`,
		`RootNamespace:` + fmt.Sprintf("%v", this.RootNamespace) + `,`,
		`LocalityLbSetting:` + strings.Replace(fmt.Sprintf("%v", this.LocalityLbSetting), "LocalityLoadBalancerSetting", "v1alpha3.LocalityLoadBalancerSetting", 1) + `,`,
		`DnsRefreshRate:` + strings.Replace(fmt.Sprintf("%v", this.DnsRefreshRate), "Duration", "types.Duration", 1) + `,`,
		...
		`EnableEnvoyAccessLogService:` + fmt.Sprintf("%v", this.EnableEnvoyAccessLogService) + `,`,
		`H2UpgradePolicy:` + fmt.Sprintf("%v", this.H2UpgradePolicy) + `,`,
		`ProtocolDetectionTimeout:` + strings.Replace(fmt.Sprintf("%v", this.ProtocolDetectionTimeout), "Duration", "types.Duration", 1) + `,`,
		`EnableAutoMtls:` + strings.Replace(fmt.Sprintf("%v", this.EnableAutoMtls), "BoolValue", "types.BoolValue", 1) + `,`,
		`InboundClusterStatName:` + fmt.Sprintf("%v", this.InboundClusterStatName) + `,`,
		`OutboundClusterStatName:` + fmt.Sprintf("%v", this.OutboundClusterStatName) + `,`,
		`TrustDomainAliases:` + fmt.Sprintf("%v", this.TrustDomainAliases) + `,`,
		`Certificates:` + repeatedStringForCertificates + `,`,
		`DisableMixerHttpReports:` + fmt.Sprintf("%v", this.DisableMixerHttpReports) + `,`,
		`}`,
	}, "")
	return s
}
func (this *MeshConfig_OutboundTrafficPolicy) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&MeshConfig_OutboundTrafficPolicy{`,
		`Mode:` + fmt.Sprintf("%v", this.Mode) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ConfigSource) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ConfigSource{`,
		`Address:` + fmt.Sprintf("%v", this.Address) + `,`,
		`TlsSettings:` + strings.Replace(fmt.Sprintf("%v", this.TlsSettings), "TLSSettings", "v1alpha3.TLSSettings", 1) + `,`,
		`SubscribedResources:` + fmt.Sprintf("%v", this.SubscribedResources) + `,`,
		`}`,
	}, "")
	return s
}
