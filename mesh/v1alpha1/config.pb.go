...
type MeshConfig_ExternalServer struct {
	...
	//	*MeshConfig_ExternalServer_Authz_
...
type MeshConfig_ExternalServer_Authz_ struct {
	Authz *MeshConfig_ExternalServer_Authz `protobuf:"bytes,2,opt,name=authz,proto3,oneof"`
}

func (*MeshConfig_ExternalServer_Authz_) isMeshConfig_ExternalServer_Config() {}
...
func (m *MeshConfig_ExternalServer) GetAuthz() *MeshConfig_ExternalServer_Authz {
	if x, ok := m.GetConfig().(*MeshConfig_ExternalServer_Authz_); ok {
		return x.Authz
	}
	return nil
}
...
func (*MeshConfig_ExternalServer) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*MeshConfig_ExternalServer_Authz_)(nil),
	}
}

// $hide_from_docs
// Authz supplies the detail configuration of the external authorization server.
type MeshConfig_ExternalServer_Authz struct {
	...
	// REQUIRED. Specifies the protocol used to talk to the external authorization server.
	//
	// Types that are valid to be assigned to ExternalAuthzServiceType:
	//	*MeshConfig_ExternalServer_Authz_Http
	//	*MeshConfig_ExternalServer_Authz_Grpc
	ExternalAuthzServiceType isMeshConfig_ExternalServer_Authz_ExternalAuthzServiceType `protobuf_oneof:"external_authz_service_type"`
	XXX_NoUnkeyedLiteral     struct{}                                                   `json:"-"`
	XXX_unrecognized         []byte                                                     `json:"-"`
	XXX_sizecache            int32                                                      `json:"-"`
}

func (m *MeshConfig_ExternalServer_Authz) Reset()         { *m = MeshConfig_ExternalServer_Authz{} }
func (m *MeshConfig_ExternalServer_Authz) String() string { return proto.CompactTextString(m) }
func (*MeshConfig_ExternalServer_Authz) ProtoMessage()    {}
func (*MeshConfig_ExternalServer_Authz) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 4, 0}
}
func (m *MeshConfig_ExternalServer_Authz) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_ExternalServer_Authz) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_ExternalServer_Authz.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_ExternalServer_Authz) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_ExternalServer_Authz.Merge(m, src)
}
func (m *MeshConfig_ExternalServer_Authz) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_ExternalServer_Authz) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_ExternalServer_Authz.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_ExternalServer_Authz proto.InternalMessageInfo

type isMeshConfig_ExternalServer_Authz_ExternalAuthzServiceType interface {
	isMeshConfig_ExternalServer_Authz_ExternalAuthzServiceType()
	MarshalTo([]byte) (int, error)
	Size() int
}

type MeshConfig_ExternalServer_Authz_Http struct {
	Http *MeshConfig_ExternalServer_Authz_HTTP `protobuf:"bytes,3,opt,name=http,proto3,oneof"`
}
type MeshConfig_ExternalServer_Authz_Grpc struct {
	Grpc *MeshConfig_ExternalServer_Authz_GRPC `protobuf:"bytes,4,opt,name=grpc,proto3,oneof"`
}

func (*MeshConfig_ExternalServer_Authz_Http) isMeshConfig_ExternalServer_Authz_ExternalAuthzServiceType() {
}
func (*MeshConfig_ExternalServer_Authz_Grpc) isMeshConfig_ExternalServer_Authz_ExternalAuthzServiceType() {
}

func (m *MeshConfig_ExternalServer_Authz) GetExternalAuthzServiceType() isMeshConfig_ExternalServer_Authz_ExternalAuthzServiceType {
	if m != nil {
...
func (m *MeshConfig_ExternalServer_Authz) GetService() *v1alpha3.Destination {
	if m != nil {
		return m.Service
	}
	return nil
...
func (m *MeshConfig_ExternalServer_Authz) GetTimeout() *types.Duration {
	if m != nil {
		return m.Timeout
	}
	return nil
...
func (m *MeshConfig_ExternalServer_Authz) GetHttp() *MeshConfig_ExternalServer_Authz_HTTP {
	if x, ok := m.GetExternalAuthzServiceType().(*MeshConfig_ExternalServer_Authz_Http); ok {
		return x.Http
	}
	return nil
}

func (m *MeshConfig_ExternalServer_Authz) GetGrpc() *MeshConfig_ExternalServer_Authz_GRPC {
	if x, ok := m.GetExternalAuthzServiceType().(*MeshConfig_ExternalServer_Authz_Grpc); ok {
		return x.Grpc
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*MeshConfig_ExternalServer_Authz) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*MeshConfig_ExternalServer_Authz_Http)(nil),
		(*MeshConfig_ExternalServer_Authz_Grpc)(nil),
	}
}
...
type MeshConfig_ExternalServer_Authz_HTTP struct {
	...
	// Note that in addition to the user's supplied headers:
	// 1. *Host*, *Method*, *Path* and *Content-Length* are automatically included to the list.
	// 2. *Content-Length* will be set to 0 and the request will not have a message body.
	IncludeHeaders []string `protobuf:"bytes,2,rep,name=include_headers,json=includeHeaders,proto3" json:"includeHeaders,omitempty"`
	...
	ForwardToUpstream []string `protobuf:"bytes,3,rep,name=forward_to_upstream,json=forwardToUpstream,proto3" json:"forwardToUpstream,omitempty"`
	...
	ForwardToDownstream  []string `protobuf:"bytes,4,rep,name=forward_to_downstream,json=forwardToDownstream,proto3" json:"forwardToDownstream,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *MeshConfig_ExternalServer_Authz_HTTP) Reset()         { *m = MeshConfig_ExternalServer_Authz_HTTP{} }
func (m *MeshConfig_ExternalServer_Authz_HTTP) String() string { return proto.CompactTextString(m) }
func (*MeshConfig_ExternalServer_Authz_HTTP) ProtoMessage()    {}
func (*MeshConfig_ExternalServer_Authz_HTTP) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 4, 0, 0}
}
func (m *MeshConfig_ExternalServer_Authz_HTTP) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_ExternalServer_Authz_HTTP) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_ExternalServer_Authz_HTTP.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_ExternalServer_Authz_HTTP) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_ExternalServer_Authz_HTTP.Merge(m, src)
}
func (m *MeshConfig_ExternalServer_Authz_HTTP) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_ExternalServer_Authz_HTTP) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_ExternalServer_Authz_HTTP.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_ExternalServer_Authz_HTTP proto.InternalMessageInfo

func (m *MeshConfig_ExternalServer_Authz_HTTP) GetPathPrefix() string {
	if m != nil {
		return m.PathPrefix
	}
	return ""
...
func (m *MeshConfig_ExternalServer_Authz_HTTP) GetIncludeHeaders() []string {
	if m != nil {
...
func (m *MeshConfig_ExternalServer_Authz_HTTP) GetForwardToUpstream() []string {
	if m != nil {
...
func (m *MeshConfig_ExternalServer_Authz_HTTP) GetForwardToDownstream() []string {
	if m != nil {
...
func (m *MeshConfig_ExternalServer_Authz_GRPC) Reset()         { *m = MeshConfig_ExternalServer_Authz_GRPC{} }
func (m *MeshConfig_ExternalServer_Authz_GRPC) String() string { return proto.CompactTextString(m) }
func (*MeshConfig_ExternalServer_Authz_GRPC) ProtoMessage()    {}
func (*MeshConfig_ExternalServer_Authz_GRPC) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 4, 0, 1}
}
func (m *MeshConfig_ExternalServer_Authz_GRPC) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_ExternalServer_Authz_GRPC) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_ExternalServer_Authz_GRPC.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_ExternalServer_Authz_GRPC) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_ExternalServer_Authz_GRPC.Merge(m, src)
}
func (m *MeshConfig_ExternalServer_Authz_GRPC) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_ExternalServer_Authz_GRPC) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_ExternalServer_Authz_GRPC.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_ExternalServer_Authz_GRPC proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MeshConfig_ExternalServer_Authz)(nil), "istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz")
	proto.RegisterType((*MeshConfig_ExternalServer_Authz_HTTP)(nil), "istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz.HTTP")
	proto.RegisterType((*MeshConfig_ExternalServer_Authz_GRPC)(nil), "istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authz.GRPC")
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig_ExternalServer_Authz_) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *MeshConfig_ExternalServer_Authz_) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Authz != nil {
		{
			size, err := m.Authz.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MeshConfig_ExternalServer_Authz) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_ExternalServer_Authz) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MeshConfig_ExternalServer_Authz) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MeshConfig_ExternalServer_Authz_Http) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *MeshConfig_ExternalServer_Authz_Http) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Http != nil {
		{
...
func (m *MeshConfig_ExternalServer_Authz_Grpc) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *MeshConfig_ExternalServer_Authz_Grpc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Grpc != nil {
		{
...
func (m *MeshConfig_ExternalServer_Authz_HTTP) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_ExternalServer_Authz_HTTP) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ForwardToDownstream) > 0 {
		for iNdEx := len(m.ForwardToDownstream) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintConfig(dAtA, i, uint64(len(m.ForwardToDownstream[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
	if len(m.ForwardToUpstream) > 0 {
		for iNdEx := len(m.ForwardToUpstream) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintConfig(dAtA, i, uint64(len(m.ForwardToUpstream[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
	if len(m.IncludeHeaders) > 0 {
		for iNdEx := len(m.IncludeHeaders) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.IncludeHeaders[iNdEx])
			copy(dAtA[i:], m.IncludeHeaders[iNdEx])
			i = encodeVarintConfig(dAtA, i, uint64(len(m.IncludeHeaders[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *MeshConfig_ExternalServer_Authz_GRPC) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_ExternalServer_Authz_) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_ExternalServer_Authz) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_ExternalServer_Authz_Http) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_ExternalServer_Authz_Grpc) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_ExternalServer_Authz_HTTP) Size() (n int) {
	...
	if len(m.IncludeHeaders) > 0 {
		for _, s := range m.IncludeHeaders {
			l = len(s)
			n += 1 + l + sovConfig(uint64(l))
		}
	}
...
func (m *MeshConfig_ExternalServer) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			v := &MeshConfig_ExternalServer_Authz{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Config = &MeshConfig_ExternalServer_Authz_{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipConfig(dAtA[iNdEx:])
...
func (m *MeshConfig_ExternalServer_Authz) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Authz: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Authz: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			v := &MeshConfig_ExternalServer_Authz_HTTP{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.ExternalAuthzServiceType = &MeshConfig_ExternalServer_Authz_Http{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			v := &MeshConfig_ExternalServer_Authz_GRPC{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.ExternalAuthzServiceType = &MeshConfig_ExternalServer_Authz_Grpc{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipConfig(dAtA[iNdEx:])
...
func (m *MeshConfig_ExternalServer_Authz_HTTP) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 2:
			...
			m.IncludeHeaders = append(m.IncludeHeaders, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
...
func (m *MeshConfig_ExternalServer_Authz_GRPC) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
