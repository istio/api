...
type MeshConfig_ExtensionProvider_StackdriverProvider struct {
	...
	// Customize the logging behavior of the Stackdriver provider.
	// $hide_from_docs.
...
type MeshConfig_ExtensionProvider_StackdriverProvider_LoggingOptions struct {
	// Turns on gzip-compression of logs when sending to Cloud Logging.
	CompressLogs *types.BoolValue `protobuf:"bytes,1,opt,name=compress_logs,json=compressLogs,proto3" json:"compressLogs,omitempty"`
	// For access logs, only generate for requests with a response.code >= 400.
	// TODO: replace with filter options in Telemetry API (when ready)
	OnlyErrors           *types.BoolValue `protobuf:"bytes,2,opt,name=only_errors,json=onlyErrors,proto3" json:"onlyErrors,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *MeshConfig_ExtensionProvider_StackdriverProvider_LoggingOptions) GetCompressLogs() *types.BoolValue {
	if m != nil {
		return m.CompressLogs
	}
	return nil
}

func (m *MeshConfig_ExtensionProvider_StackdriverProvider_LoggingOptions) GetOnlyErrors() *types.BoolValue {
	if m != nil {
		return m.OnlyErrors
	}
	return nil
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig_ExtensionProvider_StackdriverProvider_LoggingOptions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.OnlyErrors != nil {
		{
			size, err := m.OnlyErrors.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.CompressLogs != nil {
		{
			size, err := m.CompressLogs.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MeshConfig_ExtensionProvider_StackdriverProvider_LoggingOptions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CompressLogs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.CompressLogs == nil {
				m.CompressLogs = &types.BoolValue{}
			}
			if err := m.CompressLogs.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OnlyErrors", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.OnlyErrors == nil {
				m.OnlyErrors = &types.BoolValue{}
			}
			if err := m.OnlyErrors.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
