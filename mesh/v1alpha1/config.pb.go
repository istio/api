...
type MeshConfig struct {
	...
	CaCertificatePems []string `protobuf:"bytes,58,rep,name=ca_certificate_pems,json=caCertificatePems,proto3" json:"caCertificatePems,omitempty"`
	...
	// This field specifies the SPIFFE Bundle Endpoint URL. The endpoint should support authentication based on Web PKI:
	// https://github.com/spiffe/spiffe/blob/master/standards/SPIFFE_Trust_Domain_and_Bundle.md#521-web-pki
	// The fetched root certificates are added to the root of trust for workload-to-workload communication.
	CaCertificateUrls []string `protobuf:"bytes,59,rep,name=ca_certificate_urls,json=caCertificateUrls,proto3" json:"caCertificateUrls,omitempty"`
...
func (m *MeshConfig) GetCaCertificatePems() []string {
	if m != nil {
		return m.CaCertificatePems
	}
	return nil
}

func (m *MeshConfig) GetCaCertificateUrls() []string {
	if m != nil {
		return m.CaCertificateUrls
	}
	return nil
}
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CaCertificateUrls) > 0 {
		for iNdEx := len(m.CaCertificateUrls) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.CaCertificateUrls[iNdEx])
			copy(dAtA[i:], m.CaCertificateUrls[iNdEx])
			i = encodeVarintConfig(dAtA, i, uint64(len(m.CaCertificateUrls[iNdEx])))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0xda
	...
	if len(m.CaCertificatePems) > 0 {
		for iNdEx := len(m.CaCertificatePems) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.CaCertificatePems[iNdEx])
			copy(dAtA[i:], m.CaCertificatePems[iNdEx])
			i = encodeVarintConfig(dAtA, i, uint64(len(m.CaCertificatePems[iNdEx])))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0xd2
...
func (m *MeshConfig) Size() (n int) {
	...
	if len(m.CaCertificatePems) > 0 {
		for _, s := range m.CaCertificatePems {
			l = len(s)
			n += 2 + l + sovConfig(uint64(l))
		}
	}
	if len(m.CaCertificateUrls) > 0 {
		for _, s := range m.CaCertificateUrls {
			l = len(s)
			n += 2 + l + sovConfig(uint64(l))
		}
	}
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 58:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CaCertificatePems", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CaCertificatePems = append(m.CaCertificatePems, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 59:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CaCertificateUrls", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CaCertificateUrls = append(m.CaCertificateUrls, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
