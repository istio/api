...
type MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationRequestBody struct {
	// Sets the maximum size of a message body that the filter will hold in memory. Envoy will return HTTP 413 and
	// will not initiate the authorization process when buffer reaches the number set in this field. Note that this
	// setting will have precedence over failure_mode_allow.
	...
	// If true, the body sent to the external authorization service is set with raw bytes, it sets the raw_body field
	// of HTTP request attribute context. Otherwise, it will be filled with UTF-8 string request body.
...
type MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider struct {
	...
	// Sets the maximum duration in milliseconds that a response can take to arrive upon request (default timeout: 600s).
	...
	//
	// Exact, prefix and suffix presence match is supported:
	...
	// Set of headers that will be included in the authorization request sent to the authorization service.
	// Note that client request of the same key will be overridden.
	AddHeadersInCheck map[string]string `protobuf:"bytes,10,rep,name=add_headers_in_check,json=addHeadersInCheck,proto3" json:"addHeadersInCheck,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	WithRequestBody      *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationRequestBody `protobuf:"bytes,11,opt,name=with_request_body,json=withRequestBody,proto3" json:"withRequestBody,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                                            `json:"-"`
	XXX_unrecognized     []byte                                                              `json:"-"`
	XXX_sizecache        int32                                                               `json:"-"`
}
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) GetAddHeadersInCheck() map[string]string {
	if m != nil {
		return m.AddHeadersInCheck
	}
	return nil
}
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) GetWithRequestBody() *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationRequestBody {
	if m != nil {
...
type MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationGrpcProvider struct {
	...
	// A "x-envoy-auth-partial-body: false|true" metadata header will be added to the authorization request message
	// indicating if the body data is partial.
	WithRequestBody      *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationRequestBody `protobuf:"bytes,5,opt,name=with_request_body,json=withRequestBody,proto3" json:"withRequestBody,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                                            `json:"-"`
	XXX_unrecognized     []byte                                                              `json:"-"`
	XXX_sizecache        int32                                                               `json:"-"`
}
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationGrpcProvider) GetWithRequestBody() *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationRequestBody {
	if m != nil {
		return m.WithRequestBody
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationHttpProvider.AddHeadersInCheckEntry")
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AddHeadersInCheck) > 0 {
		for k := range m.AddHeadersInCheck {
			v := m.AddHeadersInCheck[k]
			baseI := i
			i -= len(v)
			copy(dAtA[i:], v)
...
func (m *MeshConfig_ExtensionProvider_OpenCensusAgentTracingProvider) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Context) > 0 {
		dAtA33 := make([]byte, len(m.Context)*10)
		var j32 int
		...
		i = encodeVarintConfig(dAtA, i, uint64(j32))
		i--
		dAtA[i] = 0x1a
	}
	if m.Port != 0 {
...
func (m *ConfigSource) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SubscribedResources) > 0 {
		dAtA35 := make([]byte, len(m.SubscribedResources)*10)
		var j34 int
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) Size() (n int) {
	...
	if len(m.AddHeadersInCheck) > 0 {
		for k, v := range m.AddHeadersInCheck {
			_ = k
			_ = v
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AddHeadersInCheck", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.AddHeadersInCheck == nil {
				m.AddHeadersInCheck = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.AddHeadersInCheck[mapkey] = mapvalue
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
			...
			if m.WithRequestBody == nil {
				m.WithRequestBody = &MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationRequestBody{}
			}
