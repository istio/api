...
type MeshConfig struct {
	...
	// Deploy ingress gateway agent, which runs in the same pod as ingress gateway proxy and provisions credentials to ingress
	// gateway proxy via SDS. The ingress gateway agent watches kubernetes secrets in namespace istio-ingress.
	EnableIngressGatewayAgent bool `protobuf:"varint,31,opt,name=enable_ingress_gateway_agent,json=enableIngressGatewayAgent,proto3" json:"enable_ingress_gateway_agent,omitempty"`
...
func (m *MeshConfig) GetEnableIngressGatewayAgent() bool {
	if m != nil {
		return m.EnableIngressGatewayAgent
	}
	return false
}
...
func (m *MeshConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EnableIngressGatewayAgent {
		dAtA[i] = 0xf8
		i++
		dAtA[i] = 0x1
		i++
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 31:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableIngressGatewayAgent", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnableIngressGatewayAgent = bool(v != 0)
		default:
			iNdEx = preIndex
...
var fileDescriptorConfig = []byte{
	...
	,
}
