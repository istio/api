...
var MeshConfig_TLSConfig_TLSProtocol_name = map[int32]string{
	0: "TLS_AUTO",
	1: "TLSV1_2",
	2: "TLSV1_3",
}

var MeshConfig_TLSConfig_TLSProtocol_value = map[string]int32{
	"TLS_AUTO": 0,
	"TLSV1_2":  1,
	"TLSV1_3":  2,
}
...
func (x MeshConfig_TLSConfig_TLSProtocol) String() string {
	return proto.EnumName(MeshConfig_TLSConfig_TLSProtocol_name, int32(x))
}
...
type MeshConfig struct {
	...
	EnablePrometheusMerge *types.BoolValue `protobuf:"bytes,51,opt,name=enable_prometheus_merge,json=enablePrometheusMerge,proto3" json:"enable_prometheus_merge,omitempty"`
	// $hide_from_docs
	...
	// ``.x.y.com` suffix.
	VerifyCertificateAtClient *types.BoolValue `protobuf:"bytes,54,opt,name=verify_certificate_at_client,json=verifyCertificateAtClient,proto3" json:"verify_certificate_at_client,omitempty"` // Deprecated: Do not use.
	// $hide_from_docs
...
func (m *MeshConfig) GetMeshMTLS() *MeshConfig_TLSConfig {
	if m != nil {
		return m.MeshMTLS
	}
	return nil
...
type MeshConfig_CertificateData_SpiffeBundleUrl struct {
	SpiffeBundleUrl string `protobuf:"bytes,2,opt,name=spiffe_bundle_url,json=spiffeBundleUrl,proto3,oneof" json:"spiffe_bundle_url,omitempty"`
}
...
type MeshConfig_ThriftConfig struct {
	...
	RateLimitTimeout     *types.Duration `protobuf:"bytes,2,opt,name=rate_limit_timeout,json=rateLimitTimeout,proto3" json:"rate_limit_timeout,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
type MeshConfig_ExtensionProvider_EnvoyExtAuthzHttp struct {
	EnvoyExtAuthzHttp *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider `protobuf:"bytes,2,opt,name=envoy_ext_authz_http,json=envoyExtAuthzHttp,proto3,oneof" json:"envoy_ext_authz_http,omitempty"`
}
type MeshConfig_ExtensionProvider_EnvoyExtAuthzGrpc struct {
	EnvoyExtAuthzGrpc *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationGrpcProvider `protobuf:"bytes,3,opt,name=envoy_ext_authz_grpc,json=envoyExtAuthzGrpc,proto3,oneof" json:"envoy_ext_authz_grpc,omitempty"`
}
...
type MeshConfig_ExtensionProvider_EnvoyFileAccessLog struct {
	EnvoyFileAccessLog *MeshConfig_ExtensionProvider_EnvoyFileAccessLogProvider `protobuf:"bytes,11,opt,name=envoy_file_access_log,json=envoyFileAccessLog,proto3,oneof" json:"envoy_file_access_log,omitempty"`
}
type MeshConfig_ExtensionProvider_EnvoyHttpAls struct {
	EnvoyHttpAls *MeshConfig_ExtensionProvider_EnvoyHttpGrpcV3LogProvider `protobuf:"bytes,12,opt,name=envoy_http_als,json=envoyHttpAls,proto3,oneof" json:"envoy_http_als,omitempty"`
}
type MeshConfig_ExtensionProvider_EnvoyTcpAls struct {
	EnvoyTcpAls *MeshConfig_ExtensionProvider_EnvoyTcpGrpcV3LogProvider `protobuf:"bytes,13,opt,name=envoy_tcp_als,json=envoyTcpAls,proto3,oneof" json:"envoy_tcp_als,omitempty"`
}
type MeshConfig_ExtensionProvider_EnvoyOtelAls struct {
	EnvoyOtelAls *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider `protobuf:"bytes,14,opt,name=envoy_otel_als,json=envoyOtelAls,proto3,oneof" json:"envoy_otel_als,omitempty"`
}
...
func (m *MeshConfig_ExtensionProvider) GetEnvoyOtelAls() *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider {
	if x, ok := m.GetProvider().(*MeshConfig_ExtensionProvider_EnvoyOtelAls); ok {
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) GetHeadersToDownstreamOnAllow() []string {
	if m != nil {
		return m.HeadersToDownstreamOnAllow
	}
	return nil
}
...
func (*MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 5, 13}
}
...
func (m *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider) GetLogFormat() *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat {
	if m != nil {
		return m.LogFormat
	}
	return nil
...
type MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat struct {
	...
	// ```
	Labels               *types.Struct `protobuf:"bytes,2,opt,name=labels,proto3" json:"labels,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}

func (m *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat) Reset() {
	*m = MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat{}
}
func (m *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat) String() string {
	return proto.CompactTextString(m)
}
...
func (*MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 5, 13, 0}
}
func (m *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat.Merge(m, src)
}
func (m *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat proto.InternalMessageInfo

func (m *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat) GetText() string {
	if m != nil {
		return m.Text
	}
	return ""
...
func (m *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat) GetLabels() *types.Struct {
	if m != nil {
		return m.Labels
	}
	return nil
...
func (m *MeshConfig_TLSConfig) Reset()         { *m = MeshConfig_TLSConfig{} }
func (m *MeshConfig_TLSConfig) String() string { return proto.CompactTextString(m) }
...
func (m *MeshConfig_TLSConfig) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_TLSConfig) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_TLSConfig.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_TLSConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_TLSConfig.Merge(m, src)
}
func (m *MeshConfig_TLSConfig) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_TLSConfig) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_TLSConfig.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_TLSConfig proto.InternalMessageInfo

func (m *MeshConfig_TLSConfig) GetMinProtocolVersion() MeshConfig_TLSConfig_TLSProtocol {
	if m != nil {
...
func init() {
	...
	proto.RegisterEnum("istio.mesh.v1alpha1.MeshConfig_TLSConfig_TLSProtocol", MeshConfig_TLSConfig_TLSProtocol_name, MeshConfig_TLSConfig_TLSProtocol_value)
	...
	proto.RegisterType((*MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat)(nil), "istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyOpenTelemetryLogProvider.LogFormat")
	...
	proto.RegisterType((*MeshConfig_TLSConfig)(nil), "istio.mesh.v1alpha1.MeshConfig.TLSConfig")
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MeshMTLS != nil {
		{
			size, err := m.MeshMTLS.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MeshConfig_ExtensionProvider_EnvoyOtelAls) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MeshConfig_ExtensionProvider_EnvoyOtelAls) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.EnvoyOtelAls != nil {
		{
			size, err := m.EnvoyOtelAls.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.HeadersToDownstreamOnAllow) > 0 {
		for iNdEx := len(m.HeadersToDownstreamOnAllow) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.HeadersToDownstreamOnAllow[iNdEx])
			copy(dAtA[i:], m.HeadersToDownstreamOnAllow[iNdEx])
			i = encodeVarintConfig(dAtA, i, uint64(len(m.HeadersToDownstreamOnAllow[iNdEx])))
			i--
			dAtA[i] = 0x6a
		}
	}
...
func (m *MeshConfig_ExtensionProvider_OpenCensusAgentTracingProvider) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Context) > 0 {
		dAtA43 := make([]byte, len(m.Context)*10)
		var j42 int
...
func (m *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MeshConfig_TLSConfig) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_TLSConfig) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MeshConfig_TLSConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.MinProtocolVersion != 0 {
		i = encodeVarintConfig(dAtA, i, uint64(m.MinProtocolVersion))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *ConfigSource) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SubscribedResources) > 0 {
		dAtA49 := make([]byte, len(m.SubscribedResources)*10)
		var j48 int
		...
		i = encodeVarintConfig(dAtA, i, uint64(j48))
		i--
		dAtA[i] = 0x1a
	}
	if m.TlsSettings != nil {
...
func (m *MeshConfig_ExtensionProvider_EnvoyOtelAls) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) Size() (n int) {
	...
	if len(m.HeadersToDownstreamOnAllow) > 0 {
		for _, s := range m.HeadersToDownstreamOnAllow {
			l = len(s)
			n += 1 + l + sovConfig(uint64(l))
		}
	}
...
func (m *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_TLSConfig) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.MinProtocolVersion != 0 {
		n += 1 + sovConfig(uint64(m.MinProtocolVersion))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 63:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MeshMTLS", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.MeshMTLS == nil {
				m.MeshMTLS = &MeshConfig_TLSConfig{}
			}
			if err := m.MeshMTLS.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *MeshConfig_ExtensionProvider) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnvoyOtelAls", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Provider = &MeshConfig_ExtensionProvider_EnvoyOtelAls{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipConfig(dAtA[iNdEx:])
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HeadersToDownstreamOnAllow", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HeadersToDownstreamOnAllow = append(m.HeadersToDownstreamOnAllow, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipConfig(dAtA[iNdEx:])
...
func (m *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.LogFormat == nil {
				m.LogFormat = &MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat{}
			}
			if err := m.LogFormat.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *MeshConfig_TLSConfig) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinProtocolVersion |= MeshConfig_TLSConfig_TLSProtocol(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
