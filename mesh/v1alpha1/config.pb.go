...
type MeshConfig struct {
	...
	// $hide_from_docs
	// Defines a list of external servers that provide extra functionality to the mesh. The external servers are usually
	// deployed and managed by the mesh administrator to extend Istio's functionality, for example, an external authorization
	// server is used with the AuthorizationPolicy to integrate custom authorization system into Istio.
	// Note, at most 1 external server is allowed for now.
	ExternalServers      []*MeshConfig_ExternalServer `protobuf:"bytes,56,rep,name=external_servers,json=externalServers,proto3" json:"externalServers,omitempty"`
...
func (m *MeshConfig) GetExternalServers() []*MeshConfig_ExternalServer {
	if m != nil {
		return m.ExternalServers
	}
	return nil
}
...
// $hide_from_docs
type MeshConfig_ExternalServer struct {
	// REQUIRED. A unique name identifying the external server.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// REQUIRED. Specifies detail configurations of the external server.
	//
	// Types that are valid to be assigned to Config:
	//	*MeshConfig_ExternalServer_Authorization_
	Config               isMeshConfig_ExternalServer_Config `protobuf_oneof:"config"`
	XXX_NoUnkeyedLiteral struct{}                           `json:"-"`
	XXX_unrecognized     []byte                             `json:"-"`
	XXX_sizecache        int32                              `json:"-"`
}

func (m *MeshConfig_ExternalServer) Reset()         { *m = MeshConfig_ExternalServer{} }
func (m *MeshConfig_ExternalServer) String() string { return proto.CompactTextString(m) }
func (*MeshConfig_ExternalServer) ProtoMessage()    {}
func (*MeshConfig_ExternalServer) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 4}
}
func (m *MeshConfig_ExternalServer) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_ExternalServer) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_ExternalServer.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_ExternalServer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_ExternalServer.Merge(m, src)
}
func (m *MeshConfig_ExternalServer) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_ExternalServer) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_ExternalServer.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_ExternalServer proto.InternalMessageInfo

type isMeshConfig_ExternalServer_Config interface {
	isMeshConfig_ExternalServer_Config()
	MarshalTo([]byte) (int, error)
	Size() int
}

type MeshConfig_ExternalServer_Authorization_ struct {
	Authorization *MeshConfig_ExternalServer_Authorization `protobuf:"bytes,2,opt,name=authorization,proto3,oneof"`
}

func (*MeshConfig_ExternalServer_Authorization_) isMeshConfig_ExternalServer_Config() {}

func (m *MeshConfig_ExternalServer) GetConfig() isMeshConfig_ExternalServer_Config {
	if m != nil {
		return m.Config
	}
	return nil
...
func (m *MeshConfig_ExternalServer) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *MeshConfig_ExternalServer) GetAuthorization() *MeshConfig_ExternalServer_Authorization {
	if x, ok := m.GetConfig().(*MeshConfig_ExternalServer_Authorization_); ok {
...
func (*MeshConfig_ExternalServer) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*MeshConfig_ExternalServer_Authorization_)(nil),
	}
}

// $hide_from_docs
// Authorization supplies the detail configuration of the external authorization server.
type MeshConfig_ExternalServer_Authorization struct {
	...
	//	*MeshConfig_ExternalServer_Authorization_Http
	//	*MeshConfig_ExternalServer_Authorization_Grpc
	ExternalAuthzServiceType isMeshConfig_ExternalServer_Authorization_ExternalAuthzServiceType `protobuf_oneof:"external_authz_service_type"`
	XXX_NoUnkeyedLiteral     struct{}                                                           `json:"-"`
	XXX_unrecognized         []byte                                                             `json:"-"`
	XXX_sizecache            int32                                                              `json:"-"`
}

func (m *MeshConfig_ExternalServer_Authorization) Reset() {
	*m = MeshConfig_ExternalServer_Authorization{}
}
func (m *MeshConfig_ExternalServer_Authorization) String() string { return proto.CompactTextString(m) }
func (*MeshConfig_ExternalServer_Authorization) ProtoMessage()    {}
func (*MeshConfig_ExternalServer_Authorization) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 4, 0}
}
func (m *MeshConfig_ExternalServer_Authorization) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_ExternalServer_Authorization) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_ExternalServer_Authorization.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_ExternalServer_Authorization) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_ExternalServer_Authorization.Merge(m, src)
}
func (m *MeshConfig_ExternalServer_Authorization) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_ExternalServer_Authorization) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_ExternalServer_Authorization.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_ExternalServer_Authorization proto.InternalMessageInfo

type isMeshConfig_ExternalServer_Authorization_ExternalAuthzServiceType interface {
	isMeshConfig_ExternalServer_Authorization_ExternalAuthzServiceType()
	MarshalTo([]byte) (int, error)
	Size() int
}

type MeshConfig_ExternalServer_Authorization_Http struct {
	Http *MeshConfig_ExternalServer_Authorization_HTTP `protobuf:"bytes,3,opt,name=http,proto3,oneof"`
}
type MeshConfig_ExternalServer_Authorization_Grpc struct {
	Grpc *MeshConfig_ExternalServer_Authorization_GRPC `protobuf:"bytes,4,opt,name=grpc,proto3,oneof"`
}

func (*MeshConfig_ExternalServer_Authorization_Http) isMeshConfig_ExternalServer_Authorization_ExternalAuthzServiceType() {
}
func (*MeshConfig_ExternalServer_Authorization_Grpc) isMeshConfig_ExternalServer_Authorization_ExternalAuthzServiceType() {
}

func (m *MeshConfig_ExternalServer_Authorization) GetExternalAuthzServiceType() isMeshConfig_ExternalServer_Authorization_ExternalAuthzServiceType {
	if m != nil {
...
func (m *MeshConfig_ExternalServer_Authorization) GetService() *v1alpha3.Destination {
	if m != nil {
		return m.Service
	}
	return nil
...
func (m *MeshConfig_ExternalServer_Authorization) GetTimeout() *types.Duration {
	if m != nil {
		return m.Timeout
	}
	return nil
...
func (m *MeshConfig_ExternalServer_Authorization) GetHttp() *MeshConfig_ExternalServer_Authorization_HTTP {
	if x, ok := m.GetExternalAuthzServiceType().(*MeshConfig_ExternalServer_Authorization_Http); ok {
		return x.Http
	}
	return nil
}

func (m *MeshConfig_ExternalServer_Authorization) GetGrpc() *MeshConfig_ExternalServer_Authorization_GRPC {
	if x, ok := m.GetExternalAuthzServiceType().(*MeshConfig_ExternalServer_Authorization_Grpc); ok {
		return x.Grpc
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*MeshConfig_ExternalServer_Authorization) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*MeshConfig_ExternalServer_Authorization_Http)(nil),
		(*MeshConfig_ExternalServer_Authorization_Grpc)(nil),
	}
}
...
func (m *MeshConfig_ExternalServer_Authorization_HTTP) Reset() {
	*m = MeshConfig_ExternalServer_Authorization_HTTP{}
}
func (m *MeshConfig_ExternalServer_Authorization_HTTP) String() string {
	return proto.CompactTextString(m)
}
func (*MeshConfig_ExternalServer_Authorization_HTTP) ProtoMessage() {}
func (*MeshConfig_ExternalServer_Authorization_HTTP) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 4, 0, 0}
}
func (m *MeshConfig_ExternalServer_Authorization_HTTP) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_ExternalServer_Authorization_HTTP) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_ExternalServer_Authorization_HTTP.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_ExternalServer_Authorization_HTTP) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_ExternalServer_Authorization_HTTP.Merge(m, src)
}
func (m *MeshConfig_ExternalServer_Authorization_HTTP) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_ExternalServer_Authorization_HTTP) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_ExternalServer_Authorization_HTTP.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_ExternalServer_Authorization_HTTP proto.InternalMessageInfo

func (m *MeshConfig_ExternalServer_Authorization_HTTP) GetPathPrefix() string {
	if m != nil {
		return m.PathPrefix
	}
	return ""
...
func (m *MeshConfig_ExternalServer_Authorization_HTTP) GetIncludeHeadersInCheck() []string {
	if m != nil {
...
func (m *MeshConfig_ExternalServer_Authorization_HTTP) GetHeadersToUpstreamOnAllow() []string {
	if m != nil {
...
func (m *MeshConfig_ExternalServer_Authorization_HTTP) GetHeadersToDownstreamOnDeny() []string {
	if m != nil {
...
func (m *MeshConfig_ExternalServer_Authorization_GRPC) Reset() {
	*m = MeshConfig_ExternalServer_Authorization_GRPC{}
}
func (m *MeshConfig_ExternalServer_Authorization_GRPC) String() string {
	return proto.CompactTextString(m)
}
func (*MeshConfig_ExternalServer_Authorization_GRPC) ProtoMessage() {}
func (*MeshConfig_ExternalServer_Authorization_GRPC) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 4, 0, 1}
}
func (m *MeshConfig_ExternalServer_Authorization_GRPC) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_ExternalServer_Authorization_GRPC) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_ExternalServer_Authorization_GRPC.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_ExternalServer_Authorization_GRPC) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_ExternalServer_Authorization_GRPC.Merge(m, src)
}
func (m *MeshConfig_ExternalServer_Authorization_GRPC) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_ExternalServer_Authorization_GRPC) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_ExternalServer_Authorization_GRPC.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_ExternalServer_Authorization_GRPC proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MeshConfig_ExternalServer)(nil), "istio.mesh.v1alpha1.MeshConfig.ExternalServer")
	proto.RegisterType((*MeshConfig_ExternalServer_Authorization)(nil), "istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization")
	proto.RegisterType((*MeshConfig_ExternalServer_Authorization_HTTP)(nil), "istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization.HTTP")
	proto.RegisterType((*MeshConfig_ExternalServer_Authorization_GRPC)(nil), "istio.mesh.v1alpha1.MeshConfig.ExternalServer.Authorization.GRPC")
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExternalServers) > 0 {
		for iNdEx := len(m.ExternalServers) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ExternalServers[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *MeshConfig_ExternalServer) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_ExternalServer) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MeshConfig_ExternalServer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MeshConfig_ExternalServer_Authorization_) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *MeshConfig_ExternalServer_Authorization_) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *MeshConfig_ExternalServer_Authorization) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_ExternalServer_Authorization) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MeshConfig_ExternalServer_Authorization) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MeshConfig_ExternalServer_Authorization_Http) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *MeshConfig_ExternalServer_Authorization_Http) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Http != nil {
		{
...
func (m *MeshConfig_ExternalServer_Authorization_Grpc) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *MeshConfig_ExternalServer_Authorization_Grpc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Grpc != nil {
		{
...
func (m *MeshConfig_ExternalServer_Authorization_HTTP) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_ExternalServer_Authorization_GRPC) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig) Size() (n int) {
	...
	if len(m.ExternalServers) > 0 {
		for _, e := range m.ExternalServers {
			l = e.Size()
			n += 2 + l + sovConfig(uint64(l))
		}
	}
...
func (m *MeshConfig_ExternalServer) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_ExternalServer_Authorization_) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_ExternalServer_Authorization) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_ExternalServer_Authorization_Http) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_ExternalServer_Authorization_Grpc) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 56:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExternalServers", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExternalServers = append(m.ExternalServers, &MeshConfig_ExternalServer{})
			if err := m.ExternalServers[len(m.ExternalServers)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *MeshConfig_ExternalServer) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ExternalServer: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ExternalServer: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			v := &MeshConfig_ExternalServer_Authorization{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Config = &MeshConfig_ExternalServer_Authorization_{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipConfig(dAtA[iNdEx:])
...
func (m *MeshConfig_ExternalServer_Authorization) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 3:
			...
			v := &MeshConfig_ExternalServer_Authorization_HTTP{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.ExternalAuthzServiceType = &MeshConfig_ExternalServer_Authorization_Http{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			v := &MeshConfig_ExternalServer_Authorization_GRPC{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.ExternalAuthzServiceType = &MeshConfig_ExternalServer_Authorization_Grpc{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipConfig(dAtA[iNdEx:])
...
func (m *MeshConfig_ExternalServer_Authorization_HTTP) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *MeshConfig_ExternalServer_Authorization_GRPC) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
