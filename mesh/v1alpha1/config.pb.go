...
type MeshConfig struct {
	...
	// If enabled, Istio agent will aggregate metrics exposed by the application with metrics from Envoy
	// and Istio agent. The sidecar injection will replace prometheus.io annotations present on the pod
	// and redirect them towards Istio agent, which will then handle the aggregation of metrics.
	// If your prometheus is not setup to scrape based on prometheus.io/scrape, prometheus.io/port, and
	// prometheus.io/path annotations, you may need to disable this.
	// If you application exposes the same metrics as Envoy, this may cause issues. In this case, it is recommended
	// to disable aggregation on that deployment with the `prometheus.istio.io/aggregate: "false"` annotation.
	EnablePrometheusAggregation *types.BoolValue `protobuf:"bytes,51,opt,name=enable_prometheus_aggregation,json=enablePrometheusAggregation,proto3" json:"enablePrometheusAggregation,omitempty"`
...
func (m *MeshConfig) GetEnablePrometheusAggregation() *types.BoolValue {
	if m != nil {
		return m.EnablePrometheusAggregation
	}
	return nil
}
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.EnablePrometheusAggregation != nil {
		{
			size, err := m.EnablePrometheusAggregation.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MeshConfig) Size() (n int) {
	...
	if m.EnablePrometheusAggregation != nil {
		l = m.EnablePrometheusAggregation.Size()
		n += 2 + l + sovConfig(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 51:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnablePrometheusAggregation", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.EnablePrometheusAggregation == nil {
				m.EnablePrometheusAggregation = &types.BoolValue{}
			}
			if err := m.EnablePrometheusAggregation.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
