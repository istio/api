...
type MeshConfig struct {
	...
	// $hide_from_docs
	// Defines a list of extension services that provide extra functionality to the mesh. The extension services are usually
	// deployed and managed by the mesh administrator to extend Istio's functionality, for example, an external authorization
	// service is used with the AuthorizationPolicy to integrate custom authorization system into Istio.
	// Note, at most 1 extension service is allowed for now.
	ExtensionServices    []*MeshConfig_ExtensionService `protobuf:"bytes,57,rep,name=extension_services,json=extensionServices,proto3" json:"extensionServices,omitempty"`
...
func (m *MeshConfig) GetExtensionServices() []*MeshConfig_ExtensionService {
	if m != nil {
		return m.ExtensionServices
	}
	return nil
}
...
// $hide_from_docs
type MeshConfig_ExtensionService struct {
	// REQUIRED. A unique name identifying the extension service.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// REQUIRED. Specifies detail configurations of the extension service.
	//
	// Types that are valid to be assigned to Config:
	//	*MeshConfig_ExtensionService_Authorization_
	Config               isMeshConfig_ExtensionService_Config `protobuf_oneof:"config"`
	XXX_NoUnkeyedLiteral struct{}                             `json:"-"`
	XXX_unrecognized     []byte                               `json:"-"`
	XXX_sizecache        int32                                `json:"-"`
}

func (m *MeshConfig_ExtensionService) Reset()         { *m = MeshConfig_ExtensionService{} }
func (m *MeshConfig_ExtensionService) String() string { return proto.CompactTextString(m) }
func (*MeshConfig_ExtensionService) ProtoMessage()    {}
func (*MeshConfig_ExtensionService) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 4}
}
func (m *MeshConfig_ExtensionService) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_ExtensionService) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_ExtensionService.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_ExtensionService) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_ExtensionService.Merge(m, src)
}
func (m *MeshConfig_ExtensionService) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_ExtensionService) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_ExtensionService.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_ExtensionService proto.InternalMessageInfo

type isMeshConfig_ExtensionService_Config interface {
	isMeshConfig_ExtensionService_Config()
	MarshalTo([]byte) (int, error)
	Size() int
}

type MeshConfig_ExtensionService_Authorization_ struct {
	Authorization *MeshConfig_ExtensionService_Authorization `protobuf:"bytes,2,opt,name=authorization,proto3,oneof"`
}

func (*MeshConfig_ExtensionService_Authorization_) isMeshConfig_ExtensionService_Config() {}

func (m *MeshConfig_ExtensionService) GetConfig() isMeshConfig_ExtensionService_Config {
	if m != nil {
		return m.Config
	}
	return nil
...
func (m *MeshConfig_ExtensionService) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *MeshConfig_ExtensionService) GetAuthorization() *MeshConfig_ExtensionService_Authorization {
	if x, ok := m.GetConfig().(*MeshConfig_ExtensionService_Authorization_); ok {
...
func (*MeshConfig_ExtensionService) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*MeshConfig_ExtensionService_Authorization_)(nil),
	}
}

// $hide_from_docs
// Authorization supplies the detail configuration of the external authorization server.
type MeshConfig_ExtensionService_Authorization struct {
	// REQUIRED. Specifies the network addressable service to which the authorization check request should be sent.
	// Note, the `service.port` must always be configured explicitly even if the service exposes only a single port.
	Service *v1alpha3.Destination `protobuf:"bytes,1,opt,name=service,proto3" json:"service,omitempty"`
	// Sets the maximum duration in milliseconds for connection to the external server (default is 1s).
	Timeout *types.Duration `protobuf:"bytes,2,opt,name=timeout,proto3" json:"timeout,omitempty"`
	// REQUIRED. Specifies the API used to talk to the external authorization server.
	//
	// Types that are valid to be assigned to ExternalAuthzServiceType:
	//	*MeshConfig_ExtensionService_Authorization_Http
	//	*MeshConfig_ExtensionService_Authorization_Grpc
	ExternalAuthzServiceType isMeshConfig_ExtensionService_Authorization_ExternalAuthzServiceType `protobuf_oneof:"external_authz_service_type"`
	XXX_NoUnkeyedLiteral     struct{}                                                             `json:"-"`
	XXX_unrecognized         []byte                                                               `json:"-"`
	XXX_sizecache            int32                                                                `json:"-"`
}

func (m *MeshConfig_ExtensionService_Authorization) Reset() {
	*m = MeshConfig_ExtensionService_Authorization{}
}
func (m *MeshConfig_ExtensionService_Authorization) String() string {
	return proto.CompactTextString(m)
}
func (*MeshConfig_ExtensionService_Authorization) ProtoMessage() {}
func (*MeshConfig_ExtensionService_Authorization) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 4, 0}
}
func (m *MeshConfig_ExtensionService_Authorization) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_ExtensionService_Authorization) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_ExtensionService_Authorization.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_ExtensionService_Authorization) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_ExtensionService_Authorization.Merge(m, src)
}
func (m *MeshConfig_ExtensionService_Authorization) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_ExtensionService_Authorization) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_ExtensionService_Authorization.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_ExtensionService_Authorization proto.InternalMessageInfo

type isMeshConfig_ExtensionService_Authorization_ExternalAuthzServiceType interface {
	isMeshConfig_ExtensionService_Authorization_ExternalAuthzServiceType()
	MarshalTo([]byte) (int, error)
	Size() int
}

type MeshConfig_ExtensionService_Authorization_Http struct {
	Http *MeshConfig_ExtensionService_Authorization_HTTP `protobuf:"bytes,3,opt,name=http,proto3,oneof"`
}
type MeshConfig_ExtensionService_Authorization_Grpc struct {
	Grpc *MeshConfig_ExtensionService_Authorization_GRPC `protobuf:"bytes,4,opt,name=grpc,proto3,oneof"`
}

func (*MeshConfig_ExtensionService_Authorization_Http) isMeshConfig_ExtensionService_Authorization_ExternalAuthzServiceType() {
}
func (*MeshConfig_ExtensionService_Authorization_Grpc) isMeshConfig_ExtensionService_Authorization_ExternalAuthzServiceType() {
}

func (m *MeshConfig_ExtensionService_Authorization) GetExternalAuthzServiceType() isMeshConfig_ExtensionService_Authorization_ExternalAuthzServiceType {
	if m != nil {
		return m.ExternalAuthzServiceType
	}
	return nil
}

func (m *MeshConfig_ExtensionService_Authorization) GetService() *v1alpha3.Destination {
	if m != nil {
		return m.Service
	}
	return nil
...
func (m *MeshConfig_ExtensionService_Authorization) GetTimeout() *types.Duration {
	if m != nil {
		return m.Timeout
	}
	return nil
...
func (m *MeshConfig_ExtensionService_Authorization) GetHttp() *MeshConfig_ExtensionService_Authorization_HTTP {
	if x, ok := m.GetExternalAuthzServiceType().(*MeshConfig_ExtensionService_Authorization_Http); ok {
		return x.Http
	}
	return nil
}

func (m *MeshConfig_ExtensionService_Authorization) GetGrpc() *MeshConfig_ExtensionService_Authorization_GRPC {
	if x, ok := m.GetExternalAuthzServiceType().(*MeshConfig_ExtensionService_Authorization_Grpc); ok {
		return x.Grpc
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*MeshConfig_ExtensionService_Authorization) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*MeshConfig_ExtensionService_Authorization_Http)(nil),
		(*MeshConfig_ExtensionService_Authorization_Grpc)(nil),
	}
}
...
type MeshConfig_ExtensionService_Authorization_HTTP struct {
	...
	PathPrefix string `protobuf:"bytes,1,opt,name=path_prefix,json=pathPrefix,proto3" json:"pathPrefix,omitempty"`
	// List of headers that should be included in the authorization check request to the external auth server.
	...
	IncludeHeadersInCheck []string `protobuf:"bytes,2,rep,name=include_headers_in_check,json=includeHeadersInCheck,proto3" json:"includeHeadersInCheck,omitempty"`
	...
	HeadersToUpstreamOnAllow []string `protobuf:"bytes,3,rep,name=headers_to_upstream_on_allow,json=headersToUpstreamOnAllow,proto3" json:"headersToUpstreamOnAllow,omitempty"`
	// List of headers from the external server that should be forwarded to downstream when the authorization check result
	...
	// the downstream. When a header is included in this list, *Path*, *Status*, *Content-Length*, *WWWAuthenticate*
	// and *Location* are automatically added.
	HeadersToDownstreamOnDeny []string `protobuf:"bytes,4,rep,name=headers_to_downstream_on_deny,json=headersToDownstreamOnDeny,proto3" json:"headersToDownstreamOnDeny,omitempty"`
	XXX_NoUnkeyedLiteral      struct{} `json:"-"`
	XXX_unrecognized          []byte   `json:"-"`
	XXX_sizecache             int32    `json:"-"`
}

func (m *MeshConfig_ExtensionService_Authorization_HTTP) Reset() {
	*m = MeshConfig_ExtensionService_Authorization_HTTP{}
}
func (m *MeshConfig_ExtensionService_Authorization_HTTP) String() string {
	return proto.CompactTextString(m)
}
func (*MeshConfig_ExtensionService_Authorization_HTTP) ProtoMessage() {}
func (*MeshConfig_ExtensionService_Authorization_HTTP) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 4, 0, 0}
}
func (m *MeshConfig_ExtensionService_Authorization_HTTP) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_ExtensionService_Authorization_HTTP) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_ExtensionService_Authorization_HTTP.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_ExtensionService_Authorization_HTTP) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_ExtensionService_Authorization_HTTP.Merge(m, src)
}
func (m *MeshConfig_ExtensionService_Authorization_HTTP) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_ExtensionService_Authorization_HTTP) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_ExtensionService_Authorization_HTTP.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_ExtensionService_Authorization_HTTP proto.InternalMessageInfo

func (m *MeshConfig_ExtensionService_Authorization_HTTP) GetPathPrefix() string {
	if m != nil {
		return m.PathPrefix
	}
	return ""
...
func (m *MeshConfig_ExtensionService_Authorization_HTTP) GetIncludeHeadersInCheck() []string {
	if m != nil {
...
func (m *MeshConfig_ExtensionService_Authorization_HTTP) GetHeadersToUpstreamOnAllow() []string {
	if m != nil {
...
func (m *MeshConfig_ExtensionService_Authorization_HTTP) GetHeadersToDownstreamOnDeny() []string {
	if m != nil {
...
func (m *MeshConfig_ExtensionService_Authorization_GRPC) Reset() {
	*m = MeshConfig_ExtensionService_Authorization_GRPC{}
}
func (m *MeshConfig_ExtensionService_Authorization_GRPC) String() string {
	return proto.CompactTextString(m)
}
func (*MeshConfig_ExtensionService_Authorization_GRPC) ProtoMessage() {}
func (*MeshConfig_ExtensionService_Authorization_GRPC) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 4, 0, 1}
}
func (m *MeshConfig_ExtensionService_Authorization_GRPC) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_ExtensionService_Authorization_GRPC) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_ExtensionService_Authorization_GRPC.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_ExtensionService_Authorization_GRPC) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_ExtensionService_Authorization_GRPC.Merge(m, src)
}
func (m *MeshConfig_ExtensionService_Authorization_GRPC) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_ExtensionService_Authorization_GRPC) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_ExtensionService_Authorization_GRPC.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_ExtensionService_Authorization_GRPC proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MeshConfig_ExtensionService)(nil), "istio.mesh.v1alpha1.MeshConfig.ExtensionService")
	proto.RegisterType((*MeshConfig_ExtensionService_Authorization)(nil), "istio.mesh.v1alpha1.MeshConfig.ExtensionService.Authorization")
	proto.RegisterType((*MeshConfig_ExtensionService_Authorization_HTTP)(nil), "istio.mesh.v1alpha1.MeshConfig.ExtensionService.Authorization.HTTP")
	proto.RegisterType((*MeshConfig_ExtensionService_Authorization_GRPC)(nil), "istio.mesh.v1alpha1.MeshConfig.ExtensionService.Authorization.GRPC")
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExtensionServices) > 0 {
		for iNdEx := len(m.ExtensionServices) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ExtensionServices[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *MeshConfig_ExtensionService) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_ExtensionService) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MeshConfig_ExtensionService) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MeshConfig_ExtensionService_Authorization_) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *MeshConfig_ExtensionService_Authorization_) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *MeshConfig_ExtensionService_Authorization) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_ExtensionService_Authorization) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MeshConfig_ExtensionService_Authorization) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.ExternalAuthzServiceType != nil {
		{
			size := m.ExternalAuthzServiceType.Size()
			i -= size
			if _, err := m.ExternalAuthzServiceType.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *MeshConfig_ExtensionService_Authorization_Http) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *MeshConfig_ExtensionService_Authorization_Http) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Http != nil {
		{
...
func (m *MeshConfig_ExtensionService_Authorization_Grpc) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *MeshConfig_ExtensionService_Authorization_Grpc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Grpc != nil {
		{
...
func (m *MeshConfig_ExtensionService_Authorization_HTTP) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_ExtensionService_Authorization_GRPC) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ConfigSource) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SubscribedResources) > 0 {
		dAtA24 := make([]byte, len(m.SubscribedResources)*10)
		var j23 int
		...
		i = encodeVarintConfig(dAtA, i, uint64(j23))
		i--
		dAtA[i] = 0x1a
	}
	if m.TlsSettings != nil {
...
func (m *MeshConfig) Size() (n int) {
	...
	if len(m.ExtensionServices) > 0 {
		for _, e := range m.ExtensionServices {
			l = e.Size()
			n += 2 + l + sovConfig(uint64(l))
		}
	}
...
func (m *MeshConfig_ExtensionService) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_ExtensionService_Authorization_) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_ExtensionService_Authorization) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.ExternalAuthzServiceType != nil {
		n += m.ExternalAuthzServiceType.Size()
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *MeshConfig_ExtensionService_Authorization_Http) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_ExtensionService_Authorization_Grpc) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 57:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExtensionServices", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExtensionServices = append(m.ExtensionServices, &MeshConfig_ExtensionService{})
			if err := m.ExtensionServices[len(m.ExtensionServices)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *MeshConfig_ExtensionService) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ExtensionService: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ExtensionService: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			v := &MeshConfig_ExtensionService_Authorization{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Config = &MeshConfig_ExtensionService_Authorization_{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipConfig(dAtA[iNdEx:])
...
func (m *MeshConfig_ExtensionService_Authorization) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 3:
			...
			v := &MeshConfig_ExtensionService_Authorization_HTTP{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.ExternalAuthzServiceType = &MeshConfig_ExtensionService_Authorization_Http{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			v := &MeshConfig_ExtensionService_Authorization_GRPC{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.ExternalAuthzServiceType = &MeshConfig_ExtensionService_Authorization_Grpc{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipConfig(dAtA[iNdEx:])
...
func (m *MeshConfig_ExtensionService_Authorization_HTTP) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *MeshConfig_ExtensionService_Authorization_GRPC) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
