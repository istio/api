...
type MeshConfig struct {
	...
	Service              *RateLimitService `protobuf:"bytes,58,opt,name=service,proto3" json:"service,omitempty"`
...
func (m *MeshConfig) GetService() *RateLimitService {
	if m != nil {
		return m.Service
	}
	return nil
...
func (m *RateLimitService) GetHost() string {
	if m != nil {
		return m.Host
	}
	return ""
...
func (m *RateLimitService) GetPort() uint32 {
	if m != nil {
		return m.Port
	}
	return 0
...
func (m *RateLimitService) GetFailOpen() bool {
	if m != nil {
		return m.FailOpen
	}
	return false
...
func (m *RateLimitService) GetTimeout() *types.Duration {
	if m != nil {
		return m.Timeout
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*RateLimitService)(nil), "istio.mesh.v1alpha1.RateLimitService")
}
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *RateLimitService) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RateLimitService) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RateLimitService) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RateLimitService) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RateLimitService) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RateLimitService: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RateLimitService: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
