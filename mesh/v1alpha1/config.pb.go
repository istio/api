...
type MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_AccessLogEncoding int32

const (
	// text encoding for the proxy access log
	MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_TEXT MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_AccessLogEncoding = 0
	// json encoding for the proxy access log
	MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_JSON MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_AccessLogEncoding = 1
)

var MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_AccessLogEncoding_name = map[int32]string{
	0: "TEXT",
	1: "JSON",
}

var MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_AccessLogEncoding_value = map[string]int32{
	"TEXT": 0,
	"JSON": 1,
}

func (x MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_AccessLogEncoding) String() string {
	return proto.EnumName(MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_AccessLogEncoding_name, int32(x))
}

func (MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_AccessLogEncoding) EnumDescriptor() ([]byte, []int) {
...
type MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger struct {
	// File address for the proxy access log (e.g. /dev/stdout).
	// If empty, no logs will be generated.
	...
	// Encoding for the proxy access log (`TEXT` or `JSON`).
	// Default value is `TEXT`.
	Encoding             MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_AccessLogEncoding `protobuf:"varint,3,opt,name=encoding,proto3,enum=istio.mesh.v1alpha1.MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_AccessLogEncoding" json:"encoding,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                                                  `json:"-"`
	XXX_unrecognized     []byte                                                                    `json:"-"`
	XXX_sizecache        int32                                                                     `json:"-"`
}

func (m *MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger) Reset() {
	*m = MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger{}
}
func (m *MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger) String() string {
	return proto.CompactTextString(m)
}
func (*MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger) ProtoMessage() {}
func (*MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 5, 10}
}
func (m *MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger.Merge(m, src)
}
func (m *MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger proto.InternalMessageInfo

func (m *MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger) GetFile() string {
	if m != nil {
		return m.File
	}
	return ""
...
func (m *MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger) GetFormat() string {
	if m != nil {
		return m.Format
	}
	return ""
...
func (m *MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger) GetEncoding() MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_AccessLogEncoding {
	if m != nil {
		return m.Encoding
	}
	return MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_TEXT
}
...
type MeshConfig_DefaultProviders struct {
	...
	// defined in `extension_providers` that is one of the supported tracing
	// providers.
	Tracing string `protobuf:"bytes,1,opt,name=tracing,proto3" json:"tracing,omitempty"`
	// Name of the default provider for metrics. This must match a provider
	// defined in `extension_providers` that is one of the supported metrics
	// providers.
	Metrics string `protobuf:"bytes,2,opt,name=metrics,proto3" json:"metrics,omitempty"`
	// Name of the default provider for access logging. This must match a provider
	// defined in `extension_providers` that is one of the supported access logging
	// providers.
	AccessLogging        string   `protobuf:"bytes,3,opt,name=access_logging,json=accessLogging,proto3" json:"accessLogging,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func init() {
	...
	proto.RegisterEnum("istio.mesh.v1alpha1.MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_AccessLogEncoding", MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_AccessLogEncoding_name, MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_AccessLogEncoding_value)
	...
	proto.RegisterType((*MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger)(nil), "istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyFileBasedAccessLogger")
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig_ExtensionProvider_OpenCensusAgentTracingProvider) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Context) > 0 {
		dAtA36 := make([]byte, len(m.Context)*10)
		var j35 int
...
func (m *MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Encoding != 0 {
		i = encodeVarintConfig(dAtA, i, uint64(m.Encoding))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Format) > 0 {
	...
	if len(m.File) > 0 {
		i -= len(m.File)
		copy(dAtA[i:], m.File)
		i = encodeVarintConfig(dAtA, i, uint64(len(m.File)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *MeshConfig_DefaultProviders) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AccessLogging) > 0 {
		i -= len(m.AccessLogging)
		copy(dAtA[i:], m.AccessLogging)
		i = encodeVarintConfig(dAtA, i, uint64(len(m.AccessLogging)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Metrics) > 0 {
		...
		i = encodeVarintConfig(dAtA, i, uint64(len(m.Metrics)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Tracing) > 0 {
...
func (m *MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.Encoding != 0 {
		n += 1 + sovConfig(uint64(m.Encoding))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EnvoyFileBasedAccessLogger: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EnvoyFileBasedAccessLogger: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Encoding |= MeshConfig_ExtensionProvider_EnvoyFileBasedAccessLogger_AccessLogEncoding(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *MeshConfig_DefaultProviders) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.AccessLogging = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipConfig(dAtA[iNdEx:])
