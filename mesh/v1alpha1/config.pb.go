...
type MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider struct {
	...
	// Prefix, suffix and substring matching is supported by using "*" in the format of "prefix*", "*suffix" and "*substring*".
	...
	// List of fixed header values that should be added in the authorization request sent to the authorization service.
	// Note that client request of the same key will be overridden.
	AddHeadersInCheck []*MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue `protobuf:"bytes,9,rep,name=add_headers_in_check,json=addHeadersInCheck,proto3" json:"addHeadersInCheck,omitempty"`
	...
	// List of headers from the authorization service that should be added or appended in the original request and
	// forwarded to the upstream when the authorization check result is allowed (HTTP code 200).
	// If not specified, the original request will not be modified and forwarded to backend as-is.
	// Note, any existing headers will be appended.
	// Prefix, suffix and substring matching is supported by using "*" in the format of "prefix*", "*suffix" and "*substring*".
	AppendHeadersToUpstreamOnAllow []string `protobuf:"bytes,10,rep,name=append_headers_to_upstream_on_allow,json=appendHeadersToUpstreamOnAllow,proto3" json:"appendHeadersToUpstreamOnAllow,omitempty"`
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) GetAddHeadersInCheck() []*MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue {
	if m != nil {
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) GetAppendHeadersToUpstreamOnAllow() []string {
	if m != nil {
		return m.AppendHeadersToUpstreamOnAllow
	}
	return nil
}
...
// HeaderValue defines the header name and value pair.
type MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue struct {
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue) Reset() {
	*m = MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue{}
}
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue) String() string {
	return proto.CompactTextString(m)
}
func (*MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue) ProtoMessage() {
}
func (*MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 4, 0, 0}
}
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue.Merge(m, src)
}
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue proto.InternalMessageInfo

func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue)(nil), "istio.mesh.v1alpha1.MeshConfig.ExtensionProvider.EnvoyExternalAuthorizationHttpProvider.HeaderValue")
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AppendHeadersToUpstreamOnAllow) > 0 {
		for iNdEx := len(m.AppendHeadersToUpstreamOnAllow) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.AppendHeadersToUpstreamOnAllow[iNdEx])
			copy(dAtA[i:], m.AppendHeadersToUpstreamOnAllow[iNdEx])
			i = encodeVarintConfig(dAtA, i, uint64(len(m.AppendHeadersToUpstreamOnAllow[iNdEx])))
			i--
			dAtA[i] = 0x52
		}
	}
	if len(m.AddHeadersInCheck) > 0 {
		for iNdEx := len(m.AddHeadersInCheck) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.AddHeadersInCheck[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) Size() (n int) {
	...
	if len(m.AddHeadersInCheck) > 0 {
		for _, e := range m.AddHeadersInCheck {
			l = e.Size()
			n += 1 + l + sovConfig(uint64(l))
		}
	}
	if len(m.AppendHeadersToUpstreamOnAllow) > 0 {
		for _, s := range m.AppendHeadersToUpstreamOnAllow {
			l = len(s)
			n += 1 + l + sovConfig(uint64(l))
		}
	}
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			m.AddHeadersInCheck = append(m.AddHeadersInCheck, &MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue{})
			if err := m.AddHeadersInCheck[len(m.AddHeadersInCheck)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AppendHeadersToUpstreamOnAllow", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AppendHeadersToUpstreamOnAllow = append(m.AppendHeadersToUpstreamOnAllow, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipConfig(dAtA[iNdEx:])
...
func (m *MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider_HeaderValue) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
