...
type MeshConfig struct {
	...
	InboundClusterStatName string `protobuf:"bytes,43,opt,name=inbound_cluster_stat_name,json=inboundClusterStatName,proto3" json:"inbound_cluster_stat_name,omitempty"`
	...
	// %SERVICE_FQDN%_%SERVICE_PORT% will use reviews.prod.svc.cluster.local_7443 as the stats name.
	// %SERVICE% will use reviews.prod as the stats name.
	OutboundClusterStatName string   `protobuf:"bytes,44,opt,name=outbound_cluster_stat_name,json=outboundClusterStatName,proto3" json:"outbound_cluster_stat_name,omitempty"`
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
