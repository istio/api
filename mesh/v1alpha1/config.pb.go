...
type MeshConfig struct {
	...
	// and pass to sds server, which will be used to generate key/cert eventually.
	// This isn't supported for non-k8s case.
	EnableSdsK8SSaJwt bool `protobuf:"varint,30,opt,name=enable_sds_k8s_sa_jwt,json=enableSdsK8sSaJwt,proto3" json:"enable_sds_k8s_sa_jwt,omitempty"`
...
func (m *MeshConfig) GetEnableSdsK8SSaJwt() bool {
	if m != nil {
		return m.EnableSdsK8SSaJwt
	}
	return false
}
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 30:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableSdsK8SSaJwt", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorConfig = []byte{
	...
	,
}
