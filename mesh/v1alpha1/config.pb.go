...
type MeshConfig struct {
	...
	// If omitted, Istio will create istio-ca-root-cert configmap in all namespaces except kubernetes system namespaces.
	// Elements in the list are disjunctive (OR semantics), i.e. a namespace will be included if it matches any selector.
	// The following example selects any namespace that matches either below:
	// 1. The namespace has both of these labels: `env: prod` and `region: us-east1`
	// 2. The namespace has label `app` equal to `cassandra` or `spark`.
	...
	// Refer to the [kubernetes selector docs](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors)
	// for additional detail on selector semantics.
	InjectionSelectors   []*v1.LabelSelector `protobuf:"bytes,63,rep,name=injection_selectors,json=injectionSelectors,proto3" json:"injectionSelectors,omitempty"`
...
func (m *MeshConfig) GetInjectionSelectors() []*v1.LabelSelector {
	if m != nil {
		return m.InjectionSelectors
	}
	return nil
}
...
type MeshConfig_ExtensionProvider_EnvoyOtelAls struct {
	EnvoyOtelAls *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider `protobuf:"bytes,14,opt,name=envoy_otel_als,json=envoyOtelAls,proto3,oneof" json:"envoyOtelAls,omitempty"`
}
...
type MeshConfig_ExtensionProvider_EnvoyExternalAuthorizationHttpProvider struct {
	...
	// - Prefix match: "abc*" will match on value "abc" and "abcd".
	// - Suffix match: "*abc" will match on value "abc" and "xabc".
	HeadersToDownstreamOnAllow []string `protobuf:"bytes,13,rep,name=headers_to_downstream_on_allow,json=headersToDownstreamOnAllow,proto3" json:"headersToDownstreamOnAllow,omitempty"`
	XXX_NoUnkeyedLiteral       struct{} `json:"-"`
	XXX_unrecognized           []byte   `json:"-"`
	XXX_sizecache              int32    `json:"-"`
}
...
type MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider struct {
	...
	LogFormat            *MeshConfig_ExtensionProvider_EnvoyOpenTelemetryLogProvider_LogFormat `protobuf:"bytes,4,opt,name=log_format,json=logFormat,proto3" json:"logFormat,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                                              `json:"-"`
	XXX_unrecognized     []byte                                                                `json:"-"`
	XXX_sizecache        int32                                                                 `json:"-"`
}
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.InjectionSelectors) > 0 {
		for iNdEx := len(m.InjectionSelectors) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.InjectionSelectors[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *MeshConfig_ExtensionProvider_OpenCensusAgentTracingProvider) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Context) > 0 {
		dAtA42 := make([]byte, len(m.Context)*10)
		var j41 int
		...
		i = encodeVarintConfig(dAtA, i, uint64(j41))
		i--
		dAtA[i] = 0x1a
	}
	if m.Port != 0 {
...
func (m *ConfigSource) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SubscribedResources) > 0 {
		dAtA48 := make([]byte, len(m.SubscribedResources)*10)
		var j47 int
		...
		i = encodeVarintConfig(dAtA, i, uint64(j47))
		i--
		dAtA[i] = 0x1a
	}
	if m.TlsSettings != nil {
...
func (m *MeshConfig) Size() (n int) {
	...
	if len(m.InjectionSelectors) > 0 {
		for _, e := range m.InjectionSelectors {
			l = e.Size()
			n += 2 + l + sovConfig(uint64(l))
		}
	}
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 63:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InjectionSelectors", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.InjectionSelectors = append(m.InjectionSelectors, &v1.LabelSelector{})
			if err := m.InjectionSelectors[len(m.InjectionSelectors)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
