...
type MeshConfig struct {
	...
	// If EnableInsecureSkipVerifyDestinationRule is set to true and either CaCertificates
	// or SubjectAltNames fields in DestinationRule are empty, client-side proxy will not
	// verify presented peer TLS certificates during TLS handshake.
	// Default value is false.
	EnableInsecureSkipVerifyDestinationrule bool     `protobuf:"varint,54,opt,name=enable_insecure_skip_verify_destinationrule,json=enableInsecureSkipVerifyDestinationrule,proto3" json:"enableInsecureSkipVerifyDestinationrule,omitempty"`
...
func (m *MeshConfig) GetEnableInsecureSkipVerifyDestinationrule() bool {
	if m != nil {
		return m.EnableInsecureSkipVerifyDestinationrule
	}
	return false
}
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.EnableInsecureSkipVerifyDestinationrule {
		i--
		if m.EnableInsecureSkipVerifyDestinationrule {
			dAtA[i] = 1
		} else {
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 54:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableInsecureSkipVerifyDestinationrule", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnableInsecureSkipVerifyDestinationrule = bool(v != 0)
		default:
			iNdEx = preIndex
