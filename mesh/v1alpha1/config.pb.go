...
type MeshConfig struct {
	...
	EnvoyAccesslogService *MeshConfig_EnvoyAccesslogService `protobuf:"bytes,37,opt,name=envoy_accesslog_service,json=envoyAccesslogService,proto3" json:"envoy_accesslog_service,omitempty"`
...
func (m *MeshConfig) GetEnvoyAccesslogService() *MeshConfig_EnvoyAccesslogService {
	if m != nil {
...
type MeshConfig_EnvoyAccesslogService struct {
	//host[:port]
	Address              string                                               `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
	Credentials          *MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials `protobuf:"bytes,2,opt,name=credentials,proto3" json:"credentials,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                             `json:"-"`
	XXX_unrecognized     []byte                                               `json:"-"`
	XXX_sizecache        int32                                                `json:"-"`
}

func (m *MeshConfig_EnvoyAccesslogService) Reset()         { *m = MeshConfig_EnvoyAccesslogService{} }
func (m *MeshConfig_EnvoyAccesslogService) String() string { return proto.CompactTextString(m) }
func (*MeshConfig_EnvoyAccesslogService) ProtoMessage()    {}
func (*MeshConfig_EnvoyAccesslogService) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 0}
}
func (m *MeshConfig_EnvoyAccesslogService) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_EnvoyAccesslogService) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_EnvoyAccesslogService.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *MeshConfig_EnvoyAccesslogService) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_EnvoyAccesslogService.Merge(m, src)
}
func (m *MeshConfig_EnvoyAccesslogService) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_EnvoyAccesslogService) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_EnvoyAccesslogService.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_EnvoyAccesslogService proto.InternalMessageInfo

func (m *MeshConfig_EnvoyAccesslogService) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *MeshConfig_EnvoyAccesslogService) GetCredentials() *MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials {
	if m != nil {
...
type MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials struct {
...
func (m *MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials) Reset() {
	*m = MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials{}
}
func (m *MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials) String() string {
	return proto.CompactTextString(m)
}
func (*MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials) ProtoMessage() {}
func (*MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5c7ece76d5d5022, []int{0, 0, 0}
}
func (m *MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials.Merge(m, src)
}
func (m *MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials) XXX_Size() int {
	return m.Size()
}
func (m *MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials) XXX_DiscardUnknown() {
	xxx_messageInfo_MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials.DiscardUnknown(m)
}

var xxx_messageInfo_MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials proto.InternalMessageInfo

func (m *MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials) GetRootCerts() string {
	if m != nil {
		return m.RootCerts
	}
	return ""
...
func (m *MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials) GetPrivateKey() string {
	if m != nil {
		return m.PrivateKey
	}
	return ""
...
func (m *MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials) GetCertChain() string {
	if m != nil {
		return m.CertChain
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*MeshConfig_EnvoyAccesslogService)(nil), "istio.mesh.v1alpha1.MeshConfig.EnvoyAccesslogService")
	proto.RegisterType((*MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials)(nil), "istio.mesh.v1alpha1.MeshConfig.EnvoyAccesslogService.GrpcSSLCredentials")
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EnvoyAccesslogService != nil {
		...
		n9, err9 := m.EnvoyAccesslogService.MarshalTo(dAtA[i:])
		if err9 != nil {
			return 0, err9
		}
		i += n9
...
func (m *MeshConfig_EnvoyAccesslogService) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *MeshConfig_EnvoyAccesslogService) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.Credentials != nil {
		...
		n10, err10 := m.Credentials.MarshalTo(dAtA[i:])
		if err10 != nil {
			return 0, err10
		}
		i += n10
...
func (m *MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ConfigSource) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TlsSettings != nil {
		...
		n11, err11 := m.TlsSettings.MarshalTo(dAtA[i:])
		if err11 != nil {
			return 0, err11
		}
		i += n11
...
func (m *MeshConfig_EnvoyAccesslogService) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 37:
			...
			if m.EnvoyAccesslogService == nil {
				m.EnvoyAccesslogService = &MeshConfig_EnvoyAccesslogService{}
			}
...
func (m *MeshConfig_EnvoyAccesslogService) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EnvoyAccesslogService: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EnvoyAccesslogService: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			if m.Credentials == nil {
				m.Credentials = &MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials{}
			}
...
func (m *MeshConfig_EnvoyAccesslogService_GrpcSSLCredentials) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GrpcSSLCredentials: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GrpcSSLCredentials: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
