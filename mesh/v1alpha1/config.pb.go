...
type MeshConfig struct {
	...
	// An ordered namespace list for custom service resolution. Similar to DNS,
	// progress down the list until a match is found. If no match is found then the
	// hostname does not resolve. This does not affect namespaced-scoped services that
	// cannot conflict (e.g. $namespace.$name.svc.* or $namespace.$name.svcentry.*)
	// with other hosts.
	//
	// It’s recommended that users set:
	// meshConfig:
	//
	//	customServiceResolutionPaths:
	//	 - '.' # local namespace
	//	 # users may also consider setting istio-system
	//
	// If customServiceResolutionPaths is omitted ambient workloads will see the
	// above behavior as the default. For backwards compatability, sidecar workloads
	// will see the following default:
	// meshConfig:
	//
	//	customServiceResolutionPaths:
	//	 - '.' # local namespace
	...
	//
	// Users can also set this proactively for migrations from classic to ambient
	// Istio to protect workloads that may depend on the original (but insecure)
	// global-by-default nature of ServiceEntry in classic Istio.
	//
	// With support for '*' there can still be conflicting ServiceEntry hosts;
	// The tiebreak uses the oldest creation timestamp.
	CustomServiceResolutionPaths []string `protobuf:"bytes,66,rep,name=custom_service_resolution_paths,json=customServiceResolutionPaths,proto3" json:"custom_service_resolution_paths,omitempty"`
}
...
func (x *MeshConfig) GetCustomServiceResolutionPaths() []string {
	if x != nil {
		return x.CustomServiceResolutionPaths
	}
	return nil
}
...
var file_mesh_v1alpha1_config_proto_rawDesc = []byte{
	...
	0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xaf, 0x59, 0x0a, 0x0a, 0x4d, 0x65, 0x73, 0x68,
	...
	0x45, 0x0a, 0x1f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x5f, 0x72, 0x65, 0x73, 0x6f, 0x6c, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x61, 0x74,
	0x68, 0x73, 0x18, 0x42, 0x20, 0x03, 0x28, 0x09, 0x52, 0x1c, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x75, 0x74, 0x69, 0x6f,
	0x6e, 0x50, 0x61, 0x74, 0x68, 0x73, 0x1a, 0xad, 0x01, 0x0a, 0x15, 0x4f, 0x75, 0x74, 0x62, 0x6f,
	...
	0x1a, 0xb8, 0x2f, 0x0a, 0x11, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x50, 0x72,
	...
	0x1a, 0x9e, 0x01, 0x0a, 0x15, 0x5a, 0x69, 0x70, 0x6b, 0x69, 0x6e, 0x54, 0x72, 0x61, 0x63, 0x69,
	...
	0x52, 0x0c, 0x6d, 0x61, 0x78, 0x54, 0x61, 0x67, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x12, 0x31,
	0x0a, 0x15, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x36, 0x34, 0x62, 0x69, 0x74, 0x5f, 0x74,
	0x72, 0x61, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x12, 0x65,
	0x6e, 0x61, 0x62, 0x6c, 0x65, 0x36, 0x34, 0x62, 0x69, 0x74, 0x54, 0x72, 0x61, 0x63, 0x65, 0x49,
	0x64, 0x1a, 0x91, 0x01, 0x0a, 0x18, 0x4c, 0x69, 0x67, 0x68, 0x74, 0x73, 0x74, 0x65, 0x70, 0x54,
	...
	0x75, 0x63, 0x74, 0x52, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x1a, 0x72, 0x0a, 0x1c, 0x4f,
	...
	0x0d, 0x52, 0x0c, 0x6d, 0x61, 0x78, 0x54, 0x61, 0x67, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x42,
