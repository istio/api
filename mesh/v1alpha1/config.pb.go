...
type MeshConfig struct {
	...
	AccessLogEncoding string `protobuf:"bytes,27,opt,name=access_log_encoding,json=accessLogEncoding,proto3" json:"access_log_encoding,omitempty"`
...
func (m *MeshConfig) GetAccessLogEncoding() string {
	if m != nil {
...
func (m *MeshConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.AccessLogEncoding) > 0 {
		dAtA[i] = 0xda
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintConfig(dAtA, i, uint64(len(m.AccessLogEncoding)))
		i += copy(dAtA[i:], m.AccessLogEncoding)
	}
	return i, nil
}
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 27:
			...
			m.AccessLogEncoding = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
var fileDescriptorConfig = []byte{
	...
	,
}
