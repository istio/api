...
type MeshConfig_ThriftConfig struct {
	...
	ThriftRateLimitUrl string `protobuf:"bytes,1,opt,name=thrift_rate_limit_url,json=thriftRateLimitUrl,proto3" json:"thrift_rate_limit_url,omitempty"`
	// Specify thrift rate limit service timeout, in milliseconds
	ThriftRateLimitTimeout string   `protobuf:"bytes,2,opt,name=thrift_rate_limit_timeout,json=thriftRateLimitTimeout,proto3" json:"thrift_rate_limit_timeout,omitempty"`
	XXX_NoUnkeyedLiteral   struct{} `json:"-"`
	XXX_unrecognized       []byte   `json:"-"`
	XXX_sizecache          int32    `json:"-"`
}
...
func (m *MeshConfig_ThriftConfig) GetThriftRateLimitUrl() string {
	if m != nil {
		return m.ThriftRateLimitUrl
	}
	return ""
}

func (m *MeshConfig_ThriftConfig) GetThriftRateLimitTimeout() string {
	if m != nil {
		return m.ThriftRateLimitTimeout
	}
	return ""
}
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig_ThriftConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ThriftRateLimitTimeout) > 0 {
		i -= len(m.ThriftRateLimitTimeout)
		copy(dAtA[i:], m.ThriftRateLimitTimeout)
		i = encodeVarintConfig(dAtA, i, uint64(len(m.ThriftRateLimitTimeout)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ThriftRateLimitUrl) > 0 {
		i -= len(m.ThriftRateLimitUrl)
		copy(dAtA[i:], m.ThriftRateLimitUrl)
		i = encodeVarintConfig(dAtA, i, uint64(len(m.ThriftRateLimitUrl)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *MeshConfig_ThriftConfig) Size() (n int) {
	...
	var l int
	_ = l
	l = len(m.ThriftRateLimitUrl)
	if l > 0 {
		n += 1 + l + sovConfig(uint64(l))
	}
	l = len(m.ThriftRateLimitTimeout)
	if l > 0 {
		n += 1 + l + sovConfig(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *MeshConfig_ThriftConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ThriftRateLimitUrl", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ThriftRateLimitUrl = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ThriftRateLimitTimeout", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ThriftRateLimitTimeout = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipConfig(dAtA[iNdEx:])
