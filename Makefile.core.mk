...
$(operator_v1alpha1_pb_gos) $(operator_v1alpha1_pb_doc) $(operator_v1alpha1_pb_pythons) $(operator_v1alpha1_k8s_gos): $(operator_v1alpha1_protos)
	...
	@sed -i -E '/DeepCopyInto supports using TypeMapStringInterface/,+5d' $(operator_v1alpha1_path)/operator_deepcopy.gen.go
	@sed -i -E '/DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TypeMapStringInterface/,+9d' $(operator_v1alpha1_path)/operator_deepcopy.gen.go
	@sed -i -E '/DeepCopyInto supports using TypeInterface/,+5d' $(operator_v1alpha1_path)/operator_deepcopy.gen.go
	@sed -i -E '/DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TypeInterface/,+9d' $(operator_v1alpha1_path)/operator_deepcopy.gen.go
	@sed -i -E '/MarshalJSON is a custom marshaler for TypeMapStringInterface/,+10d' $(operator_v1alpha1_path)/operator_json.gen.go
	@sed -i -E '/MarshalJSON is a custom marshaler for TypeInterface/,+10d' $(operator_v1alpha1_path)/operator_json.gen.go
