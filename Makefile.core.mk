...
$(operator_v1alpha1_pb_gos) $(operator_v1alpha1_pb_doc) $(operator_v1alpha1_pb_pythons) $(operator_v1alpha1_k8s_gos): $(operator_v1alpha1_protos)
	...
	@sed -i -E '/DeepCopyInto supports using TypeMapStringInterface2/,+5d' $(operator_v1alpha1_path)/operator_deepcopy.gen.go
	@sed -i -E '/DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TypeMapStringInterface2/,+9d' $(operator_v1alpha1_path)/operator_deepcopy.gen.go
	@sed -i -E '/DeepCopyInto supports using TypeInterface2/,+5d' $(operator_v1alpha1_path)/operator_deepcopy.gen.go
	@sed -i -E '/DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TypeInterface2/,+9d' $(operator_v1alpha1_path)/operator_deepcopy.gen.go
